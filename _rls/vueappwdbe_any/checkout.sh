...
mkdir $WEBROOT/vueappwdbe/src/components/CrdWdbeSys

cp ../../vueappwdbe/CrdWdbeSys/*.vue $WEBROOT/vueappwdbe/src/components/CrdWdbeSys/

mkdir $WEBROOT/vueappwdbe/src/components/CrdWdbeTrg

cp ../../vueappwdbe/CrdWdbeTrg/*.vue $WEBROOT/vueappwdbe/src/components/CrdWdbeTrg/
