...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeModCtrHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModCtrHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModCtrHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModCtrHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModCtrHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModCtrHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModCtrHk1NVector) this.continf = dpcheng.ContInfWdbeModCtrHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModCtrHk1NVector) this.statapp = dpcheng.StatAppWdbeModCtrHk1NVector;
				if (dpcheng.StatShrWdbeModCtrHk1NVector) this.statshr = dpcheng.StatShrWdbeModCtrHk1NVector;
				if (dpcheng.StgIacWdbeModCtrHk1NVector) this.stgiac = dpcheng.StgIacWdbeModCtrHk1NVector;
				if (dpcheng.TagWdbeModCtrHk1NVector) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModCtrHk1NVector);
					this.tag = dpcheng.TagWdbeModCtrHk1NVector;
				}
				if (dpcheng.ListWdbeQModCtrHk1NVector) this.rst = dpcheng.ListWdbeQModCtrHk1NVector;
				if (dpcheng.StatAppQryWdbeModCtrHk1NVector) this.statappqry = dpcheng.StatAppQryWdbeModCtrHk1NVector;
				if (dpcheng.StatShrQryWdbeModCtrHk1NVector) this.statshrqry = dpcheng.StatShrQryWdbeModCtrHk1NVector;
				if (dpcheng.StgIacQryWdbeModCtrHk1NVector) this.stgiacqry = dpcheng.StgIacQryWdbeModCtrHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModCtrHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModCtrHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModCtrHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
