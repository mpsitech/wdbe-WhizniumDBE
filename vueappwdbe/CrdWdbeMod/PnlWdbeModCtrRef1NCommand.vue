...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbeModCtrRef1NCommand',
		...
		mounted() {
			//console.log("PnlWdbeModCtrRef1NCommand.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbeModCtrRef1NCommandDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModCtrRef1NCommandData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModCtrRef1NCommand": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModCtrRef1NCommand"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModCtrRef1NCommandData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModCtrRef1NCommandData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModCtrRef1NCommand) this.continf = dpcheng.ContInfWdbeModCtrRef1NCommand;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModCtrRef1NCommand) this.statapp = dpcheng.StatAppWdbeModCtrRef1NCommand;
				if (dpcheng.StatShrWdbeModCtrRef1NCommand) this.statshr = dpcheng.StatShrWdbeModCtrRef1NCommand;
				if (dpcheng.StgIacWdbeModCtrRef1NCommand) this.stgiac = dpcheng.StgIacWdbeModCtrRef1NCommand;
				if (dpcheng.TagWdbeModCtrRef1NCommand) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModCtrRef1NCommand);
					this.tag = dpcheng.TagWdbeModCtrRef1NCommand;
				}
				if (dpcheng.ListWdbeQModCtrRef1NCommand) this.rst = dpcheng.ListWdbeQModCtrRef1NCommand;
				if (dpcheng.StatAppQryWdbeModCtrRef1NCommand) this.statappqry = dpcheng.StatAppQryWdbeModCtrRef1NCommand;
				if (dpcheng.StatShrQryWdbeModCtrRef1NCommand) this.statshrqry = dpcheng.StatShrQryWdbeModCtrRef1NCommand;
				if (dpcheng.StgIacQryWdbeModCtrRef1NCommand) this.stgiacqry = dpcheng.StgIacQryWdbeModCtrRef1NCommand;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModCtrRef1NCommand) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModCtrRef1NCommandData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModCtrRef1NCommandData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
