...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeModRef1NSignal.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModRef1NSignalData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModRef1NSignal": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModRef1NSignal"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModRef1NSignalData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModRef1NSignalData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModRef1NSignal) this.continf = dpcheng.ContInfWdbeModRef1NSignal;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModRef1NSignal) this.statapp = dpcheng.StatAppWdbeModRef1NSignal;
				if (dpcheng.StatShrWdbeModRef1NSignal) this.statshr = dpcheng.StatShrWdbeModRef1NSignal;
				if (dpcheng.StgIacWdbeModRef1NSignal) this.stgiac = dpcheng.StgIacWdbeModRef1NSignal;
				if (dpcheng.TagWdbeModRef1NSignal) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModRef1NSignal);
					this.tag = dpcheng.TagWdbeModRef1NSignal;
				}
				if (dpcheng.ListWdbeQModRef1NSignal) this.rst = dpcheng.ListWdbeQModRef1NSignal;
				if (dpcheng.StatAppQryWdbeModRef1NSignal) this.statappqry = dpcheng.StatAppQryWdbeModRef1NSignal;
				if (dpcheng.StatShrQryWdbeModRef1NSignal) this.statshrqry = dpcheng.StatShrQryWdbeModRef1NSignal;
				if (dpcheng.StgIacQryWdbeModRef1NSignal) this.stgiacqry = dpcheng.StgIacQryWdbeModRef1NSignal;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModRef1NSignal) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModRef1NSignalData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModRef1NSignalData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
