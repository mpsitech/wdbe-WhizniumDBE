...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeModMdl1NGeneric.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModMdl1NGenericData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModMdl1NGeneric": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModMdl1NGeneric"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModMdl1NGenericData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModMdl1NGenericData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModMdl1NGeneric) this.continf = dpcheng.ContInfWdbeModMdl1NGeneric;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModMdl1NGeneric) this.statapp = dpcheng.StatAppWdbeModMdl1NGeneric;
				if (dpcheng.StatShrWdbeModMdl1NGeneric) this.statshr = dpcheng.StatShrWdbeModMdl1NGeneric;
				if (dpcheng.StgIacWdbeModMdl1NGeneric) this.stgiac = dpcheng.StgIacWdbeModMdl1NGeneric;
				if (dpcheng.TagWdbeModMdl1NGeneric) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModMdl1NGeneric);
					this.tag = dpcheng.TagWdbeModMdl1NGeneric;
				}
				if (dpcheng.ListWdbeQModMdl1NGeneric) this.rst = dpcheng.ListWdbeQModMdl1NGeneric;
				if (dpcheng.StatAppQryWdbeModMdl1NGeneric) this.statappqry = dpcheng.StatAppQryWdbeModMdl1NGeneric;
				if (dpcheng.StatShrQryWdbeModMdl1NGeneric) this.statshrqry = dpcheng.StatShrQryWdbeModMdl1NGeneric;
				if (dpcheng.StgIacQryWdbeModMdl1NGeneric) this.stgiacqry = dpcheng.StgIacQryWdbeModMdl1NGeneric;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModMdl1NGeneric) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModMdl1NGenericData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModMdl1NGenericData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
