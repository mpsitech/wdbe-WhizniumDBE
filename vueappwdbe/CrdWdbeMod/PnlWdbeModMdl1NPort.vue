...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeModMdl1NPort.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModMdl1NPortData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModMdl1NPort": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModMdl1NPort"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModMdl1NPortData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModMdl1NPortData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModMdl1NPort) this.continf = dpcheng.ContInfWdbeModMdl1NPort;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModMdl1NPort) this.statapp = dpcheng.StatAppWdbeModMdl1NPort;
				if (dpcheng.StatShrWdbeModMdl1NPort) this.statshr = dpcheng.StatShrWdbeModMdl1NPort;
				if (dpcheng.StgIacWdbeModMdl1NPort) this.stgiac = dpcheng.StgIacWdbeModMdl1NPort;
				if (dpcheng.TagWdbeModMdl1NPort) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModMdl1NPort);
					this.tag = dpcheng.TagWdbeModMdl1NPort;
				}
				if (dpcheng.ListWdbeQModMdl1NPort) this.rst = dpcheng.ListWdbeQModMdl1NPort;
				if (dpcheng.StatAppQryWdbeModMdl1NPort) this.statappqry = dpcheng.StatAppQryWdbeModMdl1NPort;
				if (dpcheng.StatShrQryWdbeModMdl1NPort) this.statshrqry = dpcheng.StatShrQryWdbeModMdl1NPort;
				if (dpcheng.StgIacQryWdbeModMdl1NPort) this.stgiacqry = dpcheng.StgIacQryWdbeModMdl1NPort;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModMdl1NPort) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModMdl1NPortData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModMdl1NPortData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
