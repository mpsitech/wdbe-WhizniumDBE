...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeModMge1NSignal.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModMge1NSignalData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModMge1NSignal": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModMge1NSignal"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModMge1NSignalData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModMge1NSignalData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModMge1NSignal) this.continf = dpcheng.ContInfWdbeModMge1NSignal;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModMge1NSignal) this.statapp = dpcheng.StatAppWdbeModMge1NSignal;
				if (dpcheng.StatShrWdbeModMge1NSignal) this.statshr = dpcheng.StatShrWdbeModMge1NSignal;
				if (dpcheng.StgIacWdbeModMge1NSignal) this.stgiac = dpcheng.StgIacWdbeModMge1NSignal;
				if (dpcheng.TagWdbeModMge1NSignal) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModMge1NSignal);
					this.tag = dpcheng.TagWdbeModMge1NSignal;
				}
				if (dpcheng.ListWdbeQModMge1NSignal) this.rst = dpcheng.ListWdbeQModMge1NSignal;
				if (dpcheng.StatAppQryWdbeModMge1NSignal) this.statappqry = dpcheng.StatAppQryWdbeModMge1NSignal;
				if (dpcheng.StatShrQryWdbeModMge1NSignal) this.statshrqry = dpcheng.StatShrQryWdbeModMge1NSignal;
				if (dpcheng.StgIacQryWdbeModMge1NSignal) this.stgiacqry = dpcheng.StgIacQryWdbeModMge1NSignal;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModMge1NSignal) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModMge1NSignalData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModMge1NSignalData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
