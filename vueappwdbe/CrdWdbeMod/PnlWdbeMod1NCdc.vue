...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMod1NCdc.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMod1NCdcData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMod1NCdc": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMod1NCdc"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMod1NCdcData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMod1NCdcData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMod1NCdc) this.continf = dpcheng.ContInfWdbeMod1NCdc;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMod1NCdc) this.statapp = dpcheng.StatAppWdbeMod1NCdc;
				if (dpcheng.StatShrWdbeMod1NCdc) this.statshr = dpcheng.StatShrWdbeMod1NCdc;
				if (dpcheng.StgIacWdbeMod1NCdc) this.stgiac = dpcheng.StgIacWdbeMod1NCdc;
				if (dpcheng.TagWdbeMod1NCdc) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMod1NCdc);
					this.tag = dpcheng.TagWdbeMod1NCdc;
				}
				if (dpcheng.ListWdbeQMod1NCdc) this.rst = dpcheng.ListWdbeQMod1NCdc;
				if (dpcheng.StatAppQryWdbeMod1NCdc) this.statappqry = dpcheng.StatAppQryWdbeMod1NCdc;
				if (dpcheng.StatShrQryWdbeMod1NCdc) this.statshrqry = dpcheng.StatShrQryWdbeMod1NCdc;
				if (dpcheng.StgIacQryWdbeMod1NCdc) this.stgiacqry = dpcheng.StgIacQryWdbeMod1NCdc;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMod1NCdcData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMod1NCdcData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
