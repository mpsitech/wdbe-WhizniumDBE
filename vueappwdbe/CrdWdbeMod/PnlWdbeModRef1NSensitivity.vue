...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbeModRef1NSensitivity',
		...
		mounted() {
			//console.log("PnlWdbeModRef1NSensitivity.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbeModRef1NSensitivityDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModRef1NSensitivityData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModRef1NSensitivity": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModRef1NSensitivity"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModRef1NSensitivityData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModRef1NSensitivityData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModRef1NSensitivity) this.continf = dpcheng.ContInfWdbeModRef1NSensitivity;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModRef1NSensitivity) this.statapp = dpcheng.StatAppWdbeModRef1NSensitivity;
				if (dpcheng.StatShrWdbeModRef1NSensitivity) this.statshr = dpcheng.StatShrWdbeModRef1NSensitivity;
				if (dpcheng.StgIacWdbeModRef1NSensitivity) this.stgiac = dpcheng.StgIacWdbeModRef1NSensitivity;
				if (dpcheng.TagWdbeModRef1NSensitivity) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModRef1NSensitivity);
					this.tag = dpcheng.TagWdbeModRef1NSensitivity;
				}
				if (dpcheng.ListWdbeQModRef1NSensitivity) this.rst = dpcheng.ListWdbeQModRef1NSensitivity;
				if (dpcheng.StatAppQryWdbeModRef1NSensitivity) this.statappqry = dpcheng.StatAppQryWdbeModRef1NSensitivity;
				if (dpcheng.StatShrQryWdbeModRef1NSensitivity) this.statshrqry = dpcheng.StatShrQryWdbeModRef1NSensitivity;
				if (dpcheng.StgIacQryWdbeModRef1NSensitivity) this.stgiacqry = dpcheng.StgIacQryWdbeModRef1NSensitivity;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModRef1NSensitivity) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModRef1NSensitivityData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModRef1NSensitivityData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
