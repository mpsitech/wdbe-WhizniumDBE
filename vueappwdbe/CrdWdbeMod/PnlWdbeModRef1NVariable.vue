...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeModRef1NVariable.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeModRef1NVariableData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeModRef1NVariable": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeModRef1NVariable"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeModRef1NVariableData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeModRef1NVariableData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeModRef1NVariable) this.continf = dpcheng.ContInfWdbeModRef1NVariable;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeModRef1NVariable) this.statapp = dpcheng.StatAppWdbeModRef1NVariable;
				if (dpcheng.StatShrWdbeModRef1NVariable) this.statshr = dpcheng.StatShrWdbeModRef1NVariable;
				if (dpcheng.StgIacWdbeModRef1NVariable) this.stgiac = dpcheng.StgIacWdbeModRef1NVariable;
				if (dpcheng.TagWdbeModRef1NVariable) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeModRef1NVariable);
					this.tag = dpcheng.TagWdbeModRef1NVariable;
				}
				if (dpcheng.ListWdbeQModRef1NVariable) this.rst = dpcheng.ListWdbeQModRef1NVariable;
				if (dpcheng.StatAppQryWdbeModRef1NVariable) this.statappqry = dpcheng.StatAppQryWdbeModRef1NVariable;
				if (dpcheng.StatShrQryWdbeModRef1NVariable) this.statshrqry = dpcheng.StatShrQryWdbeModRef1NVariable;
				if (dpcheng.StgIacQryWdbeModRef1NVariable) this.stgiacqry = dpcheng.StgIacQryWdbeModRef1NVariable;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQModRef1NVariable) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeModRef1NVariableData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeModRef1NVariableData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
