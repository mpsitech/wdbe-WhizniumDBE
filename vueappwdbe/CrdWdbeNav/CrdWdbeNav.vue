		...
		methods: {
			...
			*/
			...
			mergeDpchEngData_pnldevdev: function(dpcheng) {
				...
				if (dpcheng.FeedFLstRls) this.pnldevdev.feedFLstRls = dpcheng.FeedFLstRls;
				if (dpcheng.FeedFLstSys) this.pnldevdev.feedFLstSys = dpcheng.FeedFLstSys;
				if (dpcheng.FeedFLstTrg) this.pnldevdev.feedFLstTrg = dpcheng.FeedFLstTrg;
		...
		data: () => ({
			...
			*/
			MenCrd: [
				...
				{
					pnlsref: "pnldevdev",
					mits: ["MitCrdPrj", "MitCrdVer", "MitCrdSys", "MitCrdTrg", "MitCrdUnt", "MitCrdRls"]
				},
				{
					pnlsref: "pnlcoredev",
			...
			*/
			...
			MbarVer: [
				{
					sref: "MenCrd",
					mits: ["MitCrdNew", "MitCrdPcv", "MitCrdImd", "MitCrdIcs", "MitCrdIda", "MitCrdGfs", "MitCrdIfs", "MitCrdFnm"]
				}
			],
			...
			MbarRls: [
				{
					sref: "MenCrd",
					mits: ["MitCrdNew", "MitCrdSrt", "MitCrdCrt", "MitCrdFrt", "MitCrdWco"]
				}
			],
