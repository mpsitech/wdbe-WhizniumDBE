...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeCmdMNController.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeCmdMNControllerData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeCmdMNController": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeCmdMNController"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeCmdMNControllerData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeCmdMNControllerData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeCmdMNController) this.continf = dpcheng.ContInfWdbeCmdMNController;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeCmdMNController) this.statapp = dpcheng.StatAppWdbeCmdMNController;
				if (dpcheng.StatShrWdbeCmdMNController) this.statshr = dpcheng.StatShrWdbeCmdMNController;
				if (dpcheng.StgIacWdbeCmdMNController) this.stgiac = dpcheng.StgIacWdbeCmdMNController;
				if (dpcheng.TagWdbeCmdMNController) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeCmdMNController);
					this.tag = dpcheng.TagWdbeCmdMNController;
				}
				if (dpcheng.ListWdbeQCmdMNController) this.rst = dpcheng.ListWdbeQCmdMNController;
				if (dpcheng.StatAppQryWdbeCmdMNController) this.statappqry = dpcheng.StatAppQryWdbeCmdMNController;
				if (dpcheng.StatShrQryWdbeCmdMNController) this.statshrqry = dpcheng.StatShrQryWdbeCmdMNController;
				if (dpcheng.StgIacQryWdbeCmdMNController) this.stgiacqry = dpcheng.StgIacQryWdbeCmdMNController;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQCmdMNController) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeCmdMNControllerData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeCmdMNControllerData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
