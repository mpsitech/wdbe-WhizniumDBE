...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeCmdHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeCmdHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeCmdHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeCmdHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeCmdHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeCmdHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeCmdHk1NVector) this.continf = dpcheng.ContInfWdbeCmdHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeCmdHk1NVector) this.statapp = dpcheng.StatAppWdbeCmdHk1NVector;
				if (dpcheng.StatShrWdbeCmdHk1NVector) this.statshr = dpcheng.StatShrWdbeCmdHk1NVector;
				if (dpcheng.StgIacWdbeCmdHk1NVector) this.stgiac = dpcheng.StgIacWdbeCmdHk1NVector;
				if (dpcheng.TagWdbeCmdHk1NVector) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeCmdHk1NVector);
					this.tag = dpcheng.TagWdbeCmdHk1NVector;
				}
				if (dpcheng.ListWdbeQCmdHk1NVector) this.rst = dpcheng.ListWdbeQCmdHk1NVector;
				if (dpcheng.StatAppQryWdbeCmdHk1NVector) this.statappqry = dpcheng.StatAppQryWdbeCmdHk1NVector;
				if (dpcheng.StatShrQryWdbeCmdHk1NVector) this.statshrqry = dpcheng.StatShrQryWdbeCmdHk1NVector;
				if (dpcheng.StgIacQryWdbeCmdHk1NVector) this.stgiacqry = dpcheng.StgIacQryWdbeCmdHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQCmdHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeCmdHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeCmdHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
