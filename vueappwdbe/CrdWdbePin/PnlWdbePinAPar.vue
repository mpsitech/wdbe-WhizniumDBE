...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePinAPar.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePinAParData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePinAPar": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePinAPar"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePinAParData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePinAParData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePinAPar) this.continf = dpcheng.ContInfWdbePinAPar;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePinAPar) this.statapp = dpcheng.StatAppWdbePinAPar;
				if (dpcheng.StatShrWdbePinAPar) this.statshr = dpcheng.StatShrWdbePinAPar;
				if (dpcheng.StgIacWdbePinAPar) this.stgiac = dpcheng.StgIacWdbePinAPar;
				if (dpcheng.TagWdbePinAPar) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePinAPar);
					this.tag = dpcheng.TagWdbePinAPar;
				}
				if (dpcheng.ListWdbeQPinAPar) this.rst = dpcheng.ListWdbeQPinAPar;
				if (dpcheng.StatAppQryWdbePinAPar) this.statappqry = dpcheng.StatAppQryWdbePinAPar;
				if (dpcheng.StatShrQryWdbePinAPar) this.statshrqry = dpcheng.StatShrQryWdbePinAPar;
				if (dpcheng.StgIacQryWdbePinAPar) this.stgiacqry = dpcheng.StgIacQryWdbePinAPar;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePinAParData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePinAParData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
