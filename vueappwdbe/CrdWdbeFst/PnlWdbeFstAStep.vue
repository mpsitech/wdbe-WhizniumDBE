			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				...
				if (dpcheng.TagWdbeFstAStep) {
					...
					/*
					*/
					tcos.push({value: "jnum", text: "jnum"}, {value: "TcoFnx", text: this.tag.TcoFnx}, {value: "TcoCn1", text: this.tag.TcoCn1}, {value: "TcoIp1", text: this.tag.TcoIp1}, {value: "TcoCn2", text: this.tag.TcoCn2}, {value: "TcoIp2", text: this.tag.TcoIp2}, {value: "TcoCn3", text: this.tag.TcoCn3}, {value: "TcoIp3", text: this.tag.TcoIp3}, {value: "TcoCn4", text: this.tag.TcoCn4}, {value: "TcoIp4", text: this.tag.TcoIp4});
					/*
					*/
				...
				if (dpcheng.ListWdbeQFstAStep) {
					...
					for (var i = 0; i < this.rst.length; i++) {
						...
						/*
						*/
						rows.push({jnum: rec["jnum"], TcoFnx: rec["fnx"], TcoCn1: rec["cn1"], TcoIp1: rec["ip1"], TcoCn2: rec["cn2"], TcoIp2: rec["ip2"], TcoCn3: rec["cn3"], TcoIp3: rec["ip3"], TcoCn4: rec["cn4"], TcoIp4: rec["ip4"]})
						/*
						*/
