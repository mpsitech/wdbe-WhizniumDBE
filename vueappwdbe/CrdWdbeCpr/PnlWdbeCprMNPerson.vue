...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeCprMNPerson.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeCprMNPersonData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeCprMNPerson": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeCprMNPerson"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeCprMNPersonData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeCprMNPersonData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeCprMNPerson) this.continf = dpcheng.ContInfWdbeCprMNPerson;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeCprMNPerson) this.statapp = dpcheng.StatAppWdbeCprMNPerson;
				if (dpcheng.StatShrWdbeCprMNPerson) this.statshr = dpcheng.StatShrWdbeCprMNPerson;
				if (dpcheng.StgIacWdbeCprMNPerson) this.stgiac = dpcheng.StgIacWdbeCprMNPerson;
				if (dpcheng.TagWdbeCprMNPerson) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeCprMNPerson);
					this.tag = dpcheng.TagWdbeCprMNPerson;
				}
				if (dpcheng.ListWdbeQCprMNPerson) this.rst = dpcheng.ListWdbeQCprMNPerson;
				if (dpcheng.StatAppQryWdbeCprMNPerson) this.statappqry = dpcheng.StatAppQryWdbeCprMNPerson;
				if (dpcheng.StatShrQryWdbeCprMNPerson) this.statshrqry = dpcheng.StatShrQryWdbeCprMNPerson;
				if (dpcheng.StgIacQryWdbeCprMNPerson) this.stgiacqry = dpcheng.StgIacQryWdbeCprMNPerson;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQCprMNPerson) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeCprMNPersonData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeCprMNPersonData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
