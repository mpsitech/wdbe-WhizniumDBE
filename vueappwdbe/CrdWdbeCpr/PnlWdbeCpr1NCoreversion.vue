...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeCpr1NCoreversion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeCpr1NCoreversionData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeCpr1NCoreversion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeCpr1NCoreversion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeCpr1NCoreversionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeCpr1NCoreversionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeCpr1NCoreversion) this.continf = dpcheng.ContInfWdbeCpr1NCoreversion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeCpr1NCoreversion) this.statapp = dpcheng.StatAppWdbeCpr1NCoreversion;
				if (dpcheng.StatShrWdbeCpr1NCoreversion) this.statshr = dpcheng.StatShrWdbeCpr1NCoreversion;
				if (dpcheng.StgIacWdbeCpr1NCoreversion) this.stgiac = dpcheng.StgIacWdbeCpr1NCoreversion;
				if (dpcheng.TagWdbeCpr1NCoreversion) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeCpr1NCoreversion);
					this.tag = dpcheng.TagWdbeCpr1NCoreversion;
				}
				if (dpcheng.ListWdbeQCpr1NCoreversion) this.rst = dpcheng.ListWdbeQCpr1NCoreversion;
				if (dpcheng.StatAppQryWdbeCpr1NCoreversion) this.statappqry = dpcheng.StatAppQryWdbeCpr1NCoreversion;
				if (dpcheng.StatShrQryWdbeCpr1NCoreversion) this.statshrqry = dpcheng.StatShrQryWdbeCpr1NCoreversion;
				if (dpcheng.StgIacQryWdbeCpr1NCoreversion) this.stgiacqry = dpcheng.StgIacQryWdbeCpr1NCoreversion;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQCpr1NCoreversion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeCpr1NCoreversionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeCpr1NCoreversionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
