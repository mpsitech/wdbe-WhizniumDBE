...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeBnk1NPin.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeBnk1NPinData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeBnk1NPin": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeBnk1NPin"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeBnk1NPinData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeBnk1NPinData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeBnk1NPin) this.continf = dpcheng.ContInfWdbeBnk1NPin;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeBnk1NPin) this.statapp = dpcheng.StatAppWdbeBnk1NPin;
				if (dpcheng.StatShrWdbeBnk1NPin) this.statshr = dpcheng.StatShrWdbeBnk1NPin;
				if (dpcheng.StgIacWdbeBnk1NPin) this.stgiac = dpcheng.StgIacWdbeBnk1NPin;
				if (dpcheng.TagWdbeBnk1NPin) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeBnk1NPin);
					this.tag = dpcheng.TagWdbeBnk1NPin;
				}
				if (dpcheng.ListWdbeQBnk1NPin) this.rst = dpcheng.ListWdbeQBnk1NPin;
				if (dpcheng.StatAppQryWdbeBnk1NPin) this.statappqry = dpcheng.StatAppQryWdbeBnk1NPin;
				if (dpcheng.StatShrQryWdbeBnk1NPin) this.statshrqry = dpcheng.StatShrQryWdbeBnk1NPin;
				if (dpcheng.StgIacQryWdbeBnk1NPin) this.stgiacqry = dpcheng.StgIacQryWdbeBnk1NPin;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeBnk1NPinData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeBnk1NPinData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
