...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbePrtSrc1NSensitivity',
		...
		mounted() {
			//console.log("PnlWdbePrtSrc1NSensitivity.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbePrtSrc1NSensitivityDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrtSrc1NSensitivityData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrtSrc1NSensitivity": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrtSrc1NSensitivity"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrtSrc1NSensitivityData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrtSrc1NSensitivityData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrtSrc1NSensitivity) this.continf = dpcheng.ContInfWdbePrtSrc1NSensitivity;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrtSrc1NSensitivity) this.statapp = dpcheng.StatAppWdbePrtSrc1NSensitivity;
				if (dpcheng.StatShrWdbePrtSrc1NSensitivity) this.statshr = dpcheng.StatShrWdbePrtSrc1NSensitivity;
				if (dpcheng.StgIacWdbePrtSrc1NSensitivity) this.stgiac = dpcheng.StgIacWdbePrtSrc1NSensitivity;
				if (dpcheng.TagWdbePrtSrc1NSensitivity) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrtSrc1NSensitivity);
					this.tag = dpcheng.TagWdbePrtSrc1NSensitivity;
				}
				if (dpcheng.ListWdbeQPrtSrc1NSensitivity) this.rst = dpcheng.ListWdbeQPrtSrc1NSensitivity;
				if (dpcheng.StatAppQryWdbePrtSrc1NSensitivity) this.statappqry = dpcheng.StatAppQryWdbePrtSrc1NSensitivity;
				if (dpcheng.StatShrQryWdbePrtSrc1NSensitivity) this.statshrqry = dpcheng.StatShrQryWdbePrtSrc1NSensitivity;
				if (dpcheng.StgIacQryWdbePrtSrc1NSensitivity) this.stgiacqry = dpcheng.StgIacQryWdbePrtSrc1NSensitivity;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrtSrc1NSensitivity) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrtSrc1NSensitivityData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrtSrc1NSensitivityData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
