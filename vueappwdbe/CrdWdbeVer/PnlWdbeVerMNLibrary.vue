...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeVerMNLibrary.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeVerMNLibraryData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeVerMNLibrary": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeVerMNLibrary"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeVerMNLibraryData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeVerMNLibraryData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeVerMNLibrary) this.continf = dpcheng.ContInfWdbeVerMNLibrary;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeVerMNLibrary) this.statapp = dpcheng.StatAppWdbeVerMNLibrary;
				if (dpcheng.StatShrWdbeVerMNLibrary) this.statshr = dpcheng.StatShrWdbeVerMNLibrary;
				if (dpcheng.StgIacWdbeVerMNLibrary) this.stgiac = dpcheng.StgIacWdbeVerMNLibrary;
				if (dpcheng.TagWdbeVerMNLibrary) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeVerMNLibrary);
					this.tag = dpcheng.TagWdbeVerMNLibrary;
				}
				if (dpcheng.ListWdbeQVerMNLibrary) this.rst = dpcheng.ListWdbeQVerMNLibrary;
				if (dpcheng.StatAppQryWdbeVerMNLibrary) this.statappqry = dpcheng.StatAppQryWdbeVerMNLibrary;
				if (dpcheng.StatShrQryWdbeVerMNLibrary) this.statshrqry = dpcheng.StatShrQryWdbeVerMNLibrary;
				if (dpcheng.StgIacQryWdbeVerMNLibrary) this.stgiacqry = dpcheng.StgIacQryWdbeVerMNLibrary;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQVerMNLibrary) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeVerMNLibraryData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeVerMNLibraryData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
