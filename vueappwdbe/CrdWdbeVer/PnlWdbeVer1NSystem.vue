...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeVer1NSystem.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeVer1NSystemData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeVer1NSystem": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeVer1NSystem"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeVer1NSystemData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeVer1NSystemData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeVer1NSystem) this.continf = dpcheng.ContInfWdbeVer1NSystem;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeVer1NSystem) this.statapp = dpcheng.StatAppWdbeVer1NSystem;
				if (dpcheng.StatShrWdbeVer1NSystem) this.statshr = dpcheng.StatShrWdbeVer1NSystem;
				if (dpcheng.StgIacWdbeVer1NSystem) this.stgiac = dpcheng.StgIacWdbeVer1NSystem;
				if (dpcheng.TagWdbeVer1NSystem) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeVer1NSystem);
					this.tag = dpcheng.TagWdbeVer1NSystem;
				}
				if (dpcheng.ListWdbeQVer1NSystem) this.rst = dpcheng.ListWdbeQVer1NSystem;
				if (dpcheng.StatAppQryWdbeVer1NSystem) this.statappqry = dpcheng.StatAppQryWdbeVer1NSystem;
				if (dpcheng.StatShrQryWdbeVer1NSystem) this.statshrqry = dpcheng.StatShrQryWdbeVer1NSystem;
				if (dpcheng.StgIacQryWdbeVer1NSystem) this.stgiacqry = dpcheng.StgIacQryWdbeVer1NSystem;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQVer1NSystem) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeVer1NSystemData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeVer1NSystemData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
