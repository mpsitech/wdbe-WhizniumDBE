...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeVerBvr1NVersion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeVerBvr1NVersionData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeVerBvr1NVersion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeVerBvr1NVersion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeVerBvr1NVersionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeVerBvr1NVersionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeVerBvr1NVersion) this.continf = dpcheng.ContInfWdbeVerBvr1NVersion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeVerBvr1NVersion) this.statapp = dpcheng.StatAppWdbeVerBvr1NVersion;
				if (dpcheng.StatShrWdbeVerBvr1NVersion) this.statshr = dpcheng.StatShrWdbeVerBvr1NVersion;
				if (dpcheng.StgIacWdbeVerBvr1NVersion) this.stgiac = dpcheng.StgIacWdbeVerBvr1NVersion;
				if (dpcheng.TagWdbeVerBvr1NVersion) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeVerBvr1NVersion);
					this.tag = dpcheng.TagWdbeVerBvr1NVersion;
				}
				if (dpcheng.ListWdbeQVerBvr1NVersion) this.rst = dpcheng.ListWdbeQVerBvr1NVersion;
				if (dpcheng.StatAppQryWdbeVerBvr1NVersion) this.statappqry = dpcheng.StatAppQryWdbeVerBvr1NVersion;
				if (dpcheng.StatShrQryWdbeVerBvr1NVersion) this.statshrqry = dpcheng.StatShrQryWdbeVerBvr1NVersion;
				if (dpcheng.StgIacQryWdbeVerBvr1NVersion) this.stgiacqry = dpcheng.StgIacQryWdbeVerBvr1NVersion;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQVerBvr1NVersion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeVerBvr1NVersionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeVerBvr1NVersionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
