...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeVer1NRelease.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeVer1NReleaseData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeVer1NRelease": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeVer1NRelease"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeVer1NReleaseData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeVer1NReleaseData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeVer1NRelease) this.continf = dpcheng.ContInfWdbeVer1NRelease;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeVer1NRelease) this.statapp = dpcheng.StatAppWdbeVer1NRelease;
				if (dpcheng.StatShrWdbeVer1NRelease) this.statshr = dpcheng.StatShrWdbeVer1NRelease;
				if (dpcheng.StgIacWdbeVer1NRelease) this.stgiac = dpcheng.StgIacWdbeVer1NRelease;
				if (dpcheng.TagWdbeVer1NRelease) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeVer1NRelease);
					this.tag = dpcheng.TagWdbeVer1NRelease;
				}
				if (dpcheng.ListWdbeQVer1NRelease) this.rst = dpcheng.ListWdbeQVer1NRelease;
				if (dpcheng.StatAppQryWdbeVer1NRelease) this.statappqry = dpcheng.StatAppQryWdbeVer1NRelease;
				if (dpcheng.StatShrQryWdbeVer1NRelease) this.statshrqry = dpcheng.StatShrQryWdbeVer1NRelease;
				if (dpcheng.StgIacQryWdbeVer1NRelease) this.stgiacqry = dpcheng.StgIacQryWdbeVer1NRelease;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQVer1NRelease) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeVer1NReleaseData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeVer1NReleaseData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
