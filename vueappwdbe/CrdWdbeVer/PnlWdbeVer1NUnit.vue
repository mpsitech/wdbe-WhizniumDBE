...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeVer1NUnit.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeVer1NUnitData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeVer1NUnit": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeVer1NUnit"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeVer1NUnitData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeVer1NUnitData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeVer1NUnit) this.continf = dpcheng.ContInfWdbeVer1NUnit;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeVer1NUnit) this.statapp = dpcheng.StatAppWdbeVer1NUnit;
				if (dpcheng.StatShrWdbeVer1NUnit) this.statshr = dpcheng.StatShrWdbeVer1NUnit;
				if (dpcheng.StgIacWdbeVer1NUnit) this.stgiac = dpcheng.StgIacWdbeVer1NUnit;
				if (dpcheng.TagWdbeVer1NUnit) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeVer1NUnit);
					this.tag = dpcheng.TagWdbeVer1NUnit;
				}
				if (dpcheng.ListWdbeQVer1NUnit) this.rst = dpcheng.ListWdbeQVer1NUnit;
				if (dpcheng.StatAppQryWdbeVer1NUnit) this.statappqry = dpcheng.StatAppQryWdbeVer1NUnit;
				if (dpcheng.StatShrQryWdbeVer1NUnit) this.statshrqry = dpcheng.StatShrQryWdbeVer1NUnit;
				if (dpcheng.StgIacQryWdbeVer1NUnit) this.stgiacqry = dpcheng.StgIacQryWdbeVer1NUnit;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeVer1NUnitData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeVer1NUnitData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
