...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeVerRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeVerRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeVerRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeVerRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeVerRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeVerRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeVerRef1NFile) this.continf = dpcheng.ContInfWdbeVerRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeVerRef1NFile) this.statapp = dpcheng.StatAppWdbeVerRef1NFile;
				if (dpcheng.StatShrWdbeVerRef1NFile) this.statshr = dpcheng.StatShrWdbeVerRef1NFile;
				if (dpcheng.StgIacWdbeVerRef1NFile) this.stgiac = dpcheng.StgIacWdbeVerRef1NFile;
				if (dpcheng.TagWdbeVerRef1NFile) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeVerRef1NFile);
					this.tag = dpcheng.TagWdbeVerRef1NFile;
				}
				if (dpcheng.ListWdbeQVerRef1NFile) this.rst = dpcheng.ListWdbeQVerRef1NFile;
				if (dpcheng.StatAppQryWdbeVerRef1NFile) this.statappqry = dpcheng.StatAppQryWdbeVerRef1NFile;
				if (dpcheng.StatShrQryWdbeVerRef1NFile) this.statshrqry = dpcheng.StatShrQryWdbeVerRef1NFile;
				if (dpcheng.StgIacQryWdbeVerRef1NFile) this.stgiacqry = dpcheng.StgIacQryWdbeVerRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQVerRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeVerRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeVerRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
