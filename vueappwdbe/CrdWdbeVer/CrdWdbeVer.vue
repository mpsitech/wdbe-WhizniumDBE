				...
				*/
				...
				if (dpcheng.StatShrWdbeVer) {
					if (this.statshr != null) {
						dlgopen = ((dpcheng.StatShrWdbeVer.scrJrefDlgcmdset != "") || (dpcheng.StatShrWdbeVer.scrJrefDlgcustfst != "") || (dpcheng.StatShrWdbeVer.scrJrefDlgdflalg != "") || (dpcheng.StatShrWdbeVer.scrJrefDlgfinmod != "") || (dpcheng.StatShrWdbeVer.scrJrefDlggenfst != "") || (dpcheng.StatShrWdbeVer.scrJrefDlgmdlstr != "") || (dpcheng.StatShrWdbeVer.scrJrefDlgnew != ""));
						dlgclose = ((this.statshr.scrJrefDlgcmdset != "") || (this.statshr.scrJrefDlgcustfst != "") || (this.statshr.scrJrefDlgdflalg != "") || (this.statshr.scrJrefDlgfinmod != "") || (this.statshr.scrJrefDlggenfst != "") || (this.statshr.scrJrefDlgmdlstr != "") || (this.statshr.scrJrefDlgnew != ""));
						if (dlgopen && dlgclose) {
							dlgopen = false;
							dlgclose = false;
						}
