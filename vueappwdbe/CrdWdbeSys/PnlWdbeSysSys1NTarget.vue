...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSysSys1NTarget.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSysSys1NTargetData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSysSys1NTarget": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSysSys1NTarget"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSysSys1NTargetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSysSys1NTargetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSysSys1NTarget) this.continf = dpcheng.ContInfWdbeSysSys1NTarget;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSysSys1NTarget) this.statapp = dpcheng.StatAppWdbeSysSys1NTarget;
				if (dpcheng.StatShrWdbeSysSys1NTarget) this.statshr = dpcheng.StatShrWdbeSysSys1NTarget;
				if (dpcheng.StgIacWdbeSysSys1NTarget) this.stgiac = dpcheng.StgIacWdbeSysSys1NTarget;
				if (dpcheng.TagWdbeSysSys1NTarget) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSysSys1NTarget);
					this.tag = dpcheng.TagWdbeSysSys1NTarget;
				}
				if (dpcheng.ListWdbeQSysSys1NTarget) this.rst = dpcheng.ListWdbeQSysSys1NTarget;
				if (dpcheng.StatAppQryWdbeSysSys1NTarget) this.statappqry = dpcheng.StatAppQryWdbeSysSys1NTarget;
				if (dpcheng.StatShrQryWdbeSysSys1NTarget) this.statshrqry = dpcheng.StatShrQryWdbeSysSys1NTarget;
				if (dpcheng.StgIacQryWdbeSysSys1NTarget) this.stgiacqry = dpcheng.StgIacQryWdbeSysSys1NTarget;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSysSys1NTarget) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSysSys1NTargetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSysSys1NTargetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
