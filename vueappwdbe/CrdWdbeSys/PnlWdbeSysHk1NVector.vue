...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSysHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSysHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSysHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSysHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSysHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSysHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSysHk1NVector) this.continf = dpcheng.ContInfWdbeSysHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSysHk1NVector) this.statapp = dpcheng.StatAppWdbeSysHk1NVector;
				if (dpcheng.StatShrWdbeSysHk1NVector) this.statshr = dpcheng.StatShrWdbeSysHk1NVector;
				if (dpcheng.StgIacWdbeSysHk1NVector) this.stgiac = dpcheng.StgIacWdbeSysHk1NVector;
				if (dpcheng.TagWdbeSysHk1NVector) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSysHk1NVector);
					this.tag = dpcheng.TagWdbeSysHk1NVector;
				}
				if (dpcheng.ListWdbeQSysHk1NVector) this.rst = dpcheng.ListWdbeQSysHk1NVector;
				if (dpcheng.StatAppQryWdbeSysHk1NVector) this.statappqry = dpcheng.StatAppQryWdbeSysHk1NVector;
				if (dpcheng.StatShrQryWdbeSysHk1NVector) this.statshrqry = dpcheng.StatShrQryWdbeSysHk1NVector;
				if (dpcheng.StgIacQryWdbeSysHk1NVector) this.stgiacqry = dpcheng.StgIacQryWdbeSysHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSysHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSysHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSysHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
