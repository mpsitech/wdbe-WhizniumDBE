...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSilRef1NError.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSilRef1NErrorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSilRef1NError": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSilRef1NError"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSilRef1NErrorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSilRef1NErrorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSilRef1NError) this.continf = dpcheng.ContInfWdbeSilRef1NError;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSilRef1NError) this.statapp = dpcheng.StatAppWdbeSilRef1NError;
				if (dpcheng.StatShrWdbeSilRef1NError) this.statshr = dpcheng.StatShrWdbeSilRef1NError;
				if (dpcheng.StgIacWdbeSilRef1NError) this.stgiac = dpcheng.StgIacWdbeSilRef1NError;
				if (dpcheng.TagWdbeSilRef1NError) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSilRef1NError);
					this.tag = dpcheng.TagWdbeSilRef1NError;
				}
				if (dpcheng.ListWdbeQSilRef1NError) this.rst = dpcheng.ListWdbeQSilRef1NError;
				if (dpcheng.StatAppQryWdbeSilRef1NError) this.statappqry = dpcheng.StatAppQryWdbeSilRef1NError;
				if (dpcheng.StatShrQryWdbeSilRef1NError) this.statshrqry = dpcheng.StatShrQryWdbeSilRef1NError;
				if (dpcheng.StgIacQryWdbeSilRef1NError) this.stgiacqry = dpcheng.StgIacQryWdbeSilRef1NError;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSilRef1NError) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSilRef1NErrorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSilRef1NErrorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
