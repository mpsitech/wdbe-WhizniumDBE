...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSilHk1NModule.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSilHk1NModuleData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSilHk1NModule": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSilHk1NModule"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSilHk1NModuleData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSilHk1NModuleData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSilHk1NModule) this.continf = dpcheng.ContInfWdbeSilHk1NModule;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSilHk1NModule) this.statapp = dpcheng.StatAppWdbeSilHk1NModule;
				if (dpcheng.StatShrWdbeSilHk1NModule) this.statshr = dpcheng.StatShrWdbeSilHk1NModule;
				if (dpcheng.StgIacWdbeSilHk1NModule) this.stgiac = dpcheng.StgIacWdbeSilHk1NModule;
				if (dpcheng.TagWdbeSilHk1NModule) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSilHk1NModule);
					this.tag = dpcheng.TagWdbeSilHk1NModule;
				}
				if (dpcheng.ListWdbeQSilHk1NModule) this.rst = dpcheng.ListWdbeQSilHk1NModule;
				if (dpcheng.StatAppQryWdbeSilHk1NModule) this.statappqry = dpcheng.StatAppQryWdbeSilHk1NModule;
				if (dpcheng.StatShrQryWdbeSilHk1NModule) this.statshrqry = dpcheng.StatShrQryWdbeSilHk1NModule;
				if (dpcheng.StgIacQryWdbeSilHk1NModule) this.stgiacqry = dpcheng.StgIacQryWdbeSilHk1NModule;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSilHk1NModule) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSilHk1NModuleData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSilHk1NModuleData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
