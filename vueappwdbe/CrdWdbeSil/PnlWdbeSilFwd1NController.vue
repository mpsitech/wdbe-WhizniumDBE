...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbeSilFwd1NController',
		...
		mounted() {
			//console.log("PnlWdbeSilFwd1NController.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbeSilFwd1NControllerDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSilFwd1NControllerData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSilFwd1NController": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSilFwd1NController"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSilFwd1NControllerData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSilFwd1NControllerData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSilFwd1NController) this.continf = dpcheng.ContInfWdbeSilFwd1NController;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSilFwd1NController) this.statapp = dpcheng.StatAppWdbeSilFwd1NController;
				if (dpcheng.StatShrWdbeSilFwd1NController) this.statshr = dpcheng.StatShrWdbeSilFwd1NController;
				if (dpcheng.StgIacWdbeSilFwd1NController) this.stgiac = dpcheng.StgIacWdbeSilFwd1NController;
				if (dpcheng.TagWdbeSilFwd1NController) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSilFwd1NController);
					this.tag = dpcheng.TagWdbeSilFwd1NController;
				}
				if (dpcheng.ListWdbeQSilFwd1NController) this.rst = dpcheng.ListWdbeQSilFwd1NController;
				if (dpcheng.StatAppQryWdbeSilFwd1NController) this.statappqry = dpcheng.StatAppQryWdbeSilFwd1NController;
				if (dpcheng.StatShrQryWdbeSilFwd1NController) this.statshrqry = dpcheng.StatShrQryWdbeSilFwd1NController;
				if (dpcheng.StgIacQryWdbeSilFwd1NController) this.stgiacqry = dpcheng.StgIacQryWdbeSilFwd1NController;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSilFwd1NController) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSilFwd1NControllerData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSilFwd1NControllerData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
