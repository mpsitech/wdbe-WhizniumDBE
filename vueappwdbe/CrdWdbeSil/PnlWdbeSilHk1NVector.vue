...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSilHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSilHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSilHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSilHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSilHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSilHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSilHk1NVector) this.continf = dpcheng.ContInfWdbeSilHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSilHk1NVector) this.statapp = dpcheng.StatAppWdbeSilHk1NVector;
				if (dpcheng.StatShrWdbeSilHk1NVector) this.statshr = dpcheng.StatShrWdbeSilHk1NVector;
				if (dpcheng.StgIacWdbeSilHk1NVector) this.stgiac = dpcheng.StgIacWdbeSilHk1NVector;
				if (dpcheng.TagWdbeSilHk1NVector) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSilHk1NVector);
					this.tag = dpcheng.TagWdbeSilHk1NVector;
				}
				if (dpcheng.ListWdbeQSilHk1NVector) this.rst = dpcheng.ListWdbeQSilHk1NVector;
				if (dpcheng.StatAppQryWdbeSilHk1NVector) this.statappqry = dpcheng.StatAppQryWdbeSilHk1NVector;
				if (dpcheng.StatShrQryWdbeSilHk1NVector) this.statshrqry = dpcheng.StatShrQryWdbeSilHk1NVector;
				if (dpcheng.StgIacQryWdbeSilHk1NVector) this.stgiacqry = dpcheng.StgIacQryWdbeSilHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSilHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSilHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSilHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
