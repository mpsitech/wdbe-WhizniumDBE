...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSilRef1NSignal.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSilRef1NSignalData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSilRef1NSignal": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSilRef1NSignal"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSilRef1NSignalData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSilRef1NSignalData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSilRef1NSignal) this.continf = dpcheng.ContInfWdbeSilRef1NSignal;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSilRef1NSignal) this.statapp = dpcheng.StatAppWdbeSilRef1NSignal;
				if (dpcheng.StatShrWdbeSilRef1NSignal) this.statshr = dpcheng.StatShrWdbeSilRef1NSignal;
				if (dpcheng.StgIacWdbeSilRef1NSignal) this.stgiac = dpcheng.StgIacWdbeSilRef1NSignal;
				if (dpcheng.TagWdbeSilRef1NSignal) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSilRef1NSignal);
					this.tag = dpcheng.TagWdbeSilRef1NSignal;
				}
				if (dpcheng.ListWdbeQSilRef1NSignal) this.rst = dpcheng.ListWdbeQSilRef1NSignal;
				if (dpcheng.StatAppQryWdbeSilRef1NSignal) this.statappqry = dpcheng.StatAppQryWdbeSilRef1NSignal;
				if (dpcheng.StatShrQryWdbeSilRef1NSignal) this.statshrqry = dpcheng.StatShrQryWdbeSilRef1NSignal;
				if (dpcheng.StgIacQryWdbeSilRef1NSignal) this.stgiacqry = dpcheng.StgIacQryWdbeSilRef1NSignal;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSilRef1NSignal) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSilRef1NSignalData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSilRef1NSignalData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
