...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSil1NPeripheral.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSil1NPeripheralData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSil1NPeripheral": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSil1NPeripheral"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSil1NPeripheralData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSil1NPeripheralData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSil1NPeripheral) this.continf = dpcheng.ContInfWdbeSil1NPeripheral;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSil1NPeripheral) this.statapp = dpcheng.StatAppWdbeSil1NPeripheral;
				if (dpcheng.StatShrWdbeSil1NPeripheral) this.statshr = dpcheng.StatShrWdbeSil1NPeripheral;
				if (dpcheng.StgIacWdbeSil1NPeripheral) this.stgiac = dpcheng.StgIacWdbeSil1NPeripheral;
				if (dpcheng.TagWdbeSil1NPeripheral) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSil1NPeripheral);
					this.tag = dpcheng.TagWdbeSil1NPeripheral;
				}
				if (dpcheng.ListWdbeQSil1NPeripheral) this.rst = dpcheng.ListWdbeQSil1NPeripheral;
				if (dpcheng.StatAppQryWdbeSil1NPeripheral) this.statappqry = dpcheng.StatAppQryWdbeSil1NPeripheral;
				if (dpcheng.StatShrQryWdbeSil1NPeripheral) this.statshrqry = dpcheng.StatShrQryWdbeSil1NPeripheral;
				if (dpcheng.StgIacQryWdbeSil1NPeripheral) this.stgiacqry = dpcheng.StgIacQryWdbeSil1NPeripheral;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSil1NPeripheral) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSil1NPeripheralData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSil1NPeripheralData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
