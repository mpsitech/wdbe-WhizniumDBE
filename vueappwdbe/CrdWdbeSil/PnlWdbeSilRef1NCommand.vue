...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSilRef1NCommand.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSilRef1NCommandData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSilRef1NCommand": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSilRef1NCommand"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSilRef1NCommandData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSilRef1NCommandData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSilRef1NCommand) this.continf = dpcheng.ContInfWdbeSilRef1NCommand;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSilRef1NCommand) this.statapp = dpcheng.StatAppWdbeSilRef1NCommand;
				if (dpcheng.StatShrWdbeSilRef1NCommand) this.statshr = dpcheng.StatShrWdbeSilRef1NCommand;
				if (dpcheng.StgIacWdbeSilRef1NCommand) this.stgiac = dpcheng.StgIacWdbeSilRef1NCommand;
				if (dpcheng.TagWdbeSilRef1NCommand) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSilRef1NCommand);
					this.tag = dpcheng.TagWdbeSilRef1NCommand;
				}
				if (dpcheng.ListWdbeQSilRef1NCommand) this.rst = dpcheng.ListWdbeQSilRef1NCommand;
				if (dpcheng.StatAppQryWdbeSilRef1NCommand) this.statappqry = dpcheng.StatAppQryWdbeSilRef1NCommand;
				if (dpcheng.StatShrQryWdbeSilRef1NCommand) this.statshrqry = dpcheng.StatShrQryWdbeSilRef1NCommand;
				if (dpcheng.StgIacQryWdbeSilRef1NCommand) this.stgiacqry = dpcheng.StgIacQryWdbeSilRef1NCommand;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSilRef1NCommand) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSilRef1NCommandData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSilRef1NCommandData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
