...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSil1NTarget.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSil1NTargetData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSil1NTarget": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSil1NTarget"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSil1NTargetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSil1NTargetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSil1NTarget) this.continf = dpcheng.ContInfWdbeSil1NTarget;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSil1NTarget) this.statapp = dpcheng.StatAppWdbeSil1NTarget;
				if (dpcheng.StatShrWdbeSil1NTarget) this.statshr = dpcheng.StatShrWdbeSil1NTarget;
				if (dpcheng.StgIacWdbeSil1NTarget) this.stgiac = dpcheng.StgIacWdbeSil1NTarget;
				if (dpcheng.TagWdbeSil1NTarget) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSil1NTarget);
					this.tag = dpcheng.TagWdbeSil1NTarget;
				}
				if (dpcheng.ListWdbeQSil1NTarget) this.rst = dpcheng.ListWdbeQSil1NTarget;
				if (dpcheng.StatAppQryWdbeSil1NTarget) this.statappqry = dpcheng.StatAppQryWdbeSil1NTarget;
				if (dpcheng.StatShrQryWdbeSil1NTarget) this.statshrqry = dpcheng.StatShrQryWdbeSil1NTarget;
				if (dpcheng.StgIacQryWdbeSil1NTarget) this.stgiacqry = dpcheng.StgIacQryWdbeSil1NTarget;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSil1NTarget) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSil1NTargetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSil1NTargetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
