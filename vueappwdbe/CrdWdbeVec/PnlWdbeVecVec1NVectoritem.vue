...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbeVecVec1NVectoritem',
		...
		mounted() {
			//console.log("PnlWdbeVecVec1NVectoritem.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbeVecVec1NVectoritemDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeVecVec1NVectoritemData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeVecVec1NVectoritem": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeVecVec1NVectoritem"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeVecVec1NVectoritemData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeVecVec1NVectoritemData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeVecVec1NVectoritem) this.continf = dpcheng.ContInfWdbeVecVec1NVectoritem;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeVecVec1NVectoritem) this.statapp = dpcheng.StatAppWdbeVecVec1NVectoritem;
				if (dpcheng.StatShrWdbeVecVec1NVectoritem) this.statshr = dpcheng.StatShrWdbeVecVec1NVectoritem;
				if (dpcheng.StgIacWdbeVecVec1NVectoritem) this.stgiac = dpcheng.StgIacWdbeVecVec1NVectoritem;
				if (dpcheng.TagWdbeVecVec1NVectoritem) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeVecVec1NVectoritem);
					this.tag = dpcheng.TagWdbeVecVec1NVectoritem;
				}
				if (dpcheng.ListWdbeQVecVec1NVectoritem) this.rst = dpcheng.ListWdbeQVecVec1NVectoritem;
				if (dpcheng.StatAppQryWdbeVecVec1NVectoritem) this.statappqry = dpcheng.StatAppQryWdbeVecVec1NVectoritem;
				if (dpcheng.StatShrQryWdbeVecVec1NVectoritem) this.statshrqry = dpcheng.StatShrQryWdbeVecVec1NVectoritem;
				if (dpcheng.StgIacQryWdbeVecVec1NVectoritem) this.stgiacqry = dpcheng.StgIacQryWdbeVecVec1NVectoritem;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQVecVec1NVectoritem) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeVecVec1NVectoritemData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeVecVec1NVectoritemData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
