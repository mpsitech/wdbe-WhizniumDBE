...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbePrcFsmFsm1NFsmstate',
		...
		mounted() {
			//console.log("PnlWdbePrcFsmFsm1NFsmstate.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbePrcFsmFsm1NFsmstateDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrcFsmFsm1NFsmstateData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrcFsmFsm1NFsmstate": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrcFsmFsm1NFsmstate"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrcFsmFsm1NFsmstateData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrcFsmFsm1NFsmstateData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrcFsmFsm1NFsmstate) this.continf = dpcheng.ContInfWdbePrcFsmFsm1NFsmstate;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrcFsmFsm1NFsmstate) this.statapp = dpcheng.StatAppWdbePrcFsmFsm1NFsmstate;
				if (dpcheng.StatShrWdbePrcFsmFsm1NFsmstate) this.statshr = dpcheng.StatShrWdbePrcFsmFsm1NFsmstate;
				if (dpcheng.StgIacWdbePrcFsmFsm1NFsmstate) this.stgiac = dpcheng.StgIacWdbePrcFsmFsm1NFsmstate;
				if (dpcheng.TagWdbePrcFsmFsm1NFsmstate) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrcFsmFsm1NFsmstate);
					this.tag = dpcheng.TagWdbePrcFsmFsm1NFsmstate;
				}
				if (dpcheng.ListWdbeQPrcFsmFsm1NFsmstate) this.rst = dpcheng.ListWdbeQPrcFsmFsm1NFsmstate;
				if (dpcheng.StatAppQryWdbePrcFsmFsm1NFsmstate) this.statappqry = dpcheng.StatAppQryWdbePrcFsmFsm1NFsmstate;
				if (dpcheng.StatShrQryWdbePrcFsmFsm1NFsmstate) this.statshrqry = dpcheng.StatShrQryWdbePrcFsmFsm1NFsmstate;
				if (dpcheng.StgIacQryWdbePrcFsmFsm1NFsmstate) this.stgiacqry = dpcheng.StgIacQryWdbePrcFsmFsm1NFsmstate;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrcFsmFsm1NFsmstate) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrcFsmFsm1NFsmstateData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrcFsmFsm1NFsmstateData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
