...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePrcMge1NSignal.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrcMge1NSignalData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrcMge1NSignal": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrcMge1NSignal"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrcMge1NSignalData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrcMge1NSignalData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrcMge1NSignal) this.continf = dpcheng.ContInfWdbePrcMge1NSignal;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrcMge1NSignal) this.statapp = dpcheng.StatAppWdbePrcMge1NSignal;
				if (dpcheng.StatShrWdbePrcMge1NSignal) this.statshr = dpcheng.StatShrWdbePrcMge1NSignal;
				if (dpcheng.StgIacWdbePrcMge1NSignal) this.stgiac = dpcheng.StgIacWdbePrcMge1NSignal;
				if (dpcheng.TagWdbePrcMge1NSignal) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrcMge1NSignal);
					this.tag = dpcheng.TagWdbePrcMge1NSignal;
				}
				if (dpcheng.ListWdbeQPrcMge1NSignal) this.rst = dpcheng.ListWdbeQPrcMge1NSignal;
				if (dpcheng.StatAppQryWdbePrcMge1NSignal) this.statappqry = dpcheng.StatAppQryWdbePrcMge1NSignal;
				if (dpcheng.StatShrQryWdbePrcMge1NSignal) this.statshrqry = dpcheng.StatShrQryWdbePrcMge1NSignal;
				if (dpcheng.StgIacQryWdbePrcMge1NSignal) this.stgiacqry = dpcheng.StgIacQryWdbePrcMge1NSignal;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrcMge1NSignal) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrcMge1NSignalData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrcMge1NSignalData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
