...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePrcFsmHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrcFsmHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrcFsmHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrcFsmHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrcFsmHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrcFsmHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrcFsmHk1NVector) this.continf = dpcheng.ContInfWdbePrcFsmHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrcFsmHk1NVector) this.statapp = dpcheng.StatAppWdbePrcFsmHk1NVector;
				if (dpcheng.StatShrWdbePrcFsmHk1NVector) this.statshr = dpcheng.StatShrWdbePrcFsmHk1NVector;
				if (dpcheng.StgIacWdbePrcFsmHk1NVector) this.stgiac = dpcheng.StgIacWdbePrcFsmHk1NVector;
				if (dpcheng.TagWdbePrcFsmHk1NVector) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrcFsmHk1NVector);
					this.tag = dpcheng.TagWdbePrcFsmHk1NVector;
				}
				if (dpcheng.ListWdbeQPrcFsmHk1NVector) this.rst = dpcheng.ListWdbeQPrcFsmHk1NVector;
				if (dpcheng.StatAppQryWdbePrcFsmHk1NVector) this.statappqry = dpcheng.StatAppQryWdbePrcFsmHk1NVector;
				if (dpcheng.StatShrQryWdbePrcFsmHk1NVector) this.statshrqry = dpcheng.StatShrQryWdbePrcFsmHk1NVector;
				if (dpcheng.StgIacQryWdbePrcFsmHk1NVector) this.stgiacqry = dpcheng.StgIacQryWdbePrcFsmHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrcFsmHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrcFsmHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrcFsmHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
