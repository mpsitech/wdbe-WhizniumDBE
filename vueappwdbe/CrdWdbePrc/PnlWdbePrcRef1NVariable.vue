...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePrcRef1NVariable.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrcRef1NVariableData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrcRef1NVariable": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrcRef1NVariable"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrcRef1NVariableData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrcRef1NVariableData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrcRef1NVariable) this.continf = dpcheng.ContInfWdbePrcRef1NVariable;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrcRef1NVariable) this.statapp = dpcheng.StatAppWdbePrcRef1NVariable;
				if (dpcheng.StatShrWdbePrcRef1NVariable) this.statshr = dpcheng.StatShrWdbePrcRef1NVariable;
				if (dpcheng.StgIacWdbePrcRef1NVariable) this.stgiac = dpcheng.StgIacWdbePrcRef1NVariable;
				if (dpcheng.TagWdbePrcRef1NVariable) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrcRef1NVariable);
					this.tag = dpcheng.TagWdbePrcRef1NVariable;
				}
				if (dpcheng.ListWdbeQPrcRef1NVariable) this.rst = dpcheng.ListWdbeQPrcRef1NVariable;
				if (dpcheng.StatAppQryWdbePrcRef1NVariable) this.statappqry = dpcheng.StatAppQryWdbePrcRef1NVariable;
				if (dpcheng.StatShrQryWdbePrcRef1NVariable) this.statshrqry = dpcheng.StatShrQryWdbePrcRef1NVariable;
				if (dpcheng.StgIacQryWdbePrcRef1NVariable) this.stgiacqry = dpcheng.StgIacQryWdbePrcRef1NVariable;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrcRef1NVariable) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrcRef1NVariableData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrcRef1NVariableData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
