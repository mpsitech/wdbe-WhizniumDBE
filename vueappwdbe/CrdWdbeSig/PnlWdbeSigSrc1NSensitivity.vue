...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbeSigSrc1NSensitivity',
		...
		mounted() {
			//console.log("PnlWdbeSigSrc1NSensitivity.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbeSigSrc1NSensitivityDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSigSrc1NSensitivityData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSigSrc1NSensitivity": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSigSrc1NSensitivity"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSigSrc1NSensitivityData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSigSrc1NSensitivityData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSigSrc1NSensitivity) this.continf = dpcheng.ContInfWdbeSigSrc1NSensitivity;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSigSrc1NSensitivity) this.statapp = dpcheng.StatAppWdbeSigSrc1NSensitivity;
				if (dpcheng.StatShrWdbeSigSrc1NSensitivity) this.statshr = dpcheng.StatShrWdbeSigSrc1NSensitivity;
				if (dpcheng.StgIacWdbeSigSrc1NSensitivity) this.stgiac = dpcheng.StgIacWdbeSigSrc1NSensitivity;
				if (dpcheng.TagWdbeSigSrc1NSensitivity) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSigSrc1NSensitivity);
					this.tag = dpcheng.TagWdbeSigSrc1NSensitivity;
				}
				if (dpcheng.ListWdbeQSigSrc1NSensitivity) this.rst = dpcheng.ListWdbeQSigSrc1NSensitivity;
				if (dpcheng.StatAppQryWdbeSigSrc1NSensitivity) this.statappqry = dpcheng.StatAppQryWdbeSigSrc1NSensitivity;
				if (dpcheng.StatShrQryWdbeSigSrc1NSensitivity) this.statshrqry = dpcheng.StatShrQryWdbeSigSrc1NSensitivity;
				if (dpcheng.StgIacQryWdbeSigSrc1NSensitivity) this.stgiacqry = dpcheng.StgIacQryWdbeSigSrc1NSensitivity;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSigSrc1NSensitivity) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSigSrc1NSensitivityData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSigSrc1NSensitivityData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
