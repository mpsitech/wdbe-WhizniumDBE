...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePrsMNProject.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrsMNProjectData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrsMNProject": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrsMNProject"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrsMNProjectData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrsMNProjectData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrsMNProject) this.continf = dpcheng.ContInfWdbePrsMNProject;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrsMNProject) this.statapp = dpcheng.StatAppWdbePrsMNProject;
				if (dpcheng.StatShrWdbePrsMNProject) this.statshr = dpcheng.StatShrWdbePrsMNProject;
				if (dpcheng.StgIacWdbePrsMNProject) this.stgiac = dpcheng.StgIacWdbePrsMNProject;
				if (dpcheng.TagWdbePrsMNProject) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrsMNProject);
					this.tag = dpcheng.TagWdbePrsMNProject;
				}
				if (dpcheng.ListWdbeQPrsMNProject) this.rst = dpcheng.ListWdbeQPrsMNProject;
				if (dpcheng.StatAppQryWdbePrsMNProject) this.statappqry = dpcheng.StatAppQryWdbePrsMNProject;
				if (dpcheng.StatShrQryWdbePrsMNProject) this.statshrqry = dpcheng.StatShrQryWdbePrsMNProject;
				if (dpcheng.StgIacQryWdbePrsMNProject) this.stgiacqry = dpcheng.StgIacQryWdbePrsMNProject;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrsMNProject) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrsMNProjectData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrsMNProjectData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
