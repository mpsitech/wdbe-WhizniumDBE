...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePrsMNCoreproject.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrsMNCoreprojectData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrsMNCoreproject": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrsMNCoreproject"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrsMNCoreprojectData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrsMNCoreprojectData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrsMNCoreproject) this.continf = dpcheng.ContInfWdbePrsMNCoreproject;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrsMNCoreproject) this.statapp = dpcheng.StatAppWdbePrsMNCoreproject;
				if (dpcheng.StatShrWdbePrsMNCoreproject) this.statshr = dpcheng.StatShrWdbePrsMNCoreproject;
				if (dpcheng.StgIacWdbePrsMNCoreproject) this.stgiac = dpcheng.StgIacWdbePrsMNCoreproject;
				if (dpcheng.TagWdbePrsMNCoreproject) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrsMNCoreproject);
					this.tag = dpcheng.TagWdbePrsMNCoreproject;
				}
				if (dpcheng.ListWdbeQPrsMNCoreproject) this.rst = dpcheng.ListWdbeQPrsMNCoreproject;
				if (dpcheng.StatAppQryWdbePrsMNCoreproject) this.statappqry = dpcheng.StatAppQryWdbePrsMNCoreproject;
				if (dpcheng.StatShrQryWdbePrsMNCoreproject) this.statshrqry = dpcheng.StatShrQryWdbePrsMNCoreproject;
				if (dpcheng.StgIacQryWdbePrsMNCoreproject) this.stgiacqry = dpcheng.StgIacQryWdbePrsMNCoreproject;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrsMNCoreproject) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrsMNCoreprojectData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrsMNCoreprojectData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
