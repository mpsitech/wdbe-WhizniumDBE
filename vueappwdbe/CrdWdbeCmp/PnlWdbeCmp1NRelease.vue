...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeCmp1NRelease.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeCmp1NReleaseData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeCmp1NRelease": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeCmp1NRelease"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeCmp1NReleaseData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeCmp1NReleaseData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeCmp1NRelease) this.continf = dpcheng.ContInfWdbeCmp1NRelease;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeCmp1NRelease) this.statapp = dpcheng.StatAppWdbeCmp1NRelease;
				if (dpcheng.StatShrWdbeCmp1NRelease) this.statshr = dpcheng.StatShrWdbeCmp1NRelease;
				if (dpcheng.StgIacWdbeCmp1NRelease) this.stgiac = dpcheng.StgIacWdbeCmp1NRelease;
				if (dpcheng.TagWdbeCmp1NRelease) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeCmp1NRelease);
					this.tag = dpcheng.TagWdbeCmp1NRelease;
				}
				if (dpcheng.ListWdbeQCmp1NRelease) this.rst = dpcheng.ListWdbeQCmp1NRelease;
				if (dpcheng.StatAppQryWdbeCmp1NRelease) this.statappqry = dpcheng.StatAppQryWdbeCmp1NRelease;
				if (dpcheng.StatShrQryWdbeCmp1NRelease) this.statshrqry = dpcheng.StatShrQryWdbeCmp1NRelease;
				if (dpcheng.StgIacQryWdbeCmp1NRelease) this.stgiacqry = dpcheng.StgIacQryWdbeCmp1NRelease;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQCmp1NRelease) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeCmp1NReleaseData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeCmp1NReleaseData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
