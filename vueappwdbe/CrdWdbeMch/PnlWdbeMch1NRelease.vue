...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMch1NRelease.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMch1NReleaseData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMch1NRelease": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMch1NRelease"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMch1NReleaseData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMch1NReleaseData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMch1NRelease) this.continf = dpcheng.ContInfWdbeMch1NRelease;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMch1NRelease) this.statapp = dpcheng.StatAppWdbeMch1NRelease;
				if (dpcheng.StatShrWdbeMch1NRelease) this.statshr = dpcheng.StatShrWdbeMch1NRelease;
				if (dpcheng.StgIacWdbeMch1NRelease) this.stgiac = dpcheng.StgIacWdbeMch1NRelease;
				if (dpcheng.TagWdbeMch1NRelease) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMch1NRelease);
					this.tag = dpcheng.TagWdbeMch1NRelease;
				}
				if (dpcheng.ListWdbeQMch1NRelease) this.rst = dpcheng.ListWdbeQMch1NRelease;
				if (dpcheng.StatAppQryWdbeMch1NRelease) this.statappqry = dpcheng.StatAppQryWdbeMch1NRelease;
				if (dpcheng.StatShrQryWdbeMch1NRelease) this.statshrqry = dpcheng.StatShrQryWdbeMch1NRelease;
				if (dpcheng.StgIacQryWdbeMch1NRelease) this.stgiacqry = dpcheng.StgIacQryWdbeMch1NRelease;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMch1NRelease) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMch1NReleaseData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMch1NReleaseData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
