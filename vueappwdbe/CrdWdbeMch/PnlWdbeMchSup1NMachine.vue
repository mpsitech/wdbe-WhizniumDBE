...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMchSup1NMachine.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMchSup1NMachineData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMchSup1NMachine": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMchSup1NMachine"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMchSup1NMachineData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMchSup1NMachineData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMchSup1NMachine) this.continf = dpcheng.ContInfWdbeMchSup1NMachine;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMchSup1NMachine) this.statapp = dpcheng.StatAppWdbeMchSup1NMachine;
				if (dpcheng.StatShrWdbeMchSup1NMachine) this.statshr = dpcheng.StatShrWdbeMchSup1NMachine;
				if (dpcheng.StgIacWdbeMchSup1NMachine) this.stgiac = dpcheng.StgIacWdbeMchSup1NMachine;
				if (dpcheng.TagWdbeMchSup1NMachine) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMchSup1NMachine);
					this.tag = dpcheng.TagWdbeMchSup1NMachine;
				}
				if (dpcheng.ListWdbeQMchSup1NMachine) this.rst = dpcheng.ListWdbeQMchSup1NMachine;
				if (dpcheng.StatAppQryWdbeMchSup1NMachine) this.statappqry = dpcheng.StatAppQryWdbeMchSup1NMachine;
				if (dpcheng.StatShrQryWdbeMchSup1NMachine) this.statshrqry = dpcheng.StatShrQryWdbeMchSup1NMachine;
				if (dpcheng.StgIacQryWdbeMchSup1NMachine) this.stgiacqry = dpcheng.StgIacQryWdbeMchSup1NMachine;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMchSup1NMachine) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMchSup1NMachineData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMchSup1NMachineData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
