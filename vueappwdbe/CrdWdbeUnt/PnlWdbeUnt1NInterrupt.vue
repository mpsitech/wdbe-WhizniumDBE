...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUnt1NInterrupt.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUnt1NInterruptData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUnt1NInterrupt": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUnt1NInterrupt"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUnt1NInterruptData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUnt1NInterruptData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUnt1NInterrupt) this.continf = dpcheng.ContInfWdbeUnt1NInterrupt;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUnt1NInterrupt) this.statapp = dpcheng.StatAppWdbeUnt1NInterrupt;
				if (dpcheng.StatShrWdbeUnt1NInterrupt) this.statshr = dpcheng.StatShrWdbeUnt1NInterrupt;
				if (dpcheng.StgIacWdbeUnt1NInterrupt) this.stgiac = dpcheng.StgIacWdbeUnt1NInterrupt;
				if (dpcheng.TagWdbeUnt1NInterrupt) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUnt1NInterrupt);
					this.tag = dpcheng.TagWdbeUnt1NInterrupt;
				}
				if (dpcheng.ListWdbeQUnt1NInterrupt) this.rst = dpcheng.ListWdbeQUnt1NInterrupt;
				if (dpcheng.StatAppQryWdbeUnt1NInterrupt) this.statappqry = dpcheng.StatAppQryWdbeUnt1NInterrupt;
				if (dpcheng.StatShrQryWdbeUnt1NInterrupt) this.statshrqry = dpcheng.StatShrQryWdbeUnt1NInterrupt;
				if (dpcheng.StgIacQryWdbeUnt1NInterrupt) this.stgiacqry = dpcheng.StgIacQryWdbeUnt1NInterrupt;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUnt1NInterrupt) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUnt1NInterruptData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUnt1NInterruptData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
