...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUnt1NBank.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUnt1NBankData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUnt1NBank": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUnt1NBank"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUnt1NBankData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUnt1NBankData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUnt1NBank) this.continf = dpcheng.ContInfWdbeUnt1NBank;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUnt1NBank) this.statapp = dpcheng.StatAppWdbeUnt1NBank;
				if (dpcheng.StatShrWdbeUnt1NBank) this.statshr = dpcheng.StatShrWdbeUnt1NBank;
				if (dpcheng.StgIacWdbeUnt1NBank) this.stgiac = dpcheng.StgIacWdbeUnt1NBank;
				if (dpcheng.TagWdbeUnt1NBank) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUnt1NBank);
					this.tag = dpcheng.TagWdbeUnt1NBank;
				}
				if (dpcheng.ListWdbeQUnt1NBank) this.rst = dpcheng.ListWdbeQUnt1NBank;
				if (dpcheng.StatAppQryWdbeUnt1NBank) this.statappqry = dpcheng.StatAppQryWdbeUnt1NBank;
				if (dpcheng.StatShrQryWdbeUnt1NBank) this.statshrqry = dpcheng.StatShrQryWdbeUnt1NBank;
				if (dpcheng.StgIacQryWdbeUnt1NBank) this.stgiacqry = dpcheng.StgIacQryWdbeUnt1NBank;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUnt1NBankData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUnt1NBankData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
