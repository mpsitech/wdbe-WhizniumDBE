...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUntHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUntHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUntHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUntHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUntHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUntHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUntHk1NVector) this.continf = dpcheng.ContInfWdbeUntHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUntHk1NVector) this.statapp = dpcheng.StatAppWdbeUntHk1NVector;
				if (dpcheng.StatShrWdbeUntHk1NVector) this.statshr = dpcheng.StatShrWdbeUntHk1NVector;
				if (dpcheng.StgIacWdbeUntHk1NVector) this.stgiac = dpcheng.StgIacWdbeUntHk1NVector;
				if (dpcheng.TagWdbeUntHk1NVector) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUntHk1NVector);
					this.tag = dpcheng.TagWdbeUntHk1NVector;
				}
				if (dpcheng.ListWdbeQUntHk1NVector) this.rst = dpcheng.ListWdbeQUntHk1NVector;
				if (dpcheng.StatAppQryWdbeUntHk1NVector) this.statappqry = dpcheng.StatAppQryWdbeUntHk1NVector;
				if (dpcheng.StatShrQryWdbeUntHk1NVector) this.statshrqry = dpcheng.StatShrQryWdbeUntHk1NVector;
				if (dpcheng.StgIacQryWdbeUntHk1NVector) this.stgiacqry = dpcheng.StgIacQryWdbeUntHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUntHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUntHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUntHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
