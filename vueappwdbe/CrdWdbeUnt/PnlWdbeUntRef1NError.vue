...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUntRef1NError.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUntRef1NErrorData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUntRef1NError": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUntRef1NError"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUntRef1NErrorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUntRef1NErrorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUntRef1NError) this.continf = dpcheng.ContInfWdbeUntRef1NError;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUntRef1NError) this.statapp = dpcheng.StatAppWdbeUntRef1NError;
				if (dpcheng.StatShrWdbeUntRef1NError) this.statshr = dpcheng.StatShrWdbeUntRef1NError;
				if (dpcheng.StgIacWdbeUntRef1NError) this.stgiac = dpcheng.StgIacWdbeUntRef1NError;
				if (dpcheng.TagWdbeUntRef1NError) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUntRef1NError);
					this.tag = dpcheng.TagWdbeUntRef1NError;
				}
				if (dpcheng.ListWdbeQUntRef1NError) this.rst = dpcheng.ListWdbeQUntRef1NError;
				if (dpcheng.StatAppQryWdbeUntRef1NError) this.statappqry = dpcheng.StatAppQryWdbeUntRef1NError;
				if (dpcheng.StatShrQryWdbeUntRef1NError) this.statshrqry = dpcheng.StatShrQryWdbeUntRef1NError;
				if (dpcheng.StgIacQryWdbeUntRef1NError) this.stgiacqry = dpcheng.StgIacQryWdbeUntRef1NError;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUntRef1NError) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUntRef1NErrorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUntRef1NErrorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
