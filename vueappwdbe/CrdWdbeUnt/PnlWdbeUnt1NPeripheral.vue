...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUnt1NPeripheral.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUnt1NPeripheralData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUnt1NPeripheral": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUnt1NPeripheral"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUnt1NPeripheralData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUnt1NPeripheralData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUnt1NPeripheral) this.continf = dpcheng.ContInfWdbeUnt1NPeripheral;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUnt1NPeripheral) this.statapp = dpcheng.StatAppWdbeUnt1NPeripheral;
				if (dpcheng.StatShrWdbeUnt1NPeripheral) this.statshr = dpcheng.StatShrWdbeUnt1NPeripheral;
				if (dpcheng.StgIacWdbeUnt1NPeripheral) this.stgiac = dpcheng.StgIacWdbeUnt1NPeripheral;
				if (dpcheng.TagWdbeUnt1NPeripheral) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUnt1NPeripheral);
					this.tag = dpcheng.TagWdbeUnt1NPeripheral;
				}
				if (dpcheng.ListWdbeQUnt1NPeripheral) this.rst = dpcheng.ListWdbeQUnt1NPeripheral;
				if (dpcheng.StatAppQryWdbeUnt1NPeripheral) this.statappqry = dpcheng.StatAppQryWdbeUnt1NPeripheral;
				if (dpcheng.StatShrQryWdbeUnt1NPeripheral) this.statshrqry = dpcheng.StatShrQryWdbeUnt1NPeripheral;
				if (dpcheng.StgIacQryWdbeUnt1NPeripheral) this.stgiacqry = dpcheng.StgIacQryWdbeUnt1NPeripheral;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUnt1NPeripheral) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUnt1NPeripheralData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUnt1NPeripheralData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
