...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUnt1NTarget.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUnt1NTargetData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUnt1NTarget": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUnt1NTarget"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUnt1NTargetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUnt1NTargetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUnt1NTarget) this.continf = dpcheng.ContInfWdbeUnt1NTarget;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUnt1NTarget) this.statapp = dpcheng.StatAppWdbeUnt1NTarget;
				if (dpcheng.StatShrWdbeUnt1NTarget) this.statshr = dpcheng.StatShrWdbeUnt1NTarget;
				if (dpcheng.StgIacWdbeUnt1NTarget) this.stgiac = dpcheng.StgIacWdbeUnt1NTarget;
				if (dpcheng.TagWdbeUnt1NTarget) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUnt1NTarget);
					this.tag = dpcheng.TagWdbeUnt1NTarget;
				}
				if (dpcheng.ListWdbeQUnt1NTarget) this.rst = dpcheng.ListWdbeQUnt1NTarget;
				if (dpcheng.StatAppQryWdbeUnt1NTarget) this.statappqry = dpcheng.StatAppQryWdbeUnt1NTarget;
				if (dpcheng.StatShrQryWdbeUnt1NTarget) this.statshrqry = dpcheng.StatShrQryWdbeUnt1NTarget;
				if (dpcheng.StgIacQryWdbeUnt1NTarget) this.stgiacqry = dpcheng.StgIacQryWdbeUnt1NTarget;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUnt1NTarget) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUnt1NTargetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUnt1NTargetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
