...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUntRef1NSignal.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUntRef1NSignalData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUntRef1NSignal": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUntRef1NSignal"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUntRef1NSignalData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUntRef1NSignalData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUntRef1NSignal) this.continf = dpcheng.ContInfWdbeUntRef1NSignal;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUntRef1NSignal) this.statapp = dpcheng.StatAppWdbeUntRef1NSignal;
				if (dpcheng.StatShrWdbeUntRef1NSignal) this.statshr = dpcheng.StatShrWdbeUntRef1NSignal;
				if (dpcheng.StgIacWdbeUntRef1NSignal) this.stgiac = dpcheng.StgIacWdbeUntRef1NSignal;
				if (dpcheng.TagWdbeUntRef1NSignal) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUntRef1NSignal);
					this.tag = dpcheng.TagWdbeUntRef1NSignal;
				}
				if (dpcheng.ListWdbeQUntRef1NSignal) this.rst = dpcheng.ListWdbeQUntRef1NSignal;
				if (dpcheng.StatAppQryWdbeUntRef1NSignal) this.statappqry = dpcheng.StatAppQryWdbeUntRef1NSignal;
				if (dpcheng.StatShrQryWdbeUntRef1NSignal) this.statshrqry = dpcheng.StatShrQryWdbeUntRef1NSignal;
				if (dpcheng.StgIacQryWdbeUntRef1NSignal) this.stgiacqry = dpcheng.StgIacQryWdbeUntRef1NSignal;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUntRef1NSignal) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUntRef1NSignalData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUntRef1NSignalData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
