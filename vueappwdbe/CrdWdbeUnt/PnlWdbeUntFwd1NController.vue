...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbeUntFwd1NController',
		...
		mounted() {
			//console.log("PnlWdbeUntFwd1NController.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbeUntFwd1NControllerDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUntFwd1NControllerData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUntFwd1NController": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUntFwd1NController"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUntFwd1NControllerData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUntFwd1NControllerData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUntFwd1NController) this.continf = dpcheng.ContInfWdbeUntFwd1NController;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUntFwd1NController) this.statapp = dpcheng.StatAppWdbeUntFwd1NController;
				if (dpcheng.StatShrWdbeUntFwd1NController) this.statshr = dpcheng.StatShrWdbeUntFwd1NController;
				if (dpcheng.StgIacWdbeUntFwd1NController) this.stgiac = dpcheng.StgIacWdbeUntFwd1NController;
				if (dpcheng.TagWdbeUntFwd1NController) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUntFwd1NController);
					this.tag = dpcheng.TagWdbeUntFwd1NController;
				}
				if (dpcheng.ListWdbeQUntFwd1NController) this.rst = dpcheng.ListWdbeQUntFwd1NController;
				if (dpcheng.StatAppQryWdbeUntFwd1NController) this.statappqry = dpcheng.StatAppQryWdbeUntFwd1NController;
				if (dpcheng.StatShrQryWdbeUntFwd1NController) this.statshrqry = dpcheng.StatShrQryWdbeUntFwd1NController;
				if (dpcheng.StgIacQryWdbeUntFwd1NController) this.stgiacqry = dpcheng.StgIacQryWdbeUntFwd1NController;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUntFwd1NController) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUntFwd1NControllerData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUntFwd1NControllerData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
