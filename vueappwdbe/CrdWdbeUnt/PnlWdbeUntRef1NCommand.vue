...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUntRef1NCommand.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUntRef1NCommandData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUntRef1NCommand": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUntRef1NCommand"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUntRef1NCommandData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUntRef1NCommandData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUntRef1NCommand) this.continf = dpcheng.ContInfWdbeUntRef1NCommand;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUntRef1NCommand) this.statapp = dpcheng.StatAppWdbeUntRef1NCommand;
				if (dpcheng.StatShrWdbeUntRef1NCommand) this.statshr = dpcheng.StatShrWdbeUntRef1NCommand;
				if (dpcheng.StgIacWdbeUntRef1NCommand) this.stgiac = dpcheng.StgIacWdbeUntRef1NCommand;
				if (dpcheng.TagWdbeUntRef1NCommand) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUntRef1NCommand);
					this.tag = dpcheng.TagWdbeUntRef1NCommand;
				}
				if (dpcheng.ListWdbeQUntRef1NCommand) this.rst = dpcheng.ListWdbeQUntRef1NCommand;
				if (dpcheng.StatAppQryWdbeUntRef1NCommand) this.statappqry = dpcheng.StatAppQryWdbeUntRef1NCommand;
				if (dpcheng.StatShrQryWdbeUntRef1NCommand) this.statshrqry = dpcheng.StatShrQryWdbeUntRef1NCommand;
				if (dpcheng.StgIacQryWdbeUntRef1NCommand) this.stgiacqry = dpcheng.StgIacQryWdbeUntRef1NCommand;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUntRef1NCommand) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUntRef1NCommandData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUntRef1NCommandData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
