...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUntHk1NModule.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUntHk1NModuleData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUntHk1NModule": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUntHk1NModule"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUntHk1NModuleData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUntHk1NModuleData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUntHk1NModule) this.continf = dpcheng.ContInfWdbeUntHk1NModule;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUntHk1NModule) this.statapp = dpcheng.StatAppWdbeUntHk1NModule;
				if (dpcheng.StatShrWdbeUntHk1NModule) this.statshr = dpcheng.StatShrWdbeUntHk1NModule;
				if (dpcheng.StgIacWdbeUntHk1NModule) this.stgiac = dpcheng.StgIacWdbeUntHk1NModule;
				if (dpcheng.TagWdbeUntHk1NModule) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUntHk1NModule);
					this.tag = dpcheng.TagWdbeUntHk1NModule;
				}
				if (dpcheng.ListWdbeQUntHk1NModule) this.rst = dpcheng.ListWdbeQUntHk1NModule;
				if (dpcheng.StatAppQryWdbeUntHk1NModule) this.statappqry = dpcheng.StatAppQryWdbeUntHk1NModule;
				if (dpcheng.StatShrQryWdbeUntHk1NModule) this.statshrqry = dpcheng.StatShrQryWdbeUntHk1NModule;
				if (dpcheng.StgIacQryWdbeUntHk1NModule) this.stgiacqry = dpcheng.StgIacQryWdbeUntHk1NModule;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUntHk1NModule) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUntHk1NModuleData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUntHk1NModuleData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
