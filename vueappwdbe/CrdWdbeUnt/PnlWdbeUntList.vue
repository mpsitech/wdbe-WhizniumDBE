				...
				*/
				...
				if (dpcheng.ListWdbeQUntList) {
					...
					for (var i = 0; i < this.rst.length; i++) {
						...
						/*
						*/
						rows.push({jnum: rec["jnum"], TcoSrf: rec["srf"], TcoTit: rec["tit"], TcoFsr: rec["fsr"], TcoTyp: rec["typ2"], TcoRet: rec["ret2"], TcoReu: rec["reu"], TcoMdl: rec["mdl"], TcoPkg: rec["pkg2"], TcoEsy: rec["esy"], TcoTch: rec["tch2"]})
						/*
						*/
