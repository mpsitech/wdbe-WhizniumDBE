...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePplPpl1NSegment.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePplPpl1NSegmentData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePplPpl1NSegment": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePplPpl1NSegment"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePplPpl1NSegmentData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePplPpl1NSegmentData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePplPpl1NSegment) this.continf = dpcheng.ContInfWdbePplPpl1NSegment;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePplPpl1NSegment) this.statapp = dpcheng.StatAppWdbePplPpl1NSegment;
				if (dpcheng.StatShrWdbePplPpl1NSegment) this.statshr = dpcheng.StatShrWdbePplPpl1NSegment;
				if (dpcheng.StgIacWdbePplPpl1NSegment) this.stgiac = dpcheng.StgIacWdbePplPpl1NSegment;
				if (dpcheng.TagWdbePplPpl1NSegment) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePplPpl1NSegment);
					this.tag = dpcheng.TagWdbePplPpl1NSegment;
				}
				if (dpcheng.ListWdbeQPplPpl1NSegment) this.rst = dpcheng.ListWdbeQPplPpl1NSegment;
				if (dpcheng.StatAppQryWdbePplPpl1NSegment) this.statappqry = dpcheng.StatAppQryWdbePplPpl1NSegment;
				if (dpcheng.StatShrQryWdbePplPpl1NSegment) this.statshrqry = dpcheng.StatShrQryWdbePplPpl1NSegment;
				if (dpcheng.StgIacQryWdbePplPpl1NSegment) this.stgiacqry = dpcheng.StgIacQryWdbePplPpl1NSegment;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPplPpl1NSegment) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePplPpl1NSegmentData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePplPpl1NSegmentData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
