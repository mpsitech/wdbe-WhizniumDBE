...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeCvrHk1NModule.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeCvrHk1NModuleData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeCvrHk1NModule": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeCvrHk1NModule"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeCvrHk1NModuleData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeCvrHk1NModuleData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeCvrHk1NModule) this.continf = dpcheng.ContInfWdbeCvrHk1NModule;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeCvrHk1NModule) this.statapp = dpcheng.StatAppWdbeCvrHk1NModule;
				if (dpcheng.StatShrWdbeCvrHk1NModule) this.statshr = dpcheng.StatShrWdbeCvrHk1NModule;
				if (dpcheng.StgIacWdbeCvrHk1NModule) this.stgiac = dpcheng.StgIacWdbeCvrHk1NModule;
				if (dpcheng.TagWdbeCvrHk1NModule) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeCvrHk1NModule);
					this.tag = dpcheng.TagWdbeCvrHk1NModule;
				}
				if (dpcheng.ListWdbeQCvrHk1NModule) this.rst = dpcheng.ListWdbeQCvrHk1NModule;
				if (dpcheng.StatAppQryWdbeCvrHk1NModule) this.statappqry = dpcheng.StatAppQryWdbeCvrHk1NModule;
				if (dpcheng.StatShrQryWdbeCvrHk1NModule) this.statshrqry = dpcheng.StatShrQryWdbeCvrHk1NModule;
				if (dpcheng.StgIacQryWdbeCvrHk1NModule) this.stgiacqry = dpcheng.StgIacQryWdbeCvrHk1NModule;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQCvrHk1NModule) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeCvrHk1NModuleData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeCvrHk1NModuleData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
