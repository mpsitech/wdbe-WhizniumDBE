...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWdbeCvrBcv1NCoreversion',
		...
		mounted() {
			//console.log("PnlWdbeCvrBcv1NCoreversion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWdbeCvrBcv1NCoreversionDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeCvrBcv1NCoreversionData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeCvrBcv1NCoreversion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeCvrBcv1NCoreversion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeCvrBcv1NCoreversionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeCvrBcv1NCoreversionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeCvrBcv1NCoreversion) this.continf = dpcheng.ContInfWdbeCvrBcv1NCoreversion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeCvrBcv1NCoreversion) this.statapp = dpcheng.StatAppWdbeCvrBcv1NCoreversion;
				if (dpcheng.StatShrWdbeCvrBcv1NCoreversion) this.statshr = dpcheng.StatShrWdbeCvrBcv1NCoreversion;
				if (dpcheng.StgIacWdbeCvrBcv1NCoreversion) this.stgiac = dpcheng.StgIacWdbeCvrBcv1NCoreversion;
				if (dpcheng.TagWdbeCvrBcv1NCoreversion) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeCvrBcv1NCoreversion);
					this.tag = dpcheng.TagWdbeCvrBcv1NCoreversion;
				}
				if (dpcheng.ListWdbeQCvrBcv1NCoreversion) this.rst = dpcheng.ListWdbeQCvrBcv1NCoreversion;
				if (dpcheng.StatAppQryWdbeCvrBcv1NCoreversion) this.statappqry = dpcheng.StatAppQryWdbeCvrBcv1NCoreversion;
				if (dpcheng.StatShrQryWdbeCvrBcv1NCoreversion) this.statshrqry = dpcheng.StatShrQryWdbeCvrBcv1NCoreversion;
				if (dpcheng.StgIacQryWdbeCvrBcv1NCoreversion) this.stgiacqry = dpcheng.StgIacQryWdbeCvrBcv1NCoreversion;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQCvrBcv1NCoreversion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeCvrBcv1NCoreversionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeCvrBcv1NCoreversionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
