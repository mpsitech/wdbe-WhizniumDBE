...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpAPar.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpAParData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpAPar": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpAPar"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpAParData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpAParData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpAPar) this.continf = dpcheng.ContInfWdbeMtpAPar;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpAPar) this.statapp = dpcheng.StatAppWdbeMtpAPar;
				if (dpcheng.StatShrWdbeMtpAPar) this.statshr = dpcheng.StatShrWdbeMtpAPar;
				if (dpcheng.StgIacWdbeMtpAPar) this.stgiac = dpcheng.StgIacWdbeMtpAPar;
				if (dpcheng.TagWdbeMtpAPar) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpAPar);
					this.tag = dpcheng.TagWdbeMtpAPar;
				}
				if (dpcheng.ListWdbeQMtpAPar) this.rst = dpcheng.ListWdbeQMtpAPar;
				if (dpcheng.StatAppQryWdbeMtpAPar) this.statappqry = dpcheng.StatAppQryWdbeMtpAPar;
				if (dpcheng.StatShrQryWdbeMtpAPar) this.statshrqry = dpcheng.StatShrQryWdbeMtpAPar;
				if (dpcheng.StgIacQryWdbeMtpAPar) this.stgiacqry = dpcheng.StgIacQryWdbeMtpAPar;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpAParData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpAParData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
