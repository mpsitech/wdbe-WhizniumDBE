...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpSup1NModule.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpSup1NModuleData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpSup1NModule": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpSup1NModule"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpSup1NModuleData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpSup1NModuleData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpSup1NModule) this.continf = dpcheng.ContInfWdbeMtpSup1NModule;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpSup1NModule) this.statapp = dpcheng.StatAppWdbeMtpSup1NModule;
				if (dpcheng.StatShrWdbeMtpSup1NModule) this.statshr = dpcheng.StatShrWdbeMtpSup1NModule;
				if (dpcheng.StgIacWdbeMtpSup1NModule) this.stgiac = dpcheng.StgIacWdbeMtpSup1NModule;
				if (dpcheng.TagWdbeMtpSup1NModule) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpSup1NModule);
					this.tag = dpcheng.TagWdbeMtpSup1NModule;
				}
				if (dpcheng.ListWdbeQMtpSup1NModule) this.rst = dpcheng.ListWdbeQMtpSup1NModule;
				if (dpcheng.StatAppQryWdbeMtpSup1NModule) this.statappqry = dpcheng.StatAppQryWdbeMtpSup1NModule;
				if (dpcheng.StatShrQryWdbeMtpSup1NModule) this.statshrqry = dpcheng.StatShrQryWdbeMtpSup1NModule;
				if (dpcheng.StgIacQryWdbeMtpSup1NModule) this.stgiacqry = dpcheng.StgIacQryWdbeMtpSup1NModule;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMtpSup1NModule) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpSup1NModuleData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpSup1NModuleData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
