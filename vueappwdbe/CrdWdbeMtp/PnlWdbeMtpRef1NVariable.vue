...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpRef1NVariable.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpRef1NVariableData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpRef1NVariable": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpRef1NVariable"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpRef1NVariableData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpRef1NVariableData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpRef1NVariable) this.continf = dpcheng.ContInfWdbeMtpRef1NVariable;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpRef1NVariable) this.statapp = dpcheng.StatAppWdbeMtpRef1NVariable;
				if (dpcheng.StatShrWdbeMtpRef1NVariable) this.statshr = dpcheng.StatShrWdbeMtpRef1NVariable;
				if (dpcheng.StgIacWdbeMtpRef1NVariable) this.stgiac = dpcheng.StgIacWdbeMtpRef1NVariable;
				if (dpcheng.TagWdbeMtpRef1NVariable) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpRef1NVariable);
					this.tag = dpcheng.TagWdbeMtpRef1NVariable;
				}
				if (dpcheng.ListWdbeQMtpRef1NVariable) this.rst = dpcheng.ListWdbeQMtpRef1NVariable;
				if (dpcheng.StatAppQryWdbeMtpRef1NVariable) this.statappqry = dpcheng.StatAppQryWdbeMtpRef1NVariable;
				if (dpcheng.StatShrQryWdbeMtpRef1NVariable) this.statshrqry = dpcheng.StatShrQryWdbeMtpRef1NVariable;
				if (dpcheng.StgIacQryWdbeMtpRef1NVariable) this.stgiacqry = dpcheng.StgIacQryWdbeMtpRef1NVariable;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMtpRef1NVariable) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpRef1NVariableData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpRef1NVariableData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
