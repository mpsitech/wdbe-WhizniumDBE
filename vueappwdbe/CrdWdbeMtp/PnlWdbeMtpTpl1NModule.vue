...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpTpl1NModule.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpTpl1NModuleData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpTpl1NModule": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpTpl1NModule"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpTpl1NModuleData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpTpl1NModuleData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpTpl1NModule) this.continf = dpcheng.ContInfWdbeMtpTpl1NModule;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpTpl1NModule) this.statapp = dpcheng.StatAppWdbeMtpTpl1NModule;
				if (dpcheng.StatShrWdbeMtpTpl1NModule) this.statshr = dpcheng.StatShrWdbeMtpTpl1NModule;
				if (dpcheng.StgIacWdbeMtpTpl1NModule) this.stgiac = dpcheng.StgIacWdbeMtpTpl1NModule;
				if (dpcheng.TagWdbeMtpTpl1NModule) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpTpl1NModule);
					this.tag = dpcheng.TagWdbeMtpTpl1NModule;
				}
				if (dpcheng.ListWdbeQMtpTpl1NModule) this.rst = dpcheng.ListWdbeQMtpTpl1NModule;
				if (dpcheng.StatAppQryWdbeMtpTpl1NModule) this.statappqry = dpcheng.StatAppQryWdbeMtpTpl1NModule;
				if (dpcheng.StatShrQryWdbeMtpTpl1NModule) this.statshrqry = dpcheng.StatShrQryWdbeMtpTpl1NModule;
				if (dpcheng.StgIacQryWdbeMtpTpl1NModule) this.stgiacqry = dpcheng.StgIacQryWdbeMtpTpl1NModule;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMtpTpl1NModule) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpTpl1NModuleData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpTpl1NModuleData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
