...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpHsm1NPipeline.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpHsm1NPipelineData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpHsm1NPipeline": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpHsm1NPipeline"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpHsm1NPipelineData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpHsm1NPipelineData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpHsm1NPipeline) this.continf = dpcheng.ContInfWdbeMtpHsm1NPipeline;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpHsm1NPipeline) this.statapp = dpcheng.StatAppWdbeMtpHsm1NPipeline;
				if (dpcheng.StatShrWdbeMtpHsm1NPipeline) this.statshr = dpcheng.StatShrWdbeMtpHsm1NPipeline;
				if (dpcheng.StgIacWdbeMtpHsm1NPipeline) this.stgiac = dpcheng.StgIacWdbeMtpHsm1NPipeline;
				if (dpcheng.TagWdbeMtpHsm1NPipeline) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpHsm1NPipeline);
					this.tag = dpcheng.TagWdbeMtpHsm1NPipeline;
				}
				if (dpcheng.ListWdbeQMtpHsm1NPipeline) this.rst = dpcheng.ListWdbeQMtpHsm1NPipeline;
				if (dpcheng.StatAppQryWdbeMtpHsm1NPipeline) this.statappqry = dpcheng.StatAppQryWdbeMtpHsm1NPipeline;
				if (dpcheng.StatShrQryWdbeMtpHsm1NPipeline) this.statshrqry = dpcheng.StatShrQryWdbeMtpHsm1NPipeline;
				if (dpcheng.StgIacQryWdbeMtpHsm1NPipeline) this.stgiacqry = dpcheng.StgIacQryWdbeMtpHsm1NPipeline;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMtpHsm1NPipeline) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpHsm1NPipelineData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpHsm1NPipelineData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
