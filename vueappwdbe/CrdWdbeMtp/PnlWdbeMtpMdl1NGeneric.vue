...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpMdl1NGeneric.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpMdl1NGenericData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpMdl1NGeneric": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpMdl1NGeneric"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpMdl1NGenericData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpMdl1NGenericData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpMdl1NGeneric) this.continf = dpcheng.ContInfWdbeMtpMdl1NGeneric;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpMdl1NGeneric) this.statapp = dpcheng.StatAppWdbeMtpMdl1NGeneric;
				if (dpcheng.StatShrWdbeMtpMdl1NGeneric) this.statshr = dpcheng.StatShrWdbeMtpMdl1NGeneric;
				if (dpcheng.StgIacWdbeMtpMdl1NGeneric) this.stgiac = dpcheng.StgIacWdbeMtpMdl1NGeneric;
				if (dpcheng.TagWdbeMtpMdl1NGeneric) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpMdl1NGeneric);
					this.tag = dpcheng.TagWdbeMtpMdl1NGeneric;
				}
				if (dpcheng.ListWdbeQMtpMdl1NGeneric) this.rst = dpcheng.ListWdbeQMtpMdl1NGeneric;
				if (dpcheng.StatAppQryWdbeMtpMdl1NGeneric) this.statappqry = dpcheng.StatAppQryWdbeMtpMdl1NGeneric;
				if (dpcheng.StatShrQryWdbeMtpMdl1NGeneric) this.statshrqry = dpcheng.StatShrQryWdbeMtpMdl1NGeneric;
				if (dpcheng.StgIacQryWdbeMtpMdl1NGeneric) this.stgiacqry = dpcheng.StgIacQryWdbeMtpMdl1NGeneric;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMtpMdl1NGeneric) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpMdl1NGenericData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpMdl1NGenericData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
