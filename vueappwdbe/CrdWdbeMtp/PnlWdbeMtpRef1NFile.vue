...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpRef1NFile) this.continf = dpcheng.ContInfWdbeMtpRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpRef1NFile) this.statapp = dpcheng.StatAppWdbeMtpRef1NFile;
				if (dpcheng.StatShrWdbeMtpRef1NFile) this.statshr = dpcheng.StatShrWdbeMtpRef1NFile;
				if (dpcheng.StgIacWdbeMtpRef1NFile) this.stgiac = dpcheng.StgIacWdbeMtpRef1NFile;
				if (dpcheng.TagWdbeMtpRef1NFile) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpRef1NFile);
					this.tag = dpcheng.TagWdbeMtpRef1NFile;
				}
				if (dpcheng.ListWdbeQMtpRef1NFile) this.rst = dpcheng.ListWdbeQMtpRef1NFile;
				if (dpcheng.StatAppQryWdbeMtpRef1NFile) this.statappqry = dpcheng.StatAppQryWdbeMtpRef1NFile;
				if (dpcheng.StatShrQryWdbeMtpRef1NFile) this.statshrqry = dpcheng.StatShrQryWdbeMtpRef1NFile;
				if (dpcheng.StgIacQryWdbeMtpRef1NFile) this.stgiacqry = dpcheng.StgIacQryWdbeMtpRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMtpRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
