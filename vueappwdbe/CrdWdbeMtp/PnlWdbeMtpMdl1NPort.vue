...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeMtpMdl1NPort.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeMtpMdl1NPortData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeMtpMdl1NPort": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeMtpMdl1NPort"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeMtpMdl1NPortData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeMtpMdl1NPortData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeMtpMdl1NPort) this.continf = dpcheng.ContInfWdbeMtpMdl1NPort;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeMtpMdl1NPort) this.statapp = dpcheng.StatAppWdbeMtpMdl1NPort;
				if (dpcheng.StatShrWdbeMtpMdl1NPort) this.statshr = dpcheng.StatShrWdbeMtpMdl1NPort;
				if (dpcheng.StgIacWdbeMtpMdl1NPort) this.stgiac = dpcheng.StgIacWdbeMtpMdl1NPort;
				if (dpcheng.TagWdbeMtpMdl1NPort) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeMtpMdl1NPort);
					this.tag = dpcheng.TagWdbeMtpMdl1NPort;
				}
				if (dpcheng.ListWdbeQMtpMdl1NPort) this.rst = dpcheng.ListWdbeQMtpMdl1NPort;
				if (dpcheng.StatAppQryWdbeMtpMdl1NPort) this.statappqry = dpcheng.StatAppQryWdbeMtpMdl1NPort;
				if (dpcheng.StatShrQryWdbeMtpMdl1NPort) this.statshrqry = dpcheng.StatShrQryWdbeMtpMdl1NPort;
				if (dpcheng.StgIacQryWdbeMtpMdl1NPort) this.stgiacqry = dpcheng.StgIacQryWdbeMtpMdl1NPort;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQMtpMdl1NPort) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeMtpMdl1NPortData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeMtpMdl1NPortData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
