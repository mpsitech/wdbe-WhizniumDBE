...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePrjMNPerson.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrjMNPersonData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrjMNPerson": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrjMNPerson"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrjMNPersonData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrjMNPersonData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrjMNPerson) this.continf = dpcheng.ContInfWdbePrjMNPerson;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrjMNPerson) this.statapp = dpcheng.StatAppWdbePrjMNPerson;
				if (dpcheng.StatShrWdbePrjMNPerson) this.statshr = dpcheng.StatShrWdbePrjMNPerson;
				if (dpcheng.StgIacWdbePrjMNPerson) this.stgiac = dpcheng.StgIacWdbePrjMNPerson;
				if (dpcheng.TagWdbePrjMNPerson) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrjMNPerson);
					this.tag = dpcheng.TagWdbePrjMNPerson;
				}
				if (dpcheng.ListWdbeQPrjMNPerson) this.rst = dpcheng.ListWdbeQPrjMNPerson;
				if (dpcheng.StatAppQryWdbePrjMNPerson) this.statappqry = dpcheng.StatAppQryWdbePrjMNPerson;
				if (dpcheng.StatShrQryWdbePrjMNPerson) this.statshrqry = dpcheng.StatShrQryWdbePrjMNPerson;
				if (dpcheng.StgIacQryWdbePrjMNPerson) this.stgiacqry = dpcheng.StgIacQryWdbePrjMNPerson;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrjMNPerson) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrjMNPersonData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrjMNPersonData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
