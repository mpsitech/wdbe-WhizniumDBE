...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePrjPrj1NVersion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePrjPrj1NVersionData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePrjPrj1NVersion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePrjPrj1NVersion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePrjPrj1NVersionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePrjPrj1NVersionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePrjPrj1NVersion) this.continf = dpcheng.ContInfWdbePrjPrj1NVersion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePrjPrj1NVersion) this.statapp = dpcheng.StatAppWdbePrjPrj1NVersion;
				if (dpcheng.StatShrWdbePrjPrj1NVersion) this.statshr = dpcheng.StatShrWdbePrjPrj1NVersion;
				if (dpcheng.StgIacWdbePrjPrj1NVersion) this.stgiac = dpcheng.StgIacWdbePrjPrj1NVersion;
				if (dpcheng.TagWdbePrjPrj1NVersion) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePrjPrj1NVersion);
					this.tag = dpcheng.TagWdbePrjPrj1NVersion;
				}
				if (dpcheng.ListWdbeQPrjPrj1NVersion) this.rst = dpcheng.ListWdbeQPrjPrj1NVersion;
				if (dpcheng.StatAppQryWdbePrjPrj1NVersion) this.statappqry = dpcheng.StatAppQryWdbePrjPrj1NVersion;
				if (dpcheng.StatShrQryWdbePrjPrj1NVersion) this.statshrqry = dpcheng.StatShrQryWdbePrjPrj1NVersion;
				if (dpcheng.StgIacQryWdbePrjPrj1NVersion) this.stgiacqry = dpcheng.StgIacQryWdbePrjPrj1NVersion;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPrjPrj1NVersion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePrjPrj1NVersionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePrjPrj1NVersionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
