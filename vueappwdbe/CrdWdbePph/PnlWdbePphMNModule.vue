...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbePphMNModule.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbePphMNModuleData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbePphMNModule": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbePphMNModule"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbePphMNModuleData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbePphMNModuleData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbePphMNModule) this.continf = dpcheng.ContInfWdbePphMNModule;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbePphMNModule) this.statapp = dpcheng.StatAppWdbePphMNModule;
				if (dpcheng.StatShrWdbePphMNModule) this.statshr = dpcheng.StatShrWdbePphMNModule;
				if (dpcheng.StgIacWdbePphMNModule) this.stgiac = dpcheng.StgIacWdbePphMNModule;
				if (dpcheng.TagWdbePphMNModule) {
					Wdbe.unescapeBlock(dpcheng.TagWdbePphMNModule);
					this.tag = dpcheng.TagWdbePphMNModule;
				}
				if (dpcheng.ListWdbeQPphMNModule) this.rst = dpcheng.ListWdbeQPphMNModule;
				if (dpcheng.StatAppQryWdbePphMNModule) this.statappqry = dpcheng.StatAppQryWdbePphMNModule;
				if (dpcheng.StatShrQryWdbePphMNModule) this.statshrqry = dpcheng.StatShrQryWdbePphMNModule;
				if (dpcheng.StgIacQryWdbePphMNModule) this.stgiacqry = dpcheng.StgIacQryWdbePphMNModule;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQPphMNModule) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbePphMNModuleData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbePphMNModuleData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
