...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeSegSup1NSegment.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeSegSup1NSegmentData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeSegSup1NSegment": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeSegSup1NSegment"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeSegSup1NSegmentData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeSegSup1NSegmentData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeSegSup1NSegment) this.continf = dpcheng.ContInfWdbeSegSup1NSegment;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeSegSup1NSegment) this.statapp = dpcheng.StatAppWdbeSegSup1NSegment;
				if (dpcheng.StatShrWdbeSegSup1NSegment) this.statshr = dpcheng.StatShrWdbeSegSup1NSegment;
				if (dpcheng.StgIacWdbeSegSup1NSegment) this.stgiac = dpcheng.StgIacWdbeSegSup1NSegment;
				if (dpcheng.TagWdbeSegSup1NSegment) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeSegSup1NSegment);
					this.tag = dpcheng.TagWdbeSegSup1NSegment;
				}
				if (dpcheng.ListWdbeQSegSup1NSegment) this.rst = dpcheng.ListWdbeQSegSup1NSegment;
				if (dpcheng.StatAppQryWdbeSegSup1NSegment) this.statappqry = dpcheng.StatAppQryWdbeSegSup1NSegment;
				if (dpcheng.StatShrQryWdbeSegSup1NSegment) this.statshrqry = dpcheng.StatShrQryWdbeSegSup1NSegment;
				if (dpcheng.StgIacQryWdbeSegSup1NSegment) this.stgiacqry = dpcheng.StgIacQryWdbeSegSup1NSegment;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQSegSup1NSegment) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeSegSup1NSegmentData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeSegSup1NSegmentData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
