...
<script>
	...
	*/
	...
	import PnlWdbeLibMNComponent from './PnlWdbeLibMNComponent';
	/*
	*/
				...
				if (obj.scrJref == this.scrJref) {
					...
					if (this.statshr.srefIxWdbeVExpstate == "regd") {
						...
						*/
						...
						else if (obj.scrJref == this.statshr.scrJrefMNComponent) this.$refs.PnlWdbeLibMNComponent.handleReply(obj);
						/*
						*/
					}
				}
				...
				if (obj.dpcheng.scrJref == this.scrJref) {
					...
					if (this.statshr.srefIxWdbeVExpstate == "regd") {
						...
						*/
						...
						else if (obj.dpcheng.scrJref == this.statshr.scrJrefMNComponent) this.$refs.PnlWdbeLibMNComponent.handleUpdate(obj);
						/*
						*/
