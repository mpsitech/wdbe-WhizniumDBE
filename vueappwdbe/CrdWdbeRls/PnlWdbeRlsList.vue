			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				...
				if (dpcheng.TagWdbeRlsList) {
					...
					/*
					*/
					tcos.push({value: "jnum", text: "jnum"}, {value: "TcoSrf", text: this.tag.TcoSrf}, {value: "TcoCmp", text: this.tag.TcoCmp}, {value: "TcoMch", text: this.tag.TcoMch});
					/*
					*/
				...
				if (dpcheng.ListWdbeQRlsList) {
					...
					for (var i = 0; i < this.rst.length; i++) {
						...
						/*
						*/
						rows.push({jnum: rec["jnum"], TcoSrf: rec["srf"], TcoCmp: rec["cmp"], TcoMch: rec["mch"]})
						/*
						*/
