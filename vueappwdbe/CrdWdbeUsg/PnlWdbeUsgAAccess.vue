...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUsgAAccess.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUsgAAccessData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUsgAAccess": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUsgAAccess"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUsgAAccessData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUsgAAccessData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUsgAAccess) this.continf = dpcheng.ContInfWdbeUsgAAccess;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUsgAAccess) this.statapp = dpcheng.StatAppWdbeUsgAAccess;
				if (dpcheng.StatShrWdbeUsgAAccess) this.statshr = dpcheng.StatShrWdbeUsgAAccess;
				if (dpcheng.StgIacWdbeUsgAAccess) this.stgiac = dpcheng.StgIacWdbeUsgAAccess;
				if (dpcheng.TagWdbeUsgAAccess) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUsgAAccess);
					this.tag = dpcheng.TagWdbeUsgAAccess;
				}
				if (dpcheng.ListWdbeQUsgAAccess) this.rst = dpcheng.ListWdbeQUsgAAccess;
				if (dpcheng.StatAppQryWdbeUsgAAccess) this.statappqry = dpcheng.StatAppQryWdbeUsgAAccess;
				if (dpcheng.StatShrQryWdbeUsgAAccess) this.statshrqry = dpcheng.StatShrQryWdbeUsgAAccess;
				if (dpcheng.StgIacQryWdbeUsgAAccess) this.stgiacqry = dpcheng.StgIacQryWdbeUsgAAccess;
				/*
				...
				*/
				...
				if (dpcheng.ListWdbeQUsgAAccess) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUsgAAccessData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUsgAAccessData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
