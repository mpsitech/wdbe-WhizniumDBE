...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeUsgMNUser.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeUsgMNUserData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeUsgMNUser": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeUsgMNUser"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeUsgMNUserData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeUsgMNUserData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeUsgMNUser) this.continf = dpcheng.ContInfWdbeUsgMNUser;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeUsgMNUser) this.statapp = dpcheng.StatAppWdbeUsgMNUser;
				if (dpcheng.StatShrWdbeUsgMNUser) this.statshr = dpcheng.StatShrWdbeUsgMNUser;
				if (dpcheng.StgIacWdbeUsgMNUser) this.stgiac = dpcheng.StgIacWdbeUsgMNUser;
				if (dpcheng.TagWdbeUsgMNUser) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeUsgMNUser);
					this.tag = dpcheng.TagWdbeUsgMNUser;
				}
				if (dpcheng.ListWdbeQUsgMNUser) this.rst = dpcheng.ListWdbeQUsgMNUser;
				if (dpcheng.StatAppQryWdbeUsgMNUser) this.statappqry = dpcheng.StatAppQryWdbeUsgMNUser;
				if (dpcheng.StatShrQryWdbeUsgMNUser) this.statshrqry = dpcheng.StatShrQryWdbeUsgMNUser;
				if (dpcheng.StgIacQryWdbeUsgMNUser) this.stgiacqry = dpcheng.StgIacQryWdbeUsgMNUser;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeUsgMNUserData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeUsgMNUserData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
