...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWdbeFam1NUnit.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWdbeFam1NUnitData": {
						"scrJref": this.scrJref,
						"StgIacQryWdbeFam1NUnit": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWdbeFam1NUnit"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWdbeFam1NUnitData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWdbeFam1NUnitData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWdbeFam1NUnit) this.continf = dpcheng.ContInfWdbeFam1NUnit;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWdbeFam1NUnit) this.statapp = dpcheng.StatAppWdbeFam1NUnit;
				if (dpcheng.StatShrWdbeFam1NUnit) this.statshr = dpcheng.StatShrWdbeFam1NUnit;
				if (dpcheng.StgIacWdbeFam1NUnit) this.stgiac = dpcheng.StgIacWdbeFam1NUnit;
				if (dpcheng.TagWdbeFam1NUnit) {
					Wdbe.unescapeBlock(dpcheng.TagWdbeFam1NUnit);
					this.tag = dpcheng.TagWdbeFam1NUnit;
				}
				if (dpcheng.ListWdbeQFam1NUnit) this.rst = dpcheng.ListWdbeQFam1NUnit;
				if (dpcheng.StatAppQryWdbeFam1NUnit) this.statappqry = dpcheng.StatAppQryWdbeFam1NUnit;
				if (dpcheng.StatShrQryWdbeFam1NUnit) this.statshrqry = dpcheng.StatShrQryWdbeFam1NUnit;
				if (dpcheng.StgIacQryWdbeFam1NUnit) this.stgiacqry = dpcheng.StgIacQryWdbeFam1NUnit;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWdbeVDpch, dpcheng) {
				if (srefIxWdbeVDpch == "DpchEngWdbeFam1NUnitData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWdbeVDpch == "DpchEngWdbeFam1NUnitData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
