...
public:
	...
	public:
		...
		static const Sbecore::uint PNLWDBESILFWD1NCONTROLLER_TCOREF = 81;
		static const Sbecore::uint PNLWDBESIL1NTARGET_TCOREF = 82;
		static const Sbecore::uint PNLWDBESILREF1NCOMMAND_TCOREF = 83;
		static const Sbecore::uint PNLWDBESILREF1NERROR_TCOREF = 84;
		static const Sbecore::uint PNLWDBESILHK1NVECTOR_TCOREF = 85;
		static const Sbecore::uint PNLWDBESILHK1NMODULE_TCOREF = 86;
		static const Sbecore::uint PNLWDBEMTPLIST_TCOSRF = 87;
		...
		static const Sbecore::uint PNLWDBEMTPMDL1NGENERIC_TCOREF = 106;
		static const Sbecore::uint PNLWDBEMTPSUP1NMODULE_TCOREF = 107;
		static const Sbecore::uint PNLWDBEMTPREF1NFILE_TCOREF = 108;
		static const Sbecore::uint PNLWDBEMTPMGE1NSIGNAL_TCOREF = 109;
		static const Sbecore::uint PNLWDBEPRJLIST_TCOGRP = 110;
		static const Sbecore::uint PNLWDBEPRJLIST_TCOOWN = 111;
		static const Sbecore::uint PNLWDBEPRJLIST_TCOSHO = 112;
		static const Sbecore::uint PNLWDBEPRJLIST_TCOTIT = 113;
		static const Sbecore::uint PNLWDBEPRJLIST_TCOVER = 114;
		static const Sbecore::uint PNLWDBEPRJLIST_TCOESY = 115;
		static const Sbecore::uint PNLWDBEPRJLIST_TCOGRL = 116;
		static const Sbecore::uint PNLWDBEPRJPRJ1NVERSION_TCOREF = 117;
		static const Sbecore::uint PNLWDBEPRJMNPERSON_TCOMREF = 118;
		static const Sbecore::uint PNLWDBEPRJMNPERSON_TCOSTA = 119;
		static const Sbecore::uint PNLWDBEPRJMNPERSON_TCOSTO = 120;
		static const Sbecore::uint PNLWDBEPRJMNPERSON_TCOFCT = 121;
		static const Sbecore::uint PNLWDBEVERLIST_TCOGRP = 122;
		static const Sbecore::uint PNLWDBEVERLIST_TCOOWN = 123;
		static const Sbecore::uint PNLWDBEVERLIST_TCOPRJ = 124;
		static const Sbecore::uint PNLWDBEVERLIST_TCOMAJ = 125;
		static const Sbecore::uint PNLWDBEVERLIST_TCOMIN = 126;
		static const Sbecore::uint PNLWDBEVERLIST_TCOSUB = 127;
		static const Sbecore::uint PNLWDBEVERLIST_TCOBVR = 128;
		static const Sbecore::uint PNLWDBEVERLIST_TCOSTE = 129;
		static const Sbecore::uint PNLWDBEVERBVR1NVERSION_TCOREF = 130;
		static const Sbecore::uint PNLWDBEVER1NSYSTEM_TCOREF = 131;
		static const Sbecore::uint PNLWDBEVER1NRELEASE_TCOREF = 132;
		static const Sbecore::uint PNLWDBEVER1NUNIT_TCOREF = 133;
		static const Sbecore::uint PNLWDBEVERREF1NFILE_TCOREF = 134;
		static const Sbecore::uint PNLWDBEVERMNLIBRARY_TCOMREF = 135;
		static const Sbecore::uint PNLWDBESYSLIST_TCOSRF = 136;
		static const Sbecore::uint PNLWDBESYSLIST_TCOVER = 137;
		static const Sbecore::uint PNLWDBESYSLIST_TCOUNT = 138;
		static const Sbecore::uint PNLWDBESYSSYS1NTARGET_TCOREF = 139;
		static const Sbecore::uint PNLWDBESYSHK1NVECTOR_TCOREF = 140;
		static const Sbecore::uint PNLWDBETRGLIST_TCOSRF = 141;
		static const Sbecore::uint PNLWDBETRGLIST_TCOSYS = 142;
		static const Sbecore::uint PNLWDBETRGLIST_TCOUNT = 143;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOSRF = 144;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOTIT = 145;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOFSR = 146;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOTYP = 147;
		static const Sbecore::uint PNLWDBEUNTLIST_TCORET = 148;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOREU = 149;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOSYS = 150;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOMDL = 151;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOPKG = 152;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOESY = 153;
		static const Sbecore::uint PNLWDBEUNTLIST_TCOTCH = 154;
		static const Sbecore::uint PNLWDBEUNT1NPERIPHERAL_TCOREF = 155;
		static const Sbecore::uint PNLWDBEUNTSIL1NUNIT_TCOREF = 156;
		static const Sbecore::uint PNLWDBEUNT1NBANK_TCOREF = 157;
		static const Sbecore::uint PNLWDBEUNTFWD1NCONTROLLER_TCOREF = 158;
		static const Sbecore::uint PNLWDBEUNT1NTARGET_TCOREF = 159;
		static const Sbecore::uint PNLWDBEUNTREF1NCOMMAND_TCOREF = 160;
		static const Sbecore::uint PNLWDBEUNTREF1NERROR_TCOREF = 161;
		static const Sbecore::uint PNLWDBEUNTHK1NVECTOR_TCOREF = 162;
		static const Sbecore::uint PNLWDBEUNTHK1NMODULE_TCOREF = 163;
		static const Sbecore::uint PNLWDBERLSLIST_TCOSRF = 164;
		static const Sbecore::uint PNLWDBERLSLIST_TCOTYP = 165;
		static const Sbecore::uint PNLWDBERLSLIST_TCOVER = 166;
		static const Sbecore::uint PNLWDBERLSLIST_TCOMCH = 167;
		static const Sbecore::uint PNLWDBECPRLIST_TCOGRP = 168;
		static const Sbecore::uint PNLWDBECPRLIST_TCOOWN = 169;
		static const Sbecore::uint PNLWDBECPRLIST_TCOSRF = 170;
		static const Sbecore::uint PNLWDBECPRLIST_TCOTIT = 171;
		static const Sbecore::uint PNLWDBECPRLIST_TCOTYP = 172;
		static const Sbecore::uint PNLWDBECPRLIST_TCOCVR = 173;
		static const Sbecore::uint PNLWDBECPRLIST_TCOGRL = 174;
		static const Sbecore::uint PNLWDBECPR1NCOREVERSION_TCOREF = 175;
		static const Sbecore::uint PNLWDBECPRMNPERSON_TCOMREF = 176;
		static const Sbecore::uint PNLWDBECPRMNPERSON_TCOSTA = 177;
		static const Sbecore::uint PNLWDBECPRMNPERSON_TCOSTO = 178;
		static const Sbecore::uint PNLWDBECPRMNPERSON_TCOFCT = 179;
		static const Sbecore::uint PNLWDBECVRLIST_TCOGRP = 180;
		static const Sbecore::uint PNLWDBECVRLIST_TCOOWN = 181;
		static const Sbecore::uint PNLWDBECVRLIST_TCOCPR = 182;
		static const Sbecore::uint PNLWDBECVRLIST_TCOMAJ = 183;
		static const Sbecore::uint PNLWDBECVRLIST_TCOMIN = 184;
		static const Sbecore::uint PNLWDBECVRLIST_TCOSUB = 185;
		static const Sbecore::uint PNLWDBECVRLIST_TCOBCV = 186;
		static const Sbecore::uint PNLWDBECVRLIST_TCOSTE = 187;
		static const Sbecore::uint PNLWDBECVRAPLH_TCOSRF = 188;
		static const Sbecore::uint PNLWDBECVRAPLH_TCOCMT = 189;
		static const Sbecore::uint PNLWDBECVRAIP_TCOSRF = 190;
		static const Sbecore::uint PNLWDBECVRAIP_TCOTTY = 191;
		static const Sbecore::uint PNLWDBECVRAIP_TCOCMT = 192;
		static const Sbecore::uint PNLWDBECVRBCV1NCOREVERSION_TCOREF = 193;
		static const Sbecore::uint PNLWDBECVRHK1NMODULE_TCOREF = 194;
		static const Sbecore::uint PNLWDBEMODLIST_TCOSRF = 195;
		static const Sbecore::uint PNLWDBEMODLIST_TCOTYP = 196;
		static const Sbecore::uint PNLWDBEMODLIST_TCOHKT = 197;
		static const Sbecore::uint PNLWDBEMODLIST_TCOHKU = 198;
		static const Sbecore::uint PNLWDBEMODLIST_TCOSUP = 199;
		static const Sbecore::uint PNLWDBEMODLIST_TCOTPL = 200;
		static const Sbecore::uint PNLWDBEMODKHDLTYPE_TCOFIX = 201;
		static const Sbecore::uint PNLWDBEMODKHDLTYPE_TCOSRF = 202;
		static const Sbecore::uint PNLWDBEMODKHDLTYPE_TCOAVL = 203;
		static const Sbecore::uint PNLWDBEMODKHDLTYPE_TCOIMP = 204;
		static const Sbecore::uint PNLWDBEMODKHDLTYPE_TCOTIT = 205;
		static const Sbecore::uint PNLWDBEMODKHDLTYPE_TCOCMT = 206;
		static const Sbecore::uint PNLWDBEMODAPAR_TCOKEY = 207;
		static const Sbecore::uint PNLWDBEMODAPAR_TCOVAL = 208;
		static const Sbecore::uint PNLWDBEMOD1NPERIPHERAL_TCOREF = 209;
		static const Sbecore::uint PNLWDBEMODMDL1NSIGNAL_TCOREF = 210;
		static const Sbecore::uint PNLWDBEMOD1NPROCESS_TCOREF = 211;
		static const Sbecore::uint PNLWDBEMODMDL1NPORT_TCOREF = 212;
		static const Sbecore::uint PNLWDBEMODCOR1NIMBUF_TCOREF = 213;
		static const Sbecore::uint PNLWDBEMODMDL1NGENERIC_TCOREF = 214;
		static const Sbecore::uint PNLWDBEMODSUP1NMODULE_TCOREF = 215;
		static const Sbecore::uint PNLWDBEMODMGE1NSIGNAL_TCOREF = 216;
		static const Sbecore::uint PNLWDBEMODCTRREF1NCOMMAND_TCOREF = 217;
		static const Sbecore::uint PNLWDBEMODCTRREF1NERROR_TCOREF = 218;
		static const Sbecore::uint PNLWDBEMODCTRHK1NVECTOR_TCOREF = 219;
		static const Sbecore::uint PNLWDBEMODCTRMNCOMMAND_TCOMREF = 220;
		static const Sbecore::uint PNLWDBEMODCTRMNCOMMAND_TCOIVR = 221;
		static const Sbecore::uint PNLWDBEMODCTRMNCOMMAND_TCORVR = 222;
		static const Sbecore::uint PNLWDBEVECLIST_TCOSRF = 223;
		static const Sbecore::uint PNLWDBEVECLIST_TCOTYP = 224;
		static const Sbecore::uint PNLWDBEVECLIST_TCOHKT = 225;
		static const Sbecore::uint PNLWDBEVECLIST_TCOHKU = 226;
		static const Sbecore::uint PNLWDBEVECVEC1NVECTORITEM_TCOREF = 227;
		static const Sbecore::uint PNLWDBEVITLIST_TCOSRF = 228;
		static const Sbecore::uint PNLWDBEVITLIST_TCOTIT = 229;
		static const Sbecore::uint PNLWDBEVITLIST_TCOVEC = 230;
		static const Sbecore::uint PNLWDBECMDLIST_TCOSRF = 231;
		static const Sbecore::uint PNLWDBECMDLIST_TCOFSR = 232;
		static const Sbecore::uint PNLWDBECMDLIST_TCORET = 233;
		static const Sbecore::uint PNLWDBECMDLIST_TCOREU = 234;
		static const Sbecore::uint PNLWDBECMDLIST_TCORTY = 235;
		static const Sbecore::uint PNLWDBECMDARETPAR_TCOSRF = 236;
		static const Sbecore::uint PNLWDBECMDARETPAR_TCOPTY = 237;
		static const Sbecore::uint PNLWDBECMDARETPAR_TCOVEC = 238;
		static const Sbecore::uint PNLWDBECMDARETPAR_TCOLEN = 239;
		static const Sbecore::uint PNLWDBECMDARETPAR_TCOCMT = 240;
		static const Sbecore::uint PNLWDBECMDAINVPAR_TCOSRF = 241;
		static const Sbecore::uint PNLWDBECMDAINVPAR_TCOPTY = 242;
		static const Sbecore::uint PNLWDBECMDAINVPAR_TCOVEC = 243;
		static const Sbecore::uint PNLWDBECMDAINVPAR_TCOLEN = 244;
		static const Sbecore::uint PNLWDBECMDAINVPAR_TCODFV = 245;
		static const Sbecore::uint PNLWDBECMDAINVPAR_TCOVIT = 246;
		static const Sbecore::uint PNLWDBECMDAINVPAR_TCOCMT = 247;
		static const Sbecore::uint PNLWDBECMDMNCONTROLLER_TCOMREF = 248;
		static const Sbecore::uint PNLWDBECMDMNCONTROLLER_TCOIVR = 249;
		static const Sbecore::uint PNLWDBECMDMNCONTROLLER_TCORVR = 250;
		static const Sbecore::uint PNLWDBEERRLIST_TCOSRF = 251;
		static const Sbecore::uint PNLWDBEERRLIST_TCOFSR = 252;
		static const Sbecore::uint PNLWDBEERRLIST_TCORET = 253;
		static const Sbecore::uint PNLWDBEERRLIST_TCOREU = 254;
		static const Sbecore::uint PNLWDBEERRAPAR_TCOSRF = 255;
		static const Sbecore::uint PNLWDBEERRAPAR_TCOPTY = 256;
		static const Sbecore::uint PNLWDBEERRAPAR_TCOVEC = 257;
		static const Sbecore::uint PNLWDBEERRAPAR_TCOLEN = 258;
		static const Sbecore::uint PNLWDBEERRAPAR_TCOCMT = 259;
		static const Sbecore::uint PNLWDBEPPHLIST_TCOSRF = 260;
		static const Sbecore::uint PNLWDBEPPHLIST_TCOUNT = 261;
		static const Sbecore::uint PNLWDBEPPHLIST_TCOMDL = 262;
		static const Sbecore::uint PNLWDBEPPHAPAR_TCOKEY = 263;
		static const Sbecore::uint PNLWDBEPPHAPAR_TCOVAL = 264;
		static const Sbecore::uint PNLWDBEBNKLIST_TCOSRF = 265;
		static const Sbecore::uint PNLWDBEBNKLIST_TCOUNT = 266;
		static const Sbecore::uint PNLWDBEBNKLIST_TCOVST = 267;
		static const Sbecore::uint PNLWDBEBNK1NPIN_TCOREF = 268;
		static const Sbecore::uint PNLWDBEPINLIST_TCOSRF = 269;
		static const Sbecore::uint PNLWDBEPINLIST_TCOBNK = 270;
		static const Sbecore::uint PNLWDBEPINLIST_TCOLOC = 271;
		static const Sbecore::uint PNLWDBEPINAPAR_TCOKEY = 272;
		static const Sbecore::uint PNLWDBEPINAPAR_TCOVAL = 273;
		static const Sbecore::uint PNLWDBEGENLIST_TCOSRF = 274;
		static const Sbecore::uint PNLWDBEGENLIST_TCOMDL = 275;
		static const Sbecore::uint PNLWDBEGENLIST_TCOHTY = 276;
		static const Sbecore::uint PNLWDBEGENLIST_TCOWID = 277;
		static const Sbecore::uint PNLWDBEGENLIST_TCOMMX = 278;
		static const Sbecore::uint PNLWDBEPRTLIST_TCOSRF = 279;
		static const Sbecore::uint PNLWDBEPRTLIST_TCOMDL = 280;
		static const Sbecore::uint PNLWDBEPRTLIST_TCOMDC = 281;
		static const Sbecore::uint PNLWDBEPRTLIST_TCODIR = 282;
		static const Sbecore::uint PNLWDBEPRTLIST_TCOHTY = 283;
		static const Sbecore::uint PNLWDBEPRTLIST_TCOWID = 284;
		static const Sbecore::uint PNLWDBEPRTLIST_TCOMMX = 285;
		static const Sbecore::uint PNLWDBESIGLIST_TCOSRF = 286;
		static const Sbecore::uint PNLWDBESIGLIST_TCOTYP = 287;
		static const Sbecore::uint PNLWDBESIGLIST_TCOMDL = 288;
		static const Sbecore::uint PNLWDBESIGLIST_TCOMGT = 289;
		static const Sbecore::uint PNLWDBESIGLIST_TCOMGU = 290;
		static const Sbecore::uint PNLWDBESIGLIST_TCOVEC = 291;
		static const Sbecore::uint PNLWDBESIGLIST_TCOCON = 292;
		static const Sbecore::uint PNLWDBESIGLIST_TCOHTY = 293;
		static const Sbecore::uint PNLWDBESIGLIST_TCOWID = 294;
		static const Sbecore::uint PNLWDBESIGLIST_TCOMMX = 295;
		static const Sbecore::uint PNLWDBEPRCLIST_TCOSRF = 296;
		static const Sbecore::uint PNLWDBEPRCLIST_TCOMDL = 297;
		static const Sbecore::uint PNLWDBEPRCLIST_TCOFAL = 298;
		static const Sbecore::uint PNLWDBEPRCKHDLTYPE_TCOFIX = 299;
		static const Sbecore::uint PNLWDBEPRCKHDLTYPE_TCOSRF = 300;
		static const Sbecore::uint PNLWDBEPRCKHDLTYPE_TCOAVL = 301;
		static const Sbecore::uint PNLWDBEPRCKHDLTYPE_TCOIMP = 302;
		static const Sbecore::uint PNLWDBEPRCKHDLTYPE_TCOTIT = 303;
		static const Sbecore::uint PNLWDBEPRCKHDLTYPE_TCOCMT = 304;
		static const Sbecore::uint PNLWDBEPRCPRC1NVARIABLE_TCOREF = 305;
		static const Sbecore::uint PNLWDBEPRCMGE1NSIGNAL_TCOREF = 306;
		static const Sbecore::uint PNLWDBEPRCFSMFSM1NFSMSTATE_TCOREF = 307;
		static const Sbecore::uint PNLWDBEFSTLIST_TCOSRF = 308;
		static const Sbecore::uint PNLWDBEFSTLIST_TCOFSM = 309;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOFNX = 310;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOCN1 = 311;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOIP1 = 312;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOCN2 = 313;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOIP2 = 314;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOCN3 = 315;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOIP3 = 316;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOCN4 = 317;
		static const Sbecore::uint PNLWDBEFSTASTEP_TCOIP4 = 318;
		static const Sbecore::uint PNLWDBEVARLIST_TCOSRF = 319;
		static const Sbecore::uint PNLWDBEVARLIST_TCOPRC = 320;
		static const Sbecore::uint PNLWDBEVARLIST_TCOCON = 321;
		static const Sbecore::uint PNLWDBEVARLIST_TCOFAL = 322;
		static const Sbecore::uint PNLWDBEVARLIST_TCOHTY = 323;
		static const Sbecore::uint PNLWDBEVARLIST_TCOWID = 324;
		static const Sbecore::uint PNLWDBEVARLIST_TCOMMX = 325;
	...
	public:
		...
		static const Sbecore::uint KLSTWDBEKMFAMILYVENDOR = 10;
		static const Sbecore::uint KLSTWDBEKMFILECONTENT = 11;
		static const Sbecore::uint KLSTWDBEKMFILEMIMETYPE = 12;
		static const Sbecore::uint KLSTWDBEKMRELEASEOPTION = 13;
		static const Sbecore::uint KLSTWDBEKMUNITPACKAGE = 14;
		static const Sbecore::uint KLSTWDBEKMUNITTOOLCH = 15;
		static const Sbecore::uint KLSTWDBEKMVECTOROPTION = 16;
		static const Sbecore::uint KLSTWDBEKRMCOREPROJECTMPERSONFUNCTION = 17;
		static const Sbecore::uint KLSTWDBEKRMPERSONMPROJECTFUNCTION = 18;
		static const Sbecore::uint KLSTKWDBEMTPMODBSCBUCUSTOP = 19;
		static const Sbecore::uint KLSTKWDBEMTPMODBSCTDCUSTOP = 20;
		static const Sbecore::uint KLSTKWDBEMTPMODDETCUSTOP = 21;
		static const Sbecore::uint KLSTKWDBEMTPPLHFPGACUSTOP = 22;
		static const Sbecore::uint KLSTKWDBEMTPPLHMCUCUSTOP = 23;
		static const Sbecore::uint KLSTKWDBEMTPWRFPGACUSTOP = 24;
		static const Sbecore::uint KLSTKWDBEMTPWRMCUCUSTOP = 25;
	...
	public:
		...
		static const Sbecore::uint PREWDBEMCHLIST_SRF = 82;
		static const Sbecore::uint PREWDBEMCHLIST_SUP = 83;
		...
		static const Sbecore::uint PREWDBETLAST = 188;
		static const Sbecore::uint PREWDBETRGLIST_SRF = 189;
		static const Sbecore::uint PREWDBETRGLIST_SYS = 190;
		static const Sbecore::uint PREWDBETRGLIST_UNT = 191;
		static const Sbecore::uint PREWDBEUNTLIST_MDL = 192;
		static const Sbecore::uint PREWDBEUNTLIST_RET = 193;
		static const Sbecore::uint PREWDBEUNTLIST_REU = 194;
		static const Sbecore::uint PREWDBEUNTLIST_SRF = 195;
		static const Sbecore::uint PREWDBEUNTLIST_SYS = 196;
		static const Sbecore::uint PREWDBEUNTLIST_TIT = 197;
		static const Sbecore::uint PREWDBEUNTLIST_TYP = 198;
		static const Sbecore::uint PREWDBEUSGAACCESS_X1 = 199;
		static const Sbecore::uint PREWDBEUSGAACCESS_X2 = 200;
		static const Sbecore::uint PREWDBEUSGLIST_GRP = 201;
		static const Sbecore::uint PREWDBEUSGLIST_OWN = 202;
		static const Sbecore::uint PREWDBEUSGLIST_SRF = 203;
		static const Sbecore::uint PREWDBEUSRAACCESS_X1 = 204;
		static const Sbecore::uint PREWDBEUSRAACCESS_X2 = 205;
		static const Sbecore::uint PREWDBEUSRLIST_GRP = 206;
		static const Sbecore::uint PREWDBEUSRLIST_OWN = 207;
		static const Sbecore::uint PREWDBEUSRLIST_PRS = 208;
		static const Sbecore::uint PREWDBEUSRLIST_SRF = 209;
		static const Sbecore::uint PREWDBEUSRLIST_STE = 210;
		static const Sbecore::uint PREWDBEUSRLIST_USG = 211;
		static const Sbecore::uint PREWDBEVARLIST_PRC = 212;
		static const Sbecore::uint PREWDBEVARLIST_SRF = 213;
		static const Sbecore::uint PREWDBEVECLIST_HKT = 214;
		static const Sbecore::uint PREWDBEVECLIST_HKU = 215;
		static const Sbecore::uint PREWDBEVECLIST_SRF = 216;
		static const Sbecore::uint PREWDBEVECLIST_TYP = 217;
		static const Sbecore::uint PREWDBEVERLIST_BVR = 218;
		static const Sbecore::uint PREWDBEVERLIST_GRP = 219;
		static const Sbecore::uint PREWDBEVERLIST_OWN = 220;
		static const Sbecore::uint PREWDBEVERLIST_PRJ = 221;
		static const Sbecore::uint PREWDBEVERLIST_STE = 222;
		static const Sbecore::uint PREWDBEVITLIST_SRF = 223;
		static const Sbecore::uint PREWDBEVITLIST_VEC = 224;
