...
void WdbeQMchAMakefile::writeJSON(
	...
	if (shorttags) {
		me["tag"] = x1SrefKTag;
		me["tag2"] = titX1SrefKTag;
		me["val"] = Val;
	} else {
		me["x1SrefKTag"] = x1SrefKTag;
		me["titX1SrefKTag"] = titX1SrefKTag;
		me["Val"] = Val;
	};
};
...
void ListWdbeQMchAMakefile::writeJSON(
			Json::Value& sup
			, std::string difftag
		) {
	if (difftag == "") difftag = "ListWdbeQMchAMakefile";
