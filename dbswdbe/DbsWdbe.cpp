...
void DbsWdbe::initMy() {
	...
	tblwdbeqprj1nversion = new MyTblWdbeQPrj1NVersion();
	((MyTblWdbeQPrj1NVersion*) tblwdbeqprj1nversion)->init(dbsMy);
...
void DbsWdbe::initPg() {
	...
	tblwdbeqprj1nversion = new PgTblWdbeQPrj1NVersion();
	((PgTblWdbeQPrj1NVersion*) tblwdbeqprj1nversion)->init(dbsPg);
