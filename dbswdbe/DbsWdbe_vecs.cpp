...
uint DbsWdbe::VecVControl::getIx(
	...
	if (s == "pnlwdbeprj1nversion.tcoref") return PNLWDBEPRJ1NVERSION_TCOREF;
...
string DbsWdbe::VecVControl::getSref(
	...
	if (ix == PNLWDBEPRJ1NVERSION_TCOREF) return("PnlWdbePrj1NVersion.TcoRef");
...
uint DbsWdbe::VecVKeylist::getIx(
	...
	if (s == "klstwdbekamunitpackage") return KLSTWDBEKAMUNITPACKAGE;
	if (s == "klstwdbekamunittoolch") return KLSTWDBEKAMUNITTOOLCH;
...
string DbsWdbe::VecVKeylist::getSref(
	...
	if (ix == KLSTWDBEKAMUNITPACKAGE) return("KlstWdbeKAMUnitPackage");
	if (ix == KLSTWDBEKAMUNITTOOLCH) return("KlstWdbeKAMUnitToolch");
...
string DbsWdbe::VecVKeylist::getTitle(
	...
	if (ixWdbeVLocale == 1) {
		...
		if (ix == KLSTWDBEKAMUNITPACKAGE) return("package");
		if (ix == KLSTWDBEKAMUNITTOOLCH) return("tool chain");
