/**
  * \file PnlWdbeCprMNPerson.java
  * Java API code for job PnlWdbeCprMNPerson
...
public class PnlWdbeCprMNPerson {
	/**
		* VecVDo (full: VecVWdbeCprMNPersonDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCprMNPerson)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCprMNPerson");
	...
	/**
	  * StatApp (full: StatAppWdbeCprMNPerson)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCprMNPerson");
	...
	/**
	  * StatShr (full: StatShrWdbeCprMNPerson)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCprMNPerson");
	...
	/**
	  * StgIac (full: StgIacWdbeCprMNPerson)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCprMNPerson");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCprMNPerson";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCprMNPerson");
	...
	/**
		* DpchAppData (full: DpchAppWdbeCprMNPersonData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECPRMNPERSONDATA, scrJref);
		...
		public QryWdbeCprMNPerson.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCprMNPersonData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCprMNPersonDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECPRMNPERSONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCprMNPersonDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCprMNPersonData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECPRMNPERSONDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQCprMNPerson();
			statappqry = (new QryWdbeCprMNPerson()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCprMNPerson()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCprMNPerson()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCprMNPerson rst;
		public QryWdbeCprMNPerson.StatApp statappqry;
		public QryWdbeCprMNPerson.StatShr statshrqry;
		public QryWdbeCprMNPerson.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCprMNPersonData");
