/**
  * \file QryWdbeModMdl1NPort.java
  * Java API code for job QryWdbeModMdl1NPort
...
public class QryWdbeModMdl1NPort {
	/**
	  * StatApp (full: StatAppQryWdbeModMdl1NPort)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModMdl1NPort");
	...
	/**
	  * StatShr (full: StatShrQryWdbeModMdl1NPort)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModMdl1NPort");
	...
	/**
	  * StgIac (full: StgIacQryWdbeModMdl1NPort)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModMdl1NPort");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModMdl1NPort";
