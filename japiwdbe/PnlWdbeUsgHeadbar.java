/**
  * \file PnlWdbeUsgHeadbar.java
  * Java API code for job PnlWdbeUsgHeadbar
...
public class PnlWdbeUsgHeadbar {
	/**
	  * StgInf (full: StgInfWdbeUsgHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeUsgHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUsgHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUsgHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUSGHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUsgHeadbarData");
