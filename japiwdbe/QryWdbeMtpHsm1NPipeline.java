/**
  * \file QryWdbeMtpHsm1NPipeline.java
  * Java API code for job QryWdbeMtpHsm1NPipeline
...
public class QryWdbeMtpHsm1NPipeline {
	/**
	  * StatApp (full: StatAppQryWdbeMtpHsm1NPipeline)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeMtpHsm1NPipeline");
	...
	/**
	  * StatShr (full: StatShrQryWdbeMtpHsm1NPipeline)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeMtpHsm1NPipeline");
	...
	/**
	  * StgIac (full: StgIacQryWdbeMtpHsm1NPipeline)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeMtpHsm1NPipeline");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeMtpHsm1NPipeline";
