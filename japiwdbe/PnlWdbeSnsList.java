/**
  * \file PnlWdbeSnsList.java
  * Java API code for job PnlWdbeSnsList
...
public class PnlWdbeSnsList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeSnsList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeSnsList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSnsList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSnsList");
	...
	public class StgIac extends Block {
		...
		public static final int TCORETWIDTH = 1;
		public static final int TCOREUWIDTH = 2;
		public static final int TCOSRTWIDTH = 3;
		public static final int TCOSRUWIDTH = 4;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCORETWIDTH, TCOREUWIDTH, TCOSRTWIDTH, TCOSRUWIDTH));
		};

		public int TcoRetWidth;
		public int TcoReuWidth;
		public int TcoSrtWidth;
		public int TcoSruWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSnsList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoSrtWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoSrtWidth", mask, TCOSRTWIDTH);
				TcoSruWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoSruWidth", mask, TCOSRUWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSnsList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoSrtWidth", TcoSrtWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoSruWidth", TcoSruWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoSrtWidth == comp.TcoSrtWidth) items.add(TCOSRTWIDTH);
			if (TcoSruWidth == comp.TcoSruWidth) items.add(TCOSRUWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCORETWIDTH, TCOREUWIDTH, TCOSRTWIDTH, TCOSRUWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCORET = 8;
		public static final int TCOREU = 9;
		public static final int TCOSRT = 10;
		public static final int TCOSRU = 11;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCORET, TCOREU, TCOSRT, TCOSRU));
		};
		...
		public String TcoSrt;
		public String TcoSru;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSnsList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoSrt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSrt", mask, TCOSRT);
				TcoSru = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSru", mask, TCOSRU);
		...
		public HashSet<Integer> comm(
			...
			if (TcoSrt.equals(comp.TcoSrt)) items.add(TCOSRT);
			if (TcoSru.equals(comp.TcoSru)) items.add(TCOSRU);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCORET, TCOREU, TCOSRT, TCOSRU));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESNSLISTDATA, scrJref);
		...
		public QryWdbeSnsList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSnsListData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESNSLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSnsListDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESNSLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQSnsList();
			statappqry = (new QryWdbeSnsList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSnsList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSnsList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSnsList rst;
		public QryWdbeSnsList.StatApp statappqry;
		public QryWdbeSnsList.StatShr statshrqry;
		public QryWdbeSnsList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSnsListData");
