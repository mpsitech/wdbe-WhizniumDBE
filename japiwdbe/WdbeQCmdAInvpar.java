/**
  ...
  * Java API code for record of table TblWdbeQCmdAInvpar
...
public class WdbeQCmdAInvpar {
	
	public WdbeQCmdAInvpar(
				int jnum
				, String sref
	...
	public String stubRefWdbeMVectoritem;
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WdbeQCmdAInvpar");
		...
		if (Xmlio.checkXPath(doc, basexpath)) {
			...
			stubRefWdbeMVectoritem = Xmlio.extractStringUclc(doc, basexpath, "stubRefWdbeMVectoritem", "vit", null, 0);
