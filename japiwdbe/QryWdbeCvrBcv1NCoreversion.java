/**
  * \file QryWdbeCvrBcv1NCoreversion.java
  * Java API code for job QryWdbeCvrBcv1NCoreversion
...
public class QryWdbeCvrBcv1NCoreversion {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeCvrBcv1NCoreversion");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeCvrBcv1NCoreversion");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeCvrBcv1NCoreversion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeCvrBcv1NCoreversion";
