/**
  * \file PnlWdbeCmpMNLibrary.java
  * Java API code for job PnlWdbeCmpMNLibrary
...
public class PnlWdbeCmpMNLibrary {
	/**
		* VecVDo (full: VecVWdbeCmpMNLibraryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCmpMNLibrary)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCmpMNLibrary");
	...
	/**
	  * StatApp (full: StatAppWdbeCmpMNLibrary)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCmpMNLibrary");
	...
	/**
	  * StatShr (full: StatShrWdbeCmpMNLibrary)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCmpMNLibrary");
	...
	/**
	  * StgIac (full: StgIacWdbeCmpMNLibrary)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCmpMNLibrary");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCmpMNLibrary";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCmpMNLibrary");
	...
	/**
		* DpchAppData (full: DpchAppWdbeCmpMNLibraryData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMPMNLIBRARYDATA, scrJref);
		...
		public QryWdbeCmpMNLibrary.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmpMNLibraryData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCmpMNLibraryDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMPMNLIBRARYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmpMNLibraryDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCmpMNLibraryData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECMPMNLIBRARYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQCmpMNLibrary();
			statappqry = (new QryWdbeCmpMNLibrary()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCmpMNLibrary()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCmpMNLibrary()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCmpMNLibrary rst;
		public QryWdbeCmpMNLibrary.StatApp statappqry;
		public QryWdbeCmpMNLibrary.StatShr statshrqry;
		public QryWdbeCmpMNLibrary.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCmpMNLibraryData");
