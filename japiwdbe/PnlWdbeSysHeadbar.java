/**
  * \file PnlWdbeSysHeadbar.java
  * Java API code for job PnlWdbeSysHeadbar
...
public class PnlWdbeSysHeadbar {
	/**
	  * StgInf (full: StgInfWdbeSysHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeSysHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSysHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSysHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESYSHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSysHeadbarData");
