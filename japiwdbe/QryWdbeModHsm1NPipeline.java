/**
  * \file QryWdbeModHsm1NPipeline.java
  * Java API code for job QryWdbeModHsm1NPipeline
...
public class QryWdbeModHsm1NPipeline {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModHsm1NPipeline");

			String itemtag = "StatitemAppQryWdbeModHsm1NPipeline";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModHsm1NPipeline");

			String itemtag = "StatitemShrQryWdbeModHsm1NPipeline";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModHsm1NPipeline");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModHsm1NPipeline";
