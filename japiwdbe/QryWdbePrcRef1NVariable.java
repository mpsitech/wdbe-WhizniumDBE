/**
  * \file QryWdbePrcRef1NVariable.java
  * Java API code for job QryWdbePrcRef1NVariable
...
public class QryWdbePrcRef1NVariable {
	/**
	  * StatApp (full: StatAppQryWdbePrcRef1NVariable)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbePrcRef1NVariable");
	...
	/**
	  * StatShr (full: StatShrQryWdbePrcRef1NVariable)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbePrcRef1NVariable");
	...
	/**
	  * StgIac (full: StgIacQryWdbePrcRef1NVariable)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbePrcRef1NVariable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbePrcRef1NVariable";
