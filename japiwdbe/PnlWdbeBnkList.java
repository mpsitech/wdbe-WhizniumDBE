/**
  * \file PnlWdbeBnkList.java
  * Java API code for job PnlWdbeBnkList
...
public class PnlWdbeBnkList {
	/**
		* VecVDo (full: VecVWdbeBnkListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeBnkList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeBnkList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeBnkList";
	...
	/**
	  * ContInf (full: ContInfWdbeBnkList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeBnkList");
	...
	/**
	  * StatShr (full: StatShrWdbeBnkList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeBnkList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOUNTWIDTH, TCOVSTWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoUntWidth;
		public int TcoVstWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeBnkList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoVstWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoVstWidth", mask, TCOVSTWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeBnkList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoVstWidth", TcoVstWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoVstWidth == comp.TcoVstWidth) items.add(TCOVSTWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOUNTWIDTH, TCOVSTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOVST = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOUNT, TCOVST));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeBnkList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoVst = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoVst", mask, TCOVST);
		...
		public HashSet<Integer> comm(
			...
			if (TcoVst.equals(comp.TcoVst)) items.add(TCOVST);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOUNT, TCOVST));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeBnkListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEBNKLISTDATA, scrJref);
		...
		public QryWdbeBnkList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeBnkListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeBnkListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEBNKLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeBnkListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeBnkListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEBNKLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQBnkList();
			statappqry = (new QryWdbeBnkList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeBnkList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeBnkList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQBnkList rst;
		public QryWdbeBnkList.StatApp statappqry;
		public QryWdbeBnkList.StatShr statshrqry;
		public QryWdbeBnkList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeBnkListData");
