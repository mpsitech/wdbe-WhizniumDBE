/**
  * \file QryWdbePrcMge1NSignal.java
  * Java API code for job QryWdbePrcMge1NSignal
...
public class QryWdbePrcMge1NSignal {
	/**
	  * StatApp (full: StatAppQryWdbePrcMge1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbePrcMge1NSignal");
	...
	/**
	  * StatShr (full: StatShrQryWdbePrcMge1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbePrcMge1NSignal");
	...
	/**
	  * StgIac (full: StgIacQryWdbePrcMge1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbePrcMge1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbePrcMge1NSignal";
