/**
  * \file QryWdbeVecVec1NVectoritem.java
  * Java API code for job QryWdbeVecVec1NVectoritem
...
public class QryWdbeVecVec1NVectoritem {
	/**
	  * StatApp (full: StatAppQryWdbeVecVec1NVectoritem)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeVecVec1NVectoritem");
	...
	/**
	  * StatShr (full: StatShrQryWdbeVecVec1NVectoritem)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeVecVec1NVectoritem");
	...
	/**
	  * StgIac (full: StgIacQryWdbeVecVec1NVectoritem)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeVecVec1NVectoritem");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeVecVec1NVectoritem";
