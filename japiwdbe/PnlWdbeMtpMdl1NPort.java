/**
  * \file PnlWdbeMtpMdl1NPort.java
  * Java API code for job PnlWdbeMtpMdl1NPort
...
public class PnlWdbeMtpMdl1NPort {
	/**
		* VecVDo (full: VecVWdbeMtpMdl1NPortDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpMdl1NPort)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpMdl1NPort");
	...
	/**
	  * StatApp (full: StatAppWdbeMtpMdl1NPort)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpMdl1NPort");
	...
	/**
	  * StatShr (full: StatShrWdbeMtpMdl1NPort)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpMdl1NPort");
	...
	/**
	  * StgIac (full: StgIacWdbeMtpMdl1NPort)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpMdl1NPort");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpMdl1NPort";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpMdl1NPort");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpMdl1NPortData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPMDL1NPORTDATA, scrJref);
		...
		public QryWdbeMtpMdl1NPort.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpMdl1NPortData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpMdl1NPortDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPMDL1NPORTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpMdl1NPortDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpMdl1NPortData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPMDL1NPORTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpMdl1NPort();
			statappqry = (new QryWdbeMtpMdl1NPort()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpMdl1NPort()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpMdl1NPort()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpMdl1NPort rst;
		public QryWdbeMtpMdl1NPort.StatApp statappqry;
		public QryWdbeMtpMdl1NPort.StatShr statshrqry;
		public QryWdbeMtpMdl1NPort.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpMdl1NPortData");
