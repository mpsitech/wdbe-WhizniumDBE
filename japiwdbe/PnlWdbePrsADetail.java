/**
  * \file PnlWdbePrsADetail.java
  * Java API code for job PnlWdbePrsADetail
...
public class PnlWdbePrsADetail {
	/**
		* VecVDo (full: VecVWdbePrsADetailDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrsADetail)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrsADetail");
	...
	/**
	  * StatApp (full: StatAppWdbePrsADetail)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrsADetail");
	...
	/**
	  * StatShr (full: StatShrWdbePrsADetail)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrsADetail");
	...
	/**
	  * StgIac (full: StgIacWdbePrsADetail)
	  */
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOVALWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrsADetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrsADetail";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOVALWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOVAL));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrsADetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOVAL));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbePrsADetailData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRSADETAILDATA, scrJref);
		...
		public QryWdbePrsADetail.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrsADetailData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrsADetailDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRSADETAILDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrsADetailDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrsADetailData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRSADETAILDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQPrsADetail();
			statappqry = (new QryWdbePrsADetail()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrsADetail()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrsADetail()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrsADetail rst;
		public QryWdbePrsADetail.StatApp statappqry;
		public QryWdbePrsADetail.StatShr statshrqry;
		public QryWdbePrsADetail.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrsADetailData");
