/**
  * \file PnlWdbePrtHeadbar.java
  * Java API code for job PnlWdbePrtHeadbar
...
public class PnlWdbePrtHeadbar {
	/**
	  * StgInf (full: StgInfWdbePrtHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbePrtHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrtHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrtHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRTHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrtHeadbarData");
