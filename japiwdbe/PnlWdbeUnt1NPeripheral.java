/**
  * \file PnlWdbeUnt1NPeripheral.java
  * Java API code for job PnlWdbeUnt1NPeripheral
...
public class PnlWdbeUnt1NPeripheral {
	/**
		* VecVDo (full: VecVWdbeUnt1NPeripheralDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUnt1NPeripheral)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUnt1NPeripheral");
	...
	/**
	  * StatApp (full: StatAppWdbeUnt1NPeripheral)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUnt1NPeripheral");
	...
	/**
	  * StatShr (full: StatShrWdbeUnt1NPeripheral)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUnt1NPeripheral");
	...
	/**
	  * StgIac (full: StgIacWdbeUnt1NPeripheral)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUnt1NPeripheral");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUnt1NPeripheral";
	...
	/**
	  * Tag (full: TagWdbeUnt1NPeripheral)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUnt1NPeripheral");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUnt1NPeripheralData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NPERIPHERALDATA, scrJref);
		...
		public QryWdbeUnt1NPeripheral.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NPeripheralData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUnt1NPeripheralDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NPERIPHERALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NPeripheralDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUnt1NPeripheralData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNT1NPERIPHERALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUnt1NPeripheral();
			statappqry = (new QryWdbeUnt1NPeripheral()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUnt1NPeripheral()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUnt1NPeripheral()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUnt1NPeripheral rst;
		public QryWdbeUnt1NPeripheral.StatApp statappqry;
		public QryWdbeUnt1NPeripheral.StatShr statshrqry;
		public QryWdbeUnt1NPeripheral.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUnt1NPeripheralData");
