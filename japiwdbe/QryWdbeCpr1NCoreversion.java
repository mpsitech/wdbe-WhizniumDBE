/**
  * \file QryWdbeCpr1NCoreversion.java
  * Java API code for job QryWdbeCpr1NCoreversion
...
public class QryWdbeCpr1NCoreversion {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeCpr1NCoreversion");

			String itemtag = "StatitemAppQryWdbeCpr1NCoreversion";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeCpr1NCoreversion");

			String itemtag = "StatitemShrQryWdbeCpr1NCoreversion";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeCpr1NCoreversion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeCpr1NCoreversion";
