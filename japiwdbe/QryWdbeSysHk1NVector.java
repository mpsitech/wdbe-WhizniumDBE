/**
  * \file QryWdbeSysHk1NVector.java
  * Java API code for job QryWdbeSysHk1NVector
...
public class QryWdbeSysHk1NVector {
	/**
	  * StatApp (full: StatAppQryWdbeSysHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeSysHk1NVector");
	...
	/**
	  * StatShr (full: StatShrQryWdbeSysHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeSysHk1NVector");
	...
	/**
	  * StgIac (full: StgIacQryWdbeSysHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeSysHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeSysHk1NVector";
