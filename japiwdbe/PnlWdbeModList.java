/**
  * \file PnlWdbeModList.java
  * Java API code for job PnlWdbeModList
...
public class PnlWdbeModList {
	/**
		* VecVDo (full: VecVWdbeModListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeModList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeModList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeModList";
	...
	/**
	  * ContInf (full: ContInfWdbeModList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModList");
	...
	/**
	  * StatShr (full: StatShrWdbeModList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTplWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTplWidth", mask, TCOTPLWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTplWidth", TcoTplWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoTplWidth == comp.TcoTplWidth) items.add(TCOTPLWIDTH);
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTpl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTpl", mask, TCOTPL);
		...
		public HashSet<Integer> comm(
			...
			if (TcoTpl.equals(comp.TcoTpl)) items.add(TCOTPL);
	...
	/**
		* DpchAppData (full: DpchAppWdbeModListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODLISTDATA, scrJref);
		...
		public QryWdbeModList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODLISTDATA);
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModList rst;
		public QryWdbeModList.StatApp statappqry;
		public QryWdbeModList.StatShr statshrqry;
		public QryWdbeModList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModListData");
