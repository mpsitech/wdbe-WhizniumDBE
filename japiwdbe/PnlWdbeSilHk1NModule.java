/**
  * \file PnlWdbeSilHk1NModule.java
  * Java API code for job PnlWdbeSilHk1NModule
...
public class PnlWdbeSilHk1NModule {
	/**
		* VecVDo (full: VecVWdbeSilHk1NModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSilHk1NModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSilHk1NModule");
	...
	/**
	  * StatApp (full: StatAppWdbeSilHk1NModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSilHk1NModule");
	...
	/**
	  * StatShr (full: StatShrWdbeSilHk1NModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSilHk1NModule");
	...
	/**
	  * StgIac (full: StgIacWdbeSilHk1NModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSilHk1NModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSilHk1NModule";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSilHk1NModule");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSilHk1NModuleData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILHK1NMODULEDATA, scrJref);
		...
		public QryWdbeSilHk1NModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilHk1NModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSilHk1NModuleDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILHK1NMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilHk1NModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSilHk1NModuleData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESILHK1NMODULEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSilHk1NModule();
			statappqry = (new QryWdbeSilHk1NModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSilHk1NModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSilHk1NModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSilHk1NModule rst;
		public QryWdbeSilHk1NModule.StatApp statappqry;
		public QryWdbeSilHk1NModule.StatShr statshrqry;
		public QryWdbeSilHk1NModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSilHk1NModuleData");
