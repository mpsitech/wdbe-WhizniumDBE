/**
  * \file PnlWdbeSil1NTarget.java
  * Java API code for job PnlWdbeSil1NTarget
...
public class PnlWdbeSil1NTarget {
	/**
		* VecVDo (full: VecVWdbeSil1NTargetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSil1NTarget)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSil1NTarget");
	...
	/**
	  * StatApp (full: StatAppWdbeSil1NTarget)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSil1NTarget");
	...
	/**
	  * StatShr (full: StatShrWdbeSil1NTarget)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSil1NTarget");
	...
	/**
	  * StgIac (full: StgIacWdbeSil1NTarget)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSil1NTarget");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSil1NTarget";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSil1NTarget");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSil1NTargetData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NTARGETDATA, scrJref);
		...
		public QryWdbeSil1NTarget.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NTargetData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSil1NTargetDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NTARGETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NTargetDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSil1NTargetData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESIL1NTARGETDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSil1NTarget();
			statappqry = (new QryWdbeSil1NTarget()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSil1NTarget()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSil1NTarget()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSil1NTarget rst;
		public QryWdbeSil1NTarget.StatApp statappqry;
		public QryWdbeSil1NTarget.StatShr statshrqry;
		public QryWdbeSil1NTarget.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSil1NTargetData");
