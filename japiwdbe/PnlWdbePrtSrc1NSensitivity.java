/**
  * \file PnlWdbePrtSrc1NSensitivity.java
  * Java API code for job PnlWdbePrtSrc1NSensitivity
...
public class PnlWdbePrtSrc1NSensitivity {
	/**
		* VecVDo (full: VecVWdbePrtSrc1NSensitivityDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrtSrc1NSensitivity)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrtSrc1NSensitivity");
	...
	/**
	  * StatApp (full: StatAppWdbePrtSrc1NSensitivity)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrtSrc1NSensitivity");
	...
	/**
	  * StatShr (full: StatShrWdbePrtSrc1NSensitivity)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrtSrc1NSensitivity");
	...
	/**
	  * StgIac (full: StgIacWdbePrtSrc1NSensitivity)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrtSrc1NSensitivity");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrtSrc1NSensitivity";
	...
	/**
	  * Tag (full: TagWdbePrtSrc1NSensitivity)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrtSrc1NSensitivity");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrtSrc1NSensitivityData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRTSRC1NSENSITIVITYDATA, scrJref);
		...
		public QryWdbePrtSrc1NSensitivity.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrtSrc1NSensitivityData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrtSrc1NSensitivityDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRTSRC1NSENSITIVITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrtSrc1NSensitivityDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrtSrc1NSensitivityData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRTSRC1NSENSITIVITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPrtSrc1NSensitivity();
			statappqry = (new QryWdbePrtSrc1NSensitivity()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrtSrc1NSensitivity()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrtSrc1NSensitivity()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrtSrc1NSensitivity rst;
		public QryWdbePrtSrc1NSensitivity.StatApp statappqry;
		public QryWdbePrtSrc1NSensitivity.StatShr statshrqry;
		public QryWdbePrtSrc1NSensitivity.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrtSrc1NSensitivityData");
