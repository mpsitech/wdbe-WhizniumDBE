/**
  * \file PnlWdbeModMdl1NPort.java
  * Java API code for job PnlWdbeModMdl1NPort
...
public class PnlWdbeModMdl1NPort {
	/**
		* VecVDo (full: VecVWdbeModMdl1NPortDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModMdl1NPort)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModMdl1NPort");
	...
	/**
	  * StatApp (full: StatAppWdbeModMdl1NPort)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModMdl1NPort");
	...
	/**
	  * StatShr (full: StatShrWdbeModMdl1NPort)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModMdl1NPort");
	...
	/**
	  * StgIac (full: StgIacWdbeModMdl1NPort)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModMdl1NPort");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModMdl1NPort";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModMdl1NPort");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModMdl1NPortData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMDL1NPORTDATA, scrJref);
		...
		public QryWdbeModMdl1NPort.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMdl1NPortData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModMdl1NPortDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMDL1NPORTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMdl1NPortDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModMdl1NPortData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODMDL1NPORTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModMdl1NPort();
			statappqry = (new QryWdbeModMdl1NPort()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModMdl1NPort()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModMdl1NPort()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModMdl1NPort rst;
		public QryWdbeModMdl1NPort.StatApp statappqry;
		public QryWdbeModMdl1NPort.StatShr statshrqry;
		public QryWdbeModMdl1NPort.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModMdl1NPortData");
