/**
  * \file PnlWdbeUnt1NInterrupt.java
  * Java API code for job PnlWdbeUnt1NInterrupt
...
public class PnlWdbeUnt1NInterrupt {
	/**
		* VecVDo (full: VecVWdbeUnt1NInterruptDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUnt1NInterrupt)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUnt1NInterrupt");

			String itemtag = "ContitemInfWdbeUnt1NInterrupt";
	...
	/**
	  * StatApp (full: StatAppWdbeUnt1NInterrupt)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUnt1NInterrupt");

			String itemtag = "StatitemAppWdbeUnt1NInterrupt";
	...
	/**
	  * StatShr (full: StatShrWdbeUnt1NInterrupt)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUnt1NInterrupt");

			String itemtag = "StatitemShrWdbeUnt1NInterrupt";
	...
	/**
	  * StgIac (full: StgIacWdbeUnt1NInterrupt)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUnt1NInterrupt");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUnt1NInterrupt";
	...
	/**
	  * Tag (full: TagWdbeUnt1NInterrupt)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUnt1NInterrupt");

			String itemtag = "TagitemWdbeUnt1NInterrupt";
	...
	/**
		* DpchAppData (full: DpchAppWdbeUnt1NInterruptData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NINTERRUPTDATA, scrJref);
		...
		public QryWdbeUnt1NInterrupt.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NInterruptData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUnt1NInterruptDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NINTERRUPTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NInterruptDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUnt1NInterruptData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNT1NINTERRUPTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUnt1NInterrupt();
			statappqry = (new QryWdbeUnt1NInterrupt()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUnt1NInterrupt()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUnt1NInterrupt()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUnt1NInterrupt rst;
		public QryWdbeUnt1NInterrupt.StatApp statappqry;
		public QryWdbeUnt1NInterrupt.StatShr statshrqry;
		public QryWdbeUnt1NInterrupt.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUnt1NInterruptData");
