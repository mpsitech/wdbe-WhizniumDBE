/**
  * \file PnlWdbeSilRef1NSignal.java
  * Java API code for job PnlWdbeSilRef1NSignal
...
public class PnlWdbeSilRef1NSignal {
	/**
		* VecVDo (full: VecVWdbeSilRef1NSignalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSilRef1NSignal)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSilRef1NSignal");
	...
	/**
	  * StatApp (full: StatAppWdbeSilRef1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSilRef1NSignal");
	...
	/**
	  * StatShr (full: StatShrWdbeSilRef1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSilRef1NSignal");
	...
	/**
	  * StgIac (full: StgIacWdbeSilRef1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSilRef1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSilRef1NSignal";
	...
	/**
	  * Tag (full: TagWdbeSilRef1NSignal)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSilRef1NSignal");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSilRef1NSignalData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILREF1NSIGNALDATA, scrJref);
		...
		public QryWdbeSilRef1NSignal.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilRef1NSignalData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSilRef1NSignalDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILREF1NSIGNALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilRef1NSignalDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSilRef1NSignalData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESILREF1NSIGNALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSilRef1NSignal();
			statappqry = (new QryWdbeSilRef1NSignal()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSilRef1NSignal()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSilRef1NSignal()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSilRef1NSignal rst;
		public QryWdbeSilRef1NSignal.StatApp statappqry;
		public QryWdbeSilRef1NSignal.StatShr statshrqry;
		public QryWdbeSilRef1NSignal.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSilRef1NSignalData");
