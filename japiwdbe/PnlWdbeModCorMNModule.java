/**
  * \file PnlWdbeModCorMNModule.java
  * Java API code for job PnlWdbeModCorMNModule
...
public class PnlWdbeModCorMNModule {
	/**
		* VecVDo (full: VecVWdbeModCorMNModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModCorMNModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModCorMNModule");
	...
	/**
	  * StatApp (full: StatAppWdbeModCorMNModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModCorMNModule");
	...
	/**
	  * StatShr (full: StatShrWdbeModCorMNModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModCorMNModule");
	...
	/**
	  * StgIac (full: StgIacWdbeModCorMNModule)
	  */
	public class StgIac extends Block {

		public static final int TCOMREFWIDTH = 1;
		public static final int TCOFCTWIDTH = 2;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCOFCTWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModCorMNModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModCorMNModule";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCOFCTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
	  * Tag (full: TagWdbeModCorMNModule)
	  */
	public class Tag extends Block {
		...
		public static final int TCOFCT = 8;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCOFCT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModCorMNModule");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCOFCT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeModCorMNModuleData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCORMNMODULEDATA, scrJref);
		...
		public QryWdbeModCorMNModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCorMNModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModCorMNModuleDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCORMNMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCorMNModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModCorMNModuleData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODCORMNMODULEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQModCorMNModule();
			statappqry = (new QryWdbeModCorMNModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModCorMNModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModCorMNModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModCorMNModule rst;
		public QryWdbeModCorMNModule.StatApp statappqry;
		public QryWdbeModCorMNModule.StatShr statshrqry;
		public QryWdbeModCorMNModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModCorMNModuleData");
