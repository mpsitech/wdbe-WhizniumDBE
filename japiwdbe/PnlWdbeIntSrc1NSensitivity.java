/**
  * \file PnlWdbeIntSrc1NSensitivity.java
  * Java API code for job PnlWdbeIntSrc1NSensitivity
...
public class PnlWdbeIntSrc1NSensitivity {
	/**
		* VecVDo (full: VecVWdbeIntSrc1NSensitivityDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeIntSrc1NSensitivity)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeIntSrc1NSensitivity");
	...
	/**
	  * StatApp (full: StatAppWdbeIntSrc1NSensitivity)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeIntSrc1NSensitivity");
	...
	/**
	  * StgIac (full: StgIacWdbeIntSrc1NSensitivity)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeIntSrc1NSensitivity");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeIntSrc1NSensitivity";
	...
	/**
	  * Tag (full: TagWdbeIntSrc1NSensitivity)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeIntSrc1NSensitivity");
	...
	/**
		* DpchAppData (full: DpchAppWdbeIntSrc1NSensitivityData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEINTSRC1NSENSITIVITYDATA, scrJref);
		...
		public QryWdbeIntSrc1NSensitivity.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeIntSrc1NSensitivityData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeIntSrc1NSensitivityDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEINTSRC1NSENSITIVITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeIntSrc1NSensitivityDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeIntSrc1NSensitivityData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEINTSRC1NSENSITIVITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQIntSrc1NSensitivity();
			statappqry = (new QryWdbeIntSrc1NSensitivity()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeIntSrc1NSensitivity()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeIntSrc1NSensitivity()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQIntSrc1NSensitivity rst;
		public QryWdbeIntSrc1NSensitivity.StatApp statappqry;
		public QryWdbeIntSrc1NSensitivity.StatShr statshrqry;
		public QryWdbeIntSrc1NSensitivity.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeIntSrc1NSensitivityData");
