/**
  * \file CrdWdbeFst.java
  * Java API code for job CrdWdbeFst
...
public class CrdWdbeFst {
	/**
		* VecVDo (full: VecVWdbeFstDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeFst)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDFST = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDFST));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdFst;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeFst");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdFst = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdFst", mask, MTXCRDFST);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdFst.equals(comp.MtxCrdFst)) items.add(MTXCRDFST);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDFST));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeFst");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeFst");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeFst");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeFstDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEFSTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeFstDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeFstData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEFSTDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeFstData");
