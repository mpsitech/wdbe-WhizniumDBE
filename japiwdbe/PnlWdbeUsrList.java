/**
  * \file PnlWdbeUsrList.java
  * Java API code for job PnlWdbeUsrList
...
public class PnlWdbeUsrList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeUsrList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeUsrList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUsrList");

			String itemtag = "ContitemInfWdbeUsrList";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUsrList");

			String itemtag = "StatitemShrWdbeUsrList";
	...
	public class StgIac extends Block {
		...
		public static final int TCOPRSWIDTH = 3;
		public static final int TCOSRFWIDTH = 4;
		public static final int TCOUSGWIDTH = 5;
		public static final int TCOSTEWIDTH = 6;
		public static final int TCOLCLWIDTH = 7;
		public static final int TCOULVWIDTH = 8;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOPRSWIDTH, TCOSRFWIDTH, TCOUSGWIDTH, TCOSTEWIDTH, TCOLCLWIDTH, TCOULVWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUsrList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUsrList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOPRSWIDTH, TCOSRFWIDTH, TCOUSGWIDTH, TCOSTEWIDTH, TCOLCLWIDTH, TCOULVWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOPRS = 9;
		public static final int TCOSRF = 10;
		public static final int TCOUSG = 11;
		public static final int TCOSTE = 12;
		public static final int TCOLCL = 13;
		public static final int TCOULV = 14;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOPRS, TCOSRF, TCOUSG, TCOSTE, TCOLCL, TCOULV));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUsrList");

			String itemtag = "TagitemWdbeUsrList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOPRS, TCOSRF, TCOUSG, TCOSTE, TCOLCL, TCOULV));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSRLISTDATA, scrJref);
		...
		public QryWdbeUsrList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsrListData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSRLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsrListDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUSRLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQUsrList();
			statappqry = (new QryWdbeUsrList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUsrList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUsrList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUsrList rst;
		public QryWdbeUsrList.StatApp statappqry;
		public QryWdbeUsrList.StatShr statshrqry;
		public QryWdbeUsrList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUsrListData");
