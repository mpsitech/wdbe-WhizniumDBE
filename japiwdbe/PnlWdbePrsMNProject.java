/**
  * \file PnlWdbePrsMNProject.java
  * Java API code for job PnlWdbePrsMNProject
...
public class PnlWdbePrsMNProject {
	/**
		* VecVDo (full: VecVWdbePrsMNProjectDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrsMNProject)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrsMNProject");
	...
	/**
	  * StatApp (full: StatAppWdbePrsMNProject)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrsMNProject");
	...
	/**
	  * StatShr (full: StatShrWdbePrsMNProject)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrsMNProject");
	...
	/**
	  * StgIac (full: StgIacWdbePrsMNProject)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrsMNProject");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrsMNProject";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrsMNProject");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrsMNProjectData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRSMNPROJECTDATA, scrJref);
		...
		public QryWdbePrsMNProject.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrsMNProjectData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrsMNProjectDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRSMNPROJECTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrsMNProjectDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrsMNProjectData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRSMNPROJECTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQPrsMNProject();
			statappqry = (new QryWdbePrsMNProject()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrsMNProject()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrsMNProject()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrsMNProject rst;
		public QryWdbePrsMNProject.StatApp statappqry;
		public QryWdbePrsMNProject.StatShr statshrqry;
		public QryWdbePrsMNProject.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrsMNProjectData");
