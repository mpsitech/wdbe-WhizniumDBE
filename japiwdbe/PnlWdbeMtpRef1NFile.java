/**
  * \file PnlWdbeMtpRef1NFile.java
  * Java API code for job PnlWdbeMtpRef1NFile
...
public class PnlWdbeMtpRef1NFile {
	/**
		* VecVDo (full: VecVWdbeMtpRef1NFileDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpRef1NFile)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpRef1NFile");
	...
	/**
	  * StatApp (full: StatAppWdbeMtpRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpRef1NFile");
	...
	/**
	  * StatShr (full: StatShrWdbeMtpRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpRef1NFile");
	...
	/**
	  * StgIac (full: StgIacWdbeMtpRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpRef1NFile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpRef1NFile");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpRef1NFileData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPREF1NFILEDATA, scrJref);
		...
		public QryWdbeMtpRef1NFile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpRef1NFileData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpRef1NFileDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPREF1NFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpRef1NFileDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpRef1NFileData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPREF1NFILEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpRef1NFile();
			statappqry = (new QryWdbeMtpRef1NFile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpRef1NFile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpRef1NFile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpRef1NFile rst;
		public QryWdbeMtpRef1NFile.StatApp statappqry;
		public QryWdbeMtpRef1NFile.StatShr statshrqry;
		public QryWdbeMtpRef1NFile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpRef1NFileData");
