/**
  * \file PnlWdbeLibMNVersion.java
  * Java API code for job PnlWdbeLibMNVersion
...
public class PnlWdbeLibMNVersion {
	/**
		* VecVDo (full: VecVWdbeLibMNVersionDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeLibMNVersion)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeLibMNVersion");
	...
	/**
	  * StatApp (full: StatAppWdbeLibMNVersion)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeLibMNVersion");
	...
	/**
	  * StatShr (full: StatShrWdbeLibMNVersion)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeLibMNVersion");
	...
	/**
	  * StgIac (full: StgIacWdbeLibMNVersion)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeLibMNVersion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeLibMNVersion";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeLibMNVersion");
	...
	/**
		* DpchAppData (full: DpchAppWdbeLibMNVersionData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBELIBMNVERSIONDATA, scrJref);
		...
		public QryWdbeLibMNVersion.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeLibMNVersionData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeLibMNVersionDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBELIBMNVERSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeLibMNVersionDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeLibMNVersionData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBELIBMNVERSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQLibMNVersion();
			statappqry = (new QryWdbeLibMNVersion()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeLibMNVersion()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeLibMNVersion()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQLibMNVersion rst;
		public QryWdbeLibMNVersion.StatApp statappqry;
		public QryWdbeLibMNVersion.StatShr statshrqry;
		public QryWdbeLibMNVersion.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeLibMNVersionData");
