/**
  * \file PnlWdbeErrHeadbar.java
  * Java API code for job PnlWdbeErrHeadbar
...
public class PnlWdbeErrHeadbar {
	/**
	  * StgInf (full: StgInfWdbeErrHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeErrHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeErrHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeErrHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEERRHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeErrHeadbarData");
