/**
  * \file PnlWdbeMtpSup1NModule.java
  * Java API code for job PnlWdbeMtpSup1NModule
...
public class PnlWdbeMtpSup1NModule {
	/**
		* VecVDo (full: VecVWdbeMtpSup1NModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpSup1NModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpSup1NModule");

			String itemtag = "ContitemInfWdbeMtpSup1NModule";
	...
	/**
	  * StatApp (full: StatAppWdbeMtpSup1NModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpSup1NModule");

			String itemtag = "StatitemAppWdbeMtpSup1NModule";
	...
	/**
	  * StatShr (full: StatShrWdbeMtpSup1NModule)
	  */
	public class StatShr extends Block {
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(BUTUPAVAIL, BUTUPACTIVE, BUTDOWNAVAIL, BUTDOWNACTIVE, BUTVIEWAVAIL, BUTVIEWACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpSup1NModule");

			String itemtag = "StatitemShrWdbeMtpSup1NModule";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(BUTUPAVAIL, BUTUPACTIVE, BUTDOWNAVAIL, BUTDOWNACTIVE, BUTVIEWAVAIL, BUTVIEWACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
	  * StgIac (full: StgIacWdbeMtpSup1NModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpSup1NModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpSup1NModule";
	...
	/**
	  * Tag (full: TagWdbeMtpSup1NModule)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpSup1NModule");

			String itemtag = "TagitemWdbeMtpSup1NModule";
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpSup1NModuleData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPSUP1NMODULEDATA, scrJref);
		...
		public QryWdbeMtpSup1NModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpSup1NModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpSup1NModuleDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPSUP1NMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpSup1NModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpSup1NModuleData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPSUP1NMODULEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpSup1NModule();
			statappqry = (new QryWdbeMtpSup1NModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpSup1NModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpSup1NModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpSup1NModule rst;
		public QryWdbeMtpSup1NModule.StatApp statappqry;
		public QryWdbeMtpSup1NModule.StatShr statshrqry;
		public QryWdbeMtpSup1NModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpSup1NModuleData");
