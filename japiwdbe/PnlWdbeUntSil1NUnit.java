/**
  * \file PnlWdbeUntSil1NUnit.java
  * Java API code for job PnlWdbeUntSil1NUnit
...
public class PnlWdbeUntSil1NUnit {
	/**
		* VecVDo (full: VecVWdbeUntSil1NUnitDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUntSil1NUnit)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUntSil1NUnit");
	...
	/**
	  * StatApp (full: StatAppWdbeUntSil1NUnit)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUntSil1NUnit");
	...
	/**
	  * StgIac (full: StgIacWdbeUntSil1NUnit)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUntSil1NUnit");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUntSil1NUnit";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUntSil1NUnit");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUntSil1NUnitData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTSIL1NUNITDATA, scrJref);
		...
		public QryWdbeUntSil1NUnit.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntSil1NUnitData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUntSil1NUnitDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTSIL1NUNITDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntSil1NUnitDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUntSil1NUnitData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNTSIL1NUNITDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUntSil1NUnit();
			statappqry = (new QryWdbeUntSil1NUnit()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUntSil1NUnit()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUntSil1NUnit()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUntSil1NUnit rst;
		public QryWdbeUntSil1NUnit.StatApp statappqry;
		public QryWdbeUntSil1NUnit.StatShr statshrqry;
		public QryWdbeUntSil1NUnit.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUntSil1NUnitData");
