/**
  * \file PnlWdbePrfHeadbar.java
  * Java API code for job PnlWdbePrfHeadbar
...
public class PnlWdbePrfHeadbar {
	/**
	  * StgInf (full: StgInfWdbePrfHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbePrfHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrfHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrfHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRFHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrfHeadbarData");
