/**
  * \file PnlWdbePplPpl1NSegment.java
  * Java API code for job PnlWdbePplPpl1NSegment
...
public class PnlWdbePplPpl1NSegment {
	/**
		* VecVDo (full: VecVWdbePplPpl1NSegmentDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePplPpl1NSegment)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePplPpl1NSegment");
	...
	/**
	  * StatApp (full: StatAppWdbePplPpl1NSegment)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePplPpl1NSegment");
	...
	/**
	  * StatShr (full: StatShrWdbePplPpl1NSegment)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePplPpl1NSegment");
	...
	/**
	  * StgIac (full: StgIacWdbePplPpl1NSegment)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePplPpl1NSegment");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePplPpl1NSegment";
	...
	/**
	  * Tag (full: TagWdbePplPpl1NSegment)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePplPpl1NSegment");
	...
	/**
		* DpchAppData (full: DpchAppWdbePplPpl1NSegmentData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPLPPL1NSEGMENTDATA, scrJref);
		...
		public QryWdbePplPpl1NSegment.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePplPpl1NSegmentData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePplPpl1NSegmentDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPLPPL1NSEGMENTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePplPpl1NSegmentDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePplPpl1NSegmentData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPPLPPL1NSEGMENTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPplPpl1NSegment();
			statappqry = (new QryWdbePplPpl1NSegment()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePplPpl1NSegment()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePplPpl1NSegment()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPplPpl1NSegment rst;
		public QryWdbePplPpl1NSegment.StatApp statappqry;
		public QryWdbePplPpl1NSegment.StatShr statshrqry;
		public QryWdbePplPpl1NSegment.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePplPpl1NSegmentData");
