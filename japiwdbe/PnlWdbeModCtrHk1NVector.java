/**
  * \file PnlWdbeModCtrHk1NVector.java
  * Java API code for job PnlWdbeModCtrHk1NVector
...
public class PnlWdbeModCtrHk1NVector {
	/**
		* VecVDo (full: VecVWdbeModCtrHk1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModCtrHk1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModCtrHk1NVector");
	...
	/**
	  * StatApp (full: StatAppWdbeModCtrHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModCtrHk1NVector");
	...
	/**
	  * StatShr (full: StatShrWdbeModCtrHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModCtrHk1NVector");
	...
	/**
	  * StgIac (full: StgIacWdbeModCtrHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModCtrHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModCtrHk1NVector";
	...
	/**
	  * Tag (full: TagWdbeModCtrHk1NVector)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModCtrHk1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModCtrHk1NVectorData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTRHK1NVECTORDATA, scrJref);
		...
		public QryWdbeModCtrHk1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtrHk1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModCtrHk1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTRHK1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtrHk1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModCtrHk1NVectorData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODCTRHK1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModCtrHk1NVector();
			statappqry = (new QryWdbeModCtrHk1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModCtrHk1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModCtrHk1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModCtrHk1NVector rst;
		public QryWdbeModCtrHk1NVector.StatApp statappqry;
		public QryWdbeModCtrHk1NVector.StatShr statshrqry;
		public QryWdbeModCtrHk1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModCtrHk1NVectorData");
