/**
  * \file PnlWdbeMtpHsm1NPipeline.java
  * Java API code for job PnlWdbeMtpHsm1NPipeline
...
public class PnlWdbeMtpHsm1NPipeline {
	/**
		* VecVDo (full: VecVWdbeMtpHsm1NPipelineDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpHsm1NPipeline)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpHsm1NPipeline");

			String itemtag = "ContitemInfWdbeMtpHsm1NPipeline";
	...
	/**
	  * StatApp (full: StatAppWdbeMtpHsm1NPipeline)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpHsm1NPipeline");

			String itemtag = "StatitemAppWdbeMtpHsm1NPipeline";
	...
	/**
	  * StatShr (full: StatShrWdbeMtpHsm1NPipeline)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpHsm1NPipeline");

			String itemtag = "StatitemShrWdbeMtpHsm1NPipeline";
	...
	/**
	  * StgIac (full: StgIacWdbeMtpHsm1NPipeline)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpHsm1NPipeline");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpHsm1NPipeline";
	...
	/**
	  * Tag (full: TagWdbeMtpHsm1NPipeline)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpHsm1NPipeline");

			String itemtag = "TagitemWdbeMtpHsm1NPipeline";
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpHsm1NPipelineData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPHSM1NPIPELINEDATA, scrJref);
		...
		public QryWdbeMtpHsm1NPipeline.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpHsm1NPipelineData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpHsm1NPipelineDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPHSM1NPIPELINEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpHsm1NPipelineDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpHsm1NPipelineData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPHSM1NPIPELINEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpHsm1NPipeline();
			statappqry = (new QryWdbeMtpHsm1NPipeline()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpHsm1NPipeline()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpHsm1NPipeline()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpHsm1NPipeline rst;
		public QryWdbeMtpHsm1NPipeline.StatApp statappqry;
		public QryWdbeMtpHsm1NPipeline.StatShr statshrqry;
		public QryWdbeMtpHsm1NPipeline.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpHsm1NPipelineData");
