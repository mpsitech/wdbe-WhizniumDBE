/**
  * \file PnlWdbePrcFsmHk1NVector.java
  * Java API code for job PnlWdbePrcFsmHk1NVector
...
public class PnlWdbePrcFsmHk1NVector {
	/**
		* VecVDo (full: VecVWdbePrcFsmHk1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrcFsmHk1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrcFsmHk1NVector");
	...
	/**
	  * StatApp (full: StatAppWdbePrcFsmHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrcFsmHk1NVector");
	...
	/**
	  * StatShr (full: StatShrWdbePrcFsmHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrcFsmHk1NVector");
	...
	/**
	  * StgIac (full: StgIacWdbePrcFsmHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrcFsmHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrcFsmHk1NVector";
	...
	/**
	  * Tag (full: TagWdbePrcFsmHk1NVector)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrcFsmHk1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrcFsmHk1NVectorData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCFSMHK1NVECTORDATA, scrJref);
		...
		public QryWdbePrcFsmHk1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcFsmHk1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrcFsmHk1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCFSMHK1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcFsmHk1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrcFsmHk1NVectorData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRCFSMHK1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPrcFsmHk1NVector();
			statappqry = (new QryWdbePrcFsmHk1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrcFsmHk1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrcFsmHk1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrcFsmHk1NVector rst;
		public QryWdbePrcFsmHk1NVector.StatApp statappqry;
		public QryWdbePrcFsmHk1NVector.StatShr statshrqry;
		public QryWdbePrcFsmHk1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrcFsmHk1NVectorData");
