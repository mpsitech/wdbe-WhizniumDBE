/**
  * \file PnlWdbeSil1NBank.java
  * Java API code for job PnlWdbeSil1NBank
...
public class PnlWdbeSil1NBank {
	/**
		* VecVDo (full: VecVWdbeSil1NBankDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSil1NBank)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSil1NBank");
	...
	/**
	  * StatApp (full: StatAppWdbeSil1NBank)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSil1NBank");
	...
	/**
	  * StatShr (full: StatShrWdbeSil1NBank)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSil1NBank");
	...
	/**
	  * StgIac (full: StgIacWdbeSil1NBank)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSil1NBank");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSil1NBank";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSil1NBank");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSil1NBankData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NBANKDATA, scrJref);
		...
		public QryWdbeSil1NBank.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NBankData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSil1NBankDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NBANKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NBankDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSil1NBankData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESIL1NBANKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSil1NBank();
			statappqry = (new QryWdbeSil1NBank()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSil1NBank()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSil1NBank()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSil1NBank rst;
		public QryWdbeSil1NBank.StatApp statappqry;
		public QryWdbeSil1NBank.StatShr statshrqry;
		public QryWdbeSil1NBank.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSil1NBankData");
