/**
  * \file PnlWdbeMch1NRelease.java
  * Java API code for job PnlWdbeMch1NRelease
...
public class PnlWdbeMch1NRelease {
	/**
		* VecVDo (full: VecVWdbeMch1NReleaseDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMch1NRelease)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMch1NRelease");
	...
	/**
	  * StatApp (full: StatAppWdbeMch1NRelease)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMch1NRelease");
	...
	/**
	  * StatShr (full: StatShrWdbeMch1NRelease)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMch1NRelease");
	...
	/**
	  * StgIac (full: StgIacWdbeMch1NRelease)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMch1NRelease");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMch1NRelease";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMch1NRelease");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMch1NReleaseData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMCH1NRELEASEDATA, scrJref);
		...
		public QryWdbeMch1NRelease.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMch1NReleaseData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMch1NReleaseDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMCH1NRELEASEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMch1NReleaseDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMch1NReleaseData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMCH1NRELEASEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMch1NRelease();
			statappqry = (new QryWdbeMch1NRelease()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMch1NRelease()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMch1NRelease()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMch1NRelease rst;
		public QryWdbeMch1NRelease.StatApp statappqry;
		public QryWdbeMch1NRelease.StatShr statshrqry;
		public QryWdbeMch1NRelease.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMch1NReleaseData");
