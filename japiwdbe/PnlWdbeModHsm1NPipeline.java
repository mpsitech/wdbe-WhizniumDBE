/**
  * \file PnlWdbeModHsm1NPipeline.java
  * Java API code for job PnlWdbeModHsm1NPipeline
...
public class PnlWdbeModHsm1NPipeline {
	/**
		* VecVDo (full: VecVWdbeModHsm1NPipelineDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModHsm1NPipeline)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModHsm1NPipeline");
	...
	/**
	  * StatApp (full: StatAppWdbeModHsm1NPipeline)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModHsm1NPipeline");
	...
	/**
	  * StatShr (full: StatShrWdbeModHsm1NPipeline)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModHsm1NPipeline");
	...
	/**
	  * StgIac (full: StgIacWdbeModHsm1NPipeline)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModHsm1NPipeline");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModHsm1NPipeline";
	...
	/**
	  * Tag (full: TagWdbeModHsm1NPipeline)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModHsm1NPipeline");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModHsm1NPipelineData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODHSM1NPIPELINEDATA, scrJref);
		...
		public QryWdbeModHsm1NPipeline.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModHsm1NPipelineData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModHsm1NPipelineDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODHSM1NPIPELINEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModHsm1NPipelineDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModHsm1NPipelineData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODHSM1NPIPELINEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModHsm1NPipeline();
			statappqry = (new QryWdbeModHsm1NPipeline()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModHsm1NPipeline()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModHsm1NPipeline()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModHsm1NPipeline rst;
		public QryWdbeModHsm1NPipeline.StatApp statappqry;
		public QryWdbeModHsm1NPipeline.StatShr statshrqry;
		public QryWdbeModHsm1NPipeline.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModHsm1NPipelineData");
