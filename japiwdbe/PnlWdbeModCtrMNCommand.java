/**
  * \file PnlWdbeModCtrMNCommand.java
  * Java API code for job PnlWdbeModCtrMNCommand
...
public class PnlWdbeModCtrMNCommand {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModCtrMNCommand");

			String itemtag = "ContitemInfWdbeModCtrMNCommand";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModCtrMNCommand");

			String itemtag = "StatitemAppWdbeModCtrMNCommand";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModCtrMNCommand");

			String itemtag = "StatitemShrWdbeModCtrMNCommand";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModCtrMNCommand");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModCtrMNCommand";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModCtrMNCommand");

			String itemtag = "TagitemWdbeModCtrMNCommand";
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTRMNCOMMANDDATA, scrJref);
		...
		public QryWdbeModCtrMNCommand.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtrMNCommandData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTRMNCOMMANDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtrMNCommandDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODCTRMNCOMMANDDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQModCtrMNCommand();
			statappqry = (new QryWdbeModCtrMNCommand()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModCtrMNCommand()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModCtrMNCommand()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModCtrMNCommand rst;
		public QryWdbeModCtrMNCommand.StatApp statappqry;
		public QryWdbeModCtrMNCommand.StatShr statshrqry;
		public QryWdbeModCtrMNCommand.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModCtrMNCommandData");
