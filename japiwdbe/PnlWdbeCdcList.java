/**
  * \file PnlWdbeCdcList.java
  * Java API code for job PnlWdbeCdcList
...
public class PnlWdbeCdcList {
	/**
		* VecVDo (full: VecVWdbeCdcListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeCdcList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeCdcList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeCdcList";
	...
	/**
	  * ContInf (full: ContInfWdbeCdcList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCdcList");
	...
	/**
	  * StatShr (full: StatShrWdbeCdcList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCdcList");
	...
	/**
	  * StgIac (full: StgIacWdbeCdcList)
	  */
	public class StgIac extends Block {

		public static final int TCOMDLWIDTH = 1;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOMDLWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCdcList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCdcList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOMDLWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOMDL = 8;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMDL));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCdcList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMDL));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeCdcListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECDCLISTDATA, scrJref);
		...
		public QryWdbeCdcList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCdcListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCdcListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECDCLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCdcListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCdcListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECDCLISTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQCdcList();
			statappqry = (new QryWdbeCdcList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCdcList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCdcList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCdcList rst;
		public QryWdbeCdcList.StatApp statappqry;
		public QryWdbeCdcList.StatShr statshrqry;
		public QryWdbeCdcList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCdcListData");
