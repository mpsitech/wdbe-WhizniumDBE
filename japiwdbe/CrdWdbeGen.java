/**
  * \file CrdWdbeGen.java
  * Java API code for job CrdWdbeGen
...
public class CrdWdbeGen {
	/**
		* VecVDo (full: VecVWdbeGenDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeGen)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDGEN = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDGEN));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdGen;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeGen");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdGen = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdGen", mask, MTXCRDGEN);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdGen.equals(comp.MtxCrdGen)) items.add(MTXCRDGEN);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDGEN));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeGen");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeGen");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeGen");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeGenDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEGENDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeGenDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeGenData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEGENDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeGenData");
