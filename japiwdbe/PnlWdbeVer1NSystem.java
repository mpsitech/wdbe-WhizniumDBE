/**
  * \file PnlWdbeVer1NSystem.java
  * Java API code for job PnlWdbeVer1NSystem
...
public class PnlWdbeVer1NSystem {
	/**
		* VecVDo (full: VecVWdbeVer1NSystemDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeVer1NSystem)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVer1NSystem");
	...
	/**
	  * StatApp (full: StatAppWdbeVer1NSystem)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVer1NSystem");
	...
	/**
	  * StatShr (full: StatShrWdbeVer1NSystem)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVer1NSystem");
	...
	/**
	  * StgIac (full: StgIacWdbeVer1NSystem)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVer1NSystem");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVer1NSystem";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVer1NSystem");
	...
	/**
		* DpchAppData (full: DpchAppWdbeVer1NSystemData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NSYSTEMDATA, scrJref);
		...
		public QryWdbeVer1NSystem.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NSystemData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeVer1NSystemDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NSYSTEMDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NSystemDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVer1NSystemData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVER1NSYSTEMDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVer1NSystem();
			statappqry = (new QryWdbeVer1NSystem()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVer1NSystem()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVer1NSystem()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVer1NSystem rst;
		public QryWdbeVer1NSystem.StatApp statappqry;
		public QryWdbeVer1NSystem.StatShr statshrqry;
		public QryWdbeVer1NSystem.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVer1NSystemData");
