/**
  * \file PnlWdbeMod1NCdc.java
  * Java API code for job PnlWdbeMod1NCdc
...
public class PnlWdbeMod1NCdc {
	/**
		* VecVDo (full: VecVWdbeMod1NCdcDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMod1NCdc)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMod1NCdc");
	...
	/**
	  * StatApp (full: StatAppWdbeMod1NCdc)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMod1NCdc");
	...
	/**
	  * StatShr (full: StatShrWdbeMod1NCdc)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMod1NCdc");
	...
	/**
	  * StgIac (full: StgIacWdbeMod1NCdc)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMod1NCdc");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMod1NCdc";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMod1NCdc");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMod1NCdcData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMOD1NCDCDATA, scrJref);
		...
		public QryWdbeMod1NCdc.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMod1NCdcData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMod1NCdcDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMOD1NCDCDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMod1NCdcDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMod1NCdcData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMOD1NCDCDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMod1NCdc();
			statappqry = (new QryWdbeMod1NCdc()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMod1NCdc()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMod1NCdc()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMod1NCdc rst;
		public QryWdbeMod1NCdc.StatApp statappqry;
		public QryWdbeMod1NCdc.StatShr statshrqry;
		public QryWdbeMod1NCdc.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMod1NCdcData");
