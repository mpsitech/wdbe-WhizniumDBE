/**
  * \file PnlWdbeVer1NRelease.java
  * Java API code for job PnlWdbeVer1NRelease
...
public class PnlWdbeVer1NRelease {
	/**
		* VecVDo (full: VecVWdbeVer1NReleaseDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeVer1NRelease)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVer1NRelease");
	...
	/**
	  * StatApp (full: StatAppWdbeVer1NRelease)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVer1NRelease");
	...
	/**
	  * StatShr (full: StatShrWdbeVer1NRelease)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVer1NRelease");
	...
	/**
	  * StgIac (full: StgIacWdbeVer1NRelease)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVer1NRelease");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVer1NRelease";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVer1NRelease");
	...
	/**
		* DpchAppData (full: DpchAppWdbeVer1NReleaseData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NRELEASEDATA, scrJref);
		...
		public QryWdbeVer1NRelease.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NReleaseData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeVer1NReleaseDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NRELEASEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NReleaseDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVer1NReleaseData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVER1NRELEASEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVer1NRelease();
			statappqry = (new QryWdbeVer1NRelease()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVer1NRelease()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVer1NRelease()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVer1NRelease rst;
		public QryWdbeVer1NRelease.StatApp statappqry;
		public QryWdbeVer1NRelease.StatShr statshrqry;
		public QryWdbeVer1NRelease.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVer1NReleaseData");
