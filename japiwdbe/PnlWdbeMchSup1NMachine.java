/**
  * \file PnlWdbeMchSup1NMachine.java
  * Java API code for job PnlWdbeMchSup1NMachine
...
public class PnlWdbeMchSup1NMachine {
	/**
		* VecVDo (full: VecVWdbeMchSup1NMachineDo)
		*/
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMchSup1NMachine");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMchSup1NMachine");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMchSup1NMachine");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMchSup1NMachine");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMchSup1NMachine";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMchSup1NMachine");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMchSup1NMachineData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMCHSUP1NMACHINEDATA, scrJref);
		...
		public QryWdbeMchSup1NMachine.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMchSup1NMachineData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMchSup1NMachineDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMCHSUP1NMACHINEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMchSup1NMachineDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMchSup1NMachineData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMCHSUP1NMACHINEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMchSup1NMachine();
			statappqry = (new QryWdbeMchSup1NMachine()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMchSup1NMachine()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMchSup1NMachine()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMchSup1NMachine rst;
		public QryWdbeMchSup1NMachine.StatApp statappqry;
		public QryWdbeMchSup1NMachine.StatShr statshrqry;
		public QryWdbeMchSup1NMachine.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMchSup1NMachineData");
