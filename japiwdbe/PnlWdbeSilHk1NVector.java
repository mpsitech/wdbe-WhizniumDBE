/**
  * \file PnlWdbeSilHk1NVector.java
  * Java API code for job PnlWdbeSilHk1NVector
...
public class PnlWdbeSilHk1NVector {
	/**
		* VecVDo (full: VecVWdbeSilHk1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSilHk1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSilHk1NVector");
	...
	/**
	  * StatApp (full: StatAppWdbeSilHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSilHk1NVector");
	...
	/**
	  * StatShr (full: StatShrWdbeSilHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSilHk1NVector");
	...
	/**
	  * StgIac (full: StgIacWdbeSilHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSilHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSilHk1NVector";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSilHk1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSilHk1NVectorData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILHK1NVECTORDATA, scrJref);
		...
		public QryWdbeSilHk1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilHk1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSilHk1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILHK1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilHk1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSilHk1NVectorData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESILHK1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSilHk1NVector();
			statappqry = (new QryWdbeSilHk1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSilHk1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSilHk1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSilHk1NVector rst;
		public QryWdbeSilHk1NVector.StatApp statappqry;
		public QryWdbeSilHk1NVector.StatShr statshrqry;
		public QryWdbeSilHk1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSilHk1NVectorData");
