/**
  * \file PnlWdbeModMge1NSignal.java
  * Java API code for job PnlWdbeModMge1NSignal
...
public class PnlWdbeModMge1NSignal {
	/**
		* VecVDo (full: VecVWdbeModMge1NSignalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModMge1NSignal)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModMge1NSignal");
	...
	/**
	  * StatApp (full: StatAppWdbeModMge1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModMge1NSignal");
	...
	/**
	  * StatShr (full: StatShrWdbeModMge1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModMge1NSignal");
	...
	/**
	  * StgIac (full: StgIacWdbeModMge1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModMge1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModMge1NSignal";
	...
	/**
	  * Tag (full: TagWdbeModMge1NSignal)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModMge1NSignal");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModMge1NSignalData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMGE1NSIGNALDATA, scrJref);
		...
		public QryWdbeModMge1NSignal.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMge1NSignalData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModMge1NSignalDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMGE1NSIGNALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMge1NSignalDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModMge1NSignalData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODMGE1NSIGNALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModMge1NSignal();
			statappqry = (new QryWdbeModMge1NSignal()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModMge1NSignal()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModMge1NSignal()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModMge1NSignal rst;
		public QryWdbeModMge1NSignal.StatApp statappqry;
		public QryWdbeModMge1NSignal.StatShr statshrqry;
		public QryWdbeModMge1NSignal.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModMge1NSignalData");
