/**
  * \file QryWdbePinAPar.java
  * Java API code for job QryWdbePinAPar
...
public class QryWdbePinAPar {
	/**
	  * StatApp (full: StatAppQryWdbePinAPar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbePinAPar");
	...
	/**
	  * StatShr (full: StatShrQryWdbePinAPar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbePinAPar");
	...
	/**
	  * StgIac (full: StgIacQryWdbePinAPar)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbePinAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbePinAPar";
