/**
  * \file CrdWdbeMtp.java
  * Java API code for job CrdWdbeMtp
...
public class CrdWdbeMtp {
	/**
		* VecVDo (full: VecVWdbeMtpDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtp)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDMTP = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDMTP));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdMtp;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtp");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdMtp = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdMtp", mask, MTXCRDMTP);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdMtp.equals(comp.MtxCrdMtp)) items.add(MTXCRDMTP);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDMTP));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtp");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtp");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtp");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpData");
