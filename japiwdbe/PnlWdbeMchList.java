...
public class PnlWdbeMchList {
	/**
		* VecVDo (full: VecVWdbeMchListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeMchList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeMchList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeMchList";
	...
	/**
	  * ContInf (full: ContInfWdbeMchList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMchList");
	...
	/**
	  * StatShr (full: StatShrWdbeMchList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMchList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMchList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMchList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMchList");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMchListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMCHLISTDATA, scrJref);
		...
		public QryWdbeMchList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMchListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMchListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMCHLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMchListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMchListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMCHLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQMchList();
			statappqry = (new QryWdbeMchList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMchList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMchList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMchList rst;
		public QryWdbeMchList.StatApp statappqry;
		public QryWdbeMchList.StatShr statshrqry;
		public QryWdbeMchList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMchListData");
