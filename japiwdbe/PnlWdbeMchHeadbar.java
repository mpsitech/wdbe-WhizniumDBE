/**
  * \file PnlWdbeMchHeadbar.java
  * Java API code for job PnlWdbeMchHeadbar
...
public class PnlWdbeMchHeadbar {
	/**
	  * StgInf (full: StgInfWdbeMchHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeMchHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMchHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMchHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMCHHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMchHeadbarData");
