/**
  * \file PnlWdbeMtpRef1NVariable.java
  * Java API code for job PnlWdbeMtpRef1NVariable
...
public class PnlWdbeMtpRef1NVariable {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpRef1NVariable");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpRef1NVariable");
	...
	public class StatShr extends Block {
		...
		public static final int BUTDELETEAVAIL = 5;
		public static final int BUTDELETEACTIVE = 6;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(BUTUPAVAIL, BUTUPACTIVE, BUTDOWNAVAIL, BUTDOWNACTIVE, BUTDELETEAVAIL, BUTDELETEACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpRef1NVariable");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(BUTUPAVAIL, BUTUPACTIVE, BUTDOWNAVAIL, BUTDOWNACTIVE, BUTDELETEAVAIL, BUTDELETEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpRef1NVariable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpRef1NVariable";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpRef1NVariable");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPREF1NVARIABLEDATA, scrJref);
		...
		public QryWdbeMtpRef1NVariable.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpRef1NVariableData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPREF1NVARIABLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpRef1NVariableDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPREF1NVARIABLEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpRef1NVariable();
			statappqry = (new QryWdbeMtpRef1NVariable()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpRef1NVariable()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpRef1NVariable()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpRef1NVariable rst;
		public QryWdbeMtpRef1NVariable.StatApp statappqry;
		public QryWdbeMtpRef1NVariable.StatShr statshrqry;
		public QryWdbeMtpRef1NVariable.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpRef1NVariableData");
