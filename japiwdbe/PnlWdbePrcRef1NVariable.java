/**
  * \file PnlWdbePrcRef1NVariable.java
  * Java API code for job PnlWdbePrcRef1NVariable
...
public class PnlWdbePrcRef1NVariable {
	/**
		* VecVDo (full: VecVWdbePrcRef1NVariableDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrcRef1NVariable)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrcRef1NVariable");
	...
	/**
	  * StatApp (full: StatAppWdbePrcRef1NVariable)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrcRef1NVariable");
	...
	/**
	  * StatShr (full: StatShrWdbePrcRef1NVariable)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrcRef1NVariable");
	...
	/**
	  * StgIac (full: StgIacWdbePrcRef1NVariable)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrcRef1NVariable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrcRef1NVariable";
	...
	/**
	  * Tag (full: TagWdbePrcRef1NVariable)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrcRef1NVariable");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrcRef1NVariableData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCREF1NVARIABLEDATA, scrJref);
		...
		public QryWdbePrcRef1NVariable.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcRef1NVariableData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrcRef1NVariableDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCREF1NVARIABLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcRef1NVariableDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrcRef1NVariableData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRCREF1NVARIABLEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPrcRef1NVariable();
			statappqry = (new QryWdbePrcRef1NVariable()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrcRef1NVariable()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrcRef1NVariable()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrcRef1NVariable rst;
		public QryWdbePrcRef1NVariable.StatApp statappqry;
		public QryWdbePrcRef1NVariable.StatShr statshrqry;
		public QryWdbePrcRef1NVariable.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrcRef1NVariableData");
