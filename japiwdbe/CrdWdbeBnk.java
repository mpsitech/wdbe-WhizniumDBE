/**
  * \file CrdWdbeBnk.java
  * Java API code for job CrdWdbeBnk
...
public class CrdWdbeBnk {
	/**
		* VecVDo (full: VecVWdbeBnkDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeBnk)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDBNK = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDBNK));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdBnk;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeBnk");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdBnk = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdBnk", mask, MTXCRDBNK);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdBnk.equals(comp.MtxCrdBnk)) items.add(MTXCRDBNK);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDBNK));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeBnk");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeBnk");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeBnk");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeBnkDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEBNKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeBnkDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeBnkData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEBNKDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeBnkData");
