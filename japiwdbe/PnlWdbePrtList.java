/**
  * \file PnlWdbePrtList.java
  * Java API code for job PnlWdbePrtList
...
public class PnlWdbePrtList {
	/**
		* VecVDo (full: VecVWdbePrtListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbePrtList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbePrtList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbePrtList";
	...
	/**
	  * ContInf (full: ContInfWdbePrtList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrtList");
	...
	/**
	  * StatShr (full: StatShrWdbePrtList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrtList");
	...
	/**
	  * StgIac (full: StgIacWdbePrtList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOMDLWIDTH = 2;
		public static final int TCOMDCWIDTH = 3;
		public static final int TCODIRWIDTH = 4;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOMDLWIDTH, TCOMDCWIDTH, TCODIRWIDTH, TCOHTYWIDTH, TCOWIDWIDTH, TCOMMXWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoMdlWidth;
		public int TcoMdcWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrtList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoMdcWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoMdcWidth", mask, TCOMDCWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrtList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoMdcWidth", TcoMdcWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoMdcWidth == comp.TcoMdcWidth) items.add(TCOMDCWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOMDLWIDTH, TCOMDCWIDTH, TCODIRWIDTH, TCOHTYWIDTH, TCOWIDWIDTH, TCOMMXWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOMDL = 9;
		public static final int TCOMDC = 10;
		public static final int TCODIR = 11;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOMDL, TCOMDC, TCODIR, TCOHTY, TCOWID, TCOMMX));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrtList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoMdc = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoMdc", mask, TCOMDC);
		...
		public HashSet<Integer> comm(
			...
			if (TcoMdc.equals(comp.TcoMdc)) items.add(TCOMDC);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOMDL, TCOMDC, TCODIR, TCOHTY, TCOWID, TCOMMX));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbePrtListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRTLISTDATA, scrJref);
		...
		public QryWdbePrtList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrtListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrtListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRTLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrtListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrtListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRTLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQPrtList();
			statappqry = (new QryWdbePrtList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrtList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrtList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrtList rst;
		public QryWdbePrtList.StatApp statappqry;
		public QryWdbePrtList.StatShr statshrqry;
		public QryWdbePrtList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrtListData");
