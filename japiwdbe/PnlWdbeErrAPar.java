/**
  * \file PnlWdbeErrAPar.java
  * Java API code for job PnlWdbeErrAPar
...
public class PnlWdbeErrAPar {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeErrAPar");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeErrAPar");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeErrAPar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeErrAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeErrAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeErrAPar");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEERRAPARDATA, scrJref);
		...
		public QryWdbeErrAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeErrAParData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEERRAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeErrAParDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEERRAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQErrAPar();
			statappqry = (new QryWdbeErrAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeErrAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeErrAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQErrAPar rst;
		public QryWdbeErrAPar.StatApp statappqry;
		public QryWdbeErrAPar.StatShr statshrqry;
		public QryWdbeErrAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeErrAParData");
