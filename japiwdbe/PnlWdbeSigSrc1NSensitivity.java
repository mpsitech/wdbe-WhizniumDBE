/**
  * \file PnlWdbeSigSrc1NSensitivity.java
  * Java API code for job PnlWdbeSigSrc1NSensitivity
...
public class PnlWdbeSigSrc1NSensitivity {
	/**
		* VecVDo (full: VecVWdbeSigSrc1NSensitivityDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSigSrc1NSensitivity)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSigSrc1NSensitivity");
	...
	/**
	  * StatApp (full: StatAppWdbeSigSrc1NSensitivity)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSigSrc1NSensitivity");
	...
	/**
	  * StatShr (full: StatShrWdbeSigSrc1NSensitivity)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSigSrc1NSensitivity");
	...
	/**
	  * StgIac (full: StgIacWdbeSigSrc1NSensitivity)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSigSrc1NSensitivity");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSigSrc1NSensitivity";
	...
	/**
	  * Tag (full: TagWdbeSigSrc1NSensitivity)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSigSrc1NSensitivity");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSigSrc1NSensitivityData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIGSRC1NSENSITIVITYDATA, scrJref);
		...
		public QryWdbeSigSrc1NSensitivity.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSigSrc1NSensitivityData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSigSrc1NSensitivityDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIGSRC1NSENSITIVITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSigSrc1NSensitivityDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSigSrc1NSensitivityData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESIGSRC1NSENSITIVITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSigSrc1NSensitivity();
			statappqry = (new QryWdbeSigSrc1NSensitivity()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSigSrc1NSensitivity()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSigSrc1NSensitivity()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSigSrc1NSensitivity rst;
		public QryWdbeSigSrc1NSensitivity.StatApp statappqry;
		public QryWdbeSigSrc1NSensitivity.StatShr statshrqry;
		public QryWdbeSigSrc1NSensitivity.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSigSrc1NSensitivityData");
