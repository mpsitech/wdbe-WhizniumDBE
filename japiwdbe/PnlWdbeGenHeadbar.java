/**
  * \file PnlWdbeGenHeadbar.java
  * Java API code for job PnlWdbeGenHeadbar
...
public class PnlWdbeGenHeadbar {
	/**
	  * StgInf (full: StgInfWdbeGenHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeGenHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeGenHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeGenHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEGENHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeGenHeadbarData");
