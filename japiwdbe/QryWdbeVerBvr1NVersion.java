/**
  * \file QryWdbeVerBvr1NVersion.java
  * Java API code for job QryWdbeVerBvr1NVersion
...
public class QryWdbeVerBvr1NVersion {
	/**
	  * StatApp (full: StatAppQryWdbeVerBvr1NVersion)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeVerBvr1NVersion");
	...
	/**
	  * StatShr (full: StatShrQryWdbeVerBvr1NVersion)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeVerBvr1NVersion");
	...
	/**
	  * StgIac (full: StgIacQryWdbeVerBvr1NVersion)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeVerBvr1NVersion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeVerBvr1NVersion";
