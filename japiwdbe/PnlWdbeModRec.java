...
public class PnlWdbeModRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONECOR1NIMBUF = 6;
		public static final int INITDONEMDL1NPORT = 7;
		public static final int INITDONE1NPROCESS = 8;
		public static final int INITDONEMDL1NSIGNAL = 9;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPERIPHERAL, INITDONEMDL1NGENERIC, INITDONECOR1NIMBUF, INITDONEMDL1NPORT, INITDONE1NPROCESS, INITDONEMDL1NSIGNAL, INITDONESUP1NMODULE, INITDONEMGE1NSIGNAL, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRREF1NCOMMAND, INITDONECTRMNCOMMAND));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPERIPHERAL, INITDONEMDL1NGENERIC, INITDONECOR1NIMBUF, INITDONEMDL1NPORT, INITDONE1NPROCESS, INITDONEMDL1NSIGNAL, INITDONESUP1NMODULE, INITDONEMGE1NSIGNAL, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRREF1NCOMMAND, INITDONECTRMNCOMMAND));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFCOR1NIMBUF = 7;
		public static final int SCRJREFMDL1NPORT = 8;
		public static final int SCRJREF1NPROCESS = 9;
		public static final int SCRJREFMDL1NSIGNAL = 10;
		...
		public static final int PNLCTRREF1NERRORAVAIL = 14;
		public static final int SCRJREFCTRHK1NVECTOR = 15;
		public static final int PNLCTRHK1NVECTORAVAIL = 16;
		public static final int SCRJREFCTRREF1NCOMMAND = 17;
		public static final int PNLCTRREF1NCOMMANDAVAIL = 18;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFKHDLTYPE, SCRJREFAPAR, SCRJREF1NPERIPHERAL, SCRJREFMDL1NGENERIC, SCRJREFCOR1NIMBUF, SCRJREFMDL1NPORT, SCRJREF1NPROCESS, SCRJREFMDL1NSIGNAL, SCRJREFSUP1NMODULE, SCRJREFMGE1NSIGNAL, SCRJREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, SCRJREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, SCRJREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, SCRJREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFKHDLTYPE, SCRJREFAPAR, SCRJREF1NPERIPHERAL, SCRJREFMDL1NGENERIC, SCRJREFCOR1NIMBUF, SCRJREFMDL1NPORT, SCRJREF1NPROCESS, SCRJREFMDL1NSIGNAL, SCRJREFSUP1NMODULE, SCRJREFMGE1NSIGNAL, SCRJREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, SCRJREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, SCRJREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, SCRJREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
