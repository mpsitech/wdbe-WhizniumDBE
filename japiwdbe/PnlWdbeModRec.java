...
public class PnlWdbeModRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONE1NPROCESS = 4;
		public static final int INITDONEMDL1NPORT = 5;
		public static final int INITDONE1NCDC = 6;
		...
		public static final int INITDONEREF1NVARIABLE = 10;
		public static final int INITDONEREF1NSIGNAL = 11;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPROCESS, INITDONEMDL1NPORT, INITDONE1NCDC, INITDONEHSM1NPIPELINE, INITDONEMDL1NGENERIC, INITDONESUP1NMODULE, INITDONEREF1NVARIABLE, INITDONEREF1NSIGNAL, INITDONEREF1NSENSITIVITY, INITDONEMGE1NSIGNAL, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRREF1NCOMMAND, INITDONEMNPERIPHERAL, INITDONECTDMNMODULE, INITDONECORMNMODULE, INITDONECTRMNCOMMAND));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPROCESS, INITDONEMDL1NPORT, INITDONE1NCDC, INITDONEHSM1NPIPELINE, INITDONEMDL1NGENERIC, INITDONESUP1NMODULE, INITDONEREF1NVARIABLE, INITDONEREF1NSIGNAL, INITDONEREF1NSENSITIVITY, INITDONEMGE1NSIGNAL, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRREF1NCOMMAND, INITDONEMNPERIPHERAL, INITDONECTDMNMODULE, INITDONECORMNMODULE, INITDONECTRMNCOMMAND));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NPROCESS = 5;
		public static final int SCRJREFMDL1NPORT = 6;
		public static final int SCRJREF1NCDC = 7;
		...
		public static final int SCRJREFREF1NVARIABLE = 11;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFKHDLTYPE, SCRJREFAPAR, SCRJREF1NPROCESS, SCRJREFMDL1NPORT, SCRJREF1NCDC, SCRJREFHSM1NPIPELINE, SCRJREFMDL1NGENERIC, SCRJREFSUP1NMODULE, SCRJREFREF1NVARIABLE, SCRJREFREF1NSIGNAL, SCRJREFREF1NSENSITIVITY, SCRJREFMGE1NSIGNAL, SCRJREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, SCRJREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, SCRJREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, SCRJREFMNPERIPHERAL, SCRJREFCTDMNMODULE, SCRJREFCORMNMODULE, SCRJREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFKHDLTYPE, SCRJREFAPAR, SCRJREF1NPROCESS, SCRJREFMDL1NPORT, SCRJREF1NCDC, SCRJREFHSM1NPIPELINE, SCRJREFMDL1NGENERIC, SCRJREFSUP1NMODULE, SCRJREFREF1NVARIABLE, SCRJREFREF1NSIGNAL, SCRJREFREF1NSENSITIVITY, SCRJREFMGE1NSIGNAL, SCRJREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, SCRJREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, SCRJREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, SCRJREFMNPERIPHERAL, SCRJREFCTDMNMODULE, SCRJREFCORMNMODULE, SCRJREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
