/**
  * \file PnlWdbeIntHeadbar.java
  * Java API code for job PnlWdbeIntHeadbar
...
public class PnlWdbeIntHeadbar {
	/**
	  * StgInf (full: StgInfWdbeIntHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeIntHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeIntHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeIntHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEINTHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeIntHeadbarData");
