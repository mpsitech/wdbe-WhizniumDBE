/**
  * \file PnlWdbePinList.java
  * Java API code for job PnlWdbePinList
...
public class PnlWdbePinList {
	/**
		* VecVDo (full: VecVWdbePinListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbePinList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbePinList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbePinList";
	...
	/**
	  * ContInf (full: ContInfWdbePinList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePinList");

			String itemtag = "ContitemInfWdbePinList";
	...
	/**
	  * StatShr (full: StatShrWdbePinList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePinList");

			String itemtag = "StatitemShrWdbePinList";
	...
	/**
	  * StgIac (full: StgIacWdbePinList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOBNKWIDTH = 2;
		public static final int TCOLOCWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOBNKWIDTH, TCOLOCWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoBnkWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePinList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoBnkWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoBnkWidth", mask, TCOBNKWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePinList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoBnkWidth", TcoBnkWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoBnkWidth == comp.TcoBnkWidth) items.add(TCOBNKWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOBNKWIDTH, TCOLOCWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOBNK = 9;
		public static final int TCOLOC = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOBNK, TCOLOC));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePinList");

			String itemtag = "TagitemWdbePinList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoBnk = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoBnk", mask, TCOBNK);
		...
		public HashSet<Integer> comm(
			...
			if (TcoBnk.equals(comp.TcoBnk)) items.add(TCOBNK);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOBNK, TCOLOC));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbePinListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPINLISTDATA, scrJref);
		...
		public QryWdbePinList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePinListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePinListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPINLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePinListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePinListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPINLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQPinList();
			statappqry = (new QryWdbePinList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePinList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePinList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPinList rst;
		public QryWdbePinList.StatApp statappqry;
		public QryWdbePinList.StatShr statshrqry;
		public QryWdbePinList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePinListData");
