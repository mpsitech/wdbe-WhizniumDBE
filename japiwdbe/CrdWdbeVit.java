/**
  * \file CrdWdbeVit.java
  * Java API code for job CrdWdbeVit
...
public class CrdWdbeVit {
	/**
		* VecVDo (full: VecVWdbeVitDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeVit)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDVIT = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDVIT));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdVit;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVit");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdVit = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdVit", mask, MTXCRDVIT);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdVit.equals(comp.MtxCrdVit)) items.add(MTXCRDVIT);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDVIT));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVit");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVit");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVit");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeVitDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVITDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVitDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVitData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVITDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVitData");
