/**
  * \file PnlWdbeMtpRef1NSensitivity.java
  * Java API code for job PnlWdbeMtpRef1NSensitivity
...
public class PnlWdbeMtpRef1NSensitivity {
	/**
		* VecVDo (full: VecVWdbeMtpRef1NSensitivityDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpRef1NSensitivity)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpRef1NSensitivity");
	...
	/**
	  * StatApp (full: StatAppWdbeMtpRef1NSensitivity)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpRef1NSensitivity");
	...
	/**
	  * StatShr (full: StatShrWdbeMtpRef1NSensitivity)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpRef1NSensitivity");
	...
	/**
	  * StgIac (full: StgIacWdbeMtpRef1NSensitivity)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpRef1NSensitivity");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpRef1NSensitivity";
	...
	/**
	  * Tag (full: TagWdbeMtpRef1NSensitivity)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpRef1NSensitivity");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpRef1NSensitivityData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPREF1NSENSITIVITYDATA, scrJref);
		...
		public QryWdbeMtpRef1NSensitivity.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpRef1NSensitivityData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpRef1NSensitivityDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPREF1NSENSITIVITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpRef1NSensitivityDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpRef1NSensitivityData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPREF1NSENSITIVITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpRef1NSensitivity();
			statappqry = (new QryWdbeMtpRef1NSensitivity()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpRef1NSensitivity()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpRef1NSensitivity()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpRef1NSensitivity rst;
		public QryWdbeMtpRef1NSensitivity.StatApp statappqry;
		public QryWdbeMtpRef1NSensitivity.StatShr statshrqry;
		public QryWdbeMtpRef1NSensitivity.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpRef1NSensitivityData");
