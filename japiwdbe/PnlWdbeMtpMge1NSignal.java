/**
  * \file PnlWdbeMtpMge1NSignal.java
  * Java API code for job PnlWdbeMtpMge1NSignal
...
public class PnlWdbeMtpMge1NSignal {
	/**
		* VecVDo (full: VecVWdbeMtpMge1NSignalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpMge1NSignal)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpMge1NSignal");
	...
	/**
	  * StatApp (full: StatAppWdbeMtpMge1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpMge1NSignal");
	...
	/**
	  * StatShr (full: StatShrWdbeMtpMge1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpMge1NSignal");
	...
	/**
	  * StgIac (full: StgIacWdbeMtpMge1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpMge1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpMge1NSignal";
	...
	/**
	  * Tag (full: TagWdbeMtpMge1NSignal)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpMge1NSignal");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpMge1NSignalData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPMGE1NSIGNALDATA, scrJref);
		...
		public QryWdbeMtpMge1NSignal.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpMge1NSignalData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpMge1NSignalDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPMGE1NSIGNALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpMge1NSignalDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpMge1NSignalData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPMGE1NSIGNALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpMge1NSignal();
			statappqry = (new QryWdbeMtpMge1NSignal()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpMge1NSignal()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpMge1NSignal()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpMge1NSignal rst;
		public QryWdbeMtpMge1NSignal.StatApp statappqry;
		public QryWdbeMtpMge1NSignal.StatShr statshrqry;
		public QryWdbeMtpMge1NSignal.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpMge1NSignalData");
