/**
  * \file PnlWdbeUntRef1NSignal.java
  * Java API code for job PnlWdbeUntRef1NSignal
...
public class PnlWdbeUntRef1NSignal {
	/**
		* VecVDo (full: VecVWdbeUntRef1NSignalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUntRef1NSignal)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUntRef1NSignal");
	...
	/**
	  * StatApp (full: StatAppWdbeUntRef1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUntRef1NSignal");
	...
	/**
	  * StatShr (full: StatShrWdbeUntRef1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUntRef1NSignal");
	...
	/**
	  * StgIac (full: StgIacWdbeUntRef1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUntRef1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUntRef1NSignal";
	...
	/**
	  * Tag (full: TagWdbeUntRef1NSignal)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUntRef1NSignal");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUntRef1NSignalData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTREF1NSIGNALDATA, scrJref);
		...
		public QryWdbeUntRef1NSignal.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntRef1NSignalData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUntRef1NSignalDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTREF1NSIGNALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntRef1NSignalDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUntRef1NSignalData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNTREF1NSIGNALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUntRef1NSignal();
			statappqry = (new QryWdbeUntRef1NSignal()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUntRef1NSignal()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUntRef1NSignal()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUntRef1NSignal rst;
		public QryWdbeUntRef1NSignal.StatApp statappqry;
		public QryWdbeUntRef1NSignal.StatShr statshrqry;
		public QryWdbeUntRef1NSignal.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUntRef1NSignalData");
