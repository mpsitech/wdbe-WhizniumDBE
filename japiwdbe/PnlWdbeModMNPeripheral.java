/**
  * \file PnlWdbeModMNPeripheral.java
  * Java API code for job PnlWdbeModMNPeripheral
...
public class PnlWdbeModMNPeripheral {
	/**
		* VecVDo (full: VecVWdbeModMNPeripheralDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModMNPeripheral)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModMNPeripheral");

			String itemtag = "ContitemInfWdbeModMNPeripheral";
	...
	/**
	  * StatApp (full: StatAppWdbeModMNPeripheral)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModMNPeripheral");

			String itemtag = "StatitemAppWdbeModMNPeripheral";
	...
	/**
	  * StatShr (full: StatShrWdbeModMNPeripheral)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModMNPeripheral");

			String itemtag = "StatitemShrWdbeModMNPeripheral";
	...
	/**
	  * StgIac (full: StgIacWdbeModMNPeripheral)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModMNPeripheral");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModMNPeripheral";
	...
	/**
	  * Tag (full: TagWdbeModMNPeripheral)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModMNPeripheral");

			String itemtag = "TagitemWdbeModMNPeripheral";
	...
	/**
		* DpchAppData (full: DpchAppWdbeModMNPeripheralData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMNPERIPHERALDATA, scrJref);
		...
		public QryWdbeModMNPeripheral.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMNPeripheralData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModMNPeripheralDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMNPERIPHERALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMNPeripheralDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModMNPeripheralData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODMNPERIPHERALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModMNPeripheral();
			statappqry = (new QryWdbeModMNPeripheral()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModMNPeripheral()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModMNPeripheral()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModMNPeripheral rst;
		public QryWdbeModMNPeripheral.StatApp statappqry;
		public QryWdbeModMNPeripheral.StatShr statshrqry;
		public QryWdbeModMNPeripheral.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModMNPeripheralData");
