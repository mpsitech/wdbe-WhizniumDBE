/**
  * \file PnlWdbeModMdl1NSignal.java
  * Java API code for job PnlWdbeModMdl1NSignal
...
public class PnlWdbeModMdl1NSignal {
	/**
		* VecVDo (full: VecVWdbeModMdl1NSignalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModMdl1NSignal)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModMdl1NSignal");
	...
	/**
	  * StatApp (full: StatAppWdbeModMdl1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModMdl1NSignal");
	...
	/**
	  * StatShr (full: StatShrWdbeModMdl1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModMdl1NSignal");
	...
	/**
	  * StgIac (full: StgIacWdbeModMdl1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModMdl1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModMdl1NSignal";
	...
	/**
	  * Tag (full: TagWdbeModMdl1NSignal)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModMdl1NSignal");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModMdl1NSignalData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMDL1NSIGNALDATA, scrJref);
		...
		public QryWdbeModMdl1NSignal.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMdl1NSignalData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModMdl1NSignalDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMDL1NSIGNALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMdl1NSignalDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModMdl1NSignalData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODMDL1NSIGNALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModMdl1NSignal();
			statappqry = (new QryWdbeModMdl1NSignal()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModMdl1NSignal()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModMdl1NSignal()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModMdl1NSignal rst;
		public QryWdbeModMdl1NSignal.StatApp statappqry;
		public QryWdbeModMdl1NSignal.StatShr statshrqry;
		public QryWdbeModMdl1NSignal.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModMdl1NSignalData");
