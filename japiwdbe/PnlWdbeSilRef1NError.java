/**
  * \file PnlWdbeSilRef1NError.java
  * Java API code for job PnlWdbeSilRef1NError
...
public class PnlWdbeSilRef1NError {
	/**
		* VecVDo (full: VecVWdbeSilRef1NErrorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSilRef1NError)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSilRef1NError");
	...
	/**
	  * StatApp (full: StatAppWdbeSilRef1NError)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSilRef1NError");
	...
	/**
	  * StatShr (full: StatShrWdbeSilRef1NError)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSilRef1NError");
	...
	/**
	  * StgIac (full: StgIacWdbeSilRef1NError)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSilRef1NError");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSilRef1NError";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSilRef1NError");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSilRef1NErrorData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILREF1NERRORDATA, scrJref);
		...
		public QryWdbeSilRef1NError.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilRef1NErrorData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSilRef1NErrorDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILREF1NERRORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilRef1NErrorDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSilRef1NErrorData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESILREF1NERRORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSilRef1NError();
			statappqry = (new QryWdbeSilRef1NError()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSilRef1NError()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSilRef1NError()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSilRef1NError rst;
		public QryWdbeSilRef1NError.StatApp statappqry;
		public QryWdbeSilRef1NError.StatShr statshrqry;
		public QryWdbeSilRef1NError.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSilRef1NErrorData");
