/**
  * \file PnlWdbeFstList.java
  * Java API code for job PnlWdbeFstList
...
public class PnlWdbeFstList {
	/**
		* VecVDo (full: VecVWdbeFstListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeFstList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeFstList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeFstList";
	...
	/**
	  * ContInf (full: ContInfWdbeFstList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeFstList");

			String itemtag = "ContitemInfWdbeFstList";
	...
	/**
	  * StatShr (full: StatShrWdbeFstList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeFstList");

			String itemtag = "StatitemShrWdbeFstList";
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOFSMWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoFsmWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeFstList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoFsmWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoFsmWidth", mask, TCOFSMWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeFstList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoFsmWidth", TcoFsmWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoFsmWidth == comp.TcoFsmWidth) items.add(TCOFSMWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOFSMWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOFSM = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOFSM));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeFstList");

			String itemtag = "TagitemWdbeFstList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoFsm = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoFsm", mask, TCOFSM);
		...
		public HashSet<Integer> comm(
			...
			if (TcoFsm.equals(comp.TcoFsm)) items.add(TCOFSM);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOFSM));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeFstListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEFSTLISTDATA, scrJref);
		...
		public QryWdbeFstList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeFstListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeFstListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEFSTLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeFstListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeFstListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEFSTLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQFstList();
			statappqry = (new QryWdbeFstList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeFstList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeFstList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQFstList rst;
		public QryWdbeFstList.StatApp statappqry;
		public QryWdbeFstList.StatShr statshrqry;
		public QryWdbeFstList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeFstListData");
