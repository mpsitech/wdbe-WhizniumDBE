/**
  * \file PnlWdbeVer1NUnit.java
  * Java API code for job PnlWdbeVer1NUnit
...
public class PnlWdbeVer1NUnit {
	/**
		* VecVDo (full: VecVWdbeVer1NUnitDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeVer1NUnit)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVer1NUnit");
	...
	/**
	  * StatApp (full: StatAppWdbeVer1NUnit)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVer1NUnit");
	...
	/**
	  * StatShr (full: StatShrWdbeVer1NUnit)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVer1NUnit");
	...
	/**
	  * StgIac (full: StgIacWdbeVer1NUnit)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVer1NUnit");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVer1NUnit";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVer1NUnit");
	...
	/**
		* DpchAppData (full: DpchAppWdbeVer1NUnitData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NUNITDATA, scrJref);
		...
		public QryWdbeVer1NUnit.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NUnitData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeVer1NUnitDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NUNITDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NUnitDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVer1NUnitData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVER1NUNITDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVer1NUnit();
			statappqry = (new QryWdbeVer1NUnit()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVer1NUnit()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVer1NUnit()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVer1NUnit rst;
		public QryWdbeVer1NUnit.StatApp statappqry;
		public QryWdbeVer1NUnit.StatShr statshrqry;
		public QryWdbeVer1NUnit.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVer1NUnitData");
