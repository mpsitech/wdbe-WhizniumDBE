/**
  * \file PnlWdbeUsr1NSession.java
  * Java API code for job PnlWdbeUsr1NSession
...
public class PnlWdbeUsr1NSession {
	/**
		* VecVDo (full: VecVWdbeUsr1NSessionDo)
		*/
	public static class VecVDo {

		public static final int BUTDELETECLICK = 1;
	...
	/**
	  * ContInf (full: ContInfWdbeUsr1NSession)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUsr1NSession");
	...
	/**
	  * StatApp (full: StatAppWdbeUsr1NSession)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUsr1NSession");
	...
	/**
	  * StatShr (full: StatShrWdbeUsr1NSession)
	  */
	public class StatShr extends Block {

		public static final int BUTDELETEAVAIL = 1;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(BUTDELETEAVAIL, BUTDELETEACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUsr1NSession");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(BUTDELETEAVAIL, BUTDELETEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
	  * StgIac (full: StgIacWdbeUsr1NSession)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUsr1NSession");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUsr1NSession";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUsr1NSession");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUsr1NSessionData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSR1NSESSIONDATA, scrJref);
		...
		public QryWdbeUsr1NSession.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsr1NSessionData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUsr1NSessionDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSR1NSESSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsr1NSessionDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUsr1NSessionData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUSR1NSESSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUsr1NSession();
			statappqry = (new QryWdbeUsr1NSession()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUsr1NSession()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUsr1NSession()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUsr1NSession rst;
		public QryWdbeUsr1NSession.StatApp statappqry;
		public QryWdbeUsr1NSession.StatShr statshrqry;
		public QryWdbeUsr1NSession.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUsr1NSessionData");
