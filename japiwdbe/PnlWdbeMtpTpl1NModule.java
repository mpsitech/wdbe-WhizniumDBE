/**
  * \file PnlWdbeMtpTpl1NModule.java
  * Java API code for job PnlWdbeMtpTpl1NModule
...
public class PnlWdbeMtpTpl1NModule {
	/**
		* VecVDo (full: VecVWdbeMtpTpl1NModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpTpl1NModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpTpl1NModule");

			String itemtag = "ContitemInfWdbeMtpTpl1NModule";
	...
	/**
	  * StatApp (full: StatAppWdbeMtpTpl1NModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpTpl1NModule");

			String itemtag = "StatitemAppWdbeMtpTpl1NModule";
	...
	/**
	  * StatShr (full: StatShrWdbeMtpTpl1NModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpTpl1NModule");

			String itemtag = "StatitemShrWdbeMtpTpl1NModule";
	...
	/**
	  * StgIac (full: StgIacWdbeMtpTpl1NModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpTpl1NModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpTpl1NModule";
	...
	/**
	  * Tag (full: TagWdbeMtpTpl1NModule)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpTpl1NModule");

			String itemtag = "TagitemWdbeMtpTpl1NModule";
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpTpl1NModuleData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPTPL1NMODULEDATA, scrJref);
		...
		public QryWdbeMtpTpl1NModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpTpl1NModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpTpl1NModuleDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPTPL1NMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpTpl1NModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpTpl1NModuleData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPTPL1NMODULEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpTpl1NModule();
			statappqry = (new QryWdbeMtpTpl1NModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpTpl1NModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpTpl1NModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpTpl1NModule rst;
		public QryWdbeMtpTpl1NModule.StatApp statappqry;
		public QryWdbeMtpTpl1NModule.StatShr statshrqry;
		public QryWdbeMtpTpl1NModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpTpl1NModuleData");
