...
public class PnlWdbeUntRec {
	...
	public class StatApp extends Block {
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NPERIPHERAL, INITDONESIL1NUNIT, INITDONE1NTARGET, INITDONEFWD1NCONTROLLER, INITDONE1NBANK, INITDONEREF1NERROR, INITDONEHK1NVECTOR, INITDONEHK1NMODULE, INITDONEREF1NCOMMAND));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NPERIPHERAL, INITDONESIL1NUNIT, INITDONE1NTARGET, INITDONEFWD1NCONTROLLER, INITDONE1NBANK, INITDONEREF1NERROR, INITDONEHK1NVECTOR, INITDONEHK1NMODULE, INITDONEREF1NCOMMAND));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, PNLSIL1NUNITAVAIL, SCRJREF1NTARGET, SCRJREFFWD1NCONTROLLER, SCRJREF1NBANK, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFHK1NMODULE, SCRJREFREF1NCOMMAND, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, PNLSIL1NUNITAVAIL, SCRJREF1NTARGET, SCRJREFFWD1NCONTROLLER, SCRJREF1NBANK, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFHK1NMODULE, SCRJREFREF1NCOMMAND, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
