...
public class PnlWdbeUntRec {
	...
	public class StatShr extends Block {
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, PNLSIL1NUNITAVAIL, SCRJREF1NBANK, SCRJREFFWD1NCONTROLLER, SCRJREF1NTARGET, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFREF1NCOMMAND, SCRJREFHK1NMODULE, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, PNLSIL1NUNITAVAIL, SCRJREF1NBANK, SCRJREFFWD1NCONTROLLER, SCRJREF1NTARGET, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFREF1NCOMMAND, SCRJREFHK1NMODULE, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
