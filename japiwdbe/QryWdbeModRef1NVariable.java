/**
  * \file QryWdbeModRef1NVariable.java
  * Java API code for job QryWdbeModRef1NVariable
...
public class QryWdbeModRef1NVariable {
	/**
	  * StatApp (full: StatAppQryWdbeModRef1NVariable)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModRef1NVariable");
	...
	/**
	  * StatShr (full: StatShrQryWdbeModRef1NVariable)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModRef1NVariable");
	...
	/**
	  * StgIac (full: StgIacQryWdbeModRef1NVariable)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModRef1NVariable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModRef1NVariable";
