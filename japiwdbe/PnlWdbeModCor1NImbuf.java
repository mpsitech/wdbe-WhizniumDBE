...
public class PnlWdbeModCor1NImbuf {
	/**
		* VecVDo (full: VecVWdbeModCor1NImbufDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModCor1NImbuf)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModCor1NImbuf");
	...
	/**
	  * StatApp (full: StatAppWdbeModCor1NImbuf)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModCor1NImbuf");
	...
	/**
	  * StatShr (full: StatShrWdbeModCor1NImbuf)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModCor1NImbuf");
	...
	/**
	  * StgIac (full: StgIacWdbeModCor1NImbuf)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModCor1NImbuf");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModCor1NImbuf";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModCor1NImbuf");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModCor1NImbufData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCOR1NIMBUFDATA, scrJref);
		...
		public QryWdbeModCor1NImbuf.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCor1NImbufData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModCor1NImbufDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCOR1NIMBUFDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCor1NImbufDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModCor1NImbufData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODCOR1NIMBUFDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModCor1NImbuf();
			statappqry = (new QryWdbeModCor1NImbuf()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModCor1NImbuf()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModCor1NImbuf()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModCor1NImbuf rst;
		public QryWdbeModCor1NImbuf.StatApp statappqry;
		public QryWdbeModCor1NImbuf.StatShr statshrqry;
		public QryWdbeModCor1NImbuf.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModCor1NImbufData");
