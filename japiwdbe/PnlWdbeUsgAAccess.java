/**
  * \file PnlWdbeUsgAAccess.java
  * Java API code for job PnlWdbeUsgAAccess
...
public class PnlWdbeUsgAAccess {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUsgAAccess");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUsgAAccess");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUsgAAccess");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUsgAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUsgAAccess";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUsgAAccess");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSGAACCESSDATA, scrJref);
		...
		public QryWdbeUsgAAccess.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsgAAccessData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSGAACCESSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsgAAccessDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUSGAACCESSDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQUsgAAccess();
			statappqry = (new QryWdbeUsgAAccess()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUsgAAccess()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUsgAAccess()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUsgAAccess rst;
		public QryWdbeUsgAAccess.StatApp statappqry;
		public QryWdbeUsgAAccess.StatShr statshrqry;
		public QryWdbeUsgAAccess.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUsgAAccessData");
