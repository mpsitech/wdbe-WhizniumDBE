...
public class CrdWdbePrf {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONEDAEMON = 5;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWDBEVREQITMODE, LATENCY, SHORTMENU, WIDTHMENU, INITDONEDAEMON, INITDONEHEADBAR, INITDONELICENSE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWDBEVREQITMODE, LATENCY, SHORTMENU, WIDTHMENU, INITDONEDAEMON, INITDONEHEADBAR, INITDONELICENSE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFDAEMON = 1;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(SCRJREFDAEMON, SCRJREFHEADBAR, SCRJREFLICENSE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(SCRJREFDAEMON, SCRJREFHEADBAR, SCRJREFLICENSE));
			for (Integer ci: commitems) diffitems.remove(ci);
