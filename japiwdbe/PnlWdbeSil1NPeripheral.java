/**
  * \file PnlWdbeSil1NPeripheral.java
  * Java API code for job PnlWdbeSil1NPeripheral
...
public class PnlWdbeSil1NPeripheral {
	/**
		* VecVDo (full: VecVWdbeSil1NPeripheralDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSil1NPeripheral)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSil1NPeripheral");

			String itemtag = "ContitemInfWdbeSil1NPeripheral";
	...
	/**
	  * StatApp (full: StatAppWdbeSil1NPeripheral)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSil1NPeripheral");

			String itemtag = "StatitemAppWdbeSil1NPeripheral";
	...
	/**
	  * StatShr (full: StatShrWdbeSil1NPeripheral)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSil1NPeripheral");

			String itemtag = "StatitemShrWdbeSil1NPeripheral";
	...
	/**
	  * StgIac (full: StgIacWdbeSil1NPeripheral)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSil1NPeripheral");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSil1NPeripheral";
	...
	/**
	  * Tag (full: TagWdbeSil1NPeripheral)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSil1NPeripheral");

			String itemtag = "TagitemWdbeSil1NPeripheral";
	...
	/**
		* DpchAppData (full: DpchAppWdbeSil1NPeripheralData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NPERIPHERALDATA, scrJref);
		...
		public QryWdbeSil1NPeripheral.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NPeripheralData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSil1NPeripheralDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NPERIPHERALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NPeripheralDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSil1NPeripheralData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESIL1NPERIPHERALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSil1NPeripheral();
			statappqry = (new QryWdbeSil1NPeripheral()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSil1NPeripheral()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSil1NPeripheral()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSil1NPeripheral rst;
		public QryWdbeSil1NPeripheral.StatApp statappqry;
		public QryWdbeSil1NPeripheral.StatShr statshrqry;
		public QryWdbeSil1NPeripheral.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSil1NPeripheralData");
