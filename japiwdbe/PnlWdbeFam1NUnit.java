/**
  * \file PnlWdbeFam1NUnit.java
  * Java API code for job PnlWdbeFam1NUnit
...
public class PnlWdbeFam1NUnit {
	/**
		* VecVDo (full: VecVWdbeFam1NUnitDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeFam1NUnit)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeFam1NUnit");

			String itemtag = "ContitemInfWdbeFam1NUnit";
	...
	/**
	  * StatApp (full: StatAppWdbeFam1NUnit)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeFam1NUnit");

			String itemtag = "StatitemAppWdbeFam1NUnit";
	...
	/**
	  * StatShr (full: StatShrWdbeFam1NUnit)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeFam1NUnit");

			String itemtag = "StatitemShrWdbeFam1NUnit";
	...
	/**
	  * StgIac (full: StgIacWdbeFam1NUnit)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeFam1NUnit");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeFam1NUnit";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeFam1NUnit");

			String itemtag = "TagitemWdbeFam1NUnit";
	...
	/**
		* DpchAppData (full: DpchAppWdbeFam1NUnitData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEFAM1NUNITDATA, scrJref);
		...
		public QryWdbeFam1NUnit.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeFam1NUnitData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeFam1NUnitDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEFAM1NUNITDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeFam1NUnitDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeFam1NUnitData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEFAM1NUNITDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQFam1NUnit();
			statappqry = (new QryWdbeFam1NUnit()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeFam1NUnit()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeFam1NUnit()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQFam1NUnit rst;
		public QryWdbeFam1NUnit.StatApp statappqry;
		public QryWdbeFam1NUnit.StatShr statshrqry;
		public QryWdbeFam1NUnit.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeFam1NUnitData");
