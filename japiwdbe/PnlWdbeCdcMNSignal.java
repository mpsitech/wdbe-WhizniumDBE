/**
  * \file PnlWdbeCdcMNSignal.java
  * Java API code for job PnlWdbeCdcMNSignal
...
public class PnlWdbeCdcMNSignal {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCdcMNSignal");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCdcMNSignal");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCdcMNSignal");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCdcMNSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCdcMNSignal";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCdcMNSignal");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECDCMNSIGNALDATA, scrJref);
		...
		public QryWdbeCdcMNSignal.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCdcMNSignalData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECDCMNSIGNALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCdcMNSignalDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECDCMNSIGNALDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQCdcMNSignal();
			statappqry = (new QryWdbeCdcMNSignal()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCdcMNSignal()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCdcMNSignal()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCdcMNSignal rst;
		public QryWdbeCdcMNSignal.StatApp statappqry;
		public QryWdbeCdcMNSignal.StatShr statshrqry;
		public QryWdbeCdcMNSignal.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCdcMNSignalData");
