/**
  * \file PnlWdbeIntRec.java
  * Java API code for job PnlWdbeIntRec
...
public class PnlWdbeIntRec {
	/**
		* VecVDo (full: VecVWdbeIntRecDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeIntRec)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeIntRec");
	...
	/**
	  * StatApp (full: StatAppWdbeIntRec)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeIntRec");
	...
	/**
	  * StatShr (full: StatShrWdbeIntRec)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeIntRec");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeIntRec");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeIntRecDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEINTRECDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeIntRecDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeIntRecData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEINTRECDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeIntRecData");
