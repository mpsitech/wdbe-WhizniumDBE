/**
  * \file PnlWdbeIntList.java
  * Java API code for job PnlWdbeIntList
...
public class PnlWdbeIntList {
	/**
		* VecVDo (full: VecVWdbeIntListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeIntList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeIntList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeIntList";
	...
	/**
	  * ContInf (full: ContInfWdbeIntList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeIntList");
	...
	/**
	  * StatShr (full: StatShrWdbeIntList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeIntList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeIntList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeIntList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeIntList");
	...
	/**
		* DpchAppData (full: DpchAppWdbeIntListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEINTLISTDATA, scrJref);
		...
		public QryWdbeIntList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeIntListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeIntListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEINTLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeIntListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeIntListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEINTLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQIntList();
			statappqry = (new QryWdbeIntList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeIntList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeIntList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQIntList rst;
		public QryWdbeIntList.StatApp statappqry;
		public QryWdbeIntList.StatShr statshrqry;
		public QryWdbeIntList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeIntListData");
