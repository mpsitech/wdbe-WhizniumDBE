/**
  * \file QryWdbeSilRef1NError.java
  * Java API code for job QryWdbeSilRef1NError
...
public class QryWdbeSilRef1NError {
	/**
	  * StatApp (full: StatAppQryWdbeSilRef1NError)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeSilRef1NError");
	...
	/**
	  * StatShr (full: StatShrQryWdbeSilRef1NError)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeSilRef1NError");
	...
	/**
	  * StgIac (full: StgIacQryWdbeSilRef1NError)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeSilRef1NError");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeSilRef1NError";
