/**
  * \file PnlWdbeModKHdltype.java
  * Java API code for job PnlWdbeModKHdltype
...
public class PnlWdbeModKHdltype {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModKHdltype");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModKHdltype");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModKHdltype");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModKHdltype");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModKHdltype";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModKHdltype");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODKHDLTYPEDATA, scrJref);
		...
		public QryWdbeModKHdltype.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModKHdltypeData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODKHDLTYPEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModKHdltypeDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODKHDLTYPEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQModKHdltype();
			statappqry = (new QryWdbeModKHdltype()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModKHdltype()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModKHdltype()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModKHdltype rst;
		public QryWdbeModKHdltype.StatApp statappqry;
		public QryWdbeModKHdltype.StatShr statshrqry;
		public QryWdbeModKHdltype.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModKHdltypeData");
