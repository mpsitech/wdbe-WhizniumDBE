/**
  * \file PnlWdbeSilSil1NUnit.java
  * Java API code for job PnlWdbeSilSil1NUnit
...
public class PnlWdbeSilSil1NUnit {
	/**
		* VecVDo (full: VecVWdbeSilSil1NUnitDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSilSil1NUnit)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSilSil1NUnit");
	...
	/**
	  * StatApp (full: StatAppWdbeSilSil1NUnit)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSilSil1NUnit");
	...
	/**
	  * StgIac (full: StgIacWdbeSilSil1NUnit)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSilSil1NUnit");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSilSil1NUnit";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSilSil1NUnit");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSilSil1NUnitData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILSIL1NUNITDATA, scrJref);
		...
		public QryWdbeSilSil1NUnit.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilSil1NUnitData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSilSil1NUnitDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILSIL1NUNITDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilSil1NUnitDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSilSil1NUnitData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESILSIL1NUNITDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSilSil1NUnit();
			statappqry = (new QryWdbeSilSil1NUnit()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSilSil1NUnit()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSilSil1NUnit()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSilSil1NUnit rst;
		public QryWdbeSilSil1NUnit.StatApp statappqry;
		public QryWdbeSilSil1NUnit.StatShr statshrqry;
		public QryWdbeSilSil1NUnit.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSilSil1NUnitData");
