/**
  * \file PnlWdbeModMdl1NGeneric.java
  * Java API code for job PnlWdbeModMdl1NGeneric
...
public class PnlWdbeModMdl1NGeneric {
	/**
		* VecVDo (full: VecVWdbeModMdl1NGenericDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModMdl1NGeneric)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModMdl1NGeneric");
	...
	/**
	  * StatApp (full: StatAppWdbeModMdl1NGeneric)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModMdl1NGeneric");
	...
	/**
	  * StatShr (full: StatShrWdbeModMdl1NGeneric)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModMdl1NGeneric");
	...
	/**
	  * StgIac (full: StgIacWdbeModMdl1NGeneric)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModMdl1NGeneric");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModMdl1NGeneric";
	...
	/**
	  * Tag (full: TagWdbeModMdl1NGeneric)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModMdl1NGeneric");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModMdl1NGenericData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMDL1NGENERICDATA, scrJref);
		...
		public QryWdbeModMdl1NGeneric.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMdl1NGenericData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModMdl1NGenericDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODMDL1NGENERICDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModMdl1NGenericDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModMdl1NGenericData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODMDL1NGENERICDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModMdl1NGeneric();
			statappqry = (new QryWdbeModMdl1NGeneric()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModMdl1NGeneric()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModMdl1NGeneric()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModMdl1NGeneric rst;
		public QryWdbeModMdl1NGeneric.StatApp statappqry;
		public QryWdbeModMdl1NGeneric.StatShr statshrqry;
		public QryWdbeModMdl1NGeneric.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModMdl1NGenericData");
