/**
  * \file PnlWdbePinAPar.java
  * Java API code for job PnlWdbePinAPar
...
public class PnlWdbePinAPar {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePinAPar");

			String itemtag = "ContitemInfWdbePinAPar";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePinAPar");

			String itemtag = "StatitemAppWdbePinAPar";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePinAPar");

			String itemtag = "StatitemShrWdbePinAPar";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePinAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePinAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePinAPar");

			String itemtag = "TagitemWdbePinAPar";
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPINAPARDATA, scrJref);
		...
		public QryWdbePinAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePinAParData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPINAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePinAParDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPINAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQPinAPar();
			statappqry = (new QryWdbePinAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePinAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePinAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPinAPar rst;
		public QryWdbePinAPar.StatApp statappqry;
		public QryWdbePinAPar.StatShr statshrqry;
		public QryWdbePinAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePinAParData");
