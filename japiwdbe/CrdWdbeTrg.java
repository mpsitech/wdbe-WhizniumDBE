/**
  * \file CrdWdbeTrg.java
  * Java API code for job CrdWdbeTrg
...
public class CrdWdbeTrg {
	/**
		* VecVDo (full: VecVWdbeTrgDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeTrg)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDTRG = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTRG));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdTrg;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeTrg");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdTrg = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdTrg", mask, MTXCRDTRG);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdTrg.equals(comp.MtxCrdTrg)) items.add(MTXCRDTRG);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTRG));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeTrg");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeTrg");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeTrg");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeTrgDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBETRGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeTrgDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeTrgData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBETRGDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeTrgData");
