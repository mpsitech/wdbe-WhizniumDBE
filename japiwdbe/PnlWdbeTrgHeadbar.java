/**
  * \file PnlWdbeTrgHeadbar.java
  * Java API code for job PnlWdbeTrgHeadbar
...
public class PnlWdbeTrgHeadbar {
	/**
	  * StgInf (full: StgInfWdbeTrgHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeTrgHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeTrgHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeTrgHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBETRGHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeTrgHeadbarData");
