/**
  * \file QryWdbeModCorMNModule.java
  * Java API code for job QryWdbeModCorMNModule
...
public class QryWdbeModCorMNModule {
	/**
	  * StatApp (full: StatAppQryWdbeModCorMNModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModCorMNModule");
	...
	/**
	  * StatShr (full: StatShrQryWdbeModCorMNModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModCorMNModule");
	...
	/**
	  * StgIac (full: StgIacQryWdbeModCorMNModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModCorMNModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModCorMNModule";
