/**
  * \file PnlWdbePrjList.java
  * Java API code for job PnlWdbePrjList
...
public class PnlWdbePrjList {
	/**
		* VecVDo (full: VecVWdbePrjListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbePrjList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbePrjList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbePrjList";
	...
	/**
	  * ContInf (full: ContInfWdbePrjList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrjList");
	...
	/**
	  * StatShr (full: StatShrWdbePrjList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrjList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOSHOWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOESYWIDTH, TCOGRLWIDTH));
		};

		public int TcoGrpWidth;
		public int TcoOwnWidth;
		public int TcoShoWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrjList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoShoWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoShoWidth", mask, TCOSHOWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrjList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoShoWidth", TcoShoWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoShoWidth == comp.TcoShoWidth) items.add(TCOSHOWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOSHOWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOESYWIDTH, TCOGRLWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSHO = 9;
		public static final int TCOTIT = 10;
		public static final int TCOVER = 11;
		public static final int TCOESY = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOSHO, TCOTIT, TCOVER, TCOESY, TCOGRL));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrjList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoSho = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSho", mask, TCOSHO);
		...
		public HashSet<Integer> comm(
			...
			if (TcoSho.equals(comp.TcoSho)) items.add(TCOSHO);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOSHO, TCOTIT, TCOVER, TCOESY, TCOGRL));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbePrjListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRJLISTDATA, scrJref);
		...
		public QryWdbePrjList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrjListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrjListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRJLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrjListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrjListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRJLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQPrjList();
			statappqry = (new QryWdbePrjList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrjList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrjList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrjList rst;
		public QryWdbePrjList.StatApp statappqry;
		public QryWdbePrjList.StatShr statshrqry;
		public QryWdbePrjList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrjListData");
