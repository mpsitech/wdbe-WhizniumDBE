/**
  * \file PnlWdbeBnk1NPin.java
  * Java API code for job PnlWdbeBnk1NPin
...
public class PnlWdbeBnk1NPin {
	/**
		* VecVDo (full: VecVWdbeBnk1NPinDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeBnk1NPin)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeBnk1NPin");
	...
	/**
	  * StatApp (full: StatAppWdbeBnk1NPin)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeBnk1NPin");
	...
	/**
	  * StatShr (full: StatShrWdbeBnk1NPin)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeBnk1NPin");
	...
	/**
	  * StgIac (full: StgIacWdbeBnk1NPin)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeBnk1NPin");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeBnk1NPin";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeBnk1NPin");
	...
	/**
		* DpchAppData (full: DpchAppWdbeBnk1NPinData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEBNK1NPINDATA, scrJref);
		...
		public QryWdbeBnk1NPin.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeBnk1NPinData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeBnk1NPinDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEBNK1NPINDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeBnk1NPinDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeBnk1NPinData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEBNK1NPINDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQBnk1NPin();
			statappqry = (new QryWdbeBnk1NPin()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeBnk1NPin()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeBnk1NPin()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQBnk1NPin rst;
		public QryWdbeBnk1NPin.StatApp statappqry;
		public QryWdbeBnk1NPin.StatShr statshrqry;
		public QryWdbeBnk1NPin.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeBnk1NPinData");
