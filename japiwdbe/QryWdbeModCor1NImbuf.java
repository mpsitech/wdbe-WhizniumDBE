/**
  * \file QryWdbeModCor1NImbuf.java
  * Java API code for job QryWdbeModCor1NImbuf
...
public class QryWdbeModCor1NImbuf {
	/**
	  * StatApp (full: StatAppQryWdbeModCor1NImbuf)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModCor1NImbuf");
	...
	/**
	  * StatShr (full: StatShrQryWdbeModCor1NImbuf)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModCor1NImbuf");
	...
	/**
	  * StgIac (full: StgIacQryWdbeModCor1NImbuf)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModCor1NImbuf");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModCor1NImbuf";
