/**
  * \file CrdWdbePrt.java
  * Java API code for job CrdWdbePrt
...
public class CrdWdbePrt {
	/**
		* VecVDo (full: VecVWdbePrtDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrt)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDPRT = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDPRT));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdPrt;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrt");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdPrt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdPrt", mask, MTXCRDPRT);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdPrt.equals(comp.MtxCrdPrt)) items.add(MTXCRDPRT);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDPRT));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrt");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrt");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrt");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrtDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrtDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrtData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRTDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrtData");
