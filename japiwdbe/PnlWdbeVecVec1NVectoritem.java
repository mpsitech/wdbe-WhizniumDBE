/**
  * \file PnlWdbeVecVec1NVectoritem.java
  * Java API code for job PnlWdbeVecVec1NVectoritem
...
public class PnlWdbeVecVec1NVectoritem {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVecVec1NVectoritem");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVecVec1NVectoritem");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVecVec1NVectoritem");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVecVec1NVectoritem");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVecVec1NVectoritem";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVecVec1NVectoritem");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVECVEC1NVECTORITEMDATA, scrJref);
		...
		public QryWdbeVecVec1NVectoritem.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVecVec1NVectoritemData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVECVEC1NVECTORITEMDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVecVec1NVectoritemDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVECVEC1NVECTORITEMDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVecVec1NVectoritem();
			statappqry = (new QryWdbeVecVec1NVectoritem()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVecVec1NVectoritem()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVecVec1NVectoritem()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVecVec1NVectoritem rst;
		public QryWdbeVecVec1NVectoritem.StatApp statappqry;
		public QryWdbeVecVec1NVectoritem.StatShr statshrqry;
		public QryWdbeVecVec1NVectoritem.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVecVec1NVectoritemData");
