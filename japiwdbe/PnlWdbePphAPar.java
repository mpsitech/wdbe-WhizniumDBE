/**
  * \file PnlWdbePphAPar.java
  * Java API code for job PnlWdbePphAPar
...
public class PnlWdbePphAPar {
	/**
		* VecVDo (full: VecVWdbePphAParDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePphAPar)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePphAPar");
	...
	/**
	  * StatApp (full: StatAppWdbePphAPar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePphAPar");
	...
	/**
	  * StatShr (full: StatShrWdbePphAPar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePphAPar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePphAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePphAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePphAPar");
	...
	/**
		* DpchAppData (full: DpchAppWdbePphAParData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPHAPARDATA, scrJref);
		...
		public QryWdbePphAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePphAParData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePphAParDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPHAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePphAParDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePphAParData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPPHAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQPphAPar();
			statappqry = (new QryWdbePphAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePphAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePphAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPphAPar rst;
		public QryWdbePphAPar.StatApp statappqry;
		public QryWdbePphAPar.StatShr statshrqry;
		public QryWdbePphAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePphAParData");
