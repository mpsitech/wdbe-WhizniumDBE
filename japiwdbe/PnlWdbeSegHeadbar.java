/**
  * \file PnlWdbeSegHeadbar.java
  * Java API code for job PnlWdbeSegHeadbar
...
public class PnlWdbeSegHeadbar {
	/**
	  * StgInf (full: StgInfWdbeSegHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeSegHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSegHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSegHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESEGHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSegHeadbarData");
