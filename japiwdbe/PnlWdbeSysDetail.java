/**
  * \file PnlWdbeSysDetail.java
  * Java API code for job PnlWdbeSysDetail
...
public class PnlWdbeSysDetail {
	/**
		* VecVDo (full: VecVWdbeSysDetailDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeSysDetail)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeSysDetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeSysDetail";
	...
	/**
	  * ContInf (full: ContInfWdbeSysDetail)
	  */
	public class ContInf extends Block {
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(TXTSRF, TXTVER, TXTUNT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSysDetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TXTSRF, TXTVER, TXTUNT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
	  * StatApp (full: StatAppWdbeSysDetail)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSysDetail");
	...
	/**
	  * StatShr (full: StatShrWdbeSysDetail)
	  */
	public class StatShr extends Block {
		...
		public static final int TXTVERACTIVE = 4;
		public static final int BUTVERVIEWAVAIL = 5;
		public static final int BUTVERVIEWACTIVE = 6;
		public static final int TXTUNTACTIVE = 7;
		public static final int BUTUNTVIEWAVAIL = 8;
		public static final int BUTUNTVIEWACTIVE = 9;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, TXTVERACTIVE, BUTVERVIEWAVAIL, BUTVERVIEWACTIVE, TXTUNTACTIVE, BUTUNTVIEWAVAIL, BUTUNTVIEWACTIVE, TXFCMTACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSysDetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, TXTVERACTIVE, BUTVERVIEWAVAIL, BUTVERVIEWACTIVE, TXTUNTACTIVE, BUTUNTVIEWAVAIL, BUTUNTVIEWACTIVE, TXFCMTACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, CPTSRF, CPTVER, CPTUNT, CPTCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSysDetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, CPTSRF, CPTVER, CPTUNT, CPTCMT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeSysDetailData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESYSDETAILDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSysDetailData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSysDetailDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESYSDETAILDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSysDetailDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSysDetailData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESYSDETAILDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSysDetailData");
