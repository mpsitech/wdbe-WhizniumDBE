/**
  * \file PnlWdbeVerRef1NFile.java
  * Java API code for job PnlWdbeVerRef1NFile
...
public class PnlWdbeVerRef1NFile {
	/**
		* VecVDo (full: VecVWdbeVerRef1NFileDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeVerRef1NFile)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVerRef1NFile");
	...
	/**
	  * StatApp (full: StatAppWdbeVerRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVerRef1NFile");
	...
	/**
	  * StatShr (full: StatShrWdbeVerRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVerRef1NFile");
	...
	/**
	  * StgIac (full: StgIacWdbeVerRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVerRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVerRef1NFile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVerRef1NFile");
	...
	/**
		* DpchAppData (full: DpchAppWdbeVerRef1NFileData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVERREF1NFILEDATA, scrJref);
		...
		public QryWdbeVerRef1NFile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVerRef1NFileData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeVerRef1NFileDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVERREF1NFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVerRef1NFileDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVerRef1NFileData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVERREF1NFILEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVerRef1NFile();
			statappqry = (new QryWdbeVerRef1NFile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVerRef1NFile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVerRef1NFile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVerRef1NFile rst;
		public QryWdbeVerRef1NFile.StatApp statappqry;
		public QryWdbeVerRef1NFile.StatShr statshrqry;
		public QryWdbeVerRef1NFile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVerRef1NFileData");
