/**
  * \file PnlWdbeUnt1NTarget.java
  * Java API code for job PnlWdbeUnt1NTarget
...
public class PnlWdbeUnt1NTarget {
	/**
		* VecVDo (full: VecVWdbeUnt1NTargetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUnt1NTarget)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUnt1NTarget");
	...
	/**
	  * StatApp (full: StatAppWdbeUnt1NTarget)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUnt1NTarget");
	...
	/**
	  * StatShr (full: StatShrWdbeUnt1NTarget)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUnt1NTarget");
	...
	/**
	  * StgIac (full: StgIacWdbeUnt1NTarget)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUnt1NTarget");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUnt1NTarget";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUnt1NTarget");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUnt1NTargetData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NTARGETDATA, scrJref);
		...
		public QryWdbeUnt1NTarget.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NTargetData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUnt1NTargetDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NTARGETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NTargetDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUnt1NTargetData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNT1NTARGETDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUnt1NTarget();
			statappqry = (new QryWdbeUnt1NTarget()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUnt1NTarget()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUnt1NTarget()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUnt1NTarget rst;
		public QryWdbeUnt1NTarget.StatApp statappqry;
		public QryWdbeUnt1NTarget.StatShr statshrqry;
		public QryWdbeUnt1NTarget.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUnt1NTargetData");
