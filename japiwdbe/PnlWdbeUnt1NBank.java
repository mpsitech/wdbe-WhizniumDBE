/**
  * \file PnlWdbeUnt1NBank.java
  * Java API code for job PnlWdbeUnt1NBank
...
public class PnlWdbeUnt1NBank {
	/**
		* VecVDo (full: VecVWdbeUnt1NBankDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUnt1NBank)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUnt1NBank");
	...
	/**
	  * StatApp (full: StatAppWdbeUnt1NBank)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUnt1NBank");
	...
	/**
	  * StatShr (full: StatShrWdbeUnt1NBank)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUnt1NBank");
	...
	/**
	  * StgIac (full: StgIacWdbeUnt1NBank)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUnt1NBank");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUnt1NBank";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUnt1NBank");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUnt1NBankData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NBANKDATA, scrJref);
		...
		public QryWdbeUnt1NBank.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NBankData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUnt1NBankDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNT1NBANKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUnt1NBankDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUnt1NBankData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNT1NBANKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUnt1NBank();
			statappqry = (new QryWdbeUnt1NBank()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUnt1NBank()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUnt1NBank()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUnt1NBank rst;
		public QryWdbeUnt1NBank.StatApp statappqry;
		public QryWdbeUnt1NBank.StatShr statshrqry;
		public QryWdbeUnt1NBank.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUnt1NBankData");
