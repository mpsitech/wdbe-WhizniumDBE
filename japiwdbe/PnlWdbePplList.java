/**
  * \file PnlWdbePplList.java
  * Java API code for job PnlWdbePplList
...
public class PnlWdbePplList {
	/**
		* VecVDo (full: VecVWdbePplListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbePplList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbePplList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbePplList";
	...
	/**
	  * ContInf (full: ContInfWdbePplList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePplList");
	...
	/**
	  * StatShr (full: StatShrWdbePplList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePplList");
	...
	/**
	  * StgIac (full: StgIacWdbePplList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOHSMWIDTH = 2;
		public static final int TCODPTWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOHSMWIDTH, TCODPTWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoHsmWidth;
		public int TcoDptWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePplList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoHsmWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoHsmWidth", mask, TCOHSMWIDTH);
				TcoDptWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoDptWidth", mask, TCODPTWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePplList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoHsmWidth", TcoHsmWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoDptWidth", TcoDptWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoHsmWidth == comp.TcoHsmWidth) items.add(TCOHSMWIDTH);
			if (TcoDptWidth == comp.TcoDptWidth) items.add(TCODPTWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOHSMWIDTH, TCODPTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOHSM = 9;
		public static final int TCODPT = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOHSM, TCODPT));
		};
		...
		public String TcoHsm;
		public String TcoDpt;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePplList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoHsm = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoHsm", mask, TCOHSM);
				TcoDpt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoDpt", mask, TCODPT);
		...
		public HashSet<Integer> comm(
			...
			if (TcoHsm.equals(comp.TcoHsm)) items.add(TCOHSM);
			if (TcoDpt.equals(comp.TcoDpt)) items.add(TCODPT);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOHSM, TCODPT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbePplListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPLLISTDATA, scrJref);
		...
		public QryWdbePplList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePplListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePplListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPLLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePplListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePplListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPPLLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQPplList();
			statappqry = (new QryWdbePplList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePplList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePplList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPplList rst;
		public QryWdbePplList.StatApp statappqry;
		public QryWdbePplList.StatShr statshrqry;
		public QryWdbePplList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePplListData");
