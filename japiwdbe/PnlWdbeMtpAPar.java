/**
  * \file PnlWdbeMtpAPar.java
  * Java API code for job PnlWdbeMtpAPar
...
public class PnlWdbeMtpAPar {
	/**
		* VecVDo (full: VecVWdbeMtpAParDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpAPar)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpAPar");
	...
	/**
	  * StatApp (full: StatAppWdbeMtpAPar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpAPar");
	...
	/**
	  * StatShr (full: StatShrWdbeMtpAPar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpAPar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpAPar");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpAParData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPAPARDATA, scrJref);
		...
		public QryWdbeMtpAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpAParData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpAParDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpAParDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpAParData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQMtpAPar();
			statappqry = (new QryWdbeMtpAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpAPar rst;
		public QryWdbeMtpAPar.StatApp statappqry;
		public QryWdbeMtpAPar.StatShr statshrqry;
		public QryWdbeMtpAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpAParData");
