/**
  * \file PnlWdbeCmdList.java
  * Java API code for job PnlWdbeCmdList
...
public class PnlWdbeCmdList {
	/**
		* VecVDo (full: VecVWdbeCmdListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeCmdList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeCmdList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeCmdList";
	...
	/**
	  * ContInf (full: ContInfWdbeCmdList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCmdList");
	...
	/**
	  * StatShr (full: StatShrWdbeCmdList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCmdList");
	...
	/**
	  * StgIac (full: StgIacWdbeCmdList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOFSRWIDTH = 2;
		public static final int TCORETWIDTH = 3;
		public static final int TCOREUWIDTH = 4;
		public static final int TCORTYWIDTH = 5;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOFSRWIDTH, TCORETWIDTH, TCOREUWIDTH, TCORTYWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCmdList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoRtyWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoRtyWidth", mask, TCORTYWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCmdList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoRtyWidth", TcoRtyWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoRtyWidth == comp.TcoRtyWidth) items.add(TCORTYWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOFSRWIDTH, TCORETWIDTH, TCOREUWIDTH, TCORTYWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCORTY = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOFSR, TCORET, TCOREU, TCORTY));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCmdList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoRty = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoRty", mask, TCORTY);
		...
		public HashSet<Integer> comm(
			...
			if (TcoRty.equals(comp.TcoRty)) items.add(TCORTY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOFSR, TCORET, TCOREU, TCORTY));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeCmdListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMDLISTDATA, scrJref);
		...
		public QryWdbeCmdList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmdListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCmdListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMDLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmdListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCmdListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECMDLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQCmdList();
			statappqry = (new QryWdbeCmdList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCmdList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCmdList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCmdList rst;
		public QryWdbeCmdList.StatApp statappqry;
		public QryWdbeCmdList.StatShr statshrqry;
		public QryWdbeCmdList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCmdListData");
