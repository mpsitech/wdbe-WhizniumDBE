/**
  * \file PnlWdbeCmpHeadbar.java
  * Java API code for job PnlWdbeCmpHeadbar
...
public class PnlWdbeCmpHeadbar {
	/**
	  * StgInf (full: StgInfWdbeCmpHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeCmpHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCmpHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCmpHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECMPHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCmpHeadbarData");
