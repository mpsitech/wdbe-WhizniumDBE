/**
  * \file PnlWdbeGenList.java
  * Java API code for job PnlWdbeGenList
...
public class PnlWdbeGenList {
	/**
		* VecVDo (full: VecVWdbeGenListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbeGenList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeGenList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeGenList";
	...
	/**
	  * ContInf (full: ContInfWdbeGenList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeGenList");

			String itemtag = "ContitemInfWdbeGenList";
	...
	/**
	  * StatShr (full: StatShrWdbeGenList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeGenList");

			String itemtag = "StatitemShrWdbeGenList";
	...
	/**
	  * StgIac (full: StgIacWdbeGenList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOMDLWIDTH = 2;
		public static final int TCOHTYWIDTH = 3;
		public static final int TCOWIDWIDTH = 4;
		public static final int TCOMMXWIDTH = 5;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOMDLWIDTH, TCOHTYWIDTH, TCOWIDWIDTH, TCOMMXWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeGenList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeGenList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOMDLWIDTH, TCOHTYWIDTH, TCOWIDWIDTH, TCOMMXWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOHTY = 10;
		public static final int TCOWID = 11;
		public static final int TCOMMX = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOMDL, TCOHTY, TCOWID, TCOMMX));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeGenList");

			String itemtag = "TagitemWdbeGenList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOMDL, TCOHTY, TCOWID, TCOMMX));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeGenListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEGENLISTDATA, scrJref);
		...
		public QryWdbeGenList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeGenListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeGenListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEGENLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeGenListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeGenListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEGENLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQGenList();
			statappqry = (new QryWdbeGenList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeGenList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeGenList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQGenList rst;
		public QryWdbeGenList.StatApp statappqry;
		public QryWdbeGenList.StatShr statshrqry;
		public QryWdbeGenList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeGenListData");
