/**
  * \file QryWdbeMtpRef1NVariable.java
  * Java API code for job QryWdbeMtpRef1NVariable
...
public class QryWdbeMtpRef1NVariable {
	/**
	  * StatApp (full: StatAppQryWdbeMtpRef1NVariable)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeMtpRef1NVariable");
	...
	/**
	  * StatShr (full: StatShrQryWdbeMtpRef1NVariable)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeMtpRef1NVariable");
	...
	/**
	  * StgIac (full: StgIacQryWdbeMtpRef1NVariable)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeMtpRef1NVariable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeMtpRef1NVariable";
