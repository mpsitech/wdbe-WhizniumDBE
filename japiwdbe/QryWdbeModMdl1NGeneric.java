/**
  * \file QryWdbeModMdl1NGeneric.java
  * Java API code for job QryWdbeModMdl1NGeneric
...
public class QryWdbeModMdl1NGeneric {
	/**
	  * StatApp (full: StatAppQryWdbeModMdl1NGeneric)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModMdl1NGeneric");
	...
	/**
	  * StatShr (full: StatShrQryWdbeModMdl1NGeneric)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModMdl1NGeneric");
	...
	/**
	  * StgIac (full: StgIacQryWdbeModMdl1NGeneric)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModMdl1NGeneric");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModMdl1NGeneric";
