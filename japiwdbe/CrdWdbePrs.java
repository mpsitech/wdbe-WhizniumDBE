/**
  * \file CrdWdbePrs.java
  * Java API code for job CrdWdbePrs
...
public class CrdWdbePrs {
	/**
		* VecVDo (full: VecVWdbePrsDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrs)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDPRS = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDPRS));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdPrs;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrs");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdPrs = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdPrs", mask, MTXCRDPRS);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdPrs.equals(comp.MtxCrdPrs)) items.add(MTXCRDPRS);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDPRS));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrs");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrs");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrs");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrsDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrsDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrsData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRSDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrsData");
