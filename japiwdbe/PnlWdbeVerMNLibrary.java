/**
  * \file PnlWdbeVerMNLibrary.java
  * Java API code for job PnlWdbeVerMNLibrary
...
public class PnlWdbeVerMNLibrary {
	/**
		* VecVDo (full: VecVWdbeVerMNLibraryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeVerMNLibrary)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVerMNLibrary");
	...
	/**
	  * StatApp (full: StatAppWdbeVerMNLibrary)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVerMNLibrary");
	...
	/**
	  * StatShr (full: StatShrWdbeVerMNLibrary)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVerMNLibrary");
	...
	/**
	  * StgIac (full: StgIacWdbeVerMNLibrary)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVerMNLibrary");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVerMNLibrary";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVerMNLibrary");
	...
	/**
		* DpchAppData (full: DpchAppWdbeVerMNLibraryData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVERMNLIBRARYDATA, scrJref);
		...
		public QryWdbeVerMNLibrary.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVerMNLibraryData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeVerMNLibraryDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVERMNLIBRARYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVerMNLibraryDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVerMNLibraryData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVERMNLIBRARYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVerMNLibrary();
			statappqry = (new QryWdbeVerMNLibrary()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVerMNLibrary()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVerMNLibrary()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVerMNLibrary rst;
		public QryWdbeVerMNLibrary.StatApp statappqry;
		public QryWdbeVerMNLibrary.StatShr statshrqry;
		public QryWdbeVerMNLibrary.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVerMNLibraryData");
