/**
  * \file PnlWdbeMtpHeadbar.java
  * Java API code for job PnlWdbeMtpHeadbar
...
public class PnlWdbeMtpHeadbar {
	/**
	  * StgInf (full: StgInfWdbeMtpHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeMtpHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpHeadbarData");
