/**
  * \file PnlWdbeSysHk1NVector.java
  * Java API code for job PnlWdbeSysHk1NVector
...
public class PnlWdbeSysHk1NVector {
	/**
		* VecVDo (full: VecVWdbeSysHk1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSysHk1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSysHk1NVector");
	...
	/**
	  * StatApp (full: StatAppWdbeSysHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSysHk1NVector");
	...
	/**
	  * StatShr (full: StatShrWdbeSysHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSysHk1NVector");
	...
	/**
	  * StgIac (full: StgIacWdbeSysHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSysHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSysHk1NVector";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSysHk1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSysHk1NVectorData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESYSHK1NVECTORDATA, scrJref);
		...
		public QryWdbeSysHk1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSysHk1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSysHk1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESYSHK1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSysHk1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSysHk1NVectorData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESYSHK1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSysHk1NVector();
			statappqry = (new QryWdbeSysHk1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSysHk1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSysHk1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSysHk1NVector rst;
		public QryWdbeSysHk1NVector.StatApp statappqry;
		public QryWdbeSysHk1NVector.StatShr statshrqry;
		public QryWdbeSysHk1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSysHk1NVectorData");
