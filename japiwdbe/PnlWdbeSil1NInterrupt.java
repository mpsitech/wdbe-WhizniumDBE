/**
  * \file PnlWdbeSil1NInterrupt.java
  * Java API code for job PnlWdbeSil1NInterrupt
...
public class PnlWdbeSil1NInterrupt {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSil1NInterrupt");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSil1NInterrupt");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSil1NInterrupt");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSil1NInterrupt");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSil1NInterrupt";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSil1NInterrupt");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NINTERRUPTDATA, scrJref);
		...
		public QryWdbeSil1NInterrupt.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NInterruptData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIL1NINTERRUPTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSil1NInterruptDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESIL1NINTERRUPTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSil1NInterrupt();
			statappqry = (new QryWdbeSil1NInterrupt()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSil1NInterrupt()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSil1NInterrupt()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSil1NInterrupt rst;
		public QryWdbeSil1NInterrupt.StatApp statappqry;
		public QryWdbeSil1NInterrupt.StatShr statshrqry;
		public QryWdbeSil1NInterrupt.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSil1NInterruptData");
