/**
  * \file QryWdbeUnt1NTarget.java
  * Java API code for job QryWdbeUnt1NTarget
...
public class QryWdbeUnt1NTarget {
	/**
	  * StatApp (full: StatAppQryWdbeUnt1NTarget)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeUnt1NTarget");
	...
	/**
	  * StatShr (full: StatShrQryWdbeUnt1NTarget)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeUnt1NTarget");
	...
	/**
	  * StgIac (full: StgIacQryWdbeUnt1NTarget)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeUnt1NTarget");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeUnt1NTarget";
