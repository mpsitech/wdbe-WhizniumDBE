/**
  * \file PnlWdbeUsrMNUsergroup.java
  * Java API code for job PnlWdbeUsrMNUsergroup
...
public class PnlWdbeUsrMNUsergroup {
	/**
		* VecVDo (full: VecVWdbeUsrMNUsergroupDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUsrMNUsergroup)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUsrMNUsergroup");
	...
	/**
	  * StatApp (full: StatAppWdbeUsrMNUsergroup)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUsrMNUsergroup");
	...
	/**
	  * StatShr (full: StatShrWdbeUsrMNUsergroup)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUsrMNUsergroup");
	...
	/**
	  * StgIac (full: StgIacWdbeUsrMNUsergroup)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUsrMNUsergroup");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUsrMNUsergroup";
	...
	/**
	  * Tag (full: TagWdbeUsrMNUsergroup)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUsrMNUsergroup");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUsrMNUsergroupData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSRMNUSERGROUPDATA, scrJref);
		...
		public QryWdbeUsrMNUsergroup.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsrMNUsergroupData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUsrMNUsergroupDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSRMNUSERGROUPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsrMNUsergroupDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUsrMNUsergroupData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUSRMNUSERGROUPDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQUsrMNUsergroup();
			statappqry = (new QryWdbeUsrMNUsergroup()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUsrMNUsergroup()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUsrMNUsergroup()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUsrMNUsergroup rst;
		public QryWdbeUsrMNUsergroup.StatApp statappqry;
		public QryWdbeUsrMNUsergroup.StatShr statshrqry;
		public QryWdbeUsrMNUsergroup.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUsrMNUsergroupData");
