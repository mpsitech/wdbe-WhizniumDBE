/**
  * \file PnlWdbePrsMNCoreproject.java
  * Java API code for job PnlWdbePrsMNCoreproject
...
public class PnlWdbePrsMNCoreproject {
	/**
		* VecVDo (full: VecVWdbePrsMNCoreprojectDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrsMNCoreproject)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrsMNCoreproject");
	...
	/**
	  * StatApp (full: StatAppWdbePrsMNCoreproject)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrsMNCoreproject");
	...
	/**
	  * StatShr (full: StatShrWdbePrsMNCoreproject)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrsMNCoreproject");
	...
	/**
	  * StgIac (full: StgIacWdbePrsMNCoreproject)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrsMNCoreproject");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrsMNCoreproject";
	...
	/**
	  * Tag (full: TagWdbePrsMNCoreproject)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrsMNCoreproject");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrsMNCoreprojectData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRSMNCOREPROJECTDATA, scrJref);
		...
		public QryWdbePrsMNCoreproject.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrsMNCoreprojectData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrsMNCoreprojectDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRSMNCOREPROJECTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrsMNCoreprojectDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrsMNCoreprojectData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRSMNCOREPROJECTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQPrsMNCoreproject();
			statappqry = (new QryWdbePrsMNCoreproject()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrsMNCoreproject()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrsMNCoreproject()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrsMNCoreproject rst;
		public QryWdbePrsMNCoreproject.StatApp statappqry;
		public QryWdbePrsMNCoreproject.StatShr statshrqry;
		public QryWdbePrsMNCoreproject.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrsMNCoreprojectData");
