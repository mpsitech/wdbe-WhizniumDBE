/**
  * \file PnlWdbeCmp1NRelease.java
  * Java API code for job PnlWdbeCmp1NRelease
...
public class PnlWdbeCmp1NRelease {
	/**
		* VecVDo (full: VecVWdbeCmp1NReleaseDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCmp1NRelease)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCmp1NRelease");
	...
	/**
	  * StatApp (full: StatAppWdbeCmp1NRelease)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCmp1NRelease");
	...
	/**
	  * StatShr (full: StatShrWdbeCmp1NRelease)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCmp1NRelease");
	...
	/**
	  * StgIac (full: StgIacWdbeCmp1NRelease)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCmp1NRelease");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCmp1NRelease";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCmp1NRelease");
	...
	/**
		* DpchAppData (full: DpchAppWdbeCmp1NReleaseData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMP1NRELEASEDATA, scrJref);
		...
		public QryWdbeCmp1NRelease.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmp1NReleaseData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCmp1NReleaseDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMP1NRELEASEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmp1NReleaseDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCmp1NReleaseData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECMP1NRELEASEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQCmp1NRelease();
			statappqry = (new QryWdbeCmp1NRelease()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCmp1NRelease()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCmp1NRelease()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCmp1NRelease rst;
		public QryWdbeCmp1NRelease.StatApp statappqry;
		public QryWdbeCmp1NRelease.StatShr statshrqry;
		public QryWdbeCmp1NRelease.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCmp1NReleaseData");
