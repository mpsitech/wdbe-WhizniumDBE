/**
  * \file PnlWdbeCvrHeadbar.java
  * Java API code for job PnlWdbeCvrHeadbar
...
public class PnlWdbeCvrHeadbar {
	/**
	  * StgInf (full: StgInfWdbeCvrHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeCvrHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCvrHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCvrHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECVRHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCvrHeadbarData");
