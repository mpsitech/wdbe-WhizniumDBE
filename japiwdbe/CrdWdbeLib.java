/**
  * \file CrdWdbeLib.java
  * Java API code for job CrdWdbeLib
...
public class CrdWdbeLib {
	/**
		* VecVDo (full: VecVWdbeLibDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeLib)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDLIB = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDLIB));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdLib;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeLib");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdLib = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdLib", mask, MTXCRDLIB);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdLib.equals(comp.MtxCrdLib)) items.add(MTXCRDLIB);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDLIB));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeLib");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeLib");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeLib");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeLibDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBELIBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeLibDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeLibData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBELIBDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeLibData");
