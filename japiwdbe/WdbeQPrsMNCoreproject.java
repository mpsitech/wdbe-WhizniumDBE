/**
  ...
  * Java API code for record of table TblWdbeQPrsMNCoreproject
...
public class WdbeQPrsMNCoreproject {
	
	public WdbeQPrsMNCoreproject(
				int jnum
				, String stubMref
				, String ftmX1Startd
				, String ftmX1Stopd
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WdbeQPrsMNCoreproject");
