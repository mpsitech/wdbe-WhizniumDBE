/**
  * \file CrdWdbePpl.java
  * Java API code for job CrdWdbePpl
...
public class CrdWdbePpl {
	/**
		* VecVDo (full: VecVWdbePplDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePpl)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDPPL = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDPPL));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdPpl;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePpl");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdPpl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdPpl", mask, MTXCRDPPL);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdPpl.equals(comp.MtxCrdPpl)) items.add(MTXCRDPPL);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDPPL));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePpl");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePpl");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePpl");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePplDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePplDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePplData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPPLDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePplData");
