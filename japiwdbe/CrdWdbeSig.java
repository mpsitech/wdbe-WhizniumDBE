/**
  * \file CrdWdbeSig.java
  * Java API code for job CrdWdbeSig
...
public class CrdWdbeSig {
	/**
		* VecVDo (full: VecVWdbeSigDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSig)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDSIG = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSIG));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdSig;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSig");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdSig = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdSig", mask, MTXCRDSIG);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdSig.equals(comp.MtxCrdSig)) items.add(MTXCRDSIG);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSIG));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSig");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSig");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSig");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSigDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESIGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSigDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSigData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESIGDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSigData");
