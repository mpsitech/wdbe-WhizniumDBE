/**
  * \file PnlWdbeCvrBcv1NCoreversion.java
  * Java API code for job PnlWdbeCvrBcv1NCoreversion
...
public class PnlWdbeCvrBcv1NCoreversion {
	/**
		* VecVDo (full: VecVWdbeCvrBcv1NCoreversionDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCvrBcv1NCoreversion)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCvrBcv1NCoreversion");
	...
	/**
	  * StatApp (full: StatAppWdbeCvrBcv1NCoreversion)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCvrBcv1NCoreversion");
	...
	/**
	  * StatShr (full: StatShrWdbeCvrBcv1NCoreversion)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCvrBcv1NCoreversion");
	...
	/**
	  * StgIac (full: StgIacWdbeCvrBcv1NCoreversion)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCvrBcv1NCoreversion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCvrBcv1NCoreversion";
	...
	/**
	  * Tag (full: TagWdbeCvrBcv1NCoreversion)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCvrBcv1NCoreversion");
	...
	/**
		* DpchAppData (full: DpchAppWdbeCvrBcv1NCoreversionData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRBCV1NCOREVERSIONDATA, scrJref);
		...
		public QryWdbeCvrBcv1NCoreversion.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrBcv1NCoreversionData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCvrBcv1NCoreversionDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRBCV1NCOREVERSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrBcv1NCoreversionDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCvrBcv1NCoreversionData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECVRBCV1NCOREVERSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQCvrBcv1NCoreversion();
			statappqry = (new QryWdbeCvrBcv1NCoreversion()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCvrBcv1NCoreversion()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCvrBcv1NCoreversion()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCvrBcv1NCoreversion rst;
		public QryWdbeCvrBcv1NCoreversion.StatApp statappqry;
		public QryWdbeCvrBcv1NCoreversion.StatShr statshrqry;
		public QryWdbeCvrBcv1NCoreversion.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCvrBcv1NCoreversionData");
