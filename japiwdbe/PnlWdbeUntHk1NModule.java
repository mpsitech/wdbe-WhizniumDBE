/**
  * \file PnlWdbeUntHk1NModule.java
  * Java API code for job PnlWdbeUntHk1NModule
...
public class PnlWdbeUntHk1NModule {
	/**
		* VecVDo (full: VecVWdbeUntHk1NModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUntHk1NModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUntHk1NModule");
	...
	/**
	  * StatApp (full: StatAppWdbeUntHk1NModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUntHk1NModule");
	...
	/**
	  * StatShr (full: StatShrWdbeUntHk1NModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUntHk1NModule");
	...
	/**
	  * StgIac (full: StgIacWdbeUntHk1NModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUntHk1NModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUntHk1NModule";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUntHk1NModule");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUntHk1NModuleData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTHK1NMODULEDATA, scrJref);
		...
		public QryWdbeUntHk1NModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntHk1NModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUntHk1NModuleDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTHK1NMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntHk1NModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUntHk1NModuleData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNTHK1NMODULEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUntHk1NModule();
			statappqry = (new QryWdbeUntHk1NModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUntHk1NModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUntHk1NModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUntHk1NModule rst;
		public QryWdbeUntHk1NModule.StatApp statappqry;
		public QryWdbeUntHk1NModule.StatShr statshrqry;
		public QryWdbeUntHk1NModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUntHk1NModuleData");
