/**
  * \file PnlWdbeCprHeadbar.java
  * Java API code for job PnlWdbeCprHeadbar
...
public class PnlWdbeCprHeadbar {
	/**
	  * StgInf (full: StgInfWdbeCprHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeCprHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCprHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCprHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECPRHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCprHeadbarData");
