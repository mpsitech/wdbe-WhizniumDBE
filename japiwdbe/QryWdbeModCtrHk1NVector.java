/**
  * \file QryWdbeModCtrHk1NVector.java
  * Java API code for job QryWdbeModCtrHk1NVector
...
public class QryWdbeModCtrHk1NVector {
	/**
	  * StatApp (full: StatAppQryWdbeModCtrHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModCtrHk1NVector");
	...
	/**
	  * StatShr (full: StatShrQryWdbeModCtrHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModCtrHk1NVector");
	...
	/**
	  * StgIac (full: StgIacQryWdbeModCtrHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModCtrHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModCtrHk1NVector";
