/**
  * \file PnlWdbeSysSys1NTarget.java
  * Java API code for job PnlWdbeSysSys1NTarget
...
public class PnlWdbeSysSys1NTarget {
	/**
		* VecVDo (full: VecVWdbeSysSys1NTargetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSysSys1NTarget)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSysSys1NTarget");
	...
	/**
	  * StatApp (full: StatAppWdbeSysSys1NTarget)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSysSys1NTarget");
	...
	/**
	  * StatShr (full: StatShrWdbeSysSys1NTarget)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSysSys1NTarget");
	...
	/**
	  * StgIac (full: StgIacWdbeSysSys1NTarget)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSysSys1NTarget");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSysSys1NTarget";
	...
	/**
	  * Tag (full: TagWdbeSysSys1NTarget)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSysSys1NTarget");
	...
	/**
		* DpchAppData (full: DpchAppWdbeSysSys1NTargetData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESYSSYS1NTARGETDATA, scrJref);
		...
		public QryWdbeSysSys1NTarget.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSysSys1NTargetData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSysSys1NTargetDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESYSSYS1NTARGETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSysSys1NTargetDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSysSys1NTargetData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESYSSYS1NTARGETDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSysSys1NTarget();
			statappqry = (new QryWdbeSysSys1NTarget()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSysSys1NTarget()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSysSys1NTarget()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSysSys1NTarget rst;
		public QryWdbeSysSys1NTarget.StatApp statappqry;
		public QryWdbeSysSys1NTarget.StatShr statshrqry;
		public QryWdbeSysSys1NTarget.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSysSys1NTargetData");
