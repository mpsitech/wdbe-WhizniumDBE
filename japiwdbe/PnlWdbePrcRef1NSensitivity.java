/**
  * \file PnlWdbePrcRef1NSensitivity.java
  * Java API code for job PnlWdbePrcRef1NSensitivity
...
public class PnlWdbePrcRef1NSensitivity {
	/**
		* VecVDo (full: VecVWdbePrcRef1NSensitivityDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrcRef1NSensitivity)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrcRef1NSensitivity");
	...
	/**
	  * StatApp (full: StatAppWdbePrcRef1NSensitivity)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrcRef1NSensitivity");
	...
	/**
	  * StatShr (full: StatShrWdbePrcRef1NSensitivity)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrcRef1NSensitivity");
	...
	/**
	  * StgIac (full: StgIacWdbePrcRef1NSensitivity)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrcRef1NSensitivity");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrcRef1NSensitivity";
	...
	/**
	  * Tag (full: TagWdbePrcRef1NSensitivity)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrcRef1NSensitivity");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrcRef1NSensitivityData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCREF1NSENSITIVITYDATA, scrJref);
		...
		public QryWdbePrcRef1NSensitivity.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcRef1NSensitivityData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrcRef1NSensitivityDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCREF1NSENSITIVITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcRef1NSensitivityDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrcRef1NSensitivityData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRCREF1NSENSITIVITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPrcRef1NSensitivity();
			statappqry = (new QryWdbePrcRef1NSensitivity()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrcRef1NSensitivity()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrcRef1NSensitivity()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrcRef1NSensitivity rst;
		public QryWdbePrcRef1NSensitivity.StatApp statappqry;
		public QryWdbePrcRef1NSensitivity.StatShr statshrqry;
		public QryWdbePrcRef1NSensitivity.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrcRef1NSensitivityData");
