/**
  * \file PnlWdbeModRef1NVariable.java
  * Java API code for job PnlWdbeModRef1NVariable
...
public class PnlWdbeModRef1NVariable {
	/**
		* VecVDo (full: VecVWdbeModRef1NVariableDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModRef1NVariable)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModRef1NVariable");
	...
	/**
	  * StatApp (full: StatAppWdbeModRef1NVariable)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModRef1NVariable");
	...
	/**
	  * StatShr (full: StatShrWdbeModRef1NVariable)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModRef1NVariable");
	...
	/**
	  * StgIac (full: StgIacWdbeModRef1NVariable)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModRef1NVariable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModRef1NVariable";
	...
	/**
	  * Tag (full: TagWdbeModRef1NVariable)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModRef1NVariable");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModRef1NVariableData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODREF1NVARIABLEDATA, scrJref);
		...
		public QryWdbeModRef1NVariable.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModRef1NVariableData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModRef1NVariableDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODREF1NVARIABLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModRef1NVariableDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModRef1NVariableData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODREF1NVARIABLEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModRef1NVariable();
			statappqry = (new QryWdbeModRef1NVariable()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModRef1NVariable()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModRef1NVariable()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModRef1NVariable rst;
		public QryWdbeModRef1NVariable.StatApp statappqry;
		public QryWdbeModRef1NVariable.StatShr statshrqry;
		public QryWdbeModRef1NVariable.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModRef1NVariableData");
