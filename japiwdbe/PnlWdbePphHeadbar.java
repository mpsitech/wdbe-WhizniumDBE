/**
  * \file PnlWdbePphHeadbar.java
  * Java API code for job PnlWdbePphHeadbar
...
public class PnlWdbePphHeadbar {
	/**
	  * StgInf (full: StgInfWdbePphHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbePphHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePphHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbePphHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPPHHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePphHeadbarData");
