/**
  * \file PnlWdbeCdcHeadbar.java
  * Java API code for job PnlWdbeCdcHeadbar
...
public class PnlWdbeCdcHeadbar {
	/**
	  * StgInf (full: StgInfWdbeCdcHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeCdcHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCdcHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCdcHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECDCHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCdcHeadbarData");
