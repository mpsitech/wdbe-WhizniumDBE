/**
  * \file QryWdbeUntHk1NVector.java
  * Java API code for job QryWdbeUntHk1NVector
...
public class QryWdbeUntHk1NVector {
	/**
	  * StatApp (full: StatAppQryWdbeUntHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeUntHk1NVector");
	...
	/**
	  * StatShr (full: StatShrQryWdbeUntHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeUntHk1NVector");
	...
	/**
	  * StgIac (full: StgIacQryWdbeUntHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeUntHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeUntHk1NVector";
