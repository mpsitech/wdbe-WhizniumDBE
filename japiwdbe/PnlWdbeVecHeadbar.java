/**
  * \file PnlWdbeVecHeadbar.java
  * Java API code for job PnlWdbeVecHeadbar
...
public class PnlWdbeVecHeadbar {
	/**
	  * StgInf (full: StgInfWdbeVecHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeVecHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVecHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVecHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVECHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVecHeadbarData");
