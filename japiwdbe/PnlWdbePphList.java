/**
  * \file PnlWdbePphList.java
  * Java API code for job PnlWdbePphList
...
public class PnlWdbePphList {
	/**
		* VecVDo (full: VecVWdbePphListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWdbePphList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbePphList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbePphList";
	...
	/**
	  * ContInf (full: ContInfWdbePphList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePphList");
	...
	/**
	  * StatShr (full: StatShrWdbePphList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePphList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePphList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePphList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePphList");
	...
	/**
		* DpchAppData (full: DpchAppWdbePphListData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPHLISTDATA, scrJref);
		...
		public QryWdbePphList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePphListData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePphListDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPPHLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePphListDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePphListData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPPHLISTDATA);
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPphList rst;
		public QryWdbePphList.StatApp statappqry;
		public QryWdbePphList.StatShr statshrqry;
		public QryWdbePphList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePphListData");
