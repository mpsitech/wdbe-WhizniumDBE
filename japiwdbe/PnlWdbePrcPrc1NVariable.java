/**
  * \file PnlWdbePrcPrc1NVariable.java
  * Java API code for job PnlWdbePrcPrc1NVariable
...
public class PnlWdbePrcPrc1NVariable {
	/**
		* VecVDo (full: VecVWdbePrcPrc1NVariableDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrcPrc1NVariable)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrcPrc1NVariable");
	...
	/**
	  * StatApp (full: StatAppWdbePrcPrc1NVariable)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrcPrc1NVariable");
	...
	/**
	  * StatShr (full: StatShrWdbePrcPrc1NVariable)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrcPrc1NVariable");
	...
	/**
	  * StgIac (full: StgIacWdbePrcPrc1NVariable)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrcPrc1NVariable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrcPrc1NVariable";
	...
	/**
	  * Tag (full: TagWdbePrcPrc1NVariable)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrcPrc1NVariable");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrcPrc1NVariableData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCPRC1NVARIABLEDATA, scrJref);
		...
		public QryWdbePrcPrc1NVariable.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcPrc1NVariableData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrcPrc1NVariableDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCPRC1NVARIABLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcPrc1NVariableDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrcPrc1NVariableData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRCPRC1NVARIABLEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPrcPrc1NVariable();
			statappqry = (new QryWdbePrcPrc1NVariable()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrcPrc1NVariable()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrcPrc1NVariable()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrcPrc1NVariable rst;
		public QryWdbePrcPrc1NVariable.StatApp statappqry;
		public QryWdbePrcPrc1NVariable.StatShr statshrqry;
		public QryWdbePrcPrc1NVariable.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrcPrc1NVariableData");
