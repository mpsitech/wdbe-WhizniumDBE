/**
  * \file PnlWdbeMtpMdl1NGeneric.java
  * Java API code for job PnlWdbeMtpMdl1NGeneric
...
public class PnlWdbeMtpMdl1NGeneric {
	/**
		* VecVDo (full: VecVWdbeMtpMdl1NGenericDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMtpMdl1NGeneric)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMtpMdl1NGeneric");
	...
	/**
	  * StatApp (full: StatAppWdbeMtpMdl1NGeneric)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMtpMdl1NGeneric");
	...
	/**
	  * StatShr (full: StatShrWdbeMtpMdl1NGeneric)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMtpMdl1NGeneric");
	...
	/**
	  * StgIac (full: StgIacWdbeMtpMdl1NGeneric)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMtpMdl1NGeneric");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMtpMdl1NGeneric";
	...
	/**
	  * Tag (full: TagWdbeMtpMdl1NGeneric)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMtpMdl1NGeneric");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMtpMdl1NGenericData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPMDL1NGENERICDATA, scrJref);
		...
		public QryWdbeMtpMdl1NGeneric.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpMdl1NGenericData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMtpMdl1NGenericDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMTPMDL1NGENERICDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMtpMdl1NGenericDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMtpMdl1NGenericData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMTPMDL1NGENERICDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMtpMdl1NGeneric();
			statappqry = (new QryWdbeMtpMdl1NGeneric()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMtpMdl1NGeneric()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMtpMdl1NGeneric()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMtpMdl1NGeneric rst;
		public QryWdbeMtpMdl1NGeneric.StatApp statappqry;
		public QryWdbeMtpMdl1NGeneric.StatShr statshrqry;
		public QryWdbeMtpMdl1NGeneric.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMtpMdl1NGenericData");
