/**
  * \file PnlWdbeCvrAIp.java
  * Java API code for job PnlWdbeCvrAIp
...
public class PnlWdbeCvrAIp {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCvrAIp");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCvrAIp");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCvrAIp");
	...
	public class StgIac extends Block {
		...
		public static final int TCOTTYWIDTH = 2;
		public static final int TCOCMTWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTTYWIDTH, TCOCMTWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoTtyWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCvrAIp");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTtyWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTtyWidth", mask, TCOTTYWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCvrAIp";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTtyWidth", TcoTtyWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoTtyWidth == comp.TcoTtyWidth) items.add(TCOTTYWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTTYWIDTH, TCOCMTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOTTY = 8;
		public static final int TCOCMT = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTTY, TCOCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCvrAIp");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTty = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTty", mask, TCOTTY);
		...
		public HashSet<Integer> comm(
			...
			if (TcoTty.equals(comp.TcoTty)) items.add(TCOTTY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTTY, TCOCMT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRAIPDATA, scrJref);
		...
		public QryWdbeCvrAIp.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrAIpData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRAIPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrAIpDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECVRAIPDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQCvrAIp();
			statappqry = (new QryWdbeCvrAIp()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCvrAIp()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCvrAIp()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCvrAIp rst;
		public QryWdbeCvrAIp.StatApp statappqry;
		public QryWdbeCvrAIp.StatShr statshrqry;
		public QryWdbeCvrAIp.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCvrAIpData");
