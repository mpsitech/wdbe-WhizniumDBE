/**
  * \file CrdWdbeSns.java
  * Java API code for job CrdWdbeSns
...
public class CrdWdbeSns {
	/**
		* VecVDo (full: VecVWdbeSnsDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSns)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDSNS = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSNS));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdSns;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSns");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdSns = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdSns", mask, MTXCRDSNS);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdSns.equals(comp.MtxCrdSns)) items.add(MTXCRDSNS);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSNS));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSns");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSns");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSns");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSnsDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESNSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSnsDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSnsData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESNSDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSnsData");
