/**
  * \file QryWdbeSilHk1NVector.java
  * Java API code for job QryWdbeSilHk1NVector
...
public class QryWdbeSilHk1NVector {
	/**
	  * StatApp (full: StatAppQryWdbeSilHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeSilHk1NVector");
	...
	/**
	  * StatShr (full: StatShrQryWdbeSilHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeSilHk1NVector");
	...
	/**
	  * StgIac (full: StgIacQryWdbeSilHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeSilHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeSilHk1NVector";
