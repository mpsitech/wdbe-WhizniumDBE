...
public class PnlWdbeSilRec {
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NINTERRUPT = 6;
		public static final int SCRJREFREF1NCOMMAND = 7;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NBANK, SCRJREFSIL1NUNIT, SCRJREF1NPERIPHERAL, SCRJREF1NINTERRUPT, SCRJREFREF1NCOMMAND, SCRJREFHK1NMODULE, SCRJREFHK1NVECTOR, SCRJREFREF1NERROR, SCRJREFREF1NSIGNAL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NBANK, SCRJREFSIL1NUNIT, SCRJREF1NPERIPHERAL, SCRJREF1NINTERRUPT, SCRJREFREF1NCOMMAND, SCRJREFHK1NMODULE, SCRJREFHK1NVECTOR, SCRJREFREF1NERROR, SCRJREFREF1NSIGNAL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
