/**
  * \file PnlWdbeCvrAPlh.java
  * Java API code for job PnlWdbeCvrAPlh
...
public class PnlWdbeCvrAPlh {
	/**
		* VecVDo (full: VecVWdbeCvrAPlhDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCvrAPlh)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCvrAPlh");
	...
	/**
	  * StatApp (full: StatAppWdbeCvrAPlh)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCvrAPlh");
	...
	/**
	  * StatShr (full: StatShrWdbeCvrAPlh)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCvrAPlh");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOCMTWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCvrAPlh");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCvrAPlh";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOCMTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOCMT = 8;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCvrAPlh");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOCMT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeCvrAPlhData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRAPLHDATA, scrJref);
		...
		public QryWdbeCvrAPlh.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrAPlhData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCvrAPlhDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRAPLHDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrAPlhDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCvrAPlhData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECVRAPLHDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQCvrAPlh();
			statappqry = (new QryWdbeCvrAPlh()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCvrAPlh()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCvrAPlh()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCvrAPlh rst;
		public QryWdbeCvrAPlh.StatApp statappqry;
		public QryWdbeCvrAPlh.StatShr statshrqry;
		public QryWdbeCvrAPlh.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCvrAPlhData");
