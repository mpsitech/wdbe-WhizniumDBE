/**
  * \file QryWdbeUntList.java
  * Java API code for job QryWdbeUntList
...
public class QryWdbeUntList {
	/**
		* VecVOrd (full: VecVQryWdbeUntListOrd)
		*/
	...
	/**
	  * StatApp (full: StatAppQryWdbeUntList)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeUntList");
	...
	/**
	  * StatShr (full: StatShrQryWdbeUntList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeUntList");
	...
	/**
	  * StgIac (full: StgIacQryWdbeUntList)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeUntList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeUntList";
