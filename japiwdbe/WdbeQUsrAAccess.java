/**
  ...
  * Java API code for record of table TblWdbeQUsrAAccess
...
public class WdbeQUsrAAccess {
	
	public WdbeQUsrAAccess(
				int jnum
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WdbeQUsrAAccess");
