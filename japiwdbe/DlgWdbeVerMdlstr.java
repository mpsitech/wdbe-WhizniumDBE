/**
  * \file DlgWdbeVerMdlstr.java
  * Java API code for job DlgWdbeVerMdlstr
...
public class DlgWdbeVerMdlstr {
	...
	public static class VecVSge {
		...
		public static final int ALRFER = 2;
		...
		public static final int POSTPRC3 = 13;
		public static final int ASMLFI = 14;
		...
		public static int getIx(
			...
			if (s.equals("alrfer")) return ALRFER;
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWdbeVerMdlstr");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWdbeVerMdlstr";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWdbeVerMdlstr");
	...
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWdbeVerMdlstrImp");
	...
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWdbeVerMdlstrLfi");
	...
	public class ContInfPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWdbeVerMdlstrPpr");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWdbeVerMdlstr");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWdbeVerMdlstr");
	...
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWdbeVerMdlstrIfi");
	...
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWdbeVerMdlstrImp");
	...
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWdbeVerMdlstrLfi");
	...
	public class StatShrPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWdbeVerMdlstrPpr");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWdbeVerMdlstr");
	...
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWdbeVerMdlstrIfi");
	...
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWdbeVerMdlstrImp");
	...
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWdbeVerMdlstrLfi");
	...
	public class TagPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWdbeVerMdlstrPpr");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPDLGWDBEVERMDLSTRDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWdbeVerMdlstrData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPDLGWDBEVERMDLSTRDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWdbeVerMdlstrDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGDLGWDBEVERMDLSTRDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWdbeVerMdlstrData");
