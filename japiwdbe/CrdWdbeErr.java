/**
  * \file CrdWdbeErr.java
  * Java API code for job CrdWdbeErr
...
public class CrdWdbeErr {
	/**
		* VecVDo (full: VecVWdbeErrDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeErr)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDERR = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDERR));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdErr;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeErr");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdErr = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdErr", mask, MTXCRDERR);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdErr.equals(comp.MtxCrdErr)) items.add(MTXCRDERR);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDERR));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeErr");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeErr");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeErr");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeErrDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEERRDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeErrDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeErrData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEERRDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeErrData");
