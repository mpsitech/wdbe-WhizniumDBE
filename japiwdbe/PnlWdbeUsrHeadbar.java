/**
  * \file PnlWdbeUsrHeadbar.java
  * Java API code for job PnlWdbeUsrHeadbar
...
public class PnlWdbeUsrHeadbar {
	/**
	  * StgInf (full: StgInfWdbeUsrHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWdbeUsrHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUsrHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUsrHeadbarData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUSRHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUsrHeadbarData");
