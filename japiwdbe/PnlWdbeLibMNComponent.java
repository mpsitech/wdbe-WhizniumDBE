/**
  * \file PnlWdbeLibMNComponent.java
  * Java API code for job PnlWdbeLibMNComponent
...
public class PnlWdbeLibMNComponent {
	/**
		* VecVDo (full: VecVWdbeLibMNComponentDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeLibMNComponent)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeLibMNComponent");
	...
	/**
	  * StatApp (full: StatAppWdbeLibMNComponent)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeLibMNComponent");
	...
	/**
	  * StatShr (full: StatShrWdbeLibMNComponent)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeLibMNComponent");
	...
	/**
	  * StgIac (full: StgIacWdbeLibMNComponent)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeLibMNComponent");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeLibMNComponent";
	...
	/**
	  * Tag (full: TagWdbeLibMNComponent)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeLibMNComponent");
	...
	/**
		* DpchAppData (full: DpchAppWdbeLibMNComponentData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBELIBMNCOMPONENTDATA, scrJref);
		...
		public QryWdbeLibMNComponent.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeLibMNComponentData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeLibMNComponentDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBELIBMNCOMPONENTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeLibMNComponentDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeLibMNComponentData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBELIBMNCOMPONENTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQLibMNComponent();
			statappqry = (new QryWdbeLibMNComponent()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeLibMNComponent()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeLibMNComponent()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQLibMNComponent rst;
		public QryWdbeLibMNComponent.StatApp statappqry;
		public QryWdbeLibMNComponent.StatShr statshrqry;
		public QryWdbeLibMNComponent.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeLibMNComponentData");
