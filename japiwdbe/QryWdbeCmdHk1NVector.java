/**
  * \file QryWdbeCmdHk1NVector.java
  * Java API code for job QryWdbeCmdHk1NVector
...
public class QryWdbeCmdHk1NVector {
	/**
	  * StatApp (full: StatAppQryWdbeCmdHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeCmdHk1NVector");
	...
	/**
	  * StatShr (full: StatShrQryWdbeCmdHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeCmdHk1NVector");
	...
	/**
	  * StgIac (full: StgIacQryWdbeCmdHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeCmdHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeCmdHk1NVector";
