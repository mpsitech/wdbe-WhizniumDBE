/**
  * \file QryWdbeMtpMdl1NPort.java
  * Java API code for job QryWdbeMtpMdl1NPort
...
public class QryWdbeMtpMdl1NPort {
	/**
	  * StatApp (full: StatAppQryWdbeMtpMdl1NPort)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeMtpMdl1NPort");
	...
	/**
	  * StatShr (full: StatShrQryWdbeMtpMdl1NPort)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeMtpMdl1NPort");
	...
	/**
	  * StgIac (full: StgIacQryWdbeMtpMdl1NPort)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeMtpMdl1NPort");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeMtpMdl1NPort";
