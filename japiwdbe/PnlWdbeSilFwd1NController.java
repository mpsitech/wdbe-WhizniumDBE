/**
  * \file PnlWdbeSilFwd1NController.java
  * Java API code for job PnlWdbeSilFwd1NController
...
public class PnlWdbeSilFwd1NController {
	/**
		* VecVDo (full: VecVWdbeSilFwd1NControllerDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeSilFwd1NController)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSilFwd1NController");

			String itemtag = "ContitemInfWdbeSilFwd1NController";
	...
	/**
	  * StatApp (full: StatAppWdbeSilFwd1NController)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeSilFwd1NController");

			String itemtag = "StatitemAppWdbeSilFwd1NController";
	...
	/**
	  * StatShr (full: StatShrWdbeSilFwd1NController)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSilFwd1NController");

			String itemtag = "StatitemShrWdbeSilFwd1NController";
	...
	/**
	  * StgIac (full: StgIacWdbeSilFwd1NController)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSilFwd1NController");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSilFwd1NController";
	...
	/**
	  * Tag (full: TagWdbeSilFwd1NController)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSilFwd1NController");

			String itemtag = "TagitemWdbeSilFwd1NController";
	...
	/**
		* DpchAppData (full: DpchAppWdbeSilFwd1NControllerData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILFWD1NCONTROLLERDATA, scrJref);
		...
		public QryWdbeSilFwd1NController.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilFwd1NControllerData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeSilFwd1NControllerDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESILFWD1NCONTROLLERDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSilFwd1NControllerDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeSilFwd1NControllerData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESILFWD1NCONTROLLERDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQSilFwd1NController();
			statappqry = (new QryWdbeSilFwd1NController()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSilFwd1NController()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSilFwd1NController()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSilFwd1NController rst;
		public QryWdbeSilFwd1NController.StatApp statappqry;
		public QryWdbeSilFwd1NController.StatShr statshrqry;
		public QryWdbeSilFwd1NController.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSilFwd1NControllerData");
