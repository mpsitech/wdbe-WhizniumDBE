/**
  * \file PnlWdbeUsgMNUser.java
  * Java API code for job PnlWdbeUsgMNUser
...
public class PnlWdbeUsgMNUser {
	/**
		* VecVDo (full: VecVWdbeUsgMNUserDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUsgMNUser)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUsgMNUser");
	...
	/**
	  * StatApp (full: StatAppWdbeUsgMNUser)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUsgMNUser");
	...
	/**
	  * StatShr (full: StatShrWdbeUsgMNUser)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUsgMNUser");
	...
	/**
	  * StgIac (full: StgIacWdbeUsgMNUser)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUsgMNUser");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUsgMNUser";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUsgMNUser");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUsgMNUserData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSGMNUSERDATA, scrJref);
		...
		public QryWdbeUsgMNUser.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsgMNUserData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUsgMNUserDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUSGMNUSERDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUsgMNUserDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUsgMNUserData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUSGMNUSERDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQUsgMNUser();
			statappqry = (new QryWdbeUsgMNUser()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUsgMNUser()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUsgMNUser()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUsgMNUser rst;
		public QryWdbeUsgMNUser.StatApp statappqry;
		public QryWdbeUsgMNUser.StatShr statshrqry;
		public QryWdbeUsgMNUser.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUsgMNUserData");
