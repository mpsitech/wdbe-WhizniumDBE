/**
  * \file QryWdbeSil1NTarget.java
  * Java API code for job QryWdbeSil1NTarget
...
public class QryWdbeSil1NTarget {
	/**
	  * StatApp (full: StatAppQryWdbeSil1NTarget)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeSil1NTarget");
	...
	/**
	  * StatShr (full: StatShrQryWdbeSil1NTarget)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeSil1NTarget");
	...
	/**
	  * StgIac (full: StgIacQryWdbeSil1NTarget)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeSil1NTarget");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeSil1NTarget";
