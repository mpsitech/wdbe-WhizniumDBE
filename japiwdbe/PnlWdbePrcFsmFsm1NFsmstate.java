/**
  * \file PnlWdbePrcFsmFsm1NFsmstate.java
  * Java API code for job PnlWdbePrcFsmFsm1NFsmstate
...
public class PnlWdbePrcFsmFsm1NFsmstate {
	/**
		* VecVDo (full: VecVWdbePrcFsmFsm1NFsmstateDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrcFsmFsm1NFsmstate)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrcFsmFsm1NFsmstate");
	...
	/**
	  * StatApp (full: StatAppWdbePrcFsmFsm1NFsmstate)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrcFsmFsm1NFsmstate");
	...
	/**
	  * StatShr (full: StatShrWdbePrcFsmFsm1NFsmstate)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrcFsmFsm1NFsmstate");
	...
	/**
	  * StgIac (full: StgIacWdbePrcFsmFsm1NFsmstate)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrcFsmFsm1NFsmstate");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrcFsmFsm1NFsmstate";
	...
	/**
	  * Tag (full: TagWdbePrcFsmFsm1NFsmstate)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrcFsmFsm1NFsmstate");
	...
	/**
		* DpchAppData (full: DpchAppWdbePrcFsmFsm1NFsmstateData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCFSMFSM1NFSMSTATEDATA, scrJref);
		...
		public QryWdbePrcFsmFsm1NFsmstate.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcFsmFsm1NFsmstateData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrcFsmFsm1NFsmstateDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCFSMFSM1NFSMSTATEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcFsmFsm1NFsmstateDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrcFsmFsm1NFsmstateData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRCFSMFSM1NFSMSTATEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPrcFsmFsm1NFsmstate();
			statappqry = (new QryWdbePrcFsmFsm1NFsmstate()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrcFsmFsm1NFsmstate()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrcFsmFsm1NFsmstate()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrcFsmFsm1NFsmstate rst;
		public QryWdbePrcFsmFsm1NFsmstate.StatApp statappqry;
		public QryWdbePrcFsmFsm1NFsmstate.StatShr statshrqry;
		public QryWdbePrcFsmFsm1NFsmstate.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrcFsmFsm1NFsmstateData");
