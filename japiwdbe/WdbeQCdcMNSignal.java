/**
	* \file WdbeQCdcMNSignal.java
	* Java API code for record of table TblWdbeQCdcMNSignal
...
public class WdbeQCdcMNSignal {
	
	public WdbeQCdcMNSignal(
				int jnum
				, String stubMref
				, String srefIxVDir
				, String titIxVDir
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WdbeQCdcMNSignal");
