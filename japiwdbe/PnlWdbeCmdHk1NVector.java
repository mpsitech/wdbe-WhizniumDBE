/**
  * \file PnlWdbeCmdHk1NVector.java
  * Java API code for job PnlWdbeCmdHk1NVector
...
public class PnlWdbeCmdHk1NVector {
	/**
		* VecVDo (full: VecVWdbeCmdHk1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCmdHk1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCmdHk1NVector");
	...
	/**
	  * StatApp (full: StatAppWdbeCmdHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCmdHk1NVector");
	...
	/**
	  * StatShr (full: StatShrWdbeCmdHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCmdHk1NVector");
	...
	/**
	  * StgIac (full: StgIacWdbeCmdHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCmdHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCmdHk1NVector";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCmdHk1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWdbeCmdHk1NVectorData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMDHK1NVECTORDATA, scrJref);
		...
		public QryWdbeCmdHk1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmdHk1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCmdHk1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMDHK1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmdHk1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCmdHk1NVectorData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECMDHK1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQCmdHk1NVector();
			statappqry = (new QryWdbeCmdHk1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCmdHk1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCmdHk1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCmdHk1NVector rst;
		public QryWdbeCmdHk1NVector.StatApp statappqry;
		public QryWdbeCmdHk1NVector.StatShr statshrqry;
		public QryWdbeCmdHk1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCmdHk1NVectorData");
