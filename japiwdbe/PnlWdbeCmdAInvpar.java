/**
  * \file PnlWdbeCmdAInvpar.java
  * Java API code for job PnlWdbeCmdAInvpar
...
public class PnlWdbeCmdAInvpar {
	/**
		* VecVDo (full: VecVWdbeCmdAInvparDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCmdAInvpar)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCmdAInvpar");
	...
	/**
	  * StatApp (full: StatAppWdbeCmdAInvpar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCmdAInvpar");
	...
	/**
	  * StatShr (full: StatShrWdbeCmdAInvpar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCmdAInvpar");
	...
	/**
	  * StgIac (full: StgIacWdbeCmdAInvpar)
	  */
	public class StgIac extends Block {
		...
		public static final int TCODFVWIDTH = 5;
		public static final int TCOVITWIDTH = 6;
		public static final int TCOCMTWIDTH = 7;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOPTYWIDTH, TCOVECWIDTH, TCOLENWIDTH, TCODFVWIDTH, TCOVITWIDTH, TCOCMTWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCmdAInvpar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCmdAInvpar";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOPTYWIDTH, TCOVECWIDTH, TCOLENWIDTH, TCODFVWIDTH, TCOVITWIDTH, TCOCMTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCODFV = 11;
		public static final int TCOVIT = 12;
		public static final int TCOCMT = 13;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOPTY, TCOVEC, TCOLEN, TCODFV, TCOVIT, TCOCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCmdAInvpar");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOPTY, TCOVEC, TCOLEN, TCODFV, TCOVIT, TCOCMT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWdbeCmdAInvparData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMDAINVPARDATA, scrJref);
		...
		public QryWdbeCmdAInvpar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmdAInvparData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCmdAInvparDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECMDAINVPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCmdAInvparDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCmdAInvparData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECMDAINVPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQCmdAInvpar();
			statappqry = (new QryWdbeCmdAInvpar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCmdAInvpar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCmdAInvpar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCmdAInvpar rst;
		public QryWdbeCmdAInvpar.StatApp statappqry;
		public QryWdbeCmdAInvpar.StatShr statshrqry;
		public QryWdbeCmdAInvpar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCmdAInvparData");
