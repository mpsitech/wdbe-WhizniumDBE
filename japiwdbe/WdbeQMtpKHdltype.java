/**
  ...
  * Java API code for record of table TblWdbeQMtpKHdltype
...
public class WdbeQMtpKHdltype {
	
	public WdbeQMtpKHdltype(
				int jnum
				, String yesnoFixed
				, String sref
				, String Avail
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WdbeQMtpKHdltype");
