/**
  * \file QryWdbeModMge1NSignal.java
  * Java API code for job QryWdbeModMge1NSignal
...
public class QryWdbeModMge1NSignal {
	/**
	  * StatApp (full: StatAppQryWdbeModMge1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeModMge1NSignal");
	...
	/**
	  * StatShr (full: StatShrQryWdbeModMge1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeModMge1NSignal");
	...
	/**
	  * StgIac (full: StgIacQryWdbeModMge1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeModMge1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeModMge1NSignal";
