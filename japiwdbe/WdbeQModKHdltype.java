/**
  ...
  * Java API code for record of table TblWdbeQModKHdltype
...
public class WdbeQModKHdltype {
	
	public WdbeQModKHdltype(
				int jnum
				, String yesnoFixed
				, String sref
				, String Avail
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WdbeQModKHdltype");
