/**
  * \file PnlWdbeMod1NProcess.java
  * Java API code for job PnlWdbeMod1NProcess
...
public class PnlWdbeMod1NProcess {
	/**
		* VecVDo (full: VecVWdbeMod1NProcessDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeMod1NProcess)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeMod1NProcess");
	...
	/**
	  * StatApp (full: StatAppWdbeMod1NProcess)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeMod1NProcess");
	...
	/**
	  * StatShr (full: StatShrWdbeMod1NProcess)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeMod1NProcess");
	...
	/**
	  * StgIac (full: StgIacWdbeMod1NProcess)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeMod1NProcess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeMod1NProcess";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeMod1NProcess");
	...
	/**
		* DpchAppData (full: DpchAppWdbeMod1NProcessData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMOD1NPROCESSDATA, scrJref);
		...
		public QryWdbeMod1NProcess.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMod1NProcessData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeMod1NProcessDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMOD1NPROCESSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeMod1NProcessDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeMod1NProcessData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMOD1NPROCESSDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQMod1NProcess();
			statappqry = (new QryWdbeMod1NProcess()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeMod1NProcess()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeMod1NProcess()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQMod1NProcess rst;
		public QryWdbeMod1NProcess.StatApp statappqry;
		public QryWdbeMod1NProcess.StatShr statshrqry;
		public QryWdbeMod1NProcess.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeMod1NProcessData");
