/**
  * \file PnlWdbeUntRef1NCommand.java
  * Java API code for job PnlWdbeUntRef1NCommand
...
public class PnlWdbeUntRef1NCommand {
	/**
		* VecVDo (full: VecVWdbeUntRef1NCommandDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeUntRef1NCommand)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeUntRef1NCommand");
	...
	/**
	  * StatApp (full: StatAppWdbeUntRef1NCommand)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeUntRef1NCommand");
	...
	/**
	  * StatShr (full: StatShrWdbeUntRef1NCommand)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeUntRef1NCommand");
	...
	/**
	  * StgIac (full: StgIacWdbeUntRef1NCommand)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeUntRef1NCommand");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeUntRef1NCommand";
	...
	/**
	  * Tag (full: TagWdbeUntRef1NCommand)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeUntRef1NCommand");
	...
	/**
		* DpchAppData (full: DpchAppWdbeUntRef1NCommandData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTREF1NCOMMANDDATA, scrJref);
		...
		public QryWdbeUntRef1NCommand.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntRef1NCommandData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUntRef1NCommandDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEUNTREF1NCOMMANDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeUntRef1NCommandDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeUntRef1NCommandData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEUNTREF1NCOMMANDDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQUntRef1NCommand();
			statappqry = (new QryWdbeUntRef1NCommand()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeUntRef1NCommand()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeUntRef1NCommand()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQUntRef1NCommand rst;
		public QryWdbeUntRef1NCommand.StatApp statappqry;
		public QryWdbeUntRef1NCommand.StatShr statshrqry;
		public QryWdbeUntRef1NCommand.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeUntRef1NCommandData");
