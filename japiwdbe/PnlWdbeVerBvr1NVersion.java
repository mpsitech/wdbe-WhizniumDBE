/**
  * \file PnlWdbeVerBvr1NVersion.java
  * Java API code for job PnlWdbeVerBvr1NVersion
...
public class PnlWdbeVerBvr1NVersion {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVerBvr1NVersion");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVerBvr1NVersion");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVerBvr1NVersion");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVerBvr1NVersion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVerBvr1NVersion";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVerBvr1NVersion");
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVERBVR1NVERSIONDATA, scrJref);
		...
		public QryWdbeVerBvr1NVersion.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVerBvr1NVersionData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVERBVR1NVERSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVerBvr1NVersionDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVERBVR1NVERSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVerBvr1NVersion();
			statappqry = (new QryWdbeVerBvr1NVersion()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVerBvr1NVersion()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVerBvr1NVersion()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVerBvr1NVersion rst;
		public QryWdbeVerBvr1NVersion.StatApp statappqry;
		public QryWdbeVerBvr1NVersion.StatShr statshrqry;
		public QryWdbeVerBvr1NVersion.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVerBvr1NVersionData");
