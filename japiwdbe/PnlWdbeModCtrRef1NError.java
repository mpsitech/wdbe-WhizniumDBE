/**
  * \file PnlWdbeModCtrRef1NError.java
  * Java API code for job PnlWdbeModCtrRef1NError
...
public class PnlWdbeModCtrRef1NError {
	/**
		* VecVDo (full: VecVWdbeModCtrRef1NErrorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModCtrRef1NError)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModCtrRef1NError");
	...
	/**
	  * StatApp (full: StatAppWdbeModCtrRef1NError)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModCtrRef1NError");
	...
	/**
	  * StatShr (full: StatShrWdbeModCtrRef1NError)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModCtrRef1NError");
	...
	/**
	  * StgIac (full: StgIacWdbeModCtrRef1NError)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModCtrRef1NError");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModCtrRef1NError";
	...
	/**
	  * Tag (full: TagWdbeModCtrRef1NError)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModCtrRef1NError");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModCtrRef1NErrorData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTRREF1NERRORDATA, scrJref);
		...
		public QryWdbeModCtrRef1NError.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtrRef1NErrorData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModCtrRef1NErrorDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTRREF1NERRORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtrRef1NErrorDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModCtrRef1NErrorData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODCTRREF1NERRORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQModCtrRef1NError();
			statappqry = (new QryWdbeModCtrRef1NError()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModCtrRef1NError()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModCtrRef1NError()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModCtrRef1NError rst;
		public QryWdbeModCtrRef1NError.StatApp statappqry;
		public QryWdbeModCtrRef1NError.StatShr statshrqry;
		public QryWdbeModCtrRef1NError.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModCtrRef1NErrorData");
