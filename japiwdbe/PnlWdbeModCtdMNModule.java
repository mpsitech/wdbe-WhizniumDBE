/**
  * \file PnlWdbeModCtdMNModule.java
  * Java API code for job PnlWdbeModCtdMNModule
...
public class PnlWdbeModCtdMNModule {
	/**
		* VecVDo (full: VecVWdbeModCtdMNModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeModCtdMNModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeModCtdMNModule");
	...
	/**
	  * StatApp (full: StatAppWdbeModCtdMNModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeModCtdMNModule");
	...
	/**
	  * StatShr (full: StatShrWdbeModCtdMNModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeModCtdMNModule");
	...
	/**
	  * StgIac (full: StgIacWdbeModCtdMNModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeModCtdMNModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeModCtdMNModule";
	...
	/**
	  * Tag (full: TagWdbeModCtdMNModule)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeModCtdMNModule");
	...
	/**
		* DpchAppData (full: DpchAppWdbeModCtdMNModuleData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTDMNMODULEDATA, scrJref);
		...
		public QryWdbeModCtdMNModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtdMNModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeModCtdMNModuleDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEMODCTDMNMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeModCtdMNModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeModCtdMNModuleData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEMODCTDMNMODULEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWdbeQModCtdMNModule();
			statappqry = (new QryWdbeModCtdMNModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeModCtdMNModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeModCtdMNModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQModCtdMNModule rst;
		public QryWdbeModCtdMNModule.StatApp statappqry;
		public QryWdbeModCtdMNModule.StatShr statshrqry;
		public QryWdbeModCtdMNModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeModCtdMNModuleData");
