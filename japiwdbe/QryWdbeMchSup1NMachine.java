/**
  * \file QryWdbeMchSup1NMachine.java
  * Java API code for job QryWdbeMchSup1NMachine
...
public class QryWdbeMchSup1NMachine {
	/**
	  * StatApp (full: StatAppQryWdbeMchSup1NMachine)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeMchSup1NMachine");
	...
	/**
	  * StatShr (full: StatShrQryWdbeMchSup1NMachine)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeMchSup1NMachine");
	...
	/**
	  * StgIac (full: StgIacQryWdbeMchSup1NMachine)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeMchSup1NMachine");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeMchSup1NMachine";
