/**
  * \file QryWdbePrcFsmFsm1NFsmstate.java
  * Java API code for job QryWdbePrcFsmFsm1NFsmstate
...
public class QryWdbePrcFsmFsm1NFsmstate {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbePrcFsmFsm1NFsmstate");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbePrcFsmFsm1NFsmstate");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbePrcFsmFsm1NFsmstate");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbePrcFsmFsm1NFsmstate";
