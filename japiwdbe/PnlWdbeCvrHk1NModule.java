/**
  * \file PnlWdbeCvrHk1NModule.java
  * Java API code for job PnlWdbeCvrHk1NModule
...
public class PnlWdbeCvrHk1NModule {
	/**
		* VecVDo (full: VecVWdbeCvrHk1NModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeCvrHk1NModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeCvrHk1NModule");
	...
	/**
	  * StatApp (full: StatAppWdbeCvrHk1NModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeCvrHk1NModule");
	...
	/**
	  * StatShr (full: StatShrWdbeCvrHk1NModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeCvrHk1NModule");
	...
	/**
	  * StgIac (full: StgIacWdbeCvrHk1NModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeCvrHk1NModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeCvrHk1NModule";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeCvrHk1NModule");
	...
	/**
		* DpchAppData (full: DpchAppWdbeCvrHk1NModuleData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRHK1NMODULEDATA, scrJref);
		...
		public QryWdbeCvrHk1NModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrHk1NModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeCvrHk1NModuleDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBECVRHK1NMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeCvrHk1NModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeCvrHk1NModuleData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBECVRHK1NMODULEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQCvrHk1NModule();
			statappqry = (new QryWdbeCvrHk1NModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeCvrHk1NModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeCvrHk1NModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQCvrHk1NModule rst;
		public QryWdbeCvrHk1NModule.StatApp statappqry;
		public QryWdbeCvrHk1NModule.StatShr statshrqry;
		public QryWdbeCvrHk1NModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeCvrHk1NModuleData");
