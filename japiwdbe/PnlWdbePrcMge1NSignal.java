/**
  * \file PnlWdbePrcMge1NSignal.java
  * Java API code for job PnlWdbePrcMge1NSignal
...
public class PnlWdbePrcMge1NSignal {
	/**
		* VecVDo (full: VecVWdbePrcMge1NSignalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbePrcMge1NSignal)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbePrcMge1NSignal");

			String itemtag = "ContitemInfWdbePrcMge1NSignal";
	...
	/**
	  * StatApp (full: StatAppWdbePrcMge1NSignal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbePrcMge1NSignal");

			String itemtag = "StatitemAppWdbePrcMge1NSignal";
	...
	/**
	  * StatShr (full: StatShrWdbePrcMge1NSignal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbePrcMge1NSignal");

			String itemtag = "StatitemShrWdbePrcMge1NSignal";
	...
	/**
	  * StgIac (full: StgIacWdbePrcMge1NSignal)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbePrcMge1NSignal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbePrcMge1NSignal";
	...
	/**
	  * Tag (full: TagWdbePrcMge1NSignal)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbePrcMge1NSignal");

			String itemtag = "TagitemWdbePrcMge1NSignal";
	...
	/**
		* DpchAppData (full: DpchAppWdbePrcMge1NSignalData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCMGE1NSIGNALDATA, scrJref);
		...
		public QryWdbePrcMge1NSignal.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcMge1NSignalData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbePrcMge1NSignalDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEPRCMGE1NSIGNALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbePrcMge1NSignalDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbePrcMge1NSignalData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEPRCMGE1NSIGNALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQPrcMge1NSignal();
			statappqry = (new QryWdbePrcMge1NSignal()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbePrcMge1NSignal()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbePrcMge1NSignal()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQPrcMge1NSignal rst;
		public QryWdbePrcMge1NSignal.StatApp statappqry;
		public QryWdbePrcMge1NSignal.StatShr statshrqry;
		public QryWdbePrcMge1NSignal.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbePrcMge1NSignalData");
