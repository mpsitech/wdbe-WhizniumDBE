/**
  * \file QryWdbeSilRef1NCommand.java
  * Java API code for job QryWdbeSilRef1NCommand
...
public class QryWdbeSilRef1NCommand {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWdbeSilRef1NCommand");

			String itemtag = "StatitemAppQryWdbeSilRef1NCommand";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWdbeSilRef1NCommand");

			String itemtag = "StatitemShrQryWdbeSilRef1NCommand";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWdbeSilRef1NCommand");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWdbeSilRef1NCommand";
