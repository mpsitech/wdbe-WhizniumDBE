/**
  * \file PnlWdbeSegList.java
  * Java API code for job PnlWdbeSegList
...
public class PnlWdbeSegList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWdbeSegList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWdbeSegList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeSegList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeSegList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOPPLWIDTH = 2;
		public static final int TCOSUPWIDTH = 3;
		public static final int TCOIFMWIDTH = 4;
		public static final int TCOOFMWIDTH = 5;
		public static final int TCOLCYWIDTH = 6;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOPPLWIDTH, TCOSUPWIDTH, TCOIFMWIDTH, TCOOFMWIDTH, TCOLCYWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoPplWidth;
		public int TcoSupWidth;
		public int TcoIfmWidth;
		public int TcoOfmWidth;
		public int TcoLcyWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeSegList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoPplWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoPplWidth", mask, TCOPPLWIDTH);
				TcoSupWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoSupWidth", mask, TCOSUPWIDTH);
				TcoIfmWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoIfmWidth", mask, TCOIFMWIDTH);
				TcoOfmWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoOfmWidth", mask, TCOOFMWIDTH);
				TcoLcyWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoLcyWidth", mask, TCOLCYWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeSegList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoPplWidth", TcoPplWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoSupWidth", TcoSupWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoIfmWidth", TcoIfmWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoOfmWidth", TcoOfmWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoLcyWidth", TcoLcyWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoPplWidth == comp.TcoPplWidth) items.add(TCOPPLWIDTH);
			if (TcoSupWidth == comp.TcoSupWidth) items.add(TCOSUPWIDTH);
			if (TcoIfmWidth == comp.TcoIfmWidth) items.add(TCOIFMWIDTH);
			if (TcoOfmWidth == comp.TcoOfmWidth) items.add(TCOOFMWIDTH);
			if (TcoLcyWidth == comp.TcoLcyWidth) items.add(TCOLCYWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOPPLWIDTH, TCOSUPWIDTH, TCOIFMWIDTH, TCOOFMWIDTH, TCOLCYWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOPPL = 9;
		public static final int TCOSUP = 10;
		public static final int TCOIFM = 11;
		public static final int TCOOFM = 12;
		public static final int TCOLCY = 13;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOPPL, TCOSUP, TCOIFM, TCOOFM, TCOLCY));
		};
		...
		public String TcoPpl;
		public String TcoSup;
		public String TcoIfm;
		public String TcoOfm;
		public String TcoLcy;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeSegList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoPpl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoPpl", mask, TCOPPL);
				TcoSup = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSup", mask, TCOSUP);
				TcoIfm = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoIfm", mask, TCOIFM);
				TcoOfm = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoOfm", mask, TCOOFM);
				TcoLcy = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoLcy", mask, TCOLCY);
		...
		public HashSet<Integer> comm(
			...
			if (TcoPpl.equals(comp.TcoPpl)) items.add(TCOPPL);
			if (TcoSup.equals(comp.TcoSup)) items.add(TCOSUP);
			if (TcoIfm.equals(comp.TcoIfm)) items.add(TCOIFM);
			if (TcoOfm.equals(comp.TcoOfm)) items.add(TCOOFM);
			if (TcoLcy.equals(comp.TcoLcy)) items.add(TCOLCY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOPPL, TCOSUP, TCOIFM, TCOOFM, TCOLCY));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESEGLISTDATA, scrJref);
		...
		public QryWdbeSegList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSegListData");
	...
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBESEGLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeSegListDo");
	...
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBESEGLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWdbeQSegList();
			statappqry = (new QryWdbeSegList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeSegList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeSegList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQSegList rst;
		public QryWdbeSegList.StatApp statappqry;
		public QryWdbeSegList.StatShr statshrqry;
		public QryWdbeSegList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeSegListData");
