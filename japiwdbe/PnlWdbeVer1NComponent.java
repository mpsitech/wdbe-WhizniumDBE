/**
  * \file PnlWdbeVer1NComponent.java
  * Java API code for job PnlWdbeVer1NComponent
...
public class PnlWdbeVer1NComponent {
	/**
		* VecVDo (full: VecVWdbeVer1NComponentDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWdbeVer1NComponent)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWdbeVer1NComponent");
	...
	/**
	  * StatApp (full: StatAppWdbeVer1NComponent)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWdbeVer1NComponent");
	...
	/**
	  * StatShr (full: StatShrWdbeVer1NComponent)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWdbeVer1NComponent");
	...
	/**
	  * StgIac (full: StgIacWdbeVer1NComponent)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWdbeVer1NComponent");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWdbeVer1NComponent";
	...
	/**
	  * Tag (full: TagWdbeVer1NComponent)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWdbeVer1NComponent");
	...
	/**
		* DpchAppData (full: DpchAppWdbeVer1NComponentData)
		*/
	public class DpchAppData extends DpchAppWdbe {
		...
		public DpchAppData(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NCOMPONENTDATA, scrJref);
		...
		public QryWdbeVer1NComponent.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NComponentData");
	...
	/**
		* DpchAppDo (full: DpchAppWdbeVer1NComponentDo)
		*/
	public class DpchAppDo extends DpchAppWdbe {
		...
		public DpchAppDo(
			...
			super(VecWdbeVDpch.DPCHAPPWDBEVER1NCOMPONENTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWdbeVer1NComponentDo");
	...
	/**
		* DpchEngData (full: DpchEngWdbeVer1NComponentData)
		*/
	public class DpchEngData extends DpchEngWdbe {
		...
		public DpchEngData() {
			super(VecWdbeVDpch.DPCHENGWDBEVER1NCOMPONENTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWdbeQVer1NComponent();
			statappqry = (new QryWdbeVer1NComponent()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWdbeVer1NComponent()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWdbeVer1NComponent()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWdbeQVer1NComponent rst;
		public QryWdbeVer1NComponent.StatApp statappqry;
		public QryWdbeVer1NComponent.StatShr statshrqry;
		public QryWdbeVer1NComponent.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWdbeVer1NComponentData");
