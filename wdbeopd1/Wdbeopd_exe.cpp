/**
	...
	* Wdbe operation daemon wdbeopd1 main (implementation)
...
Wdbeopd::Wdbeopd(
	...
	Xmlio::startwriteBuffer(&wr, &xbuf);
		DpchWdbeopdReg::writeXML(wr, xchg->stgwdbeopd.engsrvportbase + xchg->stgwdbeopd.engsrvportofs, VecWdbeVOpengtype::WDBEOPD1, xchg->stgwdbeopd.opprcn);
