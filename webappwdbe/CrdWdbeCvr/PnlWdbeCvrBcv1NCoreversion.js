...
function minimize(updh) {
	...
	setSi(srcdoc, "StatAppWdbeCvrBcv1NCoreversion", "srefIxWdbeVExpstate", "mind");

	getRecwnd().changeHeight("Bcv1NCoreversion", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Bcv1NCoreversion_side").setAttribute("height", "30");
	doc.getElementById("Bcv1NCoreversion_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Bcv1NCoreversion_side").src = "./PnlWdbeCvrBcv1NCoreversion_aside.html";
	doc.getElementById("Bcv1NCoreversion_cont").src = "./PnlWdbeCvrBcv1NCoreversion_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeCvrBcv1NCoreversion", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeCvrBcv1NCoreversion", "srefIxWdbeVExpstate", "regd");

	getRecwnd().changeHeight("Bcv1NCoreversion", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Bcv1NCoreversion_side").setAttribute("height", "255");
	doc.getElementById("Bcv1NCoreversion_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Bcv1NCoreversion_side").src = "./PnlWdbeCvrBcv1NCoreversion_bside.html";
	doc.getElementById("Bcv1NCoreversion_cont").src = "./PnlWdbeCvrBcv1NCoreversion_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Bcv1NCoreversion_side").contentDocument;
	contdoc = doc.getElementById("Bcv1NCoreversion_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("Bcv1NCoreversion_side").contentDocument;
	contdoc = doc.getElementById("Bcv1NCoreversion_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Bcv1NCoreversion_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Bcv1NCoreversion_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Bcv1NCoreversion_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeCvrBcv1NCoreversion", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeCvrBcv1NCoreversion", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeCvrBcv1NCoreversion", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeCvrBcv1NCoreversion", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeCvrBcv1NCoreversion", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeCvrBcv1NCoreversion", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeCvrBcv1NCoreversion", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQCvrBcv1NCoreversion
		rownode = getRownode(srcdoc, "ListWdbeQCvrBcv1NCoreversion", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeCvrBcv1NCoreversion", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Bcv1NCoreversion", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Bcv1NCoreversion_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Bcv1NCoreversion_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Bcv1NCoreversion_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Bcv1NCoreversion_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeCvrBcv1NCoreversion", "ListWdbeQCvrBcv1NCoreversion", retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeCvrBcv1NCoreversion", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeCvrBcv1NCoreversion", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeCvrBcv1NCoreversion", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeCvrBcv1NCoreversion", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeCvrBcv1NCoreversion", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeCvrBcv1NCoreversionData", scrJref, "StgIacQryWdbeCvrBcv1NCoreversion");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeCvrBcv1NCoreversion", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeCvrBcv1NCoreversion", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeCvrBcv1NCoreversion", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeCvrBcv1NCoreversion", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeCvrBcv1NCoreversionDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "ContInfWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "StatAppWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "StatShrWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "StgIacWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "TagWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "ListWdbeQCvrBcv1NCoreversion", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "StatAppQryWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "StatShrQryWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeCvrBcv1NCoreversionData", "StgIacQryWdbeCvrBcv1NCoreversion", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeCvrBcv1NCoreversionData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeCvrBcv1NCoreversionData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Bcv1NCoreversion");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeCvrBcv1NCoreversionData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
