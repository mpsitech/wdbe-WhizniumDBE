/**
  * \file PnlWdbeSilFwd1NController.js
  * web client functionality for panel PnlWdbeSilFwd1NController
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeSilFwd1NController", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeSilFwd1NController", "srefIxWdbeVExpstate", "mind");
	...
	// change content
	doc.getElementById("Fwd1NController_side").src = "./PnlWdbeSilFwd1NController_aside.html";
	doc.getElementById("Fwd1NController_cont").src = "./PnlWdbeSilFwd1NController_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeSilFwd1NController", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeSilFwd1NController", "srefIxWdbeVExpstate", "regd");
	...
	// change content
	doc.getElementById("Fwd1NController_side").src = "./PnlWdbeSilFwd1NController_bside.html";
	doc.getElementById("Fwd1NController_cont").src = "./PnlWdbeSilFwd1NController_b.html";
};
...
function initBD(bNotD) {
	...
	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeSilFwd1NController", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeSilFwd1NController", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeSilFwd1NController", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeSilFwd1NController", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeSilFwd1NController", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSilFwd1NController", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilFwd1NController", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilFwd1NController", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilFwd1NController", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeSilFwd1NController", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeSilFwd1NController", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQSilFwd1NController
		rownode = getRownode(srcdoc, "ListWdbeQSilFwd1NController", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeSilFwd1NController", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeSilFwd1NController", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeSilFwd1NController", "numFCsiQst"));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeSilFwd1NController", "ListWdbeQSilFwd1NController", retrieveTi(srcdoc, "TagWdbeSilFwd1NController", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeSilFwd1NController", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSilFwd1NController", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilFwd1NController", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeSilFwd1NController", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeSilFwd1NController", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeSilFwd1NControllerData", scrJref, "StgIacQryWdbeSilFwd1NController");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeSilFwd1NController", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeSilFwd1NController", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeSilFwd1NController", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSilFwd1NController", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeSilFwd1NControllerDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "ContInfWdbeSilFwd1NController", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "StatAppWdbeSilFwd1NController", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "StatShrWdbeSilFwd1NController", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "StgIacWdbeSilFwd1NController", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "TagWdbeSilFwd1NController", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "ListWdbeQSilFwd1NController", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "StatAppQryWdbeSilFwd1NController", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "StatShrQryWdbeSilFwd1NController", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeSilFwd1NControllerData", "StgIacQryWdbeSilFwd1NController", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeSilFwd1NControllerData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeSilFwd1NControllerData") {
				mergeDpchEngData(dom);
				init();
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeSilFwd1NControllerData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
