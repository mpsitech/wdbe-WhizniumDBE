/**
  * \file PnlWdbeSilSil1NUnit.js
  * web client functionality for panel PnlWdbeSilSil1NUnit
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeSilSil1NUnit", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeSilSil1NUnit", "srefIxWdbeVExpstate", "mind");
	...
	// change content
	doc.getElementById("Sil1NUnit_side").src = "./PnlWdbeSilSil1NUnit_aside.html";
	doc.getElementById("Sil1NUnit_cont").src = "./PnlWdbeSilSil1NUnit_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeSilSil1NUnit", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeSilSil1NUnit", "srefIxWdbeVExpstate", "regd");
	...
	// change content
	doc.getElementById("Sil1NUnit_side").src = "./PnlWdbeSilSil1NUnit_bside.html";
	doc.getElementById("Sil1NUnit_cont").src = "./PnlWdbeSilSil1NUnit_b.html";
};
...
function initBD(bNotD) {
	...
	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeSilSil1NUnit", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeSilSil1NUnit", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSilSil1NUnit", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilSil1NUnit", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilSil1NUnit", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilSil1NUnit", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeSilSil1NUnit", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQSilSil1NUnit
		rownode = getRownode(srcdoc, "ListWdbeQSilSil1NUnit", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeSilSil1NUnit", "numFCsiQst"));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeSilSil1NUnit", "ListWdbeQSilSil1NUnit", retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeSilSil1NUnit", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSilSil1NUnit", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSilSil1NUnit", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeSilSil1NUnit", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeSilSil1NUnit", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeSilSil1NUnitData", scrJref, "StgIacQryWdbeSilSil1NUnit");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeSilSil1NUnit", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeSilSil1NUnit", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeSilSil1NUnit", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSilSil1NUnit", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeSilSil1NUnitDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "ContInfWdbeSilSil1NUnit", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "StatAppWdbeSilSil1NUnit", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "StgIacWdbeSilSil1NUnit", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "TagWdbeSilSil1NUnit", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "ListWdbeQSilSil1NUnit", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "StatAppQryWdbeSilSil1NUnit", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "StatShrQryWdbeSilSil1NUnit", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeSilSil1NUnitData", "StgIacQryWdbeSilSil1NUnit", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeSilSil1NUnitData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeSilSil1NUnitData") {
				mergeDpchEngData(dom);
				init();
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeSilSil1NUnitData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
