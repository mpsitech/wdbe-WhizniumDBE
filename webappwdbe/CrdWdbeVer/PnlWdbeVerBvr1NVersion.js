/**
  * \file PnlWdbeVerBvr1NVersion.js
  * web client functionality for panel PnlWdbeVerBvr1NVersion
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeVerBvr1NVersion", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeVerBvr1NVersion", "srefIxWdbeVExpstate", "mind");

	getRecwnd().changeHeight("Bvr1NVersion", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Bvr1NVersion_side").setAttribute("height", "30");
	doc.getElementById("Bvr1NVersion_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Bvr1NVersion_side").src = "./PnlWdbeVerBvr1NVersion_aside.html";
	doc.getElementById("Bvr1NVersion_cont").src = "./PnlWdbeVerBvr1NVersion_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeVerBvr1NVersion", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeVerBvr1NVersion", "srefIxWdbeVExpstate", "regd");

	getRecwnd().changeHeight("Bvr1NVersion", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Bvr1NVersion_side").setAttribute("height", "255");
	doc.getElementById("Bvr1NVersion_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Bvr1NVersion_side").src = "./PnlWdbeVerBvr1NVersion_bside.html";
	doc.getElementById("Bvr1NVersion_cont").src = "./PnlWdbeVerBvr1NVersion_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Bvr1NVersion_side").contentDocument;
	contdoc = doc.getElementById("Bvr1NVersion_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("Bvr1NVersion_side").contentDocument;
	contdoc = doc.getElementById("Bvr1NVersion_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Bvr1NVersion_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Bvr1NVersion_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Bvr1NVersion_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeVerBvr1NVersion", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeVerBvr1NVersion", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeVerBvr1NVersion", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVerBvr1NVersion", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVerBvr1NVersion", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVerBvr1NVersion", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeVerBvr1NVersion", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQVerBvr1NVersion
		rownode = getRownode(srcdoc, "ListWdbeQVerBvr1NVersion", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeVerBvr1NVersion", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Bvr1NVersion", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Bvr1NVersion_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Bvr1NVersion_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Bvr1NVersion_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Bvr1NVersion_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeVerBvr1NVersion", "ListWdbeQVerBvr1NVersion", retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeVerBvr1NVersion", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeVerBvr1NVersion", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVerBvr1NVersion", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeVerBvr1NVersion", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeVerBvr1NVersion", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeVerBvr1NVersionData", scrJref, "StgIacQryWdbeVerBvr1NVersion");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeVerBvr1NVersion", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeVerBvr1NVersion", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeVerBvr1NVersion", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeVerBvr1NVersion", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeVerBvr1NVersionDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "ContInfWdbeVerBvr1NVersion", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "StatAppWdbeVerBvr1NVersion", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "StatShrWdbeVerBvr1NVersion", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "StgIacWdbeVerBvr1NVersion", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "TagWdbeVerBvr1NVersion", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "ListWdbeQVerBvr1NVersion", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "StatAppQryWdbeVerBvr1NVersion", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "StatShrQryWdbeVerBvr1NVersion", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeVerBvr1NVersionData", "StgIacQryWdbeVerBvr1NVersion", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeVerBvr1NVersionData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeVerBvr1NVersionData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Bvr1NVersion");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeVerBvr1NVersionData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
