...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeVer1NComponent", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeVer1NComponent", "srefIxWdbeVExpstate", "mind");

	getRecwnd().changeHeight("1NComponent", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("1NComponent_side").setAttribute("height", "30");
	doc.getElementById("1NComponent_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("1NComponent_side").src = "./PnlWdbeVer1NComponent_aside.html";
	doc.getElementById("1NComponent_cont").src = "./PnlWdbeVer1NComponent_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeVer1NComponent", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeVer1NComponent", "srefIxWdbeVExpstate", "regd");

	getRecwnd().changeHeight("1NComponent", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("1NComponent_side").setAttribute("height", "255");
	doc.getElementById("1NComponent_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("1NComponent_side").src = "./PnlWdbeVer1NComponent_bside.html";
	doc.getElementById("1NComponent_cont").src = "./PnlWdbeVer1NComponent_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("1NComponent_side").contentDocument;
	contdoc = doc.getElementById("1NComponent_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("1NComponent_side").contentDocument;
	contdoc = doc.getElementById("1NComponent_cont").contentDocument;
	hdrdoc = contdoc.getElementById("1NComponent_hdr").contentDocument;
	tbldoc = contdoc.getElementById("1NComponent_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("1NComponent_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeVer1NComponent", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeVer1NComponent", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeVer1NComponent", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeVer1NComponent", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeVer1NComponent", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeVer1NComponent", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVer1NComponent", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVer1NComponent", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVer1NComponent", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVer1NComponent", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVer1NComponent", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVer1NComponent", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVer1NComponent", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeVer1NComponent", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeVer1NComponent", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeVer1NComponent", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQVer1NComponent
		rownode = getRownode(srcdoc, "ListWdbeQVer1NComponent", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeVer1NComponent", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeVer1NComponent", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeVer1NComponent", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("1NComponent", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("1NComponent_side").setAttribute("height", "" + (height+55));
	doc.getElementById("1NComponent_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("1NComponent_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("1NComponent_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeVer1NComponent", "ListWdbeQVer1NComponent", retrieveTi(srcdoc, "TagWdbeVer1NComponent", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeVer1NComponent", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeVer1NComponent", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVer1NComponent", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeVer1NComponent", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeVer1NComponent", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeVer1NComponent", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeVer1NComponentData", scrJref, "StgIacQryWdbeVer1NComponent");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeVer1NComponent", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeVer1NComponent", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeVer1NComponent", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeVer1NComponent", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeVer1NComponent", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeVer1NComponentDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "ContInfWdbeVer1NComponent", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "StatAppWdbeVer1NComponent", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "StatShrWdbeVer1NComponent", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "StgIacWdbeVer1NComponent", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "TagWdbeVer1NComponent", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "ListWdbeQVer1NComponent", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "StatAppQryWdbeVer1NComponent", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "StatShrQryWdbeVer1NComponent", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeVer1NComponentData", "StgIacQryWdbeVer1NComponent", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeVer1NComponentData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeVer1NComponentData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("1NComponent");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeVer1NComponentData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
