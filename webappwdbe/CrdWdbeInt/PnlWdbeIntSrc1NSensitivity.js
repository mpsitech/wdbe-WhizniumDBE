...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeIntSrc1NSensitivity", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeIntSrc1NSensitivity", "srefIxWdbeVExpstate", "mind");
	...
	// change content
	doc.getElementById("Src1NSensitivity_side").src = "./PnlWdbeIntSrc1NSensitivity_aside.html";
	doc.getElementById("Src1NSensitivity_cont").src = "./PnlWdbeIntSrc1NSensitivity_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeIntSrc1NSensitivity", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeIntSrc1NSensitivity", "srefIxWdbeVExpstate", "regd");
	...
	// change content
	doc.getElementById("Src1NSensitivity_side").src = "./PnlWdbeIntSrc1NSensitivity_bside.html";
	doc.getElementById("Src1NSensitivity_cont").src = "./PnlWdbeIntSrc1NSensitivity_b.html";
};
...
function initBD(bNotD) {
	...
	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeIntSrc1NSensitivity", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeIntSrc1NSensitivity", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeIntSrc1NSensitivity", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeIntSrc1NSensitivity", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeIntSrc1NSensitivity", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeIntSrc1NSensitivity", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeIntSrc1NSensitivity", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQIntSrc1NSensitivity
		rownode = getRownode(srcdoc, "ListWdbeQIntSrc1NSensitivity", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeIntSrc1NSensitivity", "numFCsiQst"));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeIntSrc1NSensitivity", "ListWdbeQIntSrc1NSensitivity", retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeIntSrc1NSensitivity", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeIntSrc1NSensitivity", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeIntSrc1NSensitivity", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeIntSrc1NSensitivity", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeIntSrc1NSensitivity", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeIntSrc1NSensitivityData", scrJref, "StgIacQryWdbeIntSrc1NSensitivity");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeIntSrc1NSensitivity", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeIntSrc1NSensitivity", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeIntSrc1NSensitivity", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeIntSrc1NSensitivity", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeIntSrc1NSensitivityDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "ContInfWdbeIntSrc1NSensitivity", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "StatAppWdbeIntSrc1NSensitivity", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "StgIacWdbeIntSrc1NSensitivity", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "TagWdbeIntSrc1NSensitivity", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "ListWdbeQIntSrc1NSensitivity", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "StatAppQryWdbeIntSrc1NSensitivity", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "StatShrQryWdbeIntSrc1NSensitivity", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeIntSrc1NSensitivityData", "StgIacQryWdbeIntSrc1NSensitivity", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeIntSrc1NSensitivityData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeIntSrc1NSensitivityData") {
				mergeDpchEngData(dom);
				init();
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeIntSrc1NSensitivityData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
