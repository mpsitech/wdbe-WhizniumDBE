...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeSegSup1NSegment", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeSegSup1NSegment", "srefIxWdbeVExpstate", "mind");

	getRecwnd().changeHeight("Sup1NSegment", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Sup1NSegment_side").setAttribute("height", "30");
	doc.getElementById("Sup1NSegment_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Sup1NSegment_side").src = "./PnlWdbeSegSup1NSegment_aside.html";
	doc.getElementById("Sup1NSegment_cont").src = "./PnlWdbeSegSup1NSegment_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeSegSup1NSegment", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeSegSup1NSegment", "srefIxWdbeVExpstate", "regd");

	getRecwnd().changeHeight("Sup1NSegment", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Sup1NSegment_side").setAttribute("height", "255");
	doc.getElementById("Sup1NSegment_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Sup1NSegment_side").src = "./PnlWdbeSegSup1NSegment_bside.html";
	doc.getElementById("Sup1NSegment_cont").src = "./PnlWdbeSegSup1NSegment_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Sup1NSegment_side").contentDocument;
	contdoc = doc.getElementById("Sup1NSegment_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("Sup1NSegment_side").contentDocument;
	contdoc = doc.getElementById("Sup1NSegment_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Sup1NSegment_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Sup1NSegment_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Sup1NSegment_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeSegSup1NSegment", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeSegSup1NSegment", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSegSup1NSegment", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSegSup1NSegment", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSegSup1NSegment", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSegSup1NSegment", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeSegSup1NSegment", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQSegSup1NSegment
		rownode = getRownode(srcdoc, "ListWdbeQSegSup1NSegment", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeSegSup1NSegment", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Sup1NSegment", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NSegment_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NSegment_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Sup1NSegment_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Sup1NSegment_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeSegSup1NSegment", "ListWdbeQSegSup1NSegment", retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeSegSup1NSegment", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSegSup1NSegment", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeSegSup1NSegment", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeSegSup1NSegment", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeSegSup1NSegment", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeSegSup1NSegmentData", scrJref, "StgIacQryWdbeSegSup1NSegment");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeSegSup1NSegment", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeSegSup1NSegment", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeSegSup1NSegment", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeSegSup1NSegment", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeSegSup1NSegmentDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "ContInfWdbeSegSup1NSegment", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "StatAppWdbeSegSup1NSegment", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "StatShrWdbeSegSup1NSegment", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "StgIacWdbeSegSup1NSegment", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "TagWdbeSegSup1NSegment", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "ListWdbeQSegSup1NSegment", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "StatAppQryWdbeSegSup1NSegment", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "StatShrQryWdbeSegSup1NSegment", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeSegSup1NSegmentData", "StgIacQryWdbeSegSup1NSegment", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeSegSup1NSegmentData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeSegSup1NSegmentData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Sup1NSegment");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeSegSup1NSegmentData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
