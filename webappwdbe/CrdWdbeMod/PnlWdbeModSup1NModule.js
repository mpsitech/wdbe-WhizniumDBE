...
function minimize(updh) {
	...
	setSi(srcdoc, "StatAppWdbeModSup1NModule", "srefIxWdbeVExpstate", "mind");
	...
	// change content
	doc.getElementById("Sup1NModule_side").src = "./PnlWdbeModSup1NModule_aside.html";
	doc.getElementById("Sup1NModule_cont").src = "./PnlWdbeModSup1NModule_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeModSup1NModule", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeModSup1NModule", "srefIxWdbeVExpstate", "regd");
	...
	// change content
	doc.getElementById("Sup1NModule_side").src = "./PnlWdbeModSup1NModule_bside.html";
	doc.getElementById("Sup1NModule_cont").src = "./PnlWdbeModSup1NModule_b.html";
};
...
function initBD(bNotD) {
	...
	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeModSup1NModule", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeModSup1NModule", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeModSup1NModule", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeModSup1NModule", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeModSup1NModule", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeModSup1NModule", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeModSup1NModule", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeModSup1NModule", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeModSup1NModule", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeModSup1NModule", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeModSup1NModule", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeModSup1NModule", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeModSup1NModule", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeModSup1NModule", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeModSup1NModule", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeModSup1NModule", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQModSup1NModule
		rownode = getRownode(srcdoc, "ListWdbeQModSup1NModule", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeModSup1NModule", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeModSup1NModule", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeModSup1NModule", "numFCsiQst"));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeModSup1NModule", "ListWdbeQModSup1NModule", retrieveTi(srcdoc, "TagWdbeModSup1NModule", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeModSup1NModule", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeModSup1NModule", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeModSup1NModule", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeModSup1NModule", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeModSup1NModule", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeModSup1NModule", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeModSup1NModuleData", scrJref, "StgIacQryWdbeModSup1NModule");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeModSup1NModule", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeModSup1NModule", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeModSup1NModule", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeModSup1NModule", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeModSup1NModule", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeModSup1NModuleDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "ContInfWdbeModSup1NModule", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "StatAppWdbeModSup1NModule", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "StatShrWdbeModSup1NModule", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "StgIacWdbeModSup1NModule", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "TagWdbeModSup1NModule", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "ListWdbeQModSup1NModule", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "StatAppQryWdbeModSup1NModule", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "StatShrQryWdbeModSup1NModule", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeModSup1NModuleData", "StgIacQryWdbeModSup1NModule", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeModSup1NModuleData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeModSup1NModuleData") {
				mergeDpchEngData(dom);
				init();
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeModSup1NModuleData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
