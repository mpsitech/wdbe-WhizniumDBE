/**
  * \file PnlWdbeMod1NPeripheral.js
  * web client functionality for panel PnlWdbeMod1NPeripheral
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeMod1NPeripheral", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeMod1NPeripheral", "srefIxWdbeVExpstate", "mind");

	getRecwnd().changeHeight("1NPeripheral", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("1NPeripheral_side").setAttribute("height", "30");
	doc.getElementById("1NPeripheral_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("1NPeripheral_side").src = "./PnlWdbeMod1NPeripheral_aside.html";
	doc.getElementById("1NPeripheral_cont").src = "./PnlWdbeMod1NPeripheral_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeMod1NPeripheral", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeMod1NPeripheral", "srefIxWdbeVExpstate", "regd");

	getRecwnd().changeHeight("1NPeripheral", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("1NPeripheral_side").setAttribute("height", "255");
	doc.getElementById("1NPeripheral_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("1NPeripheral_side").src = "./PnlWdbeMod1NPeripheral_bside.html";
	doc.getElementById("1NPeripheral_cont").src = "./PnlWdbeMod1NPeripheral_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("1NPeripheral_side").contentDocument;
	contdoc = doc.getElementById("1NPeripheral_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("1NPeripheral_side").contentDocument;
	contdoc = doc.getElementById("1NPeripheral_cont").contentDocument;
	hdrdoc = contdoc.getElementById("1NPeripheral_hdr").contentDocument;
	tbldoc = contdoc.getElementById("1NPeripheral_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("1NPeripheral_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeMod1NPeripheral", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeMod1NPeripheral", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMod1NPeripheral", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMod1NPeripheral", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMod1NPeripheral", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMod1NPeripheral", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeMod1NPeripheral", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQMod1NPeripheral
		rownode = getRownode(srcdoc, "ListWdbeQMod1NPeripheral", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeMod1NPeripheral", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("1NPeripheral", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("1NPeripheral_side").setAttribute("height", "" + (height+55));
	doc.getElementById("1NPeripheral_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("1NPeripheral_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("1NPeripheral_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeMod1NPeripheral", "ListWdbeQMod1NPeripheral", retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeMod1NPeripheral", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMod1NPeripheral", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMod1NPeripheral", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeMod1NPeripheral", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeMod1NPeripheral", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeMod1NPeripheralData", scrJref, "StgIacQryWdbeMod1NPeripheral");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeMod1NPeripheral", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeMod1NPeripheral", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeMod1NPeripheral", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMod1NPeripheral", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeMod1NPeripheralDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "ContInfWdbeMod1NPeripheral", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "StatAppWdbeMod1NPeripheral", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "StatShrWdbeMod1NPeripheral", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "StgIacWdbeMod1NPeripheral", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "TagWdbeMod1NPeripheral", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "ListWdbeQMod1NPeripheral", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "StatAppQryWdbeMod1NPeripheral", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "StatShrQryWdbeMod1NPeripheral", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeMod1NPeripheralData", "StgIacQryWdbeMod1NPeripheral", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeMod1NPeripheralData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeMod1NPeripheralData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("1NPeripheral");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeMod1NPeripheralData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
