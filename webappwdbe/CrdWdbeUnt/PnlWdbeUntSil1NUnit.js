/**
  * \file PnlWdbeUntSil1NUnit.js
  * web client functionality for panel PnlWdbeUntSil1NUnit
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeUntSil1NUnit", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeUntSil1NUnit", "srefIxWdbeVExpstate", "mind");

	getRecwnd().changeHeight("Sil1NUnit", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Sil1NUnit_side").setAttribute("height", "30");
	doc.getElementById("Sil1NUnit_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Sil1NUnit_side").src = "./PnlWdbeUntSil1NUnit_aside.html";
	doc.getElementById("Sil1NUnit_cont").src = "./PnlWdbeUntSil1NUnit_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeUntSil1NUnit", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeUntSil1NUnit", "srefIxWdbeVExpstate", "regd");

	getRecwnd().changeHeight("Sil1NUnit", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Sil1NUnit_side").setAttribute("height", "255");
	doc.getElementById("Sil1NUnit_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Sil1NUnit_side").src = "./PnlWdbeUntSil1NUnit_bside.html";
	doc.getElementById("Sil1NUnit_cont").src = "./PnlWdbeUntSil1NUnit_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Sil1NUnit_side").contentDocument;
	contdoc = doc.getElementById("Sil1NUnit_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("Sil1NUnit_side").contentDocument;
	contdoc = doc.getElementById("Sil1NUnit_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Sil1NUnit_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Sil1NUnit_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Sil1NUnit_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeUntSil1NUnit", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeUntSil1NUnit", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeUntSil1NUnit", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeUntSil1NUnit", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeUntSil1NUnit", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeUntSil1NUnit", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeUntSil1NUnit", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQUntSil1NUnit
		rownode = getRownode(srcdoc, "ListWdbeQUntSil1NUnit", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeUntSil1NUnit", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Sil1NUnit", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Sil1NUnit_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Sil1NUnit_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Sil1NUnit_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Sil1NUnit_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeUntSil1NUnit", "ListWdbeQUntSil1NUnit", retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeUntSil1NUnit", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeUntSil1NUnit", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeUntSil1NUnit", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeUntSil1NUnit", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeUntSil1NUnit", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeUntSil1NUnitData", scrJref, "StgIacQryWdbeUntSil1NUnit");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeUntSil1NUnit", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeUntSil1NUnit", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeUntSil1NUnit", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeUntSil1NUnit", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeUntSil1NUnitDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "ContInfWdbeUntSil1NUnit", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "StatAppWdbeUntSil1NUnit", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "StgIacWdbeUntSil1NUnit", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "TagWdbeUntSil1NUnit", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "ListWdbeQUntSil1NUnit", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "StatAppQryWdbeUntSil1NUnit", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "StatShrQryWdbeUntSil1NUnit", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeUntSil1NUnitData", "StgIacQryWdbeUntSil1NUnit", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeUntSil1NUnitData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeUntSil1NUnitData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Sil1NUnit");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeUntSil1NUnitData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
