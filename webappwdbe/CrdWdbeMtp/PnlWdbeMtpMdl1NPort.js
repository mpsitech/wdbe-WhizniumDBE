/**
  * \file PnlWdbeMtpMdl1NPort.js
  * web client functionality for panel PnlWdbeMtpMdl1NPort
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NPort", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeMtpMdl1NPort", "srefIxWdbeVExpstate", "mind");
	...
	// change content
	doc.getElementById("Mdl1NPort_side").src = "./PnlWdbeMtpMdl1NPort_aside.html";
	doc.getElementById("Mdl1NPort_cont").src = "./PnlWdbeMtpMdl1NPort_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NPort", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeMtpMdl1NPort", "srefIxWdbeVExpstate", "regd");
	...
	// change content
	doc.getElementById("Mdl1NPort_side").src = "./PnlWdbeMtpMdl1NPort_bside.html";
	doc.getElementById("Mdl1NPort_cont").src = "./PnlWdbeMtpMdl1NPort_b.html";
};
...
function initBD(bNotD) {
	...
	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NPort", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NPort", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMtpMdl1NPort", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NPort", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NPort", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NPort", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeMtpMdl1NPort", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQMtpMdl1NPort
		rownode = getRownode(srcdoc, "ListWdbeQMtpMdl1NPort", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeMtpMdl1NPort", "numFCsiQst"));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeMtpMdl1NPort", "ListWdbeQMtpMdl1NPort", retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NPort", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMtpMdl1NPort", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NPort", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeMtpMdl1NPort", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeMtpMdl1NPort", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeMtpMdl1NPortData", scrJref, "StgIacQryWdbeMtpMdl1NPort");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NPort", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeMtpMdl1NPort", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NPort", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMtpMdl1NPort", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeMtpMdl1NPortDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "ContInfWdbeMtpMdl1NPort", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "StatAppWdbeMtpMdl1NPort", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "StatShrWdbeMtpMdl1NPort", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "StgIacWdbeMtpMdl1NPort", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "TagWdbeMtpMdl1NPort", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "ListWdbeQMtpMdl1NPort", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "StatAppQryWdbeMtpMdl1NPort", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "StatShrQryWdbeMtpMdl1NPort", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NPortData", "StgIacQryWdbeMtpMdl1NPort", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeMtpMdl1NPortData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeMtpMdl1NPortData") {
				mergeDpchEngData(dom);
				init();
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeMtpMdl1NPortData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
