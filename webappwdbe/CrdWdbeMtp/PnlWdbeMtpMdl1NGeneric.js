/**
  * \file PnlWdbeMtpMdl1NGeneric.js
  * web client functionality for panel PnlWdbeMtpMdl1NGeneric
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NGeneric", "srefIxWdbeVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWdbeMtpMdl1NGeneric", "srefIxWdbeVExpstate", "mind");
	...
	// change content
	doc.getElementById("Mdl1NGeneric_side").src = "./PnlWdbeMtpMdl1NGeneric_aside.html";
	doc.getElementById("Mdl1NGeneric_cont").src = "./PnlWdbeMtpMdl1NGeneric_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NGeneric", "srefIxWdbeVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWdbeMtpMdl1NGeneric", "srefIxWdbeVExpstate", "regd");
	...
	// change content
	doc.getElementById("Mdl1NGeneric_side").src = "./PnlWdbeMtpMdl1NGeneric_bside.html";
	doc.getElementById("Mdl1NGeneric_cont").src = "./PnlWdbeMtpMdl1NGeneric_b.html";
};
...
function initBD(bNotD) {
	...
	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWdbeVExpstate = retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NGeneric", "srefIxWdbeVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NGeneric", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMtpMdl1NGeneric", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NGeneric", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NGeneric", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NGeneric", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWdbeMtpMdl1NGeneric", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWdbeQMtpMdl1NGeneric
		rownode = getRownode(srcdoc, "ListWdbeQMtpMdl1NGeneric", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWdbeMtpMdl1NGeneric", "numFCsiQst"));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WdbeMtpMdl1NGeneric", "ListWdbeQMtpMdl1NGeneric", retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", "TxtRecord1"), retrieveTi(srcdoc, "TagWdbeMtpMdl1NGeneric", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMtpMdl1NGeneric", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWdbeMtpMdl1NGeneric", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWdbeMtpMdl1NGeneric", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWdbeMtpMdl1NGeneric", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWdbeMtpMdl1NGenericData", scrJref, "StgIacQryWdbeMtpMdl1NGeneric");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NGeneric", "srefIxWdbeVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "firstcol"));

	setSi(srcdoc, "StatAppQryWdbeMtpMdl1NGeneric", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWdbeMtpMdl1NGeneric", "srefIxWdbeVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWdbeMtpMdl1NGeneric", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWdbeMtpMdl1NGenericDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "ContInfWdbeMtpMdl1NGeneric", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "StatAppWdbeMtpMdl1NGeneric", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "StatShrWdbeMtpMdl1NGeneric", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "StgIacWdbeMtpMdl1NGeneric", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "TagWdbeMtpMdl1NGeneric", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "ListWdbeQMtpMdl1NGeneric", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "StatAppQryWdbeMtpMdl1NGeneric", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "StatShrQryWdbeMtpMdl1NGeneric", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWdbeMtpMdl1NGenericData", "StgIacQryWdbeMtpMdl1NGeneric", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWdbeMtpMdl1NGenericData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWdbeMtpMdl1NGenericData") {
				mergeDpchEngData(dom);
				init();
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWdbeMtpMdl1NGenericData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
