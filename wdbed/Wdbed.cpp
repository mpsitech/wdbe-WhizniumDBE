...
DpchEngWdbeAlert* AlrWdbe::prepareAlrAbt(
	...
	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		continf.TxtMsg1 = "WhizniumDBE version v1.1.44 released on 3-3-2025";
...
void XchgWdbed::startMon() {
	...
	mon.start("WhizniumDBE v1.1.44", stgwdbemonitor.ixDbsVDbstype, stgwdbemonitor.dbspath, stgwdbemonitor.dbsname, stgwdbemonitor.ip, stgwdbemonitor.port, stgwdbemonitor.dbsusername, stgwdbemonitor.dbspassword, stgwdbemonitor.username, stgwdbemonitor.password);
