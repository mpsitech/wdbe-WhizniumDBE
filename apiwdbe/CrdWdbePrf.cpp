...
CrdWdbePrf::StatApp::StatApp(
		...
		{
	mask = {IXWDBEVREQITMODE, LATENCY, SHORTMENU, WIDTHMENU, INITDONEHEADBAR, INITDONEDAEMON, INITDONELICENSE};
};
...
set<uint> CrdWdbePrf::StatApp::diff(
	...
	diffitems = {IXWDBEVREQITMODE, LATENCY, SHORTMENU, WIDTHMENU, INITDONEHEADBAR, INITDONEDAEMON, INITDONELICENSE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
CrdWdbePrf::StatShr::StatShr(
		...
		{
	mask = {SCRJREFHEADBAR, SCRJREFDAEMON, SCRJREFLICENSE};
};
...
set<uint> CrdWdbePrf::StatShr::diff(
	...
	diffitems = {SCRJREFHEADBAR, SCRJREFDAEMON, SCRJREFLICENSE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
