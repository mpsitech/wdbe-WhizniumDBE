/**
	...
	* API code for job PnlWdbeMtpMdl1NGeneric (declarations)
...
/**
	...
	*/
namespace PnlWdbeMtpMdl1NGeneric {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeMtpMdl1NGeneric::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeMtpMdl1NGeneric::StatApp statappqry;
