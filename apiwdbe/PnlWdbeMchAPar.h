/**
	...
	* API code for job PnlWdbeMchAPar (declarations)
...
namespace PnlWdbeMchAPar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeMchAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeMchAPar::StatApp statappqry;
