/**
	...
	* API code for job PnlWdbePphAPar (declarations)
...
namespace PnlWdbePphAPar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbePphAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbePphAPar::StatApp statappqry;
