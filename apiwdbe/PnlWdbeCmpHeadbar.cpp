/**
	* \file PnlWdbeCmpHeadbar.cpp
	* API code for job PnlWdbeCmpHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbeCmpHeadbar::StgInf
 ******************************************************************************/

PnlWdbeCmpHeadbar::StgInf::StgInf(
...
bool PnlWdbeCmpHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeCmpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeCmpHeadbar";
...
set<uint> PnlWdbeCmpHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCmpHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeCmpHeadbar::Tag
 ******************************************************************************/

PnlWdbeCmpHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbeCmpHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeCmpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeCmpHeadbar";
...
/******************************************************************************
 class PnlWdbeCmpHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeCmpHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBECMPHEADBARDATA)
		{
};

string PnlWdbeCmpHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCmpHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeCmpHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
