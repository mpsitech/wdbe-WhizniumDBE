/**
	...
	* API code for job QryWdbeSegList (implementation)
...
/******************************************************************************
 class QryWdbeSegList::VecVOrd
 ******************************************************************************/

uint QryWdbeSegList::VecVOrd::getIx(
			const string& sref
		) {
...
/******************************************************************************
 class QryWdbeSegList::StatApp
 ******************************************************************************/

QryWdbeSegList::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeSegList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeSegList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeSegList";
...
set<uint> QryWdbeSegList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSegList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeSegList::StatShr
 ******************************************************************************/

QryWdbeSegList::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeSegList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeSegList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeSegList";
...
set<uint> QryWdbeSegList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSegList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeSegList::StgIac
 ******************************************************************************/

QryWdbeSegList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeSegList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeSegList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeSegList";
...
void QryWdbeSegList::StgIac::writeXML(
	...
	if (difftag.length() == 0) difftag = "StgIacQryWdbeSegList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeSegList";
...
set<uint> QryWdbeSegList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSegList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
