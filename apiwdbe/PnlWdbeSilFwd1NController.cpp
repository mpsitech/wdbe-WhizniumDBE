/**
	...
	* API code for job PnlWdbeSilFwd1NController (implementation)
...
bool PnlWdbeSilFwd1NController::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeSilFwd1NController");
	else
...
PnlWdbeSilFwd1NController::StatApp::StatApp(
...
bool PnlWdbeSilFwd1NController::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeSilFwd1NController");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeSilFwd1NController::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeSilFwd1NController::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeSilFwd1NController::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeSilFwd1NController");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeSilFwd1NController::Tag::Tag(
			const string& Cpt
...
bool PnlWdbeSilFwd1NController::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeSilFwd1NController");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeSilFwd1NController::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBESILFWD1NCONTROLLERDATA, scrJref)
		{
...
void PnlWdbeSilFwd1NController::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeSilFwd1NControllerData");
...
PnlWdbeSilFwd1NController::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBESILFWD1NCONTROLLERDO, scrJref)
		{
...
void PnlWdbeSilFwd1NController::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeSilFwd1NControllerDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeSilFwd1NController::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBESILFWD1NCONTROLLERDATA)
		{
...
void PnlWdbeSilFwd1NController::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeSilFwd1NControllerData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeSilFwd1NController::StatApp();
		statshrqry = QryWdbeSilFwd1NController::StatShr();
