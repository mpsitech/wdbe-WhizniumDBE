/**
	* \file PnlWdbeMtpHsm1NPipeline.cpp
	* API code for job PnlWdbeMtpHsm1NPipeline (implementation)
...
bool PnlWdbeMtpHsm1NPipeline::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeMtpHsm1NPipeline");
	else
...
PnlWdbeMtpHsm1NPipeline::StatApp::StatApp(
...
bool PnlWdbeMtpHsm1NPipeline::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeMtpHsm1NPipeline");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeMtpHsm1NPipeline::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMtpHsm1NPipeline::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeMtpHsm1NPipeline::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeMtpHsm1NPipeline");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpHsm1NPipeline::Tag::Tag(
			const string& Cpt
...
bool PnlWdbeMtpHsm1NPipeline::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeMtpHsm1NPipeline");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpHsm1NPipeline::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPHSM1NPIPELINEDATA, scrJref)
		{
...
void PnlWdbeMtpHsm1NPipeline::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeMtpHsm1NPipelineData");
...
PnlWdbeMtpHsm1NPipeline::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPHSM1NPIPELINEDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWdbeMtpHsm1NPipeline::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeMtpHsm1NPipelineDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeMtpHsm1NPipeline::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMTPHSM1NPIPELINEDATA)
		{
...
void PnlWdbeMtpHsm1NPipeline::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeMtpHsm1NPipelineData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeMtpHsm1NPipeline::StatApp();
		statshrqry = QryWdbeMtpHsm1NPipeline::StatShr();
