/**
	...
	* API code for job QryWdbeUntSil1NUnit (implementation)
...
QryWdbeUntSil1NUnit::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeUntSil1NUnit::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeUntSil1NUnit");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeUntSil1NUnit";
...
set<uint> QryWdbeUntSil1NUnit::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeUntSil1NUnit::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeUntSil1NUnit::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeUntSil1NUnit");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeUntSil1NUnit";
