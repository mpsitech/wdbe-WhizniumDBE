/**
	...
	* API code for job PnlWdbePrjMNPerson (declarations)
...
namespace PnlWdbePrjMNPerson {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbePrjMNPerson::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbePrjMNPerson::StatApp statappqry;
