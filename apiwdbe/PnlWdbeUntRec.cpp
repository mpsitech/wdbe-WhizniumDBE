...
PnlWdbeUntRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONE1NPERIPHERAL, INITDONESIL1NUNIT, INITDONE1NBANK, INITDONEFWD1NCONTROLLER, INITDONE1NTARGET, INITDONEREF1NERROR, INITDONEHK1NVECTOR, INITDONEREF1NCOMMAND, INITDONEHK1NMODULE};
};
...
set<uint> PnlWdbeUntRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONE1NPERIPHERAL, INITDONESIL1NUNIT, INITDONE1NBANK, INITDONEFWD1NCONTROLLER, INITDONE1NTARGET, INITDONEREF1NERROR, INITDONEHK1NVECTOR, INITDONEREF1NCOMMAND, INITDONEHK1NMODULE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWdbeUntRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, PNLSIL1NUNITAVAIL, SCRJREF1NBANK, SCRJREFFWD1NCONTROLLER, SCRJREF1NTARGET, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFREF1NCOMMAND, SCRJREFHK1NMODULE, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeUntRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, PNLSIL1NUNITAVAIL, SCRJREF1NBANK, SCRJREFFWD1NCONTROLLER, SCRJREF1NTARGET, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFREF1NCOMMAND, SCRJREFHK1NMODULE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
