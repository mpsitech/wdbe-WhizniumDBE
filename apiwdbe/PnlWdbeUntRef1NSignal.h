/**
	...
	* API code for job PnlWdbeUntRef1NSignal (declarations)
...
/**
	...
	*/
namespace PnlWdbeUntRef1NSignal {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeUntRef1NSignal::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeUntRef1NSignal::StatApp statappqry;
