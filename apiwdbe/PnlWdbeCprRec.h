/**
	...
	* API code for job PnlWdbeCprRec (declarations)
...
namespace PnlWdbeCprRec {
	...
	public:
		...
		static const Sbecore::uint INITDONE1NCOREVERSION = 2;
		static const Sbecore::uint INITDONEMNPERSON = 3;

	public:
		StatApp(const bool initdoneDetail = false, const bool initdone1NCoreversion = false, const bool initdoneMNPerson = false);

	public:
		bool initdoneDetail;
		bool initdone1NCoreversion;
	...
	public:
		...
		static const Sbecore::uint SCRJREF1NCOREVERSION = 3;
		static const Sbecore::uint SCRJREFMNPERSON = 4;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 5;

	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJref1NCoreversion = "", const std::string& scrJrefMNPerson = "", const bool ButRegularizeActive = true);

	public:
		Sbecore::uint ixWdbeVExpstate;
		std::string scrJrefDetail;
		std::string scrJref1NCoreversion;
