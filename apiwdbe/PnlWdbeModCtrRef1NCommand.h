/**
	...
	* API code for job PnlWdbeModCtrRef1NCommand (declarations)
...
/**
	...
	*/
namespace PnlWdbeModCtrRef1NCommand {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeModCtrRef1NCommand::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeModCtrRef1NCommand::StatApp statappqry;
