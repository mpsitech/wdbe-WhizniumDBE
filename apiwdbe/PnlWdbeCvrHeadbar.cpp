/**
	...
	* API code for job PnlWdbeCvrHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbeCvrHeadbar::StgInf
 ******************************************************************************/

PnlWdbeCvrHeadbar::StgInf::StgInf(
...
bool PnlWdbeCvrHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeCvrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeCvrHeadbar";
...
set<uint> PnlWdbeCvrHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCvrHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeCvrHeadbar::Tag
 ******************************************************************************/

PnlWdbeCvrHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbeCvrHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeCvrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeCvrHeadbar";
...
/******************************************************************************
 class PnlWdbeCvrHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeCvrHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBECVRHEADBARDATA)
		{
};

string PnlWdbeCvrHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCvrHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeCvrHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
