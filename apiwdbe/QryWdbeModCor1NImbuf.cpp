/**
	...
	* API code for job QryWdbeModCor1NImbuf (implementation)
...
QryWdbeModCor1NImbuf::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeModCor1NImbuf::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeModCor1NImbuf");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeModCor1NImbuf";
...
set<uint> QryWdbeModCor1NImbuf::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeModCor1NImbuf::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeModCor1NImbuf::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeModCor1NImbuf");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeModCor1NImbuf";
