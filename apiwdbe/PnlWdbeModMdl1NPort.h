/**
	...
	* API code for job PnlWdbeModMdl1NPort (declarations)
...
namespace PnlWdbeModMdl1NPort {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeModMdl1NPort::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeModMdl1NPort::StatApp statappqry;
