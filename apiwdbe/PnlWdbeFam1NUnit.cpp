/**
	...
	* API code for job PnlWdbeFam1NUnit (implementation)
...
bool PnlWdbeFam1NUnit::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeFam1NUnit");
	else
...
PnlWdbeFam1NUnit::StatApp::StatApp(
...
bool PnlWdbeFam1NUnit::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeFam1NUnit");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeFam1NUnit::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeFam1NUnit::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeFam1NUnit::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeFam1NUnit");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbeFam1NUnit::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeFam1NUnit");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeFam1NUnit::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEFAM1NUNITDATA, scrJref)
		{
...
void PnlWdbeFam1NUnit::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeFam1NUnitData");
...
PnlWdbeFam1NUnit::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEFAM1NUNITDO, scrJref)
		{
...
void PnlWdbeFam1NUnit::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeFam1NUnitDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeFam1NUnit::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEFAM1NUNITDATA)
		{
...
void PnlWdbeFam1NUnit::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeFam1NUnitData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeFam1NUnit::StatApp();
		statshrqry = QryWdbeFam1NUnit::StatShr();
