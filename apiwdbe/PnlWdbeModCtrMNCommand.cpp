/**
	...
	* API code for job PnlWdbeModCtrMNCommand (implementation)
...
bool PnlWdbeModCtrMNCommand::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeModCtrMNCommand");
	else
...
PnlWdbeModCtrMNCommand::StatApp::StatApp(
...
bool PnlWdbeModCtrMNCommand::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeModCtrMNCommand");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeModCtrMNCommand::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeModCtrMNCommand::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeModCtrMNCommand::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeModCtrMNCommand");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeModCtrMNCommand::Tag::Tag(
			const string& Cpt
...
bool PnlWdbeModCtrMNCommand::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeModCtrMNCommand");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeModCtrMNCommand::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMODCTRMNCOMMANDDATA, scrJref)
		{
...
void PnlWdbeModCtrMNCommand::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeModCtrMNCommandData");
...
PnlWdbeModCtrMNCommand::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMODCTRMNCOMMANDDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWdbeModCtrMNCommand::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeModCtrMNCommandDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeModCtrMNCommand::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMODCTRMNCOMMANDDATA)
		{
...
void PnlWdbeModCtrMNCommand::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeModCtrMNCommandData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeModCtrMNCommand::StatApp();
		statshrqry = QryWdbeModCtrMNCommand::StatShr();
