...
PnlWdbeSilRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, SCRJREF1NTARGET, SCRJREFFWD1NCONTROLLER, SCRJREF1NBANK, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFHK1NMODULE, SCRJREFREF1NCOMMAND, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeSilRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, SCRJREF1NTARGET, SCRJREFFWD1NCONTROLLER, SCRJREF1NBANK, SCRJREFREF1NERROR, SCRJREFHK1NVECTOR, SCRJREFHK1NMODULE, SCRJREFREF1NCOMMAND, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
