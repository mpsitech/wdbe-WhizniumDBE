...
PnlWdbeSilRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NTARGET, SCRJREF1NINTERRUPT, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, SCRJREFFWD1NCONTROLLER, SCRJREF1NBANK, SCRJREFHK1NMODULE, SCRJREFHK1NVECTOR, SCRJREFREF1NSIGNAL, SCRJREFREF1NERROR, SCRJREFREF1NCOMMAND, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeSilRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREF1NTARGET, SCRJREF1NINTERRUPT, SCRJREF1NPERIPHERAL, SCRJREFSIL1NUNIT, SCRJREFFWD1NCONTROLLER, SCRJREF1NBANK, SCRJREFHK1NMODULE, SCRJREFHK1NVECTOR, SCRJREFREF1NSIGNAL, SCRJREFREF1NERROR, SCRJREFREF1NCOMMAND, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
