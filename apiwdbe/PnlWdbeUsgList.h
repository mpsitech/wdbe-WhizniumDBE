/**
	...
	* API code for job PnlWdbeUsgList (declarations)
...
namespace PnlWdbeUsgList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbeUsgList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeUsgList::StatApp statappqry;
