/**
	...
	* API code for job QryWdbeCvrHk1NModule (implementation)
...
QryWdbeCvrHk1NModule::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeCvrHk1NModule::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeCvrHk1NModule");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeCvrHk1NModule";
...
set<uint> QryWdbeCvrHk1NModule::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCvrHk1NModule::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeCvrHk1NModule::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeCvrHk1NModule");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeCvrHk1NModule";
