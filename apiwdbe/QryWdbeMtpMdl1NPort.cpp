/**
	...
	* API code for job QryWdbeMtpMdl1NPort (implementation)
...
QryWdbeMtpMdl1NPort::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeMtpMdl1NPort::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeMtpMdl1NPort");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeMtpMdl1NPort";
...
set<uint> QryWdbeMtpMdl1NPort::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMtpMdl1NPort::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeMtpMdl1NPort::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeMtpMdl1NPort");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeMtpMdl1NPort";
