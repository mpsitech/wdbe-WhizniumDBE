/**
	...
	* API code for job PnlWdbeCdcMNSignal (declarations)
...
namespace PnlWdbeCdcMNSignal {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeCdcMNSignal::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeCdcMNSignal::StatApp statappqry;
