/**
	...
	* API code for job PnlWdbeSil1NPeripheral (implementation)
...
bool PnlWdbeSil1NPeripheral::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeSil1NPeripheral");
	else
...
PnlWdbeSil1NPeripheral::StatApp::StatApp(
...
bool PnlWdbeSil1NPeripheral::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeSil1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeSil1NPeripheral::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeSil1NPeripheral::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeSil1NPeripheral::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeSil1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeSil1NPeripheral::Tag::Tag(
			const string& Cpt
...
bool PnlWdbeSil1NPeripheral::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeSil1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeSil1NPeripheral::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBESIL1NPERIPHERALDATA, scrJref)
		{
...
void PnlWdbeSil1NPeripheral::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeSil1NPeripheralData");
...
PnlWdbeSil1NPeripheral::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBESIL1NPERIPHERALDO, scrJref)
		{
...
void PnlWdbeSil1NPeripheral::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeSil1NPeripheralDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeSil1NPeripheral::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBESIL1NPERIPHERALDATA)
		{
...
void PnlWdbeSil1NPeripheral::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeSil1NPeripheralData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeSil1NPeripheral::StatApp();
		statshrqry = QryWdbeSil1NPeripheral::StatShr();
