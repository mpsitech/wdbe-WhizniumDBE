...
/******************************************************************************
 class QryWdbeMod1NPeripheral::StatApp
 ******************************************************************************/

QryWdbeMod1NPeripheral::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeMod1NPeripheral::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeMod1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeMod1NPeripheral";
...
set<uint> QryWdbeMod1NPeripheral::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMod1NPeripheral::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeMod1NPeripheral::StatShr
 ******************************************************************************/

QryWdbeMod1NPeripheral::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeMod1NPeripheral::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeMod1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeMod1NPeripheral";
...
set<uint> QryWdbeMod1NPeripheral::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMod1NPeripheral::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeMod1NPeripheral::StgIac
 ******************************************************************************/

QryWdbeMod1NPeripheral::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeMod1NPeripheral::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeMod1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeMod1NPeripheral";
...
void QryWdbeMod1NPeripheral::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeMod1NPeripheral";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeMod1NPeripheral";
...
set<uint> QryWdbeMod1NPeripheral::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMod1NPeripheral::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
