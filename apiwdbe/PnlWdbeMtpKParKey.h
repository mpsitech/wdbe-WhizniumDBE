/**
	...
	* API code for job PnlWdbeMtpKParKey (declarations)
...
namespace PnlWdbeMtpKParKey {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeMtpKParKey::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeMtpKParKey::StatApp statappqry;
