...
namespace CrdWdbePrf {
	...
	public:
		...
		static const Sbecore::uint INITDONEDAEMON = 5;
		static const Sbecore::uint INITDONEHEADBAR = 6;
		static const Sbecore::uint INITDONELICENSE = 7;

	public:
		StatApp(const Sbecore::uint ixWdbeVReqitmode = VecWdbeVReqitmode::IDLE, const Sbecore::usmallint latency = 5, const std::string& shortMenu = "", const Sbecore::uint widthMenu = 0, const bool initdoneDaemon = false, const bool initdoneHeadbar = false, const bool initdoneLicense = false);
	...
	public:
		static const Sbecore::uint SCRJREFDAEMON = 1;
		static const Sbecore::uint SCRJREFHEADBAR = 2;
		static const Sbecore::uint SCRJREFLICENSE = 3;

	public:
		StatShr(const std::string& scrJrefDaemon = "", const std::string& scrJrefHeadbar = "", const std::string& scrJrefLicense = "");
