/**
	...
	* API code for job PnlWdbeSysSys1NTarget (declarations)
...
/**
	...
	*/
namespace PnlWdbeSysSys1NTarget {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeSysSys1NTarget::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeSysSys1NTarget::StatApp statappqry;
