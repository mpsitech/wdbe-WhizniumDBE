...
PnlWdbeMtpRec::StatApp::StatApp(
		...
		{
	mask = {INITDONEDETAIL, INITDONEKPARKEY, INITDONEKHDLTYPE, INITDONEAPAR, INITDONEMDL1NPORT, INITDONEHSM1NPIPELINE, INITDONETPL1NMODULE, INITDONEMDL1NGENERIC, INITDONESUP1NMODULE, INITDONEREF1NVARIABLE, INITDONEREF1NSENSITIVITY, INITDONEMGE1NSIGNAL, INITDONEREF1NFILE};
};
...
set<uint> PnlWdbeMtpRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEKPARKEY, INITDONEKHDLTYPE, INITDONEAPAR, INITDONEMDL1NPORT, INITDONEHSM1NPIPELINE, INITDONETPL1NMODULE, INITDONEMDL1NGENERIC, INITDONESUP1NMODULE, INITDONEREF1NVARIABLE, INITDONEREF1NSENSITIVITY, INITDONEMGE1NSIGNAL, INITDONEREF1NFILE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWdbeMtpRec::StatShr::StatShr(
		...
		{
	mask = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFKPARKEY, SCRJREFKHDLTYPE, SCRJREFAPAR, SCRJREFMDL1NPORT, SCRJREFHSM1NPIPELINE, SCRJREFTPL1NMODULE, SCRJREFMDL1NGENERIC, SCRJREFSUP1NMODULE, SCRJREFREF1NVARIABLE, SCRJREFREF1NSENSITIVITY, SCRJREFMGE1NSIGNAL, SCRJREFREF1NFILE, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeMtpRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFKPARKEY, SCRJREFKHDLTYPE, SCRJREFAPAR, SCRJREFMDL1NPORT, SCRJREFHSM1NPIPELINE, SCRJREFTPL1NMODULE, SCRJREFMDL1NGENERIC, SCRJREFSUP1NMODULE, SCRJREFREF1NVARIABLE, SCRJREFREF1NSENSITIVITY, SCRJREFMGE1NSIGNAL, SCRJREFREF1NFILE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
