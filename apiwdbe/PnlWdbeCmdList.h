/**
	...
	* API code for job PnlWdbeCmdList (declarations)
...
namespace PnlWdbeCmdList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbeCmdList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeCmdList::StatApp statappqry;
