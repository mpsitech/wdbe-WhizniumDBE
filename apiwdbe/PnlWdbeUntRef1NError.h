/**
	...
	* API code for job PnlWdbeUntRef1NError (declarations)
...
/**
	...
	*/
namespace PnlWdbeUntRef1NError {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeUntRef1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeUntRef1NError::StatApp statappqry;
