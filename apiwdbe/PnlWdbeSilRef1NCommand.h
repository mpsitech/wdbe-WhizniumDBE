/**
	...
	* API code for job PnlWdbeSilRef1NCommand (declarations)
...
/**
	...
	*/
namespace PnlWdbeSilRef1NCommand {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeSilRef1NCommand::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeSilRef1NCommand::StatApp statappqry;
