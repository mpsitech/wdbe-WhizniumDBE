/**
	...
	* API code for job PnlWdbeMtpRef1NVariable (declarations)
...
/**
	...
	*/
namespace PnlWdbeMtpRef1NVariable {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeMtpRef1NVariable::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeMtpRef1NVariable::StatApp statappqry;
