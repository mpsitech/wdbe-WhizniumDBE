/**
	...
	* API code for job PnlWdbeMtpTpl1NModule (implementation)
...
bool PnlWdbeMtpTpl1NModule::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeMtpTpl1NModule");
	else
...
PnlWdbeMtpTpl1NModule::StatApp::StatApp(
...
bool PnlWdbeMtpTpl1NModule::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeMtpTpl1NModule");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeMtpTpl1NModule::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMtpTpl1NModule::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeMtpTpl1NModule::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeMtpTpl1NModule");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbeMtpTpl1NModule::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeMtpTpl1NModule");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpTpl1NModule::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPTPL1NMODULEDATA, scrJref)
		{
...
void PnlWdbeMtpTpl1NModule::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeMtpTpl1NModuleData");
...
PnlWdbeMtpTpl1NModule::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPTPL1NMODULEDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWdbeMtpTpl1NModule::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeMtpTpl1NModuleDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeMtpTpl1NModule::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMTPTPL1NMODULEDATA)
		{
...
void PnlWdbeMtpTpl1NModule::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeMtpTpl1NModuleData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeMtpTpl1NModule::StatApp();
		statshrqry = QryWdbeMtpTpl1NModule::StatShr();
