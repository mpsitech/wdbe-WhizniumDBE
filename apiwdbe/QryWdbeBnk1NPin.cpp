/**
	...
	* API code for job QryWdbeBnk1NPin (implementation)
...
/******************************************************************************
 class QryWdbeBnk1NPin::StatApp
 ******************************************************************************/

QryWdbeBnk1NPin::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeBnk1NPin::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeBnk1NPin");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeBnk1NPin";
...
set<uint> QryWdbeBnk1NPin::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeBnk1NPin::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeBnk1NPin::StatShr
 ******************************************************************************/

QryWdbeBnk1NPin::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeBnk1NPin::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeBnk1NPin");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeBnk1NPin";
...
set<uint> QryWdbeBnk1NPin::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeBnk1NPin::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeBnk1NPin::StgIac
 ******************************************************************************/

QryWdbeBnk1NPin::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeBnk1NPin::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeBnk1NPin");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeBnk1NPin";
...
void QryWdbeBnk1NPin::StgIac::writeXML(
	...
	if (difftag.length() == 0) difftag = "StgIacQryWdbeBnk1NPin";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeBnk1NPin";
...
set<uint> QryWdbeBnk1NPin::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeBnk1NPin::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
