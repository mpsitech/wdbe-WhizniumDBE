/**
	...
	* API code for job PnlWdbePplPpl1NSegment (declarations)
...
/**
	...
	*/
namespace PnlWdbePplPpl1NSegment {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbePplPpl1NSegment::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbePplPpl1NSegment::StatApp statappqry;
