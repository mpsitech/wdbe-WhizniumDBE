/**
	...
	* API code for job PnlWdbeCmdAInvpar (declarations)
...
namespace PnlWdbeCmdAInvpar {
	...
	public:
		...
		static const Sbecore::uint TCODFV = 11;
		static const Sbecore::uint TCOVIT = 12;
		static const Sbecore::uint TCOCMT = 13;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoPty = "", const std::string& TcoVec = "", const std::string& TcoLen = "", const std::string& TcoDfv = "", const std::string& TcoVit = "", const std::string& TcoCmt = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeCmdAInvpar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeCmdAInvpar::StatApp statappqry;
