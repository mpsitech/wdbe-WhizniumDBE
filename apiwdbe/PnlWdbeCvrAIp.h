/**
	...
	* API code for job PnlWdbeCvrAIp (declarations)
...
namespace PnlWdbeCvrAIp {
	...
	public:
		...
		static const Sbecore::uint TCOTTY = 8;
		static const Sbecore::uint TCOCMT = 9;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoTty = "", const std::string& TcoCmt = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeCvrAIp::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		Tag tag;
		ListWdbeQCvrAIp rst;
		QryWdbeCvrAIp::StatApp statappqry;
