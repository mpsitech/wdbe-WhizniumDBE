...
/******************************************************************************
 class QryWdbeSigList::VecVOrd
 ******************************************************************************/

uint QryWdbeSigList::VecVOrd::getIx(
			const string& sref
		) {
...
QryWdbeSigList::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeSigList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeSigList");
	else
...
set<uint> QryWdbeSigList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSigList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeSigList::StatShr
 ******************************************************************************/

QryWdbeSigList::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeSigList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeSigList");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> QryWdbeSigList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSigList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeSigList::StgIac
 ******************************************************************************/

QryWdbeSigList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeSigList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeSigList");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> QryWdbeSigList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSigList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
