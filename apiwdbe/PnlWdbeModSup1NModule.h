/**
	...
	* API code for job PnlWdbeModSup1NModule (declarations)
...
/**
	...
	*/
namespace PnlWdbeModSup1NModule {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeModSup1NModule::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeModSup1NModule::StatApp statappqry;
