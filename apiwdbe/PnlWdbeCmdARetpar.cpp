/**
	* \file PnlWdbeCmdARetpar.cpp
	* API code for job PnlWdbeCmdARetpar (implementation)
...
bool PnlWdbeCmdARetpar::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeCmdARetpar");
	else
...
PnlWdbeCmdARetpar::StatApp::StatApp(
...
bool PnlWdbeCmdARetpar::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeCmdARetpar");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeCmdARetpar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCmdARetpar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeCmdARetpar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeCmdARetpar");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbeCmdARetpar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeCmdARetpar");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeCmdARetpar::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBECMDARETPARDATA, scrJref)
		{
...
void PnlWdbeCmdARetpar::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeCmdARetparData");
...
PnlWdbeCmdARetpar::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBECMDARETPARDO, scrJref)
		{
...
void PnlWdbeCmdARetpar::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeCmdARetparDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeCmdARetpar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBECMDARETPARDATA)
		{
...
void PnlWdbeCmdARetpar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeCmdARetparData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeCmdARetpar::StatApp();
		statshrqry = QryWdbeCmdARetpar::StatShr();
