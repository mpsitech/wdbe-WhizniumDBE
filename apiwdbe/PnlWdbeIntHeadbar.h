/**
	* \file PnlWdbeIntHeadbar.h
	* API code for job PnlWdbeIntHeadbar (declarations)
...
#ifndef PNLWDBEINTHEADBAR_H
#define PNLWDBEINTHEADBAR_H

#include "ApiWdbe_blks.h"

#define StgInfWdbeIntHeadbar PnlWdbeIntHeadbar::StgInf
#define TagWdbeIntHeadbar PnlWdbeIntHeadbar::Tag

#define DpchEngWdbeIntHeadbarData PnlWdbeIntHeadbar::DpchEngData

/**
	* PnlWdbeIntHeadbar
	*/
namespace PnlWdbeIntHeadbar {
	/**
