/**
	...
	* API code for job QryWdbeMtpMdl1NGeneric (implementation)
...
QryWdbeMtpMdl1NGeneric::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeMtpMdl1NGeneric::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeMtpMdl1NGeneric");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeMtpMdl1NGeneric";
...
set<uint> QryWdbeMtpMdl1NGeneric::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMtpMdl1NGeneric::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeMtpMdl1NGeneric::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeMtpMdl1NGeneric");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeMtpMdl1NGeneric";
