...
namespace PnlWdbeVerRec {
	...
	public:
		StatApp(const bool initdoneDetail = false, const bool initdone1NRelease = false, const bool initdone1NSystem = false, const bool initdoneBvr1NVersion = false, const bool initdone1NUnit = false, const bool initdoneRef1NFile = false, const bool initdoneMNLibrary = false);
