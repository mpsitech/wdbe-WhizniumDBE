/**
	* \file PnlWdbeGenHeadbar.cpp
	* API code for job PnlWdbeGenHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbeGenHeadbar::StgInf
 ******************************************************************************/

PnlWdbeGenHeadbar::StgInf::StgInf(
...
bool PnlWdbeGenHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeGenHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeGenHeadbar";
...
set<uint> PnlWdbeGenHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeGenHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeGenHeadbar::Tag
 ******************************************************************************/

PnlWdbeGenHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbeGenHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeGenHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeGenHeadbar";
...
/******************************************************************************
 class PnlWdbeGenHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeGenHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEGENHEADBARDATA)
		{
};

string PnlWdbeGenHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeGenHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeGenHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
