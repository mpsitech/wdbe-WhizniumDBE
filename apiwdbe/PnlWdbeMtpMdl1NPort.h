/**
	...
	* API code for job PnlWdbeMtpMdl1NPort (declarations)
...
namespace PnlWdbeMtpMdl1NPort {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeMtpMdl1NPort::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeMtpMdl1NPort::StatApp statappqry;
