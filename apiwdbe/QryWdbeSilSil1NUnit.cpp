/**
	...
	* API code for job QryWdbeSilSil1NUnit (implementation)
...
QryWdbeSilSil1NUnit::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeSilSil1NUnit::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeSilSil1NUnit");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeSilSil1NUnit";
...
set<uint> QryWdbeSilSil1NUnit::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSilSil1NUnit::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeSilSil1NUnit::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeSilSil1NUnit");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeSilSil1NUnit";
