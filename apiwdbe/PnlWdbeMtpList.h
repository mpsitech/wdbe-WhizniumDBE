/**
	...
	* API code for job PnlWdbeMtpList (declarations)
...
namespace PnlWdbeMtpList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbeMtpList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeMtpList::StatApp statappqry;
