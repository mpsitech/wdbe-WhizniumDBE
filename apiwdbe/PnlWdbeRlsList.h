/**
	...
	* API code for job PnlWdbeRlsList (declarations)
...
namespace PnlWdbeRlsList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbeRlsList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeRlsList::StatApp statappqry;
