/**
	* \file PnlWdbeRlsList.cpp
	* API code for job PnlWdbeRlsList (implementation)
...
bool PnlWdbeRlsList::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeRlsList");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbeRlsList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeRlsList");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbeRlsList::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeRlsList");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeRlsList::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBERLSLISTDATA, scrJref)
		{
...
void PnlWdbeRlsList::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeRlsListData");
...
PnlWdbeRlsList::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBERLSLISTDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWdbeRlsList::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeRlsListDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeRlsList::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBERLSLISTDATA)
		{
...
void PnlWdbeRlsList::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeRlsListData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeRlsList::StatApp();
		statshrqry = QryWdbeRlsList::StatShr();
