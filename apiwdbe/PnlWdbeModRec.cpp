...
PnlWdbeModRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPERIPHERAL, INITDONEMDL1NGENERIC, INITDONECOR1NIMBUF, INITDONEMDL1NPORT, INITDONE1NPROCESS, INITDONEMDL1NSIGNAL, INITDONESUP1NMODULE, INITDONEMGE1NSIGNAL, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRREF1NCOMMAND, INITDONECTRMNCOMMAND};
};
...
set<uint> PnlWdbeModRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPERIPHERAL, INITDONEMDL1NGENERIC, INITDONECOR1NIMBUF, INITDONEMDL1NPORT, INITDONE1NPROCESS, INITDONEMDL1NSIGNAL, INITDONESUP1NMODULE, INITDONEMGE1NSIGNAL, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRREF1NCOMMAND, INITDONECTRMNCOMMAND};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
set<uint> PnlWdbeModRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFKHDLTYPE, SCRJREFAPAR, SCRJREF1NPERIPHERAL, SCRJREFMDL1NGENERIC, SCRJREFCOR1NIMBUF, SCRJREFMDL1NPORT, SCRJREF1NPROCESS, SCRJREFMDL1NSIGNAL, SCRJREFSUP1NMODULE, SCRJREFMGE1NSIGNAL, SCRJREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, SCRJREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, SCRJREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, SCRJREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
