...
PnlWdbeModRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPERIPHERAL, INITDONEMDL1NSIGNAL, INITDONE1NPROCESS, INITDONEMDL1NPORT, INITDONECOR1NIMBUF, INITDONEMDL1NGENERIC, INITDONESUP1NMODULE, INITDONEMGE1NSIGNAL, INITDONECTRREF1NCOMMAND, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRMNCOMMAND};
};
...
set<uint> PnlWdbeModRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEKHDLTYPE, INITDONEAPAR, INITDONE1NPERIPHERAL, INITDONEMDL1NSIGNAL, INITDONE1NPROCESS, INITDONEMDL1NPORT, INITDONECOR1NIMBUF, INITDONEMDL1NGENERIC, INITDONESUP1NMODULE, INITDONEMGE1NSIGNAL, INITDONECTRREF1NCOMMAND, INITDONECTRREF1NERROR, INITDONECTRHK1NVECTOR, INITDONECTRMNCOMMAND};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
