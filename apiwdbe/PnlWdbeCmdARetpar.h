/**
	...
	* API code for job PnlWdbeCmdARetpar (declarations)
...
namespace PnlWdbeCmdARetpar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeCmdARetpar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeCmdARetpar::StatApp statappqry;
