...
PnlWdbeVerRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEBVR1NVERSION, INITDONE1NRELEASE, INITDONE1NSYSTEM, INITDONE1NUNIT, INITDONEREF1NFILE, INITDONEMNLIBRARY};
};
...
set<uint> PnlWdbeVerRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEBVR1NVERSION, INITDONE1NRELEASE, INITDONE1NSYSTEM, INITDONE1NUNIT, INITDONEREF1NFILE, INITDONEMNLIBRARY};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWdbeVerRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFBVR1NVERSION, SCRJREF1NRELEASE, SCRJREF1NSYSTEM, SCRJREF1NUNIT, SCRJREFREF1NFILE, SCRJREFMNLIBRARY, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeVerRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, SCRJREFDETAIL, SCRJREFBVR1NVERSION, SCRJREF1NRELEASE, SCRJREF1NSYSTEM, SCRJREF1NUNIT, SCRJREFREF1NFILE, SCRJREFMNLIBRARY, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
