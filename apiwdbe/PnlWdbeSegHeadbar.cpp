/**
	* \file PnlWdbeSegHeadbar.cpp
	* API code for job PnlWdbeSegHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbeSegHeadbar::StgInf
 ******************************************************************************/

PnlWdbeSegHeadbar::StgInf::StgInf(
...
bool PnlWdbeSegHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeSegHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeSegHeadbar";
...
set<uint> PnlWdbeSegHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeSegHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeSegHeadbar::Tag
 ******************************************************************************/

PnlWdbeSegHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbeSegHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeSegHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeSegHeadbar";
...
/******************************************************************************
 class PnlWdbeSegHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeSegHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBESEGHEADBARDATA)
		{
};

string PnlWdbeSegHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeSegHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeSegHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
