/**
	...
	* API code for job QryWdbeCmdHk1NVector (implementation)
...
/******************************************************************************
 class QryWdbeCmdHk1NVector::StatApp
 ******************************************************************************/

QryWdbeCmdHk1NVector::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeCmdHk1NVector::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeCmdHk1NVector");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeCmdHk1NVector";
...
set<uint> QryWdbeCmdHk1NVector::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCmdHk1NVector::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeCmdHk1NVector::StatShr
 ******************************************************************************/

QryWdbeCmdHk1NVector::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeCmdHk1NVector::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeCmdHk1NVector");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeCmdHk1NVector";
...
set<uint> QryWdbeCmdHk1NVector::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCmdHk1NVector::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeCmdHk1NVector::StgIac
 ******************************************************************************/

QryWdbeCmdHk1NVector::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeCmdHk1NVector::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeCmdHk1NVector");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeCmdHk1NVector";
...
void QryWdbeCmdHk1NVector::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeCmdHk1NVector";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeCmdHk1NVector";
...
set<uint> QryWdbeCmdHk1NVector::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCmdHk1NVector::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
