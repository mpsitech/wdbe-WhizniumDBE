/**
	...
	* API code for job PnlWdbeUsgAAccess (declarations)
...
namespace PnlWdbeUsgAAccess {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeUsgAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeUsgAAccess::StatApp statappqry;
