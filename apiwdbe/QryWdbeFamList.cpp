...
/******************************************************************************
 class QryWdbeFamList::VecVOrd
 ******************************************************************************/

uint QryWdbeFamList::VecVOrd::getIx(
			const string& sref
		) {
...
/******************************************************************************
 class QryWdbeFamList::StatApp
 ******************************************************************************/

QryWdbeFamList::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeFamList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeFamList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeFamList";
...
set<uint> QryWdbeFamList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeFamList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeFamList::StatShr
 ******************************************************************************/

QryWdbeFamList::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeFamList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeFamList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeFamList";
...
set<uint> QryWdbeFamList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeFamList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeFamList::StgIac
 ******************************************************************************/

QryWdbeFamList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeFamList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeFamList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeFamList";
...
void QryWdbeFamList::StgIac::writeXML(
	...
	if (difftag.length() == 0) difftag = "StgIacQryWdbeFamList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeFamList";
...
set<uint> QryWdbeFamList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeFamList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
