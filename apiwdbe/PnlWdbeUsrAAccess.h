/**
	...
	* API code for job PnlWdbeUsrAAccess (declarations)
...
namespace PnlWdbeUsrAAccess {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeUsrAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeUsrAAccess::StatApp statappqry;
