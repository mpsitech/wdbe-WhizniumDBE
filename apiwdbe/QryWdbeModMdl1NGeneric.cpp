/**
	...
	* API code for job QryWdbeModMdl1NGeneric (implementation)
...
QryWdbeModMdl1NGeneric::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeModMdl1NGeneric::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeModMdl1NGeneric");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeModMdl1NGeneric";
...
set<uint> QryWdbeModMdl1NGeneric::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeModMdl1NGeneric::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeModMdl1NGeneric::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeModMdl1NGeneric");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeModMdl1NGeneric";
