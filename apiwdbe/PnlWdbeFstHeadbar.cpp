/**
	* \file PnlWdbeFstHeadbar.cpp
	* API code for job PnlWdbeFstHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbeFstHeadbar::StgInf
 ******************************************************************************/

PnlWdbeFstHeadbar::StgInf::StgInf(
...
bool PnlWdbeFstHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeFstHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeFstHeadbar";
...
set<uint> PnlWdbeFstHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeFstHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeFstHeadbar::Tag
 ******************************************************************************/

PnlWdbeFstHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbeFstHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeFstHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeFstHeadbar";
...
/******************************************************************************
 class PnlWdbeFstHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeFstHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEFSTHEADBARDATA)
		{
};

string PnlWdbeFstHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeFstHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeFstHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
