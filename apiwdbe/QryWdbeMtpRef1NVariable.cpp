/**
	...
	* API code for job QryWdbeMtpRef1NVariable (implementation)
...
QryWdbeMtpRef1NVariable::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeMtpRef1NVariable::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeMtpRef1NVariable");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeMtpRef1NVariable";
...
set<uint> QryWdbeMtpRef1NVariable::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMtpRef1NVariable::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWdbeMtpRef1NVariable::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeMtpRef1NVariable");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeMtpRef1NVariable";
