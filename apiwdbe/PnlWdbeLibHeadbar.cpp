/**
	* \file PnlWdbeLibHeadbar.cpp
	* API code for job PnlWdbeLibHeadbar (implementation)
...
PnlWdbeLibHeadbar::StgInf::StgInf(
...
bool PnlWdbeLibHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeLibHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeLibHeadbar";
...
set<uint> PnlWdbeLibHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeLibHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeLibHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeLibHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeLibHeadbar";
...
/******************************************************************************
 class PnlWdbeLibHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeLibHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBELIBHEADBARDATA)
		{
};

string PnlWdbeLibHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeLibHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeLibHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
