/**
	...
	* API code for job PnlWdbeMtpSup1NModule (implementation)
...
bool PnlWdbeMtpSup1NModule::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeMtpSup1NModule");
	else
...
PnlWdbeMtpSup1NModule::StatApp::StatApp(
...
bool PnlWdbeMtpSup1NModule::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeMtpSup1NModule");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeMtpSup1NModule::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMtpSup1NModule::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeMtpSup1NModule::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeMtpSup1NModule");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbeMtpSup1NModule::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeMtpSup1NModule");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpSup1NModule::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPSUP1NMODULEDATA, scrJref)
		{
...
void PnlWdbeMtpSup1NModule::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeMtpSup1NModuleData");
...
PnlWdbeMtpSup1NModule::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPSUP1NMODULEDO, scrJref)
		{
...
void PnlWdbeMtpSup1NModule::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeMtpSup1NModuleDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeMtpSup1NModule::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMTPSUP1NMODULEDATA)
		{
...
void PnlWdbeMtpSup1NModule::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeMtpSup1NModuleData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeMtpSup1NModule::StatApp();
		statshrqry = QryWdbeMtpSup1NModule::StatShr();
