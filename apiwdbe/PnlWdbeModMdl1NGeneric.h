/**
	...
	* API code for job PnlWdbeModMdl1NGeneric (declarations)
...
/**
	...
	*/
namespace PnlWdbeModMdl1NGeneric {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeModMdl1NGeneric::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeModMdl1NGeneric::StatApp statappqry;
