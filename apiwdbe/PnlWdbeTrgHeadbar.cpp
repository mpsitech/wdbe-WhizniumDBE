/**
	* \file PnlWdbeTrgHeadbar.cpp
	* API code for job PnlWdbeTrgHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbeTrgHeadbar::StgInf
 ******************************************************************************/

PnlWdbeTrgHeadbar::StgInf::StgInf(
...
bool PnlWdbeTrgHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeTrgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeTrgHeadbar";
...
set<uint> PnlWdbeTrgHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeTrgHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeTrgHeadbar::Tag
 ******************************************************************************/

PnlWdbeTrgHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbeTrgHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeTrgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeTrgHeadbar";
...
/******************************************************************************
 class PnlWdbeTrgHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeTrgHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBETRGHEADBARDATA)
		{
};

string PnlWdbeTrgHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeTrgHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeTrgHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
