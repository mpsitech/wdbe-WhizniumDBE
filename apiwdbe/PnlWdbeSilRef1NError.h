/**
	...
	* API code for job PnlWdbeSilRef1NError (declarations)
...
/**
	...
	*/
namespace PnlWdbeSilRef1NError {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeSilRef1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeSilRef1NError::StatApp statappqry;
