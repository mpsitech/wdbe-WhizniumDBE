/**
	* \file PnlWdbePrcKHdltype.cpp
	* API code for job PnlWdbePrcKHdltype (implementation)
...
bool PnlWdbePrcKHdltype::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbePrcKHdltype");
	else
...
PnlWdbePrcKHdltype::StatApp::StatApp(
...
bool PnlWdbePrcKHdltype::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbePrcKHdltype");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbePrcKHdltype::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcKHdltype::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbePrcKHdltype::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbePrcKHdltype");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbePrcKHdltype::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbePrcKHdltype");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbePrcKHdltype::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRCKHDLTYPEDATA, scrJref)
		{
...
void PnlWdbePrcKHdltype::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbePrcKHdltypeData");
...
PnlWdbePrcKHdltype::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRCKHDLTYPEDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWdbePrcKHdltype::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbePrcKHdltypeDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbePrcKHdltype::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEPRCKHDLTYPEDATA)
		{
...
void PnlWdbePrcKHdltype::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbePrcKHdltypeData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbePrcKHdltype::StatApp();
		statshrqry = QryWdbePrcKHdltype::StatShr();
