/**
	* \file PnlWdbeCdcHeadbar.h
	* API code for job PnlWdbeCdcHeadbar (declarations)
...
#ifndef PNLWDBECDCHEADBAR_H
#define PNLWDBECDCHEADBAR_H

#include "ApiWdbe_blks.h"

#define StgInfWdbeCdcHeadbar PnlWdbeCdcHeadbar::StgInf
#define TagWdbeCdcHeadbar PnlWdbeCdcHeadbar::Tag

#define DpchEngWdbeCdcHeadbarData PnlWdbeCdcHeadbar::DpchEngData

/**
	* PnlWdbeCdcHeadbar
	*/
namespace PnlWdbeCdcHeadbar {
	/**
