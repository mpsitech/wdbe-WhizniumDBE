/**
	* \file CrdWdbeVar.cpp
	* API code for job CrdWdbeVar (implementation)
...
bool CrdWdbeVar::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeVar");
	else
	...
	if (basefound) {
		...
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MtxCrdVar", MtxCrdVar)) add(MTXCRDVAR);
	};
...
bool CrdWdbeVar::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeVar");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> CrdWdbeVar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdWdbeVar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdWdbeVar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeVar");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool CrdWdbeVar::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeVar");
	else
		basefound = checkXPath(docctx, basexpath);
...
CrdWdbeVar::DpchAppDo::DpchAppDo(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEVARDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void CrdWdbeVar::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeVarDo");
...
CrdWdbeVar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEVARDATA)
		{
...
void CrdWdbeVar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeVarData");
	else
		basefound = checkXPath(docctx, basexpath);
