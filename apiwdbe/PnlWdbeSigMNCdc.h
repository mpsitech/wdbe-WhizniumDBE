/**
	...
	* API code for job PnlWdbeSigMNCdc (declarations)
...
namespace PnlWdbeSigMNCdc {
	...
	public:
		...
		static const Sbecore::uint TCODIR = 8;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoMref = "", const std::string& TcoDir = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeSigMNCdc::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeSigMNCdc::StatApp statappqry;
