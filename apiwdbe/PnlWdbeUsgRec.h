...
namespace PnlWdbeUsgRec {
	...
	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefAAccess = "", const std::string& scrJrefMNUser = "", const bool ButRegularizeActive = true);
