...
/******************************************************************************
 class QryWdbeRlsList::VecVOrd
 ******************************************************************************/

uint QryWdbeRlsList::VecVOrd::getIx(
			const string& sref
		) {
...
/******************************************************************************
 class QryWdbeRlsList::StatApp
 ******************************************************************************/

QryWdbeRlsList::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeRlsList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeRlsList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeRlsList";
...
set<uint> QryWdbeRlsList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeRlsList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeRlsList::StatShr
 ******************************************************************************/

QryWdbeRlsList::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeRlsList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeRlsList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeRlsList";
...
set<uint> QryWdbeRlsList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeRlsList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeRlsList::StgIac
 ******************************************************************************/

QryWdbeRlsList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeRlsList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeRlsList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeRlsList";
...
void QryWdbeRlsList::StgIac::writeXML(
	...
	if (difftag.length() == 0) difftag = "StgIacQryWdbeRlsList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeRlsList";
...
set<uint> QryWdbeRlsList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeRlsList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
