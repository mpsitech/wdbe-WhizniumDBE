/**
	...
	* API code for job PnlWdbeSil1NInterrupt (declarations)
...
/**
	...
	*/
namespace PnlWdbeSil1NInterrupt {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeSil1NInterrupt::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeSil1NInterrupt::StatApp statappqry;
