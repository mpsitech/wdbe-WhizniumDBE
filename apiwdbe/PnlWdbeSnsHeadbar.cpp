/**
	* \file PnlWdbeSnsHeadbar.cpp
	* API code for job PnlWdbeSnsHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbeSnsHeadbar::StgInf
 ******************************************************************************/

PnlWdbeSnsHeadbar::StgInf::StgInf(
...
bool PnlWdbeSnsHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbeSnsHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbeSnsHeadbar";
...
set<uint> PnlWdbeSnsHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeSnsHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeSnsHeadbar::Tag
 ******************************************************************************/

PnlWdbeSnsHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbeSnsHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeSnsHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbeSnsHeadbar";
...
/******************************************************************************
 class PnlWdbeSnsHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbeSnsHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBESNSHEADBARDATA)
		{
};

string PnlWdbeSnsHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeSnsHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeSnsHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
