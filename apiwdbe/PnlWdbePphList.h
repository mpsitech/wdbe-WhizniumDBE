/**
	...
	* API code for job PnlWdbePphList (declarations)
...
namespace PnlWdbePphList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbePphList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbePphList::StatApp statappqry;
