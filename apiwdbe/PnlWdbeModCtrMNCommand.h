/**
	...
	* API code for job PnlWdbeModCtrMNCommand (declarations)
...
/**
	...
	*/
namespace PnlWdbeModCtrMNCommand {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeModCtrMNCommand::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeModCtrMNCommand::StatApp statappqry;
