/**
	...
	* API code for job QryWdbeVecList (implementation)
...
/******************************************************************************
 class QryWdbeVecList::VecVOrd
 ******************************************************************************/

uint QryWdbeVecList::VecVOrd::getIx(
			const string& sref
		) {
...
/******************************************************************************
 class QryWdbeVecList::StatApp
 ******************************************************************************/

QryWdbeVecList::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeVecList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeVecList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeVecList";
...
set<uint> QryWdbeVecList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeVecList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeVecList::StatShr
 ******************************************************************************/

QryWdbeVecList::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeVecList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeVecList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeVecList";
...
set<uint> QryWdbeVecList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeVecList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeVecList::StgIac
 ******************************************************************************/

QryWdbeVecList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeVecList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeVecList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeVecList";
...
void QryWdbeVecList::StgIac::writeXML(
	...
	if (difftag.length() == 0) difftag = "StgIacQryWdbeVecList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeVecList";
...
set<uint> QryWdbeVecList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeVecList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
