...
namespace PnlWdbeUntRec {
	...
	public:
		...
		static const Sbecore::uint PNLSIL1NUNITAVAIL = 4;
	...
	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefSil1NUnit = "", const bool pnlsil1nunitAvail = false, const std::string& scrJref1NPeripheral = "", const std::string& scrJref1NBank = "", const std::string& scrJrefFwd1NController = "", const std::string& scrJref1NTarget = "", const std::string& scrJrefHk1NVector = "", const std::string& scrJrefHk1NModule = "", const std::string& scrJrefRef1NCommand = "", const std::string& scrJrefRef1NError = "", const bool ButRegularizeActive = true);
