/**
	* \file PnlWdbePrtList.h
	* API code for job PnlWdbePrtList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 23 Aug 2020
	* \date modified: 23 Aug 2020
	*/

#ifndef PNLWDBEPRTLIST_H
#define PNLWDBEPRTLIST_H
...
#define VecVWdbePrtListDo PnlWdbePrtList::VecVDo

#define ContIacWdbePrtList PnlWdbePrtList::ContIac
#define ContInfWdbePrtList PnlWdbePrtList::ContInf
#define StatShrWdbePrtList PnlWdbePrtList::StatShr
#define StgIacWdbePrtList PnlWdbePrtList::StgIac
#define TagWdbePrtList PnlWdbePrtList::Tag

#define DpchAppWdbePrtListData PnlWdbePrtList::DpchAppData
#define DpchAppWdbePrtListDo PnlWdbePrtList::DpchAppDo
#define DpchEngWdbePrtListData PnlWdbePrtList::DpchEngData

/**
	* PnlWdbePrtList
	*/
namespace PnlWdbePrtList {
	/**
	...
	public:
		...
		static const Sbecore::uint TCOMDLWIDTH = 2;
		static const Sbecore::uint TCOMDCWIDTH = 3;
		static const Sbecore::uint TCODIRWIDTH = 4;
		static const Sbecore::uint TCOHTYWIDTH = 5;
		static const Sbecore::uint TCOWIDWIDTH = 6;
		static const Sbecore::uint TCOMMXWIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoMdlWidth = 100, const Sbecore::uint TcoMdcWidth = 100, const Sbecore::uint TcoDirWidth = 100, const Sbecore::uint TcoHtyWidth = 100, const Sbecore::uint TcoWidWidth = 100, const Sbecore::uint TcoMmxWidth = 100);

	public:
		Sbecore::uint TcoSrfWidth;
		Sbecore::uint TcoMdlWidth;
		Sbecore::uint TcoMdcWidth;
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbePrtList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbePrtList::StatApp statappqry;
