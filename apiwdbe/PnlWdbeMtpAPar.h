/**
	...
	* API code for job PnlWdbeMtpAPar (declarations)
...
namespace PnlWdbeMtpAPar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeMtpAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeMtpAPar::StatApp statappqry;
