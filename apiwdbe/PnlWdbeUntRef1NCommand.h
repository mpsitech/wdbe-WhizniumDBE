/**
	...
	* API code for job PnlWdbeUntRef1NCommand (declarations)
...
/**
	...
	*/
namespace PnlWdbeUntRef1NCommand {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeUntRef1NCommand::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeUntRef1NCommand::StatApp statappqry;
