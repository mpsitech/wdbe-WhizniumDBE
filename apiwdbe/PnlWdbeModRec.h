...
namespace PnlWdbeModRec {
	...
	public:
		...
		static const Sbecore::uint INITDONECOR1NIMBUF = 6;
		static const Sbecore::uint INITDONEMDL1NPORT = 7;
		static const Sbecore::uint INITDONE1NPROCESS = 8;
		static const Sbecore::uint INITDONEMDL1NSIGNAL = 9;
	...
	public:
		...
		static const Sbecore::uint SCRJREFCOR1NIMBUF = 7;
		static const Sbecore::uint SCRJREFMDL1NPORT = 8;
		static const Sbecore::uint SCRJREF1NPROCESS = 9;
		static const Sbecore::uint SCRJREFMDL1NSIGNAL = 10;
	...
	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefKHdltype = "", const std::string& scrJrefAPar = "", const std::string& scrJref1NPeripheral = "", const std::string& scrJrefMdl1NGeneric = "", const std::string& scrJrefCor1NImbuf = "", const std::string& scrJrefMdl1NPort = "", const std::string& scrJref1NProcess = "", const std::string& scrJrefMdl1NSignal = "", const std::string& scrJrefSup1NModule = "", const std::string& scrJrefMge1NSignal = "", const std::string& scrJrefCtrRef1NError = "", const bool pnlctrref1nerrorAvail = false, const std::string& scrJrefCtrHk1NVector = "", const bool pnlctrhk1nvectorAvail = false, const std::string& scrJrefCtrRef1NCommand = "", const bool pnlctrref1ncommandAvail = false, const std::string& scrJrefCtrMNCommand = "", const bool pnlctrmncommandAvail = false, const bool ButRegularizeActive = true);
