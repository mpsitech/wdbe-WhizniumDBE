...
namespace PnlWdbeModRec {
	...
	public:
		...
		static const Sbecore::uint INITDONEMDL1NSIGNAL = 5;
		...
		static const Sbecore::uint INITDONEMDL1NGENERIC = 9;
	...
	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneKHdltype = false, const bool initdoneAPar = false, const bool initdone1NPeripheral = false, const bool initdoneMdl1NSignal = false, const bool initdone1NProcess = false, const bool initdoneMdl1NPort = false, const bool initdoneCor1NImbuf = false, const bool initdoneMdl1NGeneric = false, const bool initdoneSup1NModule = false, const bool initdoneMge1NSignal = false, const bool initdoneCtrRef1NCommand = false, const bool initdoneCtrRef1NError = false, const bool initdoneCtrHk1NVector = false, const bool initdoneCtrMNCommand = false);
	...
	public:
		...
		static const Sbecore::uint SCRJREFMDL1NSIGNAL = 6;
		...
		static const Sbecore::uint SCRJREFMDL1NGENERIC = 10;
	...
	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefKHdltype = "", const std::string& scrJrefAPar = "", const std::string& scrJref1NPeripheral = "", const std::string& scrJrefMdl1NSignal = "", const std::string& scrJref1NProcess = "", const std::string& scrJrefMdl1NPort = "", const std::string& scrJrefCor1NImbuf = "", const std::string& scrJrefMdl1NGeneric = "", const std::string& scrJrefSup1NModule = "", const std::string& scrJrefMge1NSignal = "", const std::string& scrJrefCtrRef1NCommand = "", const bool pnlctrref1ncommandAvail = false, const std::string& scrJrefCtrRef1NError = "", const bool pnlctrref1nerrorAvail = false, const std::string& scrJrefCtrHk1NVector = "", const bool pnlctrhk1nvectorAvail = false, const std::string& scrJrefCtrMNCommand = "", const bool pnlctrmncommandAvail = false, const bool ButRegularizeActive = true);
