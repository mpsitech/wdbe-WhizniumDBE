/**
	...
	* API code for job QryWdbeCprList (implementation)
...
/******************************************************************************
 class QryWdbeCprList::VecVOrd
 ******************************************************************************/

uint QryWdbeCprList::VecVOrd::getIx(
			const string& sref
		) {
...
/******************************************************************************
 class QryWdbeCprList::StatApp
 ******************************************************************************/

QryWdbeCprList::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeCprList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeCprList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeCprList";
...
set<uint> QryWdbeCprList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCprList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeCprList::StatShr
 ******************************************************************************/

QryWdbeCprList::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeCprList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeCprList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeCprList";
...
set<uint> QryWdbeCprList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCprList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeCprList::StgIac
 ******************************************************************************/

QryWdbeCprList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeCprList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeCprList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeCprList";
...
void QryWdbeCprList::StgIac::writeXML(
	...
	if (difftag.length() == 0) difftag = "StgIacQryWdbeCprList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeCprList";
...
set<uint> QryWdbeCprList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCprList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
