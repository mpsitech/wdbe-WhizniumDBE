/**
	...
	* API code for job PnlWdbePrsADetail (declarations)
...
namespace PnlWdbePrsADetail {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbePrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbePrsADetail::StatApp statappqry;
