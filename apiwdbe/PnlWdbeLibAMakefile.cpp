/**
	* \file PnlWdbeLibAMakefile.cpp
	* API code for job PnlWdbeLibAMakefile (implementation)
...
bool PnlWdbeLibAMakefile::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWdbeLibAMakefile");
	else
...
PnlWdbeLibAMakefile::StatApp::StatApp(
...
bool PnlWdbeLibAMakefile::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWdbeLibAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWdbeLibAMakefile::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeLibAMakefile::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeLibAMakefile::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWdbeLibAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWdbeLibAMakefile::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbeLibAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeLibAMakefile::DpchAppData::DpchAppData(
			...
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBELIBAMAKEFILEDATA, scrJref)
		{
...
void PnlWdbeLibAMakefile::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeLibAMakefileData");
...
void PnlWdbeLibAMakefile::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWdbeLibAMakefileDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWdbeLibAMakefile::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBELIBAMAKEFILEDATA)
		{
...
void PnlWdbeLibAMakefile::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbeLibAMakefileData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWdbeLibAMakefile::StatApp();
		statshrqry = QryWdbeLibAMakefile::StatShr();
