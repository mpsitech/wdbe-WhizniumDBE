/**
	* \file PnlWdbeGenList.h
	* API code for job PnlWdbeGenList (declarations)
...
#ifndef PNLWDBEGENLIST_H
#define PNLWDBEGENLIST_H
...
#define VecVWdbeGenListDo PnlWdbeGenList::VecVDo

#define ContIacWdbeGenList PnlWdbeGenList::ContIac
#define ContInfWdbeGenList PnlWdbeGenList::ContInf
#define StatShrWdbeGenList PnlWdbeGenList::StatShr
#define StgIacWdbeGenList PnlWdbeGenList::StgIac
#define TagWdbeGenList PnlWdbeGenList::Tag

#define DpchAppWdbeGenListData PnlWdbeGenList::DpchAppData
#define DpchAppWdbeGenListDo PnlWdbeGenList::DpchAppDo
#define DpchEngWdbeGenListData PnlWdbeGenList::DpchEngData

/**
	* PnlWdbeGenList
	*/
namespace PnlWdbeGenList {
	/**
	...
	public:
		...
		static const Sbecore::uint TCOHTYWIDTH = 3;
		static const Sbecore::uint TCOWIDWIDTH = 4;
		static const Sbecore::uint TCOMMXWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoMdlWidth = 100, const Sbecore::uint TcoHtyWidth = 100, const Sbecore::uint TcoWidWidth = 100, const Sbecore::uint TcoMmxWidth = 100);
	...
	public:
		...
		static const Sbecore::uint TCOHTY = 10;
		static const Sbecore::uint TCOWID = 11;
		static const Sbecore::uint TCOMMX = 12;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtFor = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoMdl = "", const std::string& TcoHty = "", const std::string& TcoWid = "", const std::string& TcoMmx = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbeGenList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeGenList::StatApp statappqry;
