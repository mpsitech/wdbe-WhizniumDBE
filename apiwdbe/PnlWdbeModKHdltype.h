/**
	...
	* API code for job PnlWdbeModKHdltype (declarations)
...
namespace PnlWdbeModKHdltype {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeModKHdltype::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeModKHdltype::StatApp statappqry;
