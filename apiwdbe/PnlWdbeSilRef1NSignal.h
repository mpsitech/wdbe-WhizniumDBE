/**
	...
	* API code for job PnlWdbeSilRef1NSignal (declarations)
...
/**
	...
	*/
namespace PnlWdbeSilRef1NSignal {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWdbeSilRef1NSignal::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeSilRef1NSignal::StatApp statappqry;
