/**
	...
	* API code for job QryWdbeUnt1NPeripheral (implementation)
...
/******************************************************************************
 class QryWdbeUnt1NPeripheral::StatApp
 ******************************************************************************/

QryWdbeUnt1NPeripheral::StatApp::StatApp(
			const uint firstcol
...
bool QryWdbeUnt1NPeripheral::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWdbeUnt1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWdbeUnt1NPeripheral";
...
set<uint> QryWdbeUnt1NPeripheral::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeUnt1NPeripheral::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeUnt1NPeripheral::StatShr
 ******************************************************************************/

QryWdbeUnt1NPeripheral::StatShr::StatShr(
			const uint ntot
...
bool QryWdbeUnt1NPeripheral::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWdbeUnt1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWdbeUnt1NPeripheral";
...
set<uint> QryWdbeUnt1NPeripheral::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeUnt1NPeripheral::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeUnt1NPeripheral::StgIac
 ******************************************************************************/

QryWdbeUnt1NPeripheral::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeUnt1NPeripheral::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeUnt1NPeripheral");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeUnt1NPeripheral";
...
void QryWdbeUnt1NPeripheral::StgIac::writeXML(
	...
	if (difftag.length() == 0) difftag = "StgIacQryWdbeUnt1NPeripheral";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeUnt1NPeripheral";
...
set<uint> QryWdbeUnt1NPeripheral::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeUnt1NPeripheral::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
