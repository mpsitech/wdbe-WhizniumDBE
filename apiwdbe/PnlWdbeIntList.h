/**
	...
	* API code for job PnlWdbeIntList (declarations)
...
namespace PnlWdbeIntList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWdbeIntList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWdbeIntList::StatApp statappqry;
