/**
	* \file PnlWdbePrcHeadbar.cpp
	* API code for job PnlWdbePrcHeadbar (implementation)
...
/******************************************************************************
 class PnlWdbePrcHeadbar::StgInf
 ******************************************************************************/

PnlWdbePrcHeadbar::StgInf::StgInf(
...
bool PnlWdbePrcHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWdbePrcHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWdbePrcHeadbar";
...
set<uint> PnlWdbePrcHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrcHeadbar::Tag
 ******************************************************************************/

PnlWdbePrcHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWdbePrcHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWdbePrcHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWdbePrcHeadbar";
...
/******************************************************************************
 class PnlWdbePrcHeadbar::DpchEngData
 ******************************************************************************/

PnlWdbePrcHeadbar::DpchEngData::DpchEngData() :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEPRCHEADBARDATA)
		{
};

string PnlWdbePrcHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrcHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWdbePrcHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
