...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQSysSys1NTarget* rst = NULL, QryWdbeSysSys1NTarget::StatShr* statshrqry = NULL, QryWdbeSysSys1NTarget::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
