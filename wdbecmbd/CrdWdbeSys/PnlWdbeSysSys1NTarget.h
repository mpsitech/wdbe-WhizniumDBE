/**
	* \file PnlWdbeSysSys1NTarget.h
	* job handler for job PnlWdbeSysSys1NTarget (declarations)
...
#ifndef PNLWDBESYSSYS1NTARGET_H
#define PNLWDBESYSSYS1NTARGET_H
...
#define VecVWdbeSysSys1NTargetDo PnlWdbeSysSys1NTarget::VecVDo

#define ContInfWdbeSysSys1NTarget PnlWdbeSysSys1NTarget::ContInf
#define StatAppWdbeSysSys1NTarget PnlWdbeSysSys1NTarget::StatApp
#define StatShrWdbeSysSys1NTarget PnlWdbeSysSys1NTarget::StatShr
#define StgIacWdbeSysSys1NTarget PnlWdbeSysSys1NTarget::StgIac
#define TagWdbeSysSys1NTarget PnlWdbeSysSys1NTarget::Tag

#define DpchAppWdbeSysSys1NTargetData PnlWdbeSysSys1NTarget::DpchAppData
#define DpchAppWdbeSysSys1NTargetDo PnlWdbeSysSys1NTarget::DpchAppDo
#define DpchEngWdbeSysSys1NTargetData PnlWdbeSysSys1NTarget::DpchEngData

/**
	* PnlWdbeSysSys1NTarget
	*/
class PnlWdbeSysSys1NTarget : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQSysSys1NTarget* rst = NULL, QryWdbeSysSys1NTarget::StatShr* statshrqry = NULL, QryWdbeSysSys1NTarget::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeSysSys1NTarget(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeSysSys1NTarget();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeSysSys1NTarget::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
