...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQSysList* rst = NULL, QryWdbeSysList::StatShr* statshrqry = NULL, QryWdbeSysList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
