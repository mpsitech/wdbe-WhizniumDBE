/**
	...
	* job handler for job QryWdbeSysSys1NTarget (declarations)
...
/**
	...
	*/
class QryWdbeSysSys1NTarget : public JobWdbe {
...
public:
	QryWdbeSysSys1NTarget(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeSysSys1NTarget();
...
public:
	...
	WdbeQSysSys1NTarget* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWdbeTrgMod_sysEq(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
