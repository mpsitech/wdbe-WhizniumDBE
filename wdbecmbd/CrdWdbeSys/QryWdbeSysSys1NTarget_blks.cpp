/**
	* \file QryWdbeSysSys1NTarget_blks.cpp
	* job handler for job QryWdbeSysSys1NTarget (implementation of blocks)
...
/******************************************************************************
 class QryWdbeSysSys1NTarget::StatApp
 ******************************************************************************/

void QryWdbeSysSys1NTarget::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeSysSys1NTarget";
...
void QryWdbeSysSys1NTarget::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeSysSys1NTarget";
...
/******************************************************************************
 class QryWdbeSysSys1NTarget::StatShr
 ******************************************************************************/

QryWdbeSysSys1NTarget::StatShr::StatShr(
			const uint ntot
...
void QryWdbeSysSys1NTarget::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeSysSys1NTarget";
...
void QryWdbeSysSys1NTarget::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeSysSys1NTarget";
...
set<uint> QryWdbeSysSys1NTarget::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSysSys1NTarget::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeSysSys1NTarget::StgIac
 ******************************************************************************/

QryWdbeSysSys1NTarget::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeSysSys1NTarget::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeSysSys1NTarget");
	else
...
void QryWdbeSysSys1NTarget::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeSysSys1NTarget";
...
void QryWdbeSysSys1NTarget::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> QryWdbeSysSys1NTarget::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSysSys1NTarget::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
