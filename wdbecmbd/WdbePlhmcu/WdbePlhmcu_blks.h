...
/**
	* DpchInvWdbePlhmcuEctr
	*/
class DpchInvWdbePlhmcuEctr : public DpchInvWdbe {
...
public:
	DpchInvWdbePlhmcuEctr(const Sbecore::ubigint oref = 0, const Sbecore::ubigint jref = 0, const Sbecore::ubigint refWdbeMModule = 0);
...
/**
	* DpchRetWdbePlhmcuEctr
	*/
class DpchRetWdbePlhmcuEctr : public DpchRetWdbe {
...
public:
	DpchRetWdbePlhmcuEctr(const std::string& scrOref = "", const std::string& scrJref = "", const Sbecore::uint ixOpVOpres = 0, const Sbecore::utinyint pdone = 0, const std::vector<std::string>& keys = {}, const std::vector<std::string>& vals = {});
