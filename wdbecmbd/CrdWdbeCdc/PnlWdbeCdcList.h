/**
	* \file PnlWdbeCdcList.h
	* job handler for job PnlWdbeCdcList (declarations)
...
#ifndef PNLWDBECDCLIST_H
#define PNLWDBECDCLIST_H
...
#define VecVWdbeCdcListDo PnlWdbeCdcList::VecVDo

#define ContIacWdbeCdcList PnlWdbeCdcList::ContIac
#define ContInfWdbeCdcList PnlWdbeCdcList::ContInf
#define StatShrWdbeCdcList PnlWdbeCdcList::StatShr
#define StgIacWdbeCdcList PnlWdbeCdcList::StgIac
#define TagWdbeCdcList PnlWdbeCdcList::Tag

#define DpchAppWdbeCdcListData PnlWdbeCdcList::DpchAppData
#define DpchAppWdbeCdcListDo PnlWdbeCdcList::DpchAppDo
#define DpchEngWdbeCdcListData PnlWdbeCdcList::DpchEngData

/**
	* PnlWdbeCdcList
	*/
class PnlWdbeCdcList : public JobWdbe {
...
public:
	...
	public:
		static const Sbecore::uint TCOMDLWIDTH = 1;

	public:
		StgIac(const Sbecore::uint TcoMdlWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCdcList* rst = NULL, QryWdbeCdcList::StatShr* statshrqry = NULL, QryWdbeCdcList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCdcList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCdcList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCdcList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
