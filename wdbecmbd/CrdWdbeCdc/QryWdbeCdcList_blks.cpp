/**
	* \file QryWdbeCdcList_blks.cpp
	* job handler for job QryWdbeCdcList (implementation of blocks)
...
/******************************************************************************
 class QryWdbeCdcList::VecVOrd
 ******************************************************************************/

uint QryWdbeCdcList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryWdbeCdcList::VecVOrd::getSref(
			const uint ix
		) {
...
void QryWdbeCdcList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWdbeCdcList::StatApp
 ******************************************************************************/

void QryWdbeCdcList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeCdcList";
...
void QryWdbeCdcList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeCdcList";
...
/******************************************************************************
 class QryWdbeCdcList::StatShr
 ******************************************************************************/

QryWdbeCdcList::StatShr::StatShr(
			const uint ntot
...
void QryWdbeCdcList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeCdcList";
...
void QryWdbeCdcList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeCdcList";
...
set<uint> QryWdbeCdcList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCdcList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeCdcList::StgIac
 ******************************************************************************/

QryWdbeCdcList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeCdcList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbeCdcList"];}();
...
bool QryWdbeCdcList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeCdcList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeCdcList";
...
void QryWdbeCdcList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeCdcList";
...
void QryWdbeCdcList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeCdcList";
...
set<uint> QryWdbeCdcList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeCdcList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
