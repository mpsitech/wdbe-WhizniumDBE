/**
	* \file PnlWdbeRlsRec.h
	* job handler for job PnlWdbeRlsRec (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBERLSREC_H
#define PNLWDBERLSREC_H
...
#define VecVWdbeRlsRecDo PnlWdbeRlsRec::VecVDo

#define ContInfWdbeRlsRec PnlWdbeRlsRec::ContInf
#define StatAppWdbeRlsRec PnlWdbeRlsRec::StatApp
#define StatShrWdbeRlsRec PnlWdbeRlsRec::StatShr
#define TagWdbeRlsRec PnlWdbeRlsRec::Tag

#define DpchAppWdbeRlsRecDo PnlWdbeRlsRec::DpchAppDo
#define DpchEngWdbeRlsRecData PnlWdbeRlsRec::DpchEngData

/**
	* PnlWdbeRlsRec
	*/
class PnlWdbeRlsRec : public JobWdbe {
...
public:
	PnlWdbeRlsRec(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeRlsRec();
