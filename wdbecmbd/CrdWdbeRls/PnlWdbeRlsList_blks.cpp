/**
	* \file PnlWdbeRlsList_blks.cpp
	* job handler for job PnlWdbeRlsList (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeRlsList::VecVDo
 ******************************************************************************/

uint PnlWdbeRlsList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeRlsList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeRlsList::ContIac
 ******************************************************************************/

PnlWdbeRlsList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
			, numFTos(numFTos)
...
bool PnlWdbeRlsList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWdbeRlsList");
	else
...
void PnlWdbeRlsList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWdbeRlsList";
...
set<uint> PnlWdbeRlsList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeRlsList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeRlsList::ContInf
 ******************************************************************************/

PnlWdbeRlsList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWdbeRlsList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeRlsList";
...
void PnlWdbeRlsList::ContInf::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWdbeRlsList";
...
set<uint> PnlWdbeRlsList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeRlsList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeRlsList::StatShr
 ******************************************************************************/

PnlWdbeRlsList::StatShr::StatShr(
...
void PnlWdbeRlsList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeRlsList";
...
void PnlWdbeRlsList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWdbeRlsList";
...
set<uint> PnlWdbeRlsList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeRlsList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbeRlsList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeRlsList");
	else
		basefound = checkXPath(docctx, basexpath);
...
void PnlWdbeRlsList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeRlsList";
...
set<uint> PnlWdbeRlsList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeRlsList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeRlsList::Tag
 ******************************************************************************/

void PnlWdbeRlsList::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeRlsList";
...
void PnlWdbeRlsList::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeRlsList";
...
/******************************************************************************
 class PnlWdbeRlsList::DpchAppData
 ******************************************************************************/

PnlWdbeRlsList::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBERLSLISTDATA)
		{
};

string PnlWdbeRlsList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeRlsList::DpchAppData::readJSON(
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWdbeRlsList::StgIac();
	};
};

void PnlWdbeRlsList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeRlsListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeRlsList::DpchAppDo
 ******************************************************************************/

PnlWdbeRlsList::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBERLSLISTDO)
		{
	ixVDo = 0;
};

string PnlWdbeRlsList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeRlsList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeRlsListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeRlsList::DpchEngData
 ******************************************************************************/

PnlWdbeRlsList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBERLSLISTDATA, jref)
		{
...
string PnlWdbeRlsList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeRlsList::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeRlsList::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeRlsListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeRlsList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeRlsList::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeRlsListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeRlsList::StatApp::writeXML(wr);
