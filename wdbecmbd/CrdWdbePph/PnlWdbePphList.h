/**
	* \file PnlWdbePphList.h
	* job handler for job PnlWdbePphList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 23 Aug 2020
	* \date modified: 23 Aug 2020
	*/

#ifndef PNLWDBEPPHLIST_H
#define PNLWDBEPPHLIST_H
...
#define VecVWdbePphListDo PnlWdbePphList::VecVDo

#define ContIacWdbePphList PnlWdbePphList::ContIac
#define ContInfWdbePphList PnlWdbePphList::ContInf
#define StatShrWdbePphList PnlWdbePphList::StatShr
#define StgIacWdbePphList PnlWdbePphList::StgIac
#define TagWdbePphList PnlWdbePphList::Tag

#define DpchAppWdbePphListData PnlWdbePphList::DpchAppData
#define DpchAppWdbePphListDo PnlWdbePphList::DpchAppDo
#define DpchEngWdbePphListData PnlWdbePphList::DpchEngData

/**
	* PnlWdbePphList
	*/
class PnlWdbePphList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPphList* rst = NULL, QryWdbePphList::StatShr* statshrqry = NULL, QryWdbePphList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePphList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePphList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePphList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
