...
void QryWdbePphAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
...
void QryWdbePphAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool QryWdbePphAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbePphAPar"];}();
...
void QryWdbePphAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
