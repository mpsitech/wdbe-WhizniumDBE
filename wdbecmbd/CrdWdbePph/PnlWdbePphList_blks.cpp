/**
	* \file PnlWdbePphList_blks.cpp
	* job handler for job PnlWdbePphList (implementation of blocks)
...
/******************************************************************************
 class PnlWdbePphList::VecVDo
 ******************************************************************************/

uint PnlWdbePphList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbePphList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbePphList::ContIac
 ******************************************************************************/

PnlWdbePphList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
			, numFTos(numFTos)
...
bool PnlWdbePphList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWdbePphList"];}();
...
bool PnlWdbePphList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWdbePphList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWdbePphList";
...
void PnlWdbePphList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWdbePphList";
...
void PnlWdbePphList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWdbePphList";
...
set<uint> PnlWdbePphList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePphList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePphList::ContInf
 ******************************************************************************/

PnlWdbePphList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWdbePphList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbePphList";
...
void PnlWdbePphList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWdbePphList";
...
set<uint> PnlWdbePphList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePphList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePphList::StatShr
 ******************************************************************************/

PnlWdbePphList::StatShr::StatShr(
...
void PnlWdbePphList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbePphList";
...
void PnlWdbePphList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWdbePphList";
...
set<uint> PnlWdbePphList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePphList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWdbePphList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbePphList"];}();
...
bool PnlWdbePphList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbePphList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbePphList";
...
void PnlWdbePphList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbePphList";
...
void PnlWdbePphList::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbePphList";
...
set<uint> PnlWdbePphList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePphList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePphList::Tag
 ******************************************************************************/

void PnlWdbePphList::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbePphList";
...
void PnlWdbePphList::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbePphList";
...
/******************************************************************************
 class PnlWdbePphList::DpchAppData
 ******************************************************************************/

PnlWdbePphList::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPPHLISTDATA)
		{
};

string PnlWdbePphList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePphList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePphListData"];}();
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWdbePphList::StgIac();
	};
};

void PnlWdbePphList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePphListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePphList::DpchAppDo
 ******************************************************************************/

PnlWdbePphList::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPPHLISTDO)
		{
	ixVDo = 0;
};

string PnlWdbePphList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePphList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePphListDo"];}();
...
void PnlWdbePphList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePphListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePphList::DpchEngData
 ******************************************************************************/

PnlWdbePphList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, QryWdbePphList::StatShr* statshrqry
			, QryWdbePphList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEPPHLISTDATA, jref)
		{
...
string PnlWdbePphList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePphList::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbePphList::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbePphListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbePphList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbePphList::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbePphListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbePphList::StatApp::writeXML(wr);
