/**
	* \file CrdWdbePph.h
	* job handler for job CrdWdbePph (declarations)
...
#define VecVWdbePphDo CrdWdbePph::VecVDo
#define VecVWdbePphSge CrdWdbePph::VecVSge

#define ContInfWdbePph CrdWdbePph::ContInf
#define StatAppWdbePph CrdWdbePph::StatApp
#define StatShrWdbePph CrdWdbePph::StatShr
#define TagWdbePph CrdWdbePph::Tag

#define DpchAppWdbePphDo CrdWdbePph::DpchAppDo
#define DpchEngWdbePphData CrdWdbePph::DpchEngData

/**
	* CrdWdbePph
	*/
class CrdWdbePph : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDPPH = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdPph = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdPph;
...
public:
	CrdWdbePph(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbePph();
...
public:
	...
	PnlWdbePphRec* pnlrec;
	PnlWdbePphHeadbar* pnlheadbar;
	PnlWdbePphList* pnllist;
