/**
	* \file QryWdbePphList.h
	* job handler for job QryWdbePphList (declarations)
...
#ifndef QRYWDBEPPHLIST_H
#define QRYWDBEPPHLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbePphListOrd QryWdbePphList::VecVOrd

#define StatAppQryWdbePphList QryWdbePphList::StatApp
#define StatShrQryWdbePphList QryWdbePphList::StatShr
#define StgIacQryWdbePphList QryWdbePphList::StgIac

/**
	* QryWdbePphList
	*/
class QryWdbePphList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbePphListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbePphList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbePphList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbePphList)
		*/
...
public:
	QryWdbePphList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePphList();
...
public:
	...
	WdbeQPphList* getRecByJnum(const Sbecore::uint jnum);
