/**
	* \file PnlWdbePphMNModule_evals.cpp
	* job handler for job PnlWdbePphMNModule (implementation of availability/activation evaluation)
...
bool PnlWdbePphMNModule::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbePphMNModule::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
...
bool PnlWdbePphMNModule::evalButAddAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbePphMNModule::evalButSubAvail(
			DbsWdbe* dbswdbe
		) {
	// pre.ixCrdaccPphIncl(edit)
...
bool PnlWdbePphMNModule::evalButSubActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
