/**
	* \file PnlWdbePphAPar.h
	* job handler for job PnlWdbePphAPar (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEPPHAPAR_H
#define PNLWDBEPPHAPAR_H
...
#define VecVWdbePphAParDo PnlWdbePphAPar::VecVDo

#define ContInfWdbePphAPar PnlWdbePphAPar::ContInf
#define StatAppWdbePphAPar PnlWdbePphAPar::StatApp
#define StatShrWdbePphAPar PnlWdbePphAPar::StatShr
#define StgIacWdbePphAPar PnlWdbePphAPar::StgIac
#define TagWdbePphAPar PnlWdbePphAPar::Tag

#define DpchAppWdbePphAParData PnlWdbePphAPar::DpchAppData
#define DpchAppWdbePphAParDo PnlWdbePphAPar::DpchAppDo
#define DpchEngWdbePphAParData PnlWdbePphAPar::DpchEngData

/**
	* PnlWdbePphAPar
	*/
class PnlWdbePphAPar : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPphAPar* rst = NULL, QryWdbePphAPar::StatShr* statshrqry = NULL, QryWdbePphAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePphAPar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePphAPar();
...
public:
	...
	WdbeAMPeripheralPar recPphApar;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePphAPar::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
