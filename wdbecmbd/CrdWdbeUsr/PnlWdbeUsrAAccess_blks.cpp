/**
	* \file PnlWdbeUsrAAccess_blks.cpp
	* job handler for job PnlWdbeUsrAAccess (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeUsrAAccess::VecVDo
 ******************************************************************************/

uint PnlWdbeUsrAAccess::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeUsrAAccess::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeUsrAAccess::ContInf
 ******************************************************************************/

PnlWdbeUsrAAccess::ContInf::ContInf(
...
void PnlWdbeUsrAAccess::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeUsrAAccess";
...
void PnlWdbeUsrAAccess::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeUsrAAccess";
...
set<uint> PnlWdbeUsrAAccess::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeUsrAAccess::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeUsrAAccess::StatApp
 ******************************************************************************/

void PnlWdbeUsrAAccess::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeUsrAAccess";
...
void PnlWdbeUsrAAccess::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeUsrAAccess";
...
/******************************************************************************
 class PnlWdbeUsrAAccess::StatShr
 ******************************************************************************/

PnlWdbeUsrAAccess::StatShr::StatShr(
...
void PnlWdbeUsrAAccess::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeUsrAAccess";
...
void PnlWdbeUsrAAccess::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeUsrAAccess";
...
set<uint> PnlWdbeUsrAAccess::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeUsrAAccess::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeUsrAAccess::StgIac
 ******************************************************************************/

PnlWdbeUsrAAccess::StgIac::StgIac(
...
bool PnlWdbeUsrAAccess::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeUsrAAccess"];}();
...
bool PnlWdbeUsrAAccess::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeUsrAAccess");
	else
...
void PnlWdbeUsrAAccess::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeUsrAAccess";
...
void PnlWdbeUsrAAccess::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> PnlWdbeUsrAAccess::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeUsrAAccess::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeUsrAAccess::Tag
 ******************************************************************************/

void PnlWdbeUsrAAccess::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeUsrAAccess";
...
void PnlWdbeUsrAAccess::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeUsrAAccess";
...
/******************************************************************************
 class PnlWdbeUsrAAccess::DpchAppData
 ******************************************************************************/

PnlWdbeUsrAAccess::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEUSRAACCESSDATA)
		{
};

string PnlWdbeUsrAAccess::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeUsrAAccess::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUsrAAccessData"];}();
...
void PnlWdbeUsrAAccess::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeUsrAAccessData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeUsrAAccess::DpchAppDo
 ******************************************************************************/

PnlWdbeUsrAAccess::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEUSRAACCESSDO)
		{
	ixVDo = 0;
};

string PnlWdbeUsrAAccess::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeUsrAAccess::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUsrAAccessDo"];}();
...
void PnlWdbeUsrAAccess::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeUsrAAccessDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeUsrAAccess::DpchEngData
 ******************************************************************************/

PnlWdbeUsrAAccess::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWdbeUsrAAccess::StatShr* statshrqry
			, QryWdbeUsrAAccess::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEUSRAACCESSDATA, jref)
		{
...
string PnlWdbeUsrAAccess::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeUsrAAccess::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeUsrAAccess::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeUsrAAccessData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeUsrAAccess::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeUsrAAccess::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeUsrAAccessData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeUsrAAccess::StatApp::writeXML(wr);
