/**
	* \file CrdWdbeUsr.h
	* job handler for job CrdWdbeUsr (declarations)
...
/**
	* CrdWdbeUsr
	*/
class CrdWdbeUsr : public JobWdbe {
...
public:
	...
	public:
		static const Sbecore::uint JREFDLGMNGKEYPAIR = 1;
	...
	public:
		StatShr(const Sbecore::ubigint jrefDlgmngkeypair = 0, const Sbecore::ubigint jrefHeadbar = 0, const Sbecore::ubigint jrefList = 0, const Sbecore::ubigint jrefRec = 0, const bool MitCrdMkpAvail = true, const bool MitCrdMkpActive = true);

	public:
		Sbecore::ubigint jrefDlgmngkeypair;
	...
	bool evalMitCrdMkpAvail(DbsWdbe* dbswdbe);
	bool evalMitCrdMkpActive(DbsWdbe* dbswdbe);

public:
	CrdWdbeUsr(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbeUsr();
...
public:
	...
	DlgWdbeUsrMngkeypair* dlgmngkeypair;
	PnlWdbeUsrRec* pnlrec;
	PnlWdbeUsrHeadbar* pnlheadbar;
	PnlWdbeUsrList* pnllist;
...
private:
	...
	void handleDpchAppDoMitCrdMkpClick(DbsWdbe* dbswdbe, DpchEngWdbe** dpcheng);
