/**
	* \file QryWdbeUsrAAccess_blks.cpp
	* job handler for job QryWdbeUsrAAccess (implementation of blocks)
...
void QryWdbeUsrAAccess::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeUsrAAccess";
...
void QryWdbeUsrAAccess::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeUsrAAccess";
...
void QryWdbeUsrAAccess::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeUsrAAccess";
...
void QryWdbeUsrAAccess::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeUsrAAccess";
...
void QryWdbeUsrAAccess::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
