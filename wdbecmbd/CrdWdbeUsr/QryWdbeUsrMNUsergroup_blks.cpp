/**
	* \file QryWdbeUsrMNUsergroup_blks.cpp
	* job handler for job QryWdbeUsrMNUsergroup (implementation of blocks)
...
/******************************************************************************
 class QryWdbeUsrMNUsergroup::StatApp
 ******************************************************************************/

void QryWdbeUsrMNUsergroup::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeUsrMNUsergroup";
...
void QryWdbeUsrMNUsergroup::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeUsrMNUsergroup";
...
/******************************************************************************
 class QryWdbeUsrMNUsergroup::StatShr
 ******************************************************************************/

QryWdbeUsrMNUsergroup::StatShr::StatShr(
			const uint ntot
...
void QryWdbeUsrMNUsergroup::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeUsrMNUsergroup";
...
void QryWdbeUsrMNUsergroup::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeUsrMNUsergroup";
...
set<uint> QryWdbeUsrMNUsergroup::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeUsrMNUsergroup::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeUsrMNUsergroup::StgIac
 ******************************************************************************/

QryWdbeUsrMNUsergroup::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeUsrMNUsergroup::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeUsrMNUsergroup";
...
void QryWdbeUsrMNUsergroup::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeUsrMNUsergroup";
...
void QryWdbeUsrMNUsergroup::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeUsrMNUsergroup";
...
set<uint> QryWdbeUsrMNUsergroup::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeUsrMNUsergroup::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
