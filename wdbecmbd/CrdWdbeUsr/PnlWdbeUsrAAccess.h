/**
	* \file PnlWdbeUsrAAccess.h
	* job handler for job PnlWdbeUsrAAccess (declarations)
	* \author Alexander Wirthmueller
	* \date created: 23 Aug 2020
	* \date modified: 23 Aug 2020
	*/

#ifndef PNLWDBEUSRAACCESS_H
#define PNLWDBEUSRAACCESS_H
...
#define VecVWdbeUsrAAccessDo PnlWdbeUsrAAccess::VecVDo

#define ContInfWdbeUsrAAccess PnlWdbeUsrAAccess::ContInf
#define StatAppWdbeUsrAAccess PnlWdbeUsrAAccess::StatApp
#define StatShrWdbeUsrAAccess PnlWdbeUsrAAccess::StatShr
#define StgIacWdbeUsrAAccess PnlWdbeUsrAAccess::StgIac
#define TagWdbeUsrAAccess PnlWdbeUsrAAccess::Tag

#define DpchAppWdbeUsrAAccessData PnlWdbeUsrAAccess::DpchAppData
#define DpchAppWdbeUsrAAccessDo PnlWdbeUsrAAccess::DpchAppDo
#define DpchEngWdbeUsrAAccessData PnlWdbeUsrAAccess::DpchEngData

/**
	* PnlWdbeUsrAAccess
	*/
class PnlWdbeUsrAAccess : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUsrAAccess* rst = NULL, QryWdbeUsrAAccess::StatShr* statshrqry = NULL, QryWdbeUsrAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeUsrAAccess(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeUsrAAccess();
...
public:
	...
	QryWdbeUsrAAccess* qry;

	WdbeAMUserAccess recUsrAacc;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeUsrAAccess::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
