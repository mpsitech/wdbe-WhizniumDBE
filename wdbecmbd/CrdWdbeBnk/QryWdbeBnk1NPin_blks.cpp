/**
	* \file QryWdbeBnk1NPin_blks.cpp
	* job handler for job QryWdbeBnk1NPin (implementation of blocks)
...
void QryWdbeBnk1NPin::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeBnk1NPin";
...
void QryWdbeBnk1NPin::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWdbeBnk1NPin";
...
void QryWdbeBnk1NPin::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeBnk1NPin";
...
void QryWdbeBnk1NPin::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeBnk1NPin";
...
void QryWdbeBnk1NPin::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
