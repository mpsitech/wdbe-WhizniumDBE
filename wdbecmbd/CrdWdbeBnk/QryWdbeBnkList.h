/**
	* \file QryWdbeBnkList.h
	* job handler for job QryWdbeBnkList (declarations)
...
#ifndef QRYWDBEBNKLIST_H
#define QRYWDBEBNKLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbeBnkListOrd QryWdbeBnkList::VecVOrd

#define StatAppQryWdbeBnkList QryWdbeBnkList::StatApp
#define StatShrQryWdbeBnkList QryWdbeBnkList::StatShr
#define StgIacQryWdbeBnkList QryWdbeBnkList::StgIac

/**
	* QryWdbeBnkList
	*/
class QryWdbeBnkList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbeBnkListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbeBnkList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeBnkList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeBnkList)
		*/
...
public:
	QryWdbeBnkList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeBnkList();
...
public:
	...
	WdbeQBnkList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbeBnkMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
