/**
	...
	* job handler for job PnlWdbeBnkList (declarations)
...
/**
	* PnlWdbeBnkList
	*/
class PnlWdbeBnkList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQBnkList* rst = NULL, QryWdbeBnkList::StatShr* statshrqry = NULL, QryWdbeBnkList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeBnkList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeBnkList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeBnkList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
