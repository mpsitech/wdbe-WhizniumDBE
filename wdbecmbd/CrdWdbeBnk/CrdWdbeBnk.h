/**
	* \file CrdWdbeBnk.h
	* job handler for job CrdWdbeBnk (declarations)
...
#define VecVWdbeBnkDo CrdWdbeBnk::VecVDo
#define VecVWdbeBnkSge CrdWdbeBnk::VecVSge

#define ContInfWdbeBnk CrdWdbeBnk::ContInf
#define StatAppWdbeBnk CrdWdbeBnk::StatApp
#define StatShrWdbeBnk CrdWdbeBnk::StatShr
#define TagWdbeBnk CrdWdbeBnk::Tag

#define DpchAppWdbeBnkDo CrdWdbeBnk::DpchAppDo
#define DpchEngWdbeBnkData CrdWdbeBnk::DpchEngData

/**
	* CrdWdbeBnk
	*/
class CrdWdbeBnk : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDBNK = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdBnk = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdBnk;
...
public:
	CrdWdbeBnk(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeBnk();
...
public:
	...
	PnlWdbeBnkList* pnllist;
	PnlWdbeBnkHeadbar* pnlheadbar;
	PnlWdbeBnkRec* pnlrec;
