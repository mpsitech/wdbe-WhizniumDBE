/**
	* \file WdbeMtpCplmstbuSmartreg_Easy_v1_0.cpp
...
/******************************************************************************
 namespace WdbeMtpCplmstbuSmartreg_Easy_v1_0
 ******************************************************************************/

DpchRetWdbe* WdbeMtpCplmstbuSmartreg_Easy_v1_0::run(
			XchgWdbe* xchg
			, DbsWdbe* dbswdbe
	...
	// IP run --- IBEGIN
	// exact copy from WdbeMtpCplmstbuSmartreg_v1_0.cpp
