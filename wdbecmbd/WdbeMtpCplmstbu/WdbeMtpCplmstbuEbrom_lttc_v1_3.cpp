/**
	* \file WdbeMtpCplmstbuEbrom_lttc_v1_3.cpp
...
DpchRetWdbe* WdbeMtpCplmstbuEbrom_lttc_v1_3::run(
			XchgWdbe* xchg
			, DbsWdbe* dbswdbe
	...
	if (Wdbe::getMpa(dbswdbe, refWdbeMModule, "size", size))
		if (Wdbe::getMpa(dbswdbe, refWdbeMModule, "w", w)) {
			...
			Wdbe::setPrtWdt(dbswdbe, refWdbeMModule, "rd_addr_i", wAddr0 - log2(wWord));
