/**
	...
	* job handler for job PnlWdbeMchAMakefile (declarations)
...
/**
	* PnlWdbeMchAMakefile
	*/
class PnlWdbeMchAMakefile : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMchAMakefile* rst = NULL, QryWdbeMchAMakefile::StatShr* statshrqry = NULL, QryWdbeMchAMakefile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMchAMakefile(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMchAMakefile();
...
public:
	...
	QryWdbeMchAMakefile* qry;

	WdbeAMMachineMakefile recMchAmkf;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMchAMakefile::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
