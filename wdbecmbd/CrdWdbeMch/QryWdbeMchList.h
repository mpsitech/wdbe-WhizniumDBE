/**
	...
	* job handler for job QryWdbeMchList (declarations)
...
/**
	* QryWdbeMchList
	*/
class QryWdbeMchList : public JobWdbe {
...
public:
	...
	public:
		static const Sbecore::uint PLA = 1;
...
public:
	QryWdbeMchList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeMchList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const std::string& prePla, const bool addwhere);
	...
	WdbeQMchList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbeMchMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
