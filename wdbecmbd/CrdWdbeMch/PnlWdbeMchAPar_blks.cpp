/**
	* \file PnlWdbeMchAPar_blks.cpp
	* job handler for job PnlWdbeMchAPar (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeMchAPar::VecVDo
 ******************************************************************************/

uint PnlWdbeMchAPar::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeMchAPar::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeMchAPar::ContInf
 ******************************************************************************/

PnlWdbeMchAPar::ContInf::ContInf(
...
void PnlWdbeMchAPar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeMchAPar";
...
void PnlWdbeMchAPar::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeMchAPar";
...
set<uint> PnlWdbeMchAPar::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMchAPar::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMchAPar::StatApp
 ******************************************************************************/

void PnlWdbeMchAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeMchAPar";
...
void PnlWdbeMchAPar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeMchAPar";
...
/******************************************************************************
 class PnlWdbeMchAPar::StatShr
 ******************************************************************************/

PnlWdbeMchAPar::StatShr::StatShr(
...
void PnlWdbeMchAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeMchAPar";
...
void PnlWdbeMchAPar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeMchAPar";
...
set<uint> PnlWdbeMchAPar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMchAPar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMchAPar::StgIac
 ******************************************************************************/

PnlWdbeMchAPar::StgIac::StgIac(
...
bool PnlWdbeMchAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeMchAPar"];}();
...
bool PnlWdbeMchAPar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeMchAPar");
	else
...
void PnlWdbeMchAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeMchAPar";
...
void PnlWdbeMchAPar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> PnlWdbeMchAPar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMchAPar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMchAPar::Tag
 ******************************************************************************/

void PnlWdbeMchAPar::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeMchAPar";
...
void PnlWdbeMchAPar::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeMchAPar";
...
/******************************************************************************
 class PnlWdbeMchAPar::DpchAppData
 ******************************************************************************/

PnlWdbeMchAPar::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMCHAPARDATA)
		{
};

string PnlWdbeMchAPar::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMchAPar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeMchAParData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWdbeMchAPar::StgIac();
	};
};

void PnlWdbeMchAPar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMchAParData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeMchAPar::DpchAppDo
 ******************************************************************************/

PnlWdbeMchAPar::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMCHAPARDO)
		{
	ixVDo = 0;
};

string PnlWdbeMchAPar::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMchAPar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeMchAParDo"];}();
...
void PnlWdbeMchAPar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMchAParDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeMchAPar::DpchEngData
 ******************************************************************************/

PnlWdbeMchAPar::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWdbeMchAPar::StatShr* statshrqry
			, QryWdbeMchAPar::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMCHAPARDATA, jref)
		{
...
string PnlWdbeMchAPar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMchAPar::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeMchAPar::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeMchAParData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeMchAPar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeMchAPar::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeMchAParData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeMchAPar::StatApp::writeXML(wr);
