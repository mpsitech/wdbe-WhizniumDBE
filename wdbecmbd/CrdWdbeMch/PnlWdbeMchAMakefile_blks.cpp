/**
	* \file PnlWdbeMchAMakefile_blks.cpp
	* job handler for job PnlWdbeMchAMakefile (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeMchAMakefile::VecVDo
 ******************************************************************************/

uint PnlWdbeMchAMakefile::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeMchAMakefile::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeMchAMakefile::ContInf
 ******************************************************************************/

PnlWdbeMchAMakefile::ContInf::ContInf(
...
void PnlWdbeMchAMakefile::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeMchAMakefile";
...
void PnlWdbeMchAMakefile::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeMchAMakefile";
...
set<uint> PnlWdbeMchAMakefile::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMchAMakefile::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMchAMakefile::StatApp
 ******************************************************************************/

void PnlWdbeMchAMakefile::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeMchAMakefile";
...
void PnlWdbeMchAMakefile::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeMchAMakefile";
...
/******************************************************************************
 class PnlWdbeMchAMakefile::StatShr
 ******************************************************************************/

PnlWdbeMchAMakefile::StatShr::StatShr(
...
void PnlWdbeMchAMakefile::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeMchAMakefile";
...
void PnlWdbeMchAMakefile::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeMchAMakefile";
...
set<uint> PnlWdbeMchAMakefile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMchAMakefile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMchAMakefile::StgIac
 ******************************************************************************/

PnlWdbeMchAMakefile::StgIac::StgIac(
...
bool PnlWdbeMchAMakefile::StgIac::readJSON(
	...
	if (basefound) {
		if (me.isMember("TcoTagWidth")) {TcoTagWidth = me["TcoTagWidth"].asUInt(); add(TCOTAGWIDTH);};
...
bool PnlWdbeMchAMakefile::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeMchAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeMchAMakefile";
...
void PnlWdbeMchAMakefile::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeMchAMakefile";
...
void PnlWdbeMchAMakefile::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeMchAMakefile";
...
set<uint> PnlWdbeMchAMakefile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMchAMakefile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMchAMakefile::Tag
 ******************************************************************************/

void PnlWdbeMchAMakefile::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeMchAMakefile";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "Makefile entries";
		me["TcoTag"] = "Tag";
		me["TcoVal"] = "Value";
	};
...
void PnlWdbeMchAMakefile::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeMchAMakefile";
...
/******************************************************************************
 class PnlWdbeMchAMakefile::DpchAppData
 ******************************************************************************/

PnlWdbeMchAMakefile::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMCHAMAKEFILEDATA)
		{
};

string PnlWdbeMchAMakefile::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMchAMakefile::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMchAMakefileData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeMchAMakefile::DpchAppDo
 ******************************************************************************/

PnlWdbeMchAMakefile::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMCHAMAKEFILEDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeMchAMakefile::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMchAMakefileDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeMchAMakefile::DpchEngData
 ******************************************************************************/

PnlWdbeMchAMakefile::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMCHAMAKEFILEDATA, jref)
		{
...
string PnlWdbeMchAMakefile::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMchAMakefile::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeMchAMakefile::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeMchAMakefileData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeMchAMakefile::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeMchAMakefile::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeMchAMakefileData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeMchAMakefile::StatApp::writeXML(wr);
