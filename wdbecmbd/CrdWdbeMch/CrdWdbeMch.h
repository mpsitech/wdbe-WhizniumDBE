/**
	* \file CrdWdbeMch.h
	* job handler for job CrdWdbeMch (declarations)
...
#define VecVWdbeMchDo CrdWdbeMch::VecVDo
#define VecVWdbeMchSge CrdWdbeMch::VecVSge

#define ContInfWdbeMch CrdWdbeMch::ContInf
#define StatAppWdbeMch CrdWdbeMch::StatApp
#define StatShrWdbeMch CrdWdbeMch::StatShr
#define TagWdbeMch CrdWdbeMch::Tag

#define DpchAppWdbeMchDo CrdWdbeMch::DpchAppDo
#define DpchEngWdbeMchData CrdWdbeMch::DpchEngData

/**
	* CrdWdbeMch
	*/
class CrdWdbeMch : public JobWdbe {
...
public:
	CrdWdbeMch(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbeMch();
...
public:
	...
	PnlWdbeMchRec* pnlrec;
	PnlWdbeMchHeadbar* pnlheadbar;
	PnlWdbeMchList* pnllist;
