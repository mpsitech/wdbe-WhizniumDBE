/**
	* \file PnlWdbeMchAPar.h
	* job handler for job PnlWdbeMchAPar (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEMCHAPAR_H
#define PNLWDBEMCHAPAR_H
...
#define VecVWdbeMchAParDo PnlWdbeMchAPar::VecVDo

#define ContInfWdbeMchAPar PnlWdbeMchAPar::ContInf
#define StatAppWdbeMchAPar PnlWdbeMchAPar::StatApp
#define StatShrWdbeMchAPar PnlWdbeMchAPar::StatShr
#define StgIacWdbeMchAPar PnlWdbeMchAPar::StgIac
#define TagWdbeMchAPar PnlWdbeMchAPar::Tag

#define DpchAppWdbeMchAParData PnlWdbeMchAPar::DpchAppData
#define DpchAppWdbeMchAParDo PnlWdbeMchAPar::DpchAppDo
#define DpchEngWdbeMchAParData PnlWdbeMchAPar::DpchEngData

/**
	* PnlWdbeMchAPar
	*/
class PnlWdbeMchAPar : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMchAPar* rst = NULL, QryWdbeMchAPar::StatShr* statshrqry = NULL, QryWdbeMchAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMchAPar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMchAPar();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMchAPar::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
