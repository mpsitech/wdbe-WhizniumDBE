...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMchAPar* rst = NULL, QryWdbeMchAPar::StatShr* statshrqry = NULL, QryWdbeMchAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
