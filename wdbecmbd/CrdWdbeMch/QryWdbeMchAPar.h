/**
	* \file QryWdbeMchAPar.h
	* job handler for job QryWdbeMchAPar (declarations)
...
#ifndef QRYWDBEMCHAPAR_H
#define QRYWDBEMCHAPAR_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeMchAPar QryWdbeMchAPar::StatApp
#define StatShrQryWdbeMchAPar QryWdbeMchAPar::StatShr
#define StgIacQryWdbeMchAPar QryWdbeMchAPar::StgIac

/**
	* QryWdbeMchAPar
	*/
class QryWdbeMchAPar : public JobWdbe {

public:
	/**
		* StatApp (full: StatAppQryWdbeMchAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeMchAPar)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeMchAPar)
		*/
...
public:
	QryWdbeMchAPar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeMchAPar();
...
public:
	...
	WdbeQMchAPar* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbeMchAparMod_mchEq(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
