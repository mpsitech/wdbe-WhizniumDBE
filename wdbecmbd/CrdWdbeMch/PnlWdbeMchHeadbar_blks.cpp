...
void PnlWdbeMchHeadbar::StgInf::writeJSON(
...
void PnlWdbeMchHeadbar::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeMchHeadbar::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeMchHeadbarData"] = Json::Value(Json::objectValue);
