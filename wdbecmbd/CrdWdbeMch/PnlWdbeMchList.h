/**
	...
	* job handler for job PnlWdbeMchList (declarations)
...
#define VecVWdbeMchListDo PnlWdbeMchList::VecVDo

#define ContIacWdbeMchList PnlWdbeMchList::ContIac
#define ContInfWdbeMchList PnlWdbeMchList::ContInf
#define StatShrWdbeMchList PnlWdbeMchList::StatShr
#define StgIacWdbeMchList PnlWdbeMchList::StgIac
#define TagWdbeMchList PnlWdbeMchList::Tag

#define DpchAppWdbeMchListData PnlWdbeMchList::DpchAppData
#define DpchAppWdbeMchListDo PnlWdbeMchList::DpchAppDo
#define DpchEngWdbeMchListData PnlWdbeMchList::DpchEngData

/**
	* PnlWdbeMchList
	*/
class PnlWdbeMchList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMchList* rst = NULL, QryWdbeMchList::StatShr* statshrqry = NULL, QryWdbeMchList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMchList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMchList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMchList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
