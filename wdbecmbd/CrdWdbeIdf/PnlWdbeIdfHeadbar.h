/**
	...
	* job handler for job PnlWdbeIdfHeadbar (declarations)
...
/**
	* PnlWdbeIdfHeadbar
	*/
class PnlWdbeIdfHeadbar : public JobWdbe {
...
public:
	PnlWdbeIdfHeadbar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeIdfHeadbar();
