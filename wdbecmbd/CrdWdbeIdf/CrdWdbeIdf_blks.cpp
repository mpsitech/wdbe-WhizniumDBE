/**
	* \file CrdWdbeIdf_blks.cpp
	* job handler for job CrdWdbeIdf (implementation of blocks)
...
void CrdWdbeIdf::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void CrdWdbeIdf::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeIdf";
...
void CrdWdbeIdf::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeIdf";
...
void CrdWdbeIdf::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	if (difftag.length() == 0) difftag = "StatAppWdbeIdf";
...
void CrdWdbeIdf::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVReqitmode
	...
	else itemtag = "StatitemAppWdbeIdf";
...
void CrdWdbeIdf::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeIdf";
...
void CrdWdbeIdf::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeIdf";
...
void CrdWdbeIdf::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeIdf";
...
CrdWdbeIdf::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEIDFDO)
		{
	ixVDo = 0;
};
...
void CrdWdbeIdf::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeIdfDo"];}();
...
void CrdWdbeIdf::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeIdfDo");
	else
...
CrdWdbeIdf::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEIDFDATA, jref)
		{
...
void CrdWdbeIdf::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void CrdWdbeIdf::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeIdfData"] = Json::Value(Json::objectValue);
...
void CrdWdbeIdf::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeIdfData");
