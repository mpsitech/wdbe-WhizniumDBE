...
bool DlgWdbePrjNew::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacDlgWdbePrjNew"];}();
...
void DlgWdbePrjNew::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWdbePrjNew::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWdbePrjNew::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void DlgWdbePrjNew::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWdbePrjNew::Tag::writeJSON(
...
void DlgWdbePrjNew::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWdbePrjNewData"];}();
...
void DlgWdbePrjNew::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWdbePrjNewDo"];}();
...
void DlgWdbePrjNew::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngDlgWdbePrjNewData"] = Json::Value(Json::objectValue);
