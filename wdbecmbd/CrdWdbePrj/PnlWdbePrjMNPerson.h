/**
	* \file PnlWdbePrjMNPerson.h
	* job handler for job PnlWdbePrjMNPerson (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEPRJMNPERSON_H
#define PNLWDBEPRJMNPERSON_H
...
#define VecVWdbePrjMNPersonDo PnlWdbePrjMNPerson::VecVDo

#define ContInfWdbePrjMNPerson PnlWdbePrjMNPerson::ContInf
#define StatAppWdbePrjMNPerson PnlWdbePrjMNPerson::StatApp
#define StatShrWdbePrjMNPerson PnlWdbePrjMNPerson::StatShr
#define StgIacWdbePrjMNPerson PnlWdbePrjMNPerson::StgIac
#define TagWdbePrjMNPerson PnlWdbePrjMNPerson::Tag

#define DpchAppWdbePrjMNPersonData PnlWdbePrjMNPerson::DpchAppData
#define DpchAppWdbePrjMNPersonDo PnlWdbePrjMNPerson::DpchAppDo
#define DpchEngWdbePrjMNPersonData PnlWdbePrjMNPerson::DpchEngData

/**
	* PnlWdbePrjMNPerson
	*/
class PnlWdbePrjMNPerson : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrjMNPerson* rst = NULL, QryWdbePrjMNPerson::StatShr* statshrqry = NULL, QryWdbePrjMNPerson::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePrjMNPerson(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrjMNPerson();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePrjMNPerson::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
