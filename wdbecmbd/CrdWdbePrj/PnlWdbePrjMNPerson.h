...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrjMNPerson* rst = NULL, QryWdbePrjMNPerson::StatShr* statshrqry = NULL, QryWdbePrjMNPerson::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
