/**
	* \file PnlWdbePrjRec.h
	* job handler for job PnlWdbePrjRec (declarations)
...
#ifndef PNLWDBEPRJREC_H
#define PNLWDBEPRJREC_H
...
#define ContInfWdbePrjRec PnlWdbePrjRec::ContInf
#define StatAppWdbePrjRec PnlWdbePrjRec::StatApp
#define StatShrWdbePrjRec PnlWdbePrjRec::StatShr
#define TagWdbePrjRec PnlWdbePrjRec::Tag

#define DpchAppWdbePrjRecDo PnlWdbePrjRec::DpchAppDo
#define DpchEngWdbePrjRecData PnlWdbePrjRec::DpchEngData

/**
	* PnlWdbePrjRec
	*/
class PnlWdbePrjRec : public JobWdbe {
...
public:
	PnlWdbePrjRec(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrjRec();
