/**
	* \file DlgWdbePrjImpex_blks.cpp
	* job handler for job DlgWdbePrjImpex (implementation of blocks)
...
string DlgWdbePrjImpex::VecVDit::getTitle(
			const uint ix
...
void DlgWdbePrjImpex::VecVDit::fillFeed(
			const uint ixWdbeVLocale
			, Feed& feed
		) {
	feed.clear();
...
void DlgWdbePrjImpex::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void DlgWdbePrjImpex::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWdbePrjImpex::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::ContInfImp::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbePrjImpexImp";
...
void DlgWdbePrjImpex::ContInfImp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbePrjImpexImp";
...
void DlgWdbePrjImpex::ContInfLfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbePrjImpexLfi";
...
void DlgWdbePrjImpex::ContInfLfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbePrjImpexLfi";
...
void DlgWdbePrjImpex::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const bool initdone
			, const string& shortMenu
		) {
	if (difftag.length() == 0) difftag = "StatAppDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const bool initdone
	...
	else itemtag = "StatitemAppDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::StatShrIfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbePrjImpexIfi";
...
void DlgWdbePrjImpex::StatShrIfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbePrjImpexIfi";
...
void DlgWdbePrjImpex::StatShrImp::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbePrjImpexImp";
...
void DlgWdbePrjImpex::StatShrImp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbePrjImpexImp";
...
void DlgWdbePrjImpex::StatShrLfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbePrjImpexLfi";
...
void DlgWdbePrjImpex::StatShrLfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbePrjImpexLfi";
...
void DlgWdbePrjImpex::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemDlgWdbePrjImpex";
...
void DlgWdbePrjImpex::TagIfi::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbePrjImpexIfi";
...
void DlgWdbePrjImpex::TagIfi::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbePrjImpexIfi";
...
void DlgWdbePrjImpex::TagImp::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbePrjImpexImp";
...
void DlgWdbePrjImpex::TagImp::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbePrjImpexImp";
...
void DlgWdbePrjImpex::TagLfi::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbePrjImpexLfi";
...
void DlgWdbePrjImpex::TagLfi::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbePrjImpexLfi";
...
DlgWdbePrjImpex::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPDLGWDBEPRJIMPEXDATA)
		{
};
...
void DlgWdbePrjImpex::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppDlgWdbePrjImpexData");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWdbePrjImpex::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPDLGWDBEPRJIMPEXDO)
		{
	ixVDo = 0;
	ixVDoImp = 0;
};
...
void DlgWdbePrjImpex::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppDlgWdbePrjImpexDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWdbePrjImpex::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGDLGWDBEPRJIMPEXDATA, jref)
		{
...
void DlgWdbePrjImpex::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void DlgWdbePrjImpex::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngDlgWdbePrjImpexData"] = Json::Value(Json::objectValue);
...
void DlgWdbePrjImpex::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngDlgWdbePrjImpexData");
