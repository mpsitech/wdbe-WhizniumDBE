/**
	* \file PnlWdbePrjMNPerson_blks.cpp
	* job handler for job PnlWdbePrjMNPerson (implementation of blocks)
...
/******************************************************************************
 class PnlWdbePrjMNPerson::VecVDo
 ******************************************************************************/

uint PnlWdbePrjMNPerson::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbePrjMNPerson::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbePrjMNPerson::ContInf
 ******************************************************************************/

PnlWdbePrjMNPerson::ContInf::ContInf(
...
void PnlWdbePrjMNPerson::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbePrjMNPerson";
...
void PnlWdbePrjMNPerson::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbePrjMNPerson";
...
set<uint> PnlWdbePrjMNPerson::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrjMNPerson::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrjMNPerson::StatApp
 ******************************************************************************/

void PnlWdbePrjMNPerson::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbePrjMNPerson";
...
void PnlWdbePrjMNPerson::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbePrjMNPerson";
...
/******************************************************************************
 class PnlWdbePrjMNPerson::StatShr
 ******************************************************************************/

PnlWdbePrjMNPerson::StatShr::StatShr(
...
void PnlWdbePrjMNPerson::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbePrjMNPerson";
...
void PnlWdbePrjMNPerson::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbePrjMNPerson";
...
set<uint> PnlWdbePrjMNPerson::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrjMNPerson::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrjMNPerson::StgIac
 ******************************************************************************/

PnlWdbePrjMNPerson::StgIac::StgIac(
...
bool PnlWdbePrjMNPerson::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbePrjMNPerson"];}();
...
bool PnlWdbePrjMNPerson::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbePrjMNPerson");
	else
...
void PnlWdbePrjMNPerson::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbePrjMNPerson";
...
void PnlWdbePrjMNPerson::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> PnlWdbePrjMNPerson::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrjMNPerson::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrjMNPerson::Tag
 ******************************************************************************/

void PnlWdbePrjMNPerson::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbePrjMNPerson";
...
void PnlWdbePrjMNPerson::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbePrjMNPerson";
...
/******************************************************************************
 class PnlWdbePrjMNPerson::DpchAppData
 ******************************************************************************/

PnlWdbePrjMNPerson::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRJMNPERSONDATA)
		{
};

string PnlWdbePrjMNPerson::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrjMNPerson::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePrjMNPersonData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWdbePrjMNPerson::StgIac();
	};
};

void PnlWdbePrjMNPerson::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrjMNPersonData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrjMNPerson::DpchAppDo
 ******************************************************************************/

PnlWdbePrjMNPerson::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRJMNPERSONDO)
		{
	ixVDo = 0;
};
...
void PnlWdbePrjMNPerson::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePrjMNPersonDo"];}();
...
void PnlWdbePrjMNPerson::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrjMNPersonDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrjMNPerson::DpchEngData
 ******************************************************************************/

PnlWdbePrjMNPerson::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWdbePrjMNPerson::StatShr* statshrqry
			, QryWdbePrjMNPerson::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEPRJMNPERSONDATA, jref)
		{
...
string PnlWdbePrjMNPerson::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrjMNPerson::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbePrjMNPerson::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbePrjMNPersonData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbePrjMNPerson::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbePrjMNPerson::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbePrjMNPersonData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbePrjMNPerson::StatApp::writeXML(wr);
