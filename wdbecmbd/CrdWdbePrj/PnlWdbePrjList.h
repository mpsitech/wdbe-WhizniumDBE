/**
	* \file PnlWdbePrjList.h
	* job handler for job PnlWdbePrjList (declarations)
...
#ifndef PNLWDBEPRJLIST_H
#define PNLWDBEPRJLIST_H
...
#define VecVWdbePrjListDo PnlWdbePrjList::VecVDo

#define ContIacWdbePrjList PnlWdbePrjList::ContIac
#define ContInfWdbePrjList PnlWdbePrjList::ContInf
#define StatShrWdbePrjList PnlWdbePrjList::StatShr
#define StgIacWdbePrjList PnlWdbePrjList::StgIac
#define TagWdbePrjList PnlWdbePrjList::Tag

#define DpchAppWdbePrjListData PnlWdbePrjList::DpchAppData
#define DpchAppWdbePrjListDo PnlWdbePrjList::DpchAppDo
#define DpchEngWdbePrjListData PnlWdbePrjList::DpchEngData

/**
	* PnlWdbePrjList
	*/
class PnlWdbePrjList : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOSHOWIDTH = 3;
		static const Sbecore::uint TCOTITWIDTH = 4;
		static const Sbecore::uint TCOVERWIDTH = 5;
		static const Sbecore::uint TCOESYWIDTH = 6;
		static const Sbecore::uint TCOGRLWIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoGrpWidth = 100, const Sbecore::uint TcoOwnWidth = 100, const Sbecore::uint TcoShoWidth = 100, const Sbecore::uint TcoTitWidth = 250, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoEsyWidth = 100, const Sbecore::uint TcoGrlWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrjList* rst = NULL, QryWdbePrjList::StatShr* statshrqry = NULL, QryWdbePrjList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePrjList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrjList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePrjList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
