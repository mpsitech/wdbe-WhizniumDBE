/**
	...
	* job handler for job PnlWdbePrjHeadbar (declarations)
...
/**
	* PnlWdbePrjHeadbar
	*/
class PnlWdbePrjHeadbar : public JobWdbe {
...
public:
	PnlWdbePrjHeadbar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrjHeadbar();
