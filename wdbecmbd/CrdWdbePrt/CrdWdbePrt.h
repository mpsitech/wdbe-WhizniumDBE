/**
	* \file CrdWdbePrt.h
	* job handler for job CrdWdbePrt (declarations)
...
#define VecVWdbePrtDo CrdWdbePrt::VecVDo
#define VecVWdbePrtSge CrdWdbePrt::VecVSge

#define ContInfWdbePrt CrdWdbePrt::ContInf
#define StatAppWdbePrt CrdWdbePrt::StatApp
#define StatShrWdbePrt CrdWdbePrt::StatShr
#define TagWdbePrt CrdWdbePrt::Tag

#define DpchAppWdbePrtDo CrdWdbePrt::DpchAppDo
#define DpchEngWdbePrtData CrdWdbePrt::DpchEngData

/**
	* CrdWdbePrt
	*/
class CrdWdbePrt : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDPRT = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdPrt = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdPrt;
...
public:
	CrdWdbePrt(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbePrt();
...
public:
	...
	PnlWdbePrtRec* pnlrec;
	PnlWdbePrtHeadbar* pnlheadbar;
	PnlWdbePrtList* pnllist;
