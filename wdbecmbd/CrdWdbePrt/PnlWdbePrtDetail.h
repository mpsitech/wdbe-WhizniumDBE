...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFLstClu = NULL, Sbecore::Xmlio::Feed* feedFPupDir = NULL, Sbecore::Xmlio::Feed* feedFPupHty = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
