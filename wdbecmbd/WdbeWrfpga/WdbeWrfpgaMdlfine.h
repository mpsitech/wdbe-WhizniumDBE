...
namespace WdbeWrfpgaMdlfine {
	...
	void writeMdlVhd_reset(std::fstream& outfile, const Sbecore::uint mgeIxVTbl, const Sbecore::ubigint mgeUref, ListWdbeMSignal& sigs, ListWdbeMVariable& vars, std::map<std::string,WdbeAVKeylistKey*>& srefsMdlhtys, const unsigned int il);
