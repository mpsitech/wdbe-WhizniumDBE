...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::MIND, const bool LstCluAlt = true, const bool PupHtyAlt = false, const bool TxtSrcAlt = false, const Sbecore::uint LstCluNumFirstdisp = 1);
	...
	public:
		...
		static const Sbecore::uint TXTMDLACTIVE = 8;
		static const Sbecore::uint BUTMDLVIEWAVAIL = 9;
		static const Sbecore::uint BUTMDLVIEWACTIVE = 10;
		static const Sbecore::uint PUPHTYACTIVE = 11;
		static const Sbecore::uint TXFHTYVALID = 12;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFLstClu = NULL, Sbecore::Feed* feedFPupHty = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
