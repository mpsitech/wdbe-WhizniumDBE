/**
	* \file CrdWdbeGen.h
	* job handler for job CrdWdbeGen (declarations)
...
#define VecVWdbeGenDo CrdWdbeGen::VecVDo
#define VecVWdbeGenSge CrdWdbeGen::VecVSge

#define ContInfWdbeGen CrdWdbeGen::ContInf
#define StatAppWdbeGen CrdWdbeGen::StatApp
#define StatShrWdbeGen CrdWdbeGen::StatShr
#define TagWdbeGen CrdWdbeGen::Tag

#define DpchAppWdbeGenDo CrdWdbeGen::DpchAppDo
#define DpchEngWdbeGenData CrdWdbeGen::DpchEngData

/**
	* CrdWdbeGen
	*/
class CrdWdbeGen : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDGEN = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdGen = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdGen;
...
public:
	CrdWdbeGen(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeGen();
...
public:
	...
	PnlWdbeGenList* pnllist;
	PnlWdbeGenHeadbar* pnlheadbar;
	PnlWdbeGenRec* pnlrec;
