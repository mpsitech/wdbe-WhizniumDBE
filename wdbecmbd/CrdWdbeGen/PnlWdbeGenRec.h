/**
	* \file PnlWdbeGenRec.h
	* job handler for job PnlWdbeGenRec (declarations)
...
#ifndef PNLWDBEGENREC_H
#define PNLWDBEGENREC_H
...
#define VecVWdbeGenRecDo PnlWdbeGenRec::VecVDo

#define ContInfWdbeGenRec PnlWdbeGenRec::ContInf
#define StatAppWdbeGenRec PnlWdbeGenRec::StatApp
#define StatShrWdbeGenRec PnlWdbeGenRec::StatShr
#define TagWdbeGenRec PnlWdbeGenRec::Tag

#define DpchAppWdbeGenRecDo PnlWdbeGenRec::DpchAppDo
#define DpchEngWdbeGenRecData PnlWdbeGenRec::DpchEngData

/**
	* PnlWdbeGenRec
	*/
class PnlWdbeGenRec : public JobWdbe {
...
public:
	PnlWdbeGenRec(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeGenRec();
