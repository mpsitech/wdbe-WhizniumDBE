...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModMdl1NGeneric* rst = NULL, QryWdbeModMdl1NGeneric::StatShr* statshrqry = NULL, QryWdbeModMdl1NGeneric::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
