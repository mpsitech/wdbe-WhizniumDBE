/**
	* \file PnlWdbeModMdl1NGeneric.h
	* job handler for job PnlWdbeModMdl1NGeneric (declarations)
...
#ifndef PNLWDBEMODMDL1NGENERIC_H
#define PNLWDBEMODMDL1NGENERIC_H
...
#define VecVWdbeModMdl1NGenericDo PnlWdbeModMdl1NGeneric::VecVDo

#define ContInfWdbeModMdl1NGeneric PnlWdbeModMdl1NGeneric::ContInf
#define StatAppWdbeModMdl1NGeneric PnlWdbeModMdl1NGeneric::StatApp
#define StatShrWdbeModMdl1NGeneric PnlWdbeModMdl1NGeneric::StatShr
#define StgIacWdbeModMdl1NGeneric PnlWdbeModMdl1NGeneric::StgIac
#define TagWdbeModMdl1NGeneric PnlWdbeModMdl1NGeneric::Tag

#define DpchAppWdbeModMdl1NGenericData PnlWdbeModMdl1NGeneric::DpchAppData
#define DpchAppWdbeModMdl1NGenericDo PnlWdbeModMdl1NGeneric::DpchAppDo
#define DpchEngWdbeModMdl1NGenericData PnlWdbeModMdl1NGeneric::DpchEngData

/**
	* PnlWdbeModMdl1NGeneric
	*/
class PnlWdbeModMdl1NGeneric : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModMdl1NGeneric* rst = NULL, QryWdbeModMdl1NGeneric::StatShr* statshrqry = NULL, QryWdbeModMdl1NGeneric::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeModMdl1NGeneric(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeModMdl1NGeneric();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeModMdl1NGeneric::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
