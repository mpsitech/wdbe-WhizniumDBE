/**
	* \file CrdWdbeMod.h
	* job handler for job CrdWdbeMod (declarations)
...
#define VecVWdbeModDo CrdWdbeMod::VecVDo
#define VecVWdbeModSge CrdWdbeMod::VecVSge

#define ContInfWdbeMod CrdWdbeMod::ContInf
#define StatAppWdbeMod CrdWdbeMod::StatApp
#define StatShrWdbeMod CrdWdbeMod::StatShr
#define TagWdbeMod CrdWdbeMod::Tag

#define DpchAppWdbeModDo CrdWdbeMod::DpchAppDo
#define DpchEngWdbeModData CrdWdbeMod::DpchEngData

/**
	* CrdWdbeMod
	*/
class CrdWdbeMod : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDMOD = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdMod = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdMod;
...
public:
	CrdWdbeMod(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeMod();
...
public:
	...
	PnlWdbeModRec* pnlrec;
	PnlWdbeModHeadbar* pnlheadbar;
	PnlWdbeModList* pnllist;
