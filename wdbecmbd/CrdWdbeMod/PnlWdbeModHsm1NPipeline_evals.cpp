/**
	* \file PnlWdbeModHsm1NPipeline_evals.cpp
	* job handler for job PnlWdbeModHsm1NPipeline (implementation of availability/activation evaluation)
...
bool PnlWdbeModHsm1NPipeline::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeModHsm1NPipeline::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
...
bool PnlWdbeModHsm1NPipeline::evalButNewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeModHsm1NPipeline::evalButDeleteAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeModHsm1NPipeline::evalButDeleteActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
