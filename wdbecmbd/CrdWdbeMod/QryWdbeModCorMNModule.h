/**
	* \file QryWdbeModCorMNModule.h
	* job handler for job QryWdbeModCorMNModule (declarations)
...
#ifndef QRYWDBEMODCORMNMODULE_H
#define QRYWDBEMODCORMNMODULE_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeModCorMNModule QryWdbeModCorMNModule::StatApp
#define StatShrQryWdbeModCorMNModule QryWdbeModCorMNModule::StatShr
#define StgIacQryWdbeModCorMNModule QryWdbeModCorMNModule::StgIac

/**
	* QryWdbeModCorMNModule
	*/
class QryWdbeModCorMNModule : public JobWdbe {
...
public:
	QryWdbeModCorMNModule(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeModCorMNModule();
...
public:
	...
	WdbeQModCorMNModule* getRecByJnum(const Sbecore::uint jnum);
