...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModCtrRef1NCommand* rst = NULL, QryWdbeModCtrRef1NCommand::StatShr* statshrqry = NULL, QryWdbeModCtrRef1NCommand::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
