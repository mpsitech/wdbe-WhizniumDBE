...
public:
	...
	public:
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdoneKHdltype = false, const bool initdoneAPar = false, const bool initdone1NPeripheral = false, const bool initdoneMdl1NGeneric = false, const bool initdoneCor1NImbuf = false, const bool initdoneMdl1NPort = false, const bool initdone1NProcess = false, const bool initdoneMdl1NSignal = false, const bool initdoneSup1NModule = false, const bool initdoneMge1NSignal = false, const bool initdoneCtrRef1NError = false, const bool initdoneCtrHk1NVector = false, const bool initdoneCtrRef1NCommand = false, const bool initdoneCtrMNCommand = false);
	};
	...
	public:
		...
		static const Sbecore::uint JREFMDL1NGENERIC = 6;
		static const Sbecore::uint JREFCOR1NIMBUF = 7;
		static const Sbecore::uint JREFMDL1NPORT = 8;
		static const Sbecore::uint JREF1NPROCESS = 9;
		static const Sbecore::uint JREFMDL1NSIGNAL = 10;
		...
		static const Sbecore::uint JREFCTRREF1NCOMMAND = 17;
	...
	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefKHdltype = 0, const Sbecore::ubigint jrefAPar = 0, const Sbecore::ubigint jref1NPeripheral = 0, const Sbecore::ubigint jrefMdl1NGeneric = 0, const Sbecore::ubigint jrefCor1NImbuf = 0, const Sbecore::ubigint jrefMdl1NPort = 0, const Sbecore::ubigint jref1NProcess = 0, const Sbecore::ubigint jrefMdl1NSignal = 0, const Sbecore::ubigint jrefSup1NModule = 0, const Sbecore::ubigint jrefMge1NSignal = 0, const Sbecore::ubigint jrefCtrRef1NError = 0, const bool pnlctrref1nerrorAvail = false, const Sbecore::ubigint jrefCtrHk1NVector = 0, const bool pnlctrhk1nvectorAvail = false, const Sbecore::ubigint jrefCtrRef1NCommand = 0, const bool pnlctrref1ncommandAvail = false, const Sbecore::ubigint jrefCtrMNCommand = 0, const bool pnlctrmncommandAvail = false, const bool ButRegularizeActive = true);
