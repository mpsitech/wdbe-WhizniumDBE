/**
	* \file PnlWdbeModMdl1NSignal.h
	* job handler for job PnlWdbeModMdl1NSignal (declarations)
...
#ifndef PNLWDBEMODMDL1NSIGNAL_H
#define PNLWDBEMODMDL1NSIGNAL_H
...
#define VecVWdbeModMdl1NSignalDo PnlWdbeModMdl1NSignal::VecVDo

#define ContInfWdbeModMdl1NSignal PnlWdbeModMdl1NSignal::ContInf
#define StatAppWdbeModMdl1NSignal PnlWdbeModMdl1NSignal::StatApp
#define StatShrWdbeModMdl1NSignal PnlWdbeModMdl1NSignal::StatShr
#define StgIacWdbeModMdl1NSignal PnlWdbeModMdl1NSignal::StgIac
#define TagWdbeModMdl1NSignal PnlWdbeModMdl1NSignal::Tag

#define DpchAppWdbeModMdl1NSignalData PnlWdbeModMdl1NSignal::DpchAppData
#define DpchAppWdbeModMdl1NSignalDo PnlWdbeModMdl1NSignal::DpchAppDo
#define DpchEngWdbeModMdl1NSignalData PnlWdbeModMdl1NSignal::DpchEngData

/**
	* PnlWdbeModMdl1NSignal
	*/
class PnlWdbeModMdl1NSignal : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModMdl1NSignal* rst = NULL, QryWdbeModMdl1NSignal::StatShr* statshrqry = NULL, QryWdbeModMdl1NSignal::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeModMdl1NSignal(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeModMdl1NSignal();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeModMdl1NSignal::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
