/**
	* \file QryWdbeModMdl1NPort.h
	* job handler for job QryWdbeModMdl1NPort (declarations)
...
#ifndef QRYWDBEMODMDL1NPORT_H
#define QRYWDBEMODMDL1NPORT_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeModMdl1NPort QryWdbeModMdl1NPort::StatApp
#define StatShrQryWdbeModMdl1NPort QryWdbeModMdl1NPort::StatShr
#define StgIacQryWdbeModMdl1NPort QryWdbeModMdl1NPort::StgIac

/**
	* QryWdbeModMdl1NPort
	*/
class QryWdbeModMdl1NPort : public JobWdbe {
...
public:
	QryWdbeModMdl1NPort(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeModMdl1NPort();
...
public:
	...
	WdbeQModMdl1NPort* getRecByJnum(const Sbecore::uint jnum);
