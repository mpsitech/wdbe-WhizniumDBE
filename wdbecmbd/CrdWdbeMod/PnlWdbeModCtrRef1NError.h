...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModCtrRef1NError* rst = NULL, QryWdbeModCtrRef1NError::StatShr* statshrqry = NULL, QryWdbeModCtrRef1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
