/**
	* \file PnlWdbeModAPar_blks.cpp
	* job handler for job PnlWdbeModAPar (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeModAPar::VecVDo
 ******************************************************************************/

uint PnlWdbeModAPar::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeModAPar::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeModAPar::ContInf
 ******************************************************************************/

PnlWdbeModAPar::ContInf::ContInf(
...
void PnlWdbeModAPar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeModAPar";
...
void PnlWdbeModAPar::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeModAPar";
...
set<uint> PnlWdbeModAPar::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeModAPar::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeModAPar::StatApp
 ******************************************************************************/

void PnlWdbeModAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeModAPar";
...
void PnlWdbeModAPar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeModAPar";
...
/******************************************************************************
 class PnlWdbeModAPar::StatShr
 ******************************************************************************/

PnlWdbeModAPar::StatShr::StatShr(
...
void PnlWdbeModAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeModAPar";
...
void PnlWdbeModAPar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeModAPar";
...
set<uint> PnlWdbeModAPar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeModAPar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeModAPar::StgIac
 ******************************************************************************/

PnlWdbeModAPar::StgIac::StgIac(
...
bool PnlWdbeModAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeModAPar"];}();
...
bool PnlWdbeModAPar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeModAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeModAPar";
...
void PnlWdbeModAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeModAPar";
...
void PnlWdbeModAPar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeModAPar";
...
set<uint> PnlWdbeModAPar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeModAPar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeModAPar::Tag
 ******************************************************************************/

void PnlWdbeModAPar::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeModAPar";
...
void PnlWdbeModAPar::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeModAPar";
...
/******************************************************************************
 class PnlWdbeModAPar::DpchAppData
 ******************************************************************************/

PnlWdbeModAPar::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMODAPARDATA)
		{
};

string PnlWdbeModAPar::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeModAPar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeModAParData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWdbeModAPar::StgIac();
	};
};

void PnlWdbeModAPar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeModAParData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeModAPar::DpchAppDo
 ******************************************************************************/

PnlWdbeModAPar::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMODAPARDO)
		{
	ixVDo = 0;
};

string PnlWdbeModAPar::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeModAPar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeModAParDo"];}();
...
void PnlWdbeModAPar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeModAParDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeModAPar::DpchEngData
 ******************************************************************************/

PnlWdbeModAPar::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMODAPARDATA, jref)
		{
...
string PnlWdbeModAPar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeModAPar::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeModAPar::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeModAParData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeModAPar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeModAPar::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeModAParData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeModAPar::StatApp::writeXML(wr);
