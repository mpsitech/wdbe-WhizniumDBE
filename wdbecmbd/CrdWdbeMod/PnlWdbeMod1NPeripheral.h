...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMod1NPeripheral* rst = NULL, QryWdbeMod1NPeripheral::StatShr* statshrqry = NULL, QryWdbeMod1NPeripheral::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
