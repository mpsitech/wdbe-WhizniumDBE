/**
	...
	* job handler for job PnlWdbeMod1NPeripheral (declarations)
...
/**
	...
	*/
class PnlWdbeMod1NPeripheral : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMod1NPeripheral* rst = NULL, QryWdbeMod1NPeripheral::StatShr* statshrqry = NULL, QryWdbeMod1NPeripheral::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMod1NPeripheral(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMod1NPeripheral();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMod1NPeripheral::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
