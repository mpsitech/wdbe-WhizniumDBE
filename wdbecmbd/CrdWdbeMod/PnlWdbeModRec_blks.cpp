...
PnlWdbeModRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREFKHDLTYPE, JREFAPAR, JREF1NPERIPHERAL, JREFMDL1NGENERIC, JREFCOR1NIMBUF, JREFMDL1NPORT, JREF1NPROCESS, JREFMDL1NSIGNAL, JREFSUP1NMODULE, JREFMGE1NSIGNAL, JREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, JREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, JREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, JREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeModRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREFKHDLTYPE, JREFAPAR, JREF1NPERIPHERAL, JREFMDL1NGENERIC, JREFCOR1NIMBUF, JREFMDL1NPORT, JREF1NPROCESS, JREFMDL1NSIGNAL, JREFSUP1NMODULE, JREFMGE1NSIGNAL, JREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, JREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, JREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, JREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
