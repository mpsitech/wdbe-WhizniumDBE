...
PnlWdbeModRec::StatShr::StatShr(
		...
		{
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREFKHDLTYPE, JREFAPAR, JREF1NPROCESS, JREFMDL1NPORT, JREF1NCDC, JREFHSM1NPIPELINE, JREFMDL1NGENERIC, JREFSUP1NMODULE, JREFREF1NVARIABLE, JREFREF1NSIGNAL, JREFREF1NSENSITIVITY, JREFMGE1NSIGNAL, JREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, JREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, JREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, JREFMNPERIPHERAL, JREFCTDMNMODULE, JREFCORMNMODULE, JREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeModRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREFKHDLTYPE, JREFAPAR, JREF1NPROCESS, JREFMDL1NPORT, JREF1NCDC, JREFHSM1NPIPELINE, JREFMDL1NGENERIC, JREFSUP1NMODULE, JREFREF1NVARIABLE, JREFREF1NSIGNAL, JREFREF1NSENSITIVITY, JREFMGE1NSIGNAL, JREFCTRREF1NERROR, PNLCTRREF1NERRORAVAIL, JREFCTRHK1NVECTOR, PNLCTRHK1NVECTORAVAIL, JREFCTRREF1NCOMMAND, PNLCTRREF1NCOMMANDAVAIL, JREFMNPERIPHERAL, JREFCTDMNMODULE, JREFCORMNMODULE, JREFCTRMNCOMMAND, PNLCTRMNCOMMANDAVAIL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
