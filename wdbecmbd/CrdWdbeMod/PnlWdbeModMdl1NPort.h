/**
	* \file PnlWdbeModMdl1NPort.h
	* job handler for job PnlWdbeModMdl1NPort (declarations)
...
#ifndef PNLWDBEMODMDL1NPORT_H
#define PNLWDBEMODMDL1NPORT_H
...
#define VecVWdbeModMdl1NPortDo PnlWdbeModMdl1NPort::VecVDo

#define ContInfWdbeModMdl1NPort PnlWdbeModMdl1NPort::ContInf
#define StatAppWdbeModMdl1NPort PnlWdbeModMdl1NPort::StatApp
#define StatShrWdbeModMdl1NPort PnlWdbeModMdl1NPort::StatShr
#define StgIacWdbeModMdl1NPort PnlWdbeModMdl1NPort::StgIac
#define TagWdbeModMdl1NPort PnlWdbeModMdl1NPort::Tag

#define DpchAppWdbeModMdl1NPortData PnlWdbeModMdl1NPort::DpchAppData
#define DpchAppWdbeModMdl1NPortDo PnlWdbeModMdl1NPort::DpchAppDo
#define DpchEngWdbeModMdl1NPortData PnlWdbeModMdl1NPort::DpchEngData

/**
	* PnlWdbeModMdl1NPort
	*/
class PnlWdbeModMdl1NPort : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModMdl1NPort* rst = NULL, QryWdbeModMdl1NPort::StatShr* statshrqry = NULL, QryWdbeModMdl1NPort::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeModMdl1NPort(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeModMdl1NPort();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeModMdl1NPort::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
