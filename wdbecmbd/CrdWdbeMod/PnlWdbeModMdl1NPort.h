...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModMdl1NPort* rst = NULL, QryWdbeModMdl1NPort::StatShr* statshrqry = NULL, QryWdbeModMdl1NPort::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
