/**
	* \file PnlWdbeModRef1NVariable.h
	* job handler for job PnlWdbeModRef1NVariable (declarations)
...
#ifndef PNLWDBEMODREF1NVARIABLE_H
#define PNLWDBEMODREF1NVARIABLE_H
...
#define VecVWdbeModRef1NVariableDo PnlWdbeModRef1NVariable::VecVDo

#define ContInfWdbeModRef1NVariable PnlWdbeModRef1NVariable::ContInf
#define StatAppWdbeModRef1NVariable PnlWdbeModRef1NVariable::StatApp
#define StatShrWdbeModRef1NVariable PnlWdbeModRef1NVariable::StatShr
#define StgIacWdbeModRef1NVariable PnlWdbeModRef1NVariable::StgIac
#define TagWdbeModRef1NVariable PnlWdbeModRef1NVariable::Tag

#define DpchAppWdbeModRef1NVariableData PnlWdbeModRef1NVariable::DpchAppData
#define DpchAppWdbeModRef1NVariableDo PnlWdbeModRef1NVariable::DpchAppDo
#define DpchEngWdbeModRef1NVariableData PnlWdbeModRef1NVariable::DpchEngData

/**
	* PnlWdbeModRef1NVariable
	*/
class PnlWdbeModRef1NVariable : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModRef1NVariable* rst = NULL, QryWdbeModRef1NVariable::StatShr* statshrqry = NULL, QryWdbeModRef1NVariable::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeModRef1NVariable(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeModRef1NVariable();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeModRef1NVariable::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
