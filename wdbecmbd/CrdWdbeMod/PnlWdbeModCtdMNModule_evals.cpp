/**
	* \file PnlWdbeModCtdMNModule_evals.cpp
	* job handler for job PnlWdbeModCtdMNModule (implementation of availability/activation evaluation)
...
bool PnlWdbeModCtdMNModule::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeModCtdMNModule::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
...
bool PnlWdbeModCtdMNModule::evalButAddAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeModCtdMNModule::evalButSubAvail(
			DbsWdbe* dbswdbe
		) {
	// pre.ixCrdaccModIncl(edit)
...
bool PnlWdbeModCtdMNModule::evalButSubActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
