...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModSup1NModule* rst = NULL, QryWdbeModSup1NModule::StatShr* statshrqry = NULL, QryWdbeModSup1NModule::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
