...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModKHdltype* rst = NULL, QryWdbeModKHdltype::StatShr* statshrqry = NULL, QryWdbeModKHdltype::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
