/**
	* \file PnlWdbeModKHdltype_blks.cpp
	* job handler for job PnlWdbeModKHdltype (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeModKHdltype::VecVDo
 ******************************************************************************/

uint PnlWdbeModKHdltype::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeModKHdltype::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeModKHdltype::ContInf
 ******************************************************************************/

PnlWdbeModKHdltype::ContInf::ContInf(
...
void PnlWdbeModKHdltype::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeModKHdltype";
...
void PnlWdbeModKHdltype::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeModKHdltype";
...
set<uint> PnlWdbeModKHdltype::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeModKHdltype::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeModKHdltype::StatApp
 ******************************************************************************/

void PnlWdbeModKHdltype::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeModKHdltype";
...
void PnlWdbeModKHdltype::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeModKHdltype";
...
/******************************************************************************
 class PnlWdbeModKHdltype::StatShr
 ******************************************************************************/

PnlWdbeModKHdltype::StatShr::StatShr(
...
void PnlWdbeModKHdltype::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeModKHdltype";
...
void PnlWdbeModKHdltype::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeModKHdltype";
...
set<uint> PnlWdbeModKHdltype::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeModKHdltype::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeModKHdltype::StgIac
 ******************************************************************************/

PnlWdbeModKHdltype::StgIac::StgIac(
...
bool PnlWdbeModKHdltype::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeModKHdltype"];}();
...
bool PnlWdbeModKHdltype::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeModKHdltype");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeModKHdltype";
...
void PnlWdbeModKHdltype::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeModKHdltype";
...
void PnlWdbeModKHdltype::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeModKHdltype";
...
set<uint> PnlWdbeModKHdltype::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeModKHdltype::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeModKHdltype::Tag
 ******************************************************************************/

void PnlWdbeModKHdltype::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeModKHdltype";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "HDL data type";
		me["TcoFix"] = "Fixed";
...
void PnlWdbeModKHdltype::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeModKHdltype";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "HDL data type");
...
/******************************************************************************
 class PnlWdbeModKHdltype::DpchAppData
 ******************************************************************************/

PnlWdbeModKHdltype::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMODKHDLTYPEDATA)
		{
};

string PnlWdbeModKHdltype::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeModKHdltype::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeModKHdltypeData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWdbeModKHdltype::StgIac();
	};
};

void PnlWdbeModKHdltype::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeModKHdltypeData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeModKHdltype::DpchAppDo
 ******************************************************************************/

PnlWdbeModKHdltype::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMODKHDLTYPEDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeModKHdltype::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeModKHdltypeDo"];}();
...
void PnlWdbeModKHdltype::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeModKHdltypeDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeModKHdltype::DpchEngData
 ******************************************************************************/

PnlWdbeModKHdltype::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMODKHDLTYPEDATA, jref)
		{
...
string PnlWdbeModKHdltype::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeModKHdltype::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeModKHdltype::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeModKHdltypeData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeModKHdltype::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeModKHdltype::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeModKHdltypeData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeModKHdltype::StatApp::writeXML(wr);
