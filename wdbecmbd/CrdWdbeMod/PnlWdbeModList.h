/**
	* \file PnlWdbeModList.h
	* job handler for job PnlWdbeModList (declarations)
...
#ifndef PNLWDBEMODLIST_H
#define PNLWDBEMODLIST_H
...
#define VecVWdbeModListDo PnlWdbeModList::VecVDo

#define ContIacWdbeModList PnlWdbeModList::ContIac
#define ContInfWdbeModList PnlWdbeModList::ContInf
#define StatShrWdbeModList PnlWdbeModList::StatShr
#define StgIacWdbeModList PnlWdbeModList::StgIac
#define TagWdbeModList PnlWdbeModList::Tag

#define DpchAppWdbeModListData PnlWdbeModList::DpchAppData
#define DpchAppWdbeModListDo PnlWdbeModList::DpchAppDo
#define DpchEngWdbeModListData PnlWdbeModList::DpchEngData

/**
	* PnlWdbeModList
	*/
class PnlWdbeModList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModList* rst = NULL, QryWdbeModList::StatShr* statshrqry = NULL, QryWdbeModList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeModList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeModList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeModList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
