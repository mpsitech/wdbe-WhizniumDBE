...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQModCtrMNCommand* rst = NULL, QryWdbeModCtrMNCommand::StatShr* statshrqry = NULL, QryWdbeModCtrMNCommand::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
