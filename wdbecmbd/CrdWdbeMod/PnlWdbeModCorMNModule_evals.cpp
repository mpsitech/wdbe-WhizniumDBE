/**
	* \file PnlWdbeModCorMNModule_evals.cpp
	* job handler for job PnlWdbeModCorMNModule (implementation of availability/activation evaluation)
...
bool PnlWdbeModCorMNModule::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeModCorMNModule::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
...
bool PnlWdbeModCorMNModule::evalButAddAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeModCorMNModule::evalButSubAvail(
			DbsWdbe* dbswdbe
		) {
	// pre.ixCrdaccModIncl(edit)
...
bool PnlWdbeModCorMNModule::evalButSubActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
