...
#define QRYWDBEMODCOR1NIMBUF_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeModCor1NImbuf QryWdbeModCor1NImbuf::StatApp
#define StatShrQryWdbeModCor1NImbuf QryWdbeModCor1NImbuf::StatShr
#define StgIacQryWdbeModCor1NImbuf QryWdbeModCor1NImbuf::StgIac

/**
	* QryWdbeModCor1NImbuf
	*/
class QryWdbeModCor1NImbuf : public JobWdbe {
...
public:
	QryWdbeModCor1NImbuf(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeModCor1NImbuf();
...
public:
	...
	WdbeQModCor1NImbuf* getRecByJnum(const Sbecore::uint jnum);
