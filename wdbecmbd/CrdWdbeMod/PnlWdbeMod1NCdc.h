/**
	* \file PnlWdbeMod1NCdc.h
	* job handler for job PnlWdbeMod1NCdc (declarations)
...
#ifndef PNLWDBEMOD1NCDC_H
#define PNLWDBEMOD1NCDC_H
...
#define VecVWdbeMod1NCdcDo PnlWdbeMod1NCdc::VecVDo

#define ContInfWdbeMod1NCdc PnlWdbeMod1NCdc::ContInf
#define StatAppWdbeMod1NCdc PnlWdbeMod1NCdc::StatApp
#define StatShrWdbeMod1NCdc PnlWdbeMod1NCdc::StatShr
#define StgIacWdbeMod1NCdc PnlWdbeMod1NCdc::StgIac
#define TagWdbeMod1NCdc PnlWdbeMod1NCdc::Tag

#define DpchAppWdbeMod1NCdcData PnlWdbeMod1NCdc::DpchAppData
#define DpchAppWdbeMod1NCdcDo PnlWdbeMod1NCdc::DpchAppDo
#define DpchEngWdbeMod1NCdcData PnlWdbeMod1NCdc::DpchEngData

/**
	* PnlWdbeMod1NCdc
	*/
class PnlWdbeMod1NCdc : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMod1NCdc* rst = NULL, QryWdbeMod1NCdc::StatShr* statshrqry = NULL, QryWdbeMod1NCdc::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMod1NCdc(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMod1NCdc();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMod1NCdc::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
