/**
	* \file QryWdbeModList_blks.cpp
	* job handler for job QryWdbeModList (implementation of blocks)
...
/******************************************************************************
 class QryWdbeModList::VecVOrd
 ******************************************************************************/

uint QryWdbeModList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWdbeModList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWdbeModList::StatApp
 ******************************************************************************/

void QryWdbeModList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeModList";
...
void QryWdbeModList::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWdbeModList";
...
/******************************************************************************
 class QryWdbeModList::StatShr
 ******************************************************************************/

QryWdbeModList::StatShr::StatShr(
			const uint ntot
...
void QryWdbeModList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeModList";
...
void QryWdbeModList::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeModList";
...
set<uint> QryWdbeModList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeModList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeModList::StgIac
 ******************************************************************************/

QryWdbeModList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeModList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeModList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeModList";
...
void QryWdbeModList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeModList";
...
void QryWdbeModList::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeModList";
...
set<uint> QryWdbeModList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeModList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
