/**
	* \file QryWdbeMod1NCdc_blks.cpp
	* job handler for job QryWdbeMod1NCdc (implementation of blocks)
...
/******************************************************************************
 class QryWdbeMod1NCdc::StatApp
 ******************************************************************************/

void QryWdbeMod1NCdc::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeMod1NCdc";
...
void QryWdbeMod1NCdc::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeMod1NCdc";
...
/******************************************************************************
 class QryWdbeMod1NCdc::StatShr
 ******************************************************************************/

QryWdbeMod1NCdc::StatShr::StatShr(
			const uint ntot
...
void QryWdbeMod1NCdc::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeMod1NCdc";
...
void QryWdbeMod1NCdc::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeMod1NCdc";
...
set<uint> QryWdbeMod1NCdc::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMod1NCdc::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeMod1NCdc::StgIac
 ******************************************************************************/

QryWdbeMod1NCdc::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeMod1NCdc::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbeMod1NCdc"];}();
...
bool QryWdbeMod1NCdc::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeMod1NCdc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeMod1NCdc";
...
void QryWdbeMod1NCdc::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeMod1NCdc";
...
void QryWdbeMod1NCdc::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeMod1NCdc";
...
set<uint> QryWdbeMod1NCdc::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMod1NCdc::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
