/**
	* \file PnlWdbeFam1NUnit.h
	* job handler for job PnlWdbeFam1NUnit (declarations)
...
#ifndef PNLWDBEFAM1NUNIT_H
#define PNLWDBEFAM1NUNIT_H
...
#define VecVWdbeFam1NUnitDo PnlWdbeFam1NUnit::VecVDo

#define ContInfWdbeFam1NUnit PnlWdbeFam1NUnit::ContInf
#define StatAppWdbeFam1NUnit PnlWdbeFam1NUnit::StatApp
#define StatShrWdbeFam1NUnit PnlWdbeFam1NUnit::StatShr
#define StgIacWdbeFam1NUnit PnlWdbeFam1NUnit::StgIac
#define TagWdbeFam1NUnit PnlWdbeFam1NUnit::Tag

#define DpchAppWdbeFam1NUnitData PnlWdbeFam1NUnit::DpchAppData
#define DpchAppWdbeFam1NUnitDo PnlWdbeFam1NUnit::DpchAppDo
#define DpchEngWdbeFam1NUnitData PnlWdbeFam1NUnit::DpchEngData

/**
	* PnlWdbeFam1NUnit
	*/
class PnlWdbeFam1NUnit : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQFam1NUnit* rst = NULL, QryWdbeFam1NUnit::StatShr* statshrqry = NULL, QryWdbeFam1NUnit::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeFam1NUnit(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeFam1NUnit();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeFam1NUnit::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
