...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQFam1NUnit* rst = NULL, QryWdbeFam1NUnit::StatShr* statshrqry = NULL, QryWdbeFam1NUnit::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
