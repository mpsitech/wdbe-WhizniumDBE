...
public:
	// IP cust --- IBEGIN
	void showSubmdls(DbsWdbe* dbswdbe, const Sbecore::ubigint refWdbeMModule, bool _gens, bool _prcs, bool _prts, bool _sigs, unsigned int indent);
	// IP cust --- IEND
...
private:
	...
	bool handleShowPrcs(DbsWdbe* dbswdbe);
