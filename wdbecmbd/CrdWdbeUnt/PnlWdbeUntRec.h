...
public:
	...
	public:
		...
		static const Sbecore::uint JREFREF1NSIGNAL = 8;
	...
	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jref1NInterrupt = 0, const Sbecore::ubigint jref1NPeripheral = 0, const Sbecore::ubigint jrefSil1NUnit = 0, const bool pnlsil1nunitAvail = false, const Sbecore::ubigint jref1NBank = 0, const Sbecore::ubigint jrefRef1NSignal = 0, const Sbecore::ubigint jrefRef1NError = 0, const Sbecore::ubigint jrefHk1NVector = 0, const Sbecore::ubigint jrefHk1NModule = 0, const Sbecore::ubigint jrefRef1NCommand = 0, const bool ButRegularizeActive = true);
