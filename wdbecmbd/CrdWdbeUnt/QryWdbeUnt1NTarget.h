...
#define StatAppQryWdbeUnt1NTarget QryWdbeUnt1NTarget::StatApp
#define StatShrQryWdbeUnt1NTarget QryWdbeUnt1NTarget::StatShr
#define StgIacQryWdbeUnt1NTarget QryWdbeUnt1NTarget::StgIac

/**
	* QryWdbeUnt1NTarget
	*/
class QryWdbeUnt1NTarget : public JobWdbe {
...
public:
	QryWdbeUnt1NTarget(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeUnt1NTarget();
...
public:
	...
	WdbeQUnt1NTarget* getRecByJnum(const Sbecore::uint jnum);
