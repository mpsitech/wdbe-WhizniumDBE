/**
	...
	* job handler for job PnlWdbeUntFwd1NController (declarations)
...
/**
	...
	*/
class PnlWdbeUntFwd1NController : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUntFwd1NController* rst = NULL, QryWdbeUntFwd1NController::StatShr* statshrqry = NULL, QryWdbeUntFwd1NController::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeUntFwd1NController(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeUntFwd1NController();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeUntFwd1NController::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
