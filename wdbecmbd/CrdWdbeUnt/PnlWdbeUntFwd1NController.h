...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUntFwd1NController* rst = NULL, QryWdbeUntFwd1NController::StatShr* statshrqry = NULL, QryWdbeUntFwd1NController::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
