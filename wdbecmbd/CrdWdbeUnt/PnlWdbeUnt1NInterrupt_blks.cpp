...
bool PnlWdbeUnt1NInterrupt::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeUnt1NInterrupt"];}();
...
void PnlWdbeUnt1NInterrupt::DpchAppData::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUnt1NInterruptData"];}();
...
void PnlWdbeUnt1NInterrupt::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUnt1NInterruptDo"];}();
