/**
	* \file QryWdbeUnt1NPeripheral_blks.cpp
	* job handler for job QryWdbeUnt1NPeripheral (implementation of blocks)
...
void QryWdbeUnt1NPeripheral::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeUnt1NPeripheral";
...
void QryWdbeUnt1NPeripheral::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWdbeUnt1NPeripheral";
...
void QryWdbeUnt1NPeripheral::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeUnt1NPeripheral";
...
void QryWdbeUnt1NPeripheral::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeUnt1NPeripheral";
...
void QryWdbeUnt1NPeripheral::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
