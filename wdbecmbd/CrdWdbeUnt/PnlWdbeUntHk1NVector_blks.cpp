/**
	* \file PnlWdbeUntHk1NVector_blks.cpp
	* job handler for job PnlWdbeUntHk1NVector (implementation of blocks)
...
void PnlWdbeUntHk1NVector::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeUntHk1NVector";
...
void PnlWdbeUntHk1NVector::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeUntHk1NVector";
...
void PnlWdbeUntHk1NVector::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeUntHk1NVector";
...
void PnlWdbeUntHk1NVector::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeUntHk1NVector";
...
void PnlWdbeUntHk1NVector::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeUntHk1NVector";
...
void PnlWdbeUntHk1NVector::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeUntHk1NVector";
...
bool PnlWdbeUntHk1NVector::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeUntHk1NVector"];}();
...
void PnlWdbeUntHk1NVector::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeUntHk1NVector::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeUntHk1NVector";
...
void PnlWdbeUntHk1NVector::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeUntHk1NVector";
...
PnlWdbeUntHk1NVector::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEUNTHK1NVECTORDATA)
		{
};
...
void PnlWdbeUntHk1NVector::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUntHk1NVectorData"];}();
...
void PnlWdbeUntHk1NVector::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeUntHk1NVectorData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeUntHk1NVector::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEUNTHK1NVECTORDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeUntHk1NVector::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUntHk1NVectorDo"];}();
...
void PnlWdbeUntHk1NVector::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeUntHk1NVectorDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeUntHk1NVector::DpchEngData::DpchEngData(
			...
			, QryWdbeUntHk1NVector::StatShr* statshrqry
			, QryWdbeUntHk1NVector::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEUNTHK1NVECTORDATA, jref)
		{
...
void PnlWdbeUntHk1NVector::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeUntHk1NVector::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeUntHk1NVectorData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeUntHk1NVector::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeUntHk1NVector::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeUntHk1NVectorData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeUntHk1NVector::StatApp::writeXML(wr);
