...
PnlWdbeUntRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREFSIL1NUNIT, PNLSIL1NUNITAVAIL, JREF1NPERIPHERAL, JREF1NBANK, JREFFWD1NCONTROLLER, JREF1NTARGET, JREFHK1NVECTOR, JREFHK1NMODULE, JREFREF1NCOMMAND, JREFREF1NERROR, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeUntRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREFSIL1NUNIT, PNLSIL1NUNITAVAIL, JREF1NPERIPHERAL, JREF1NBANK, JREFFWD1NCONTROLLER, JREF1NTARGET, JREFHK1NVECTOR, JREFHK1NMODULE, JREFREF1NCOMMAND, JREFREF1NERROR, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
