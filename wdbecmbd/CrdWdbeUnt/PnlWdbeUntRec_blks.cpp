...
PnlWdbeUntRec::StatShr::StatShr(
		...
		{
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NBANK, JREFSIL1NUNIT, PNLSIL1NUNITAVAIL, JREF1NPERIPHERAL, JREF1NINTERRUPT, JREFREF1NCOMMAND, JREFHK1NMODULE, JREFHK1NVECTOR, JREFREF1NERROR, JREFREF1NSIGNAL, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeUntRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NBANK, JREFSIL1NUNIT, PNLSIL1NUNITAVAIL, JREF1NPERIPHERAL, JREF1NINTERRUPT, JREFREF1NCOMMAND, JREFHK1NMODULE, JREFHK1NVECTOR, JREFREF1NERROR, JREFREF1NSIGNAL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
