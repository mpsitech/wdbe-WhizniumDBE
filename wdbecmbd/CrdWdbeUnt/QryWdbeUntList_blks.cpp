...
void QryWdbeUntList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWdbeUntList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeUntList";
...
void QryWdbeUntList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeUntList";
...
void QryWdbeUntList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeUntList";
...
void QryWdbeUntList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeUntList";
...
void QryWdbeUntList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
