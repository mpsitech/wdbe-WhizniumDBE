...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUntList* rst = NULL, QryWdbeUntList::StatShr* statshrqry = NULL, QryWdbeUntList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
