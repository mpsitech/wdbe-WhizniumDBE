/**
	* \file PnlWdbeUntRef1NSignal.h
	* job handler for job PnlWdbeUntRef1NSignal (declarations)
...
#ifndef PNLWDBEUNTREF1NSIGNAL_H
#define PNLWDBEUNTREF1NSIGNAL_H
...
#define VecVWdbeUntRef1NSignalDo PnlWdbeUntRef1NSignal::VecVDo

#define ContInfWdbeUntRef1NSignal PnlWdbeUntRef1NSignal::ContInf
#define StatAppWdbeUntRef1NSignal PnlWdbeUntRef1NSignal::StatApp
#define StatShrWdbeUntRef1NSignal PnlWdbeUntRef1NSignal::StatShr
#define StgIacWdbeUntRef1NSignal PnlWdbeUntRef1NSignal::StgIac
#define TagWdbeUntRef1NSignal PnlWdbeUntRef1NSignal::Tag

#define DpchAppWdbeUntRef1NSignalData PnlWdbeUntRef1NSignal::DpchAppData
#define DpchAppWdbeUntRef1NSignalDo PnlWdbeUntRef1NSignal::DpchAppDo
#define DpchEngWdbeUntRef1NSignalData PnlWdbeUntRef1NSignal::DpchEngData

/**
	* PnlWdbeUntRef1NSignal
	*/
class PnlWdbeUntRef1NSignal : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUntRef1NSignal* rst = NULL, QryWdbeUntRef1NSignal::StatShr* statshrqry = NULL, QryWdbeUntRef1NSignal::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeUntRef1NSignal(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeUntRef1NSignal();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeUntRef1NSignal::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
