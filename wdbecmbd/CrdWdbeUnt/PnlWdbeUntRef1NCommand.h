/**
	* \file PnlWdbeUntRef1NCommand.h
	* job handler for job PnlWdbeUntRef1NCommand (declarations)
...
#ifndef PNLWDBEUNTREF1NCOMMAND_H
#define PNLWDBEUNTREF1NCOMMAND_H
...
#define VecVWdbeUntRef1NCommandDo PnlWdbeUntRef1NCommand::VecVDo

#define ContInfWdbeUntRef1NCommand PnlWdbeUntRef1NCommand::ContInf
#define StatAppWdbeUntRef1NCommand PnlWdbeUntRef1NCommand::StatApp
#define StatShrWdbeUntRef1NCommand PnlWdbeUntRef1NCommand::StatShr
#define StgIacWdbeUntRef1NCommand PnlWdbeUntRef1NCommand::StgIac
#define TagWdbeUntRef1NCommand PnlWdbeUntRef1NCommand::Tag

#define DpchAppWdbeUntRef1NCommandData PnlWdbeUntRef1NCommand::DpchAppData
#define DpchAppWdbeUntRef1NCommandDo PnlWdbeUntRef1NCommand::DpchAppDo
#define DpchEngWdbeUntRef1NCommandData PnlWdbeUntRef1NCommand::DpchEngData

/**
	* PnlWdbeUntRef1NCommand
	*/
class PnlWdbeUntRef1NCommand : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUntRef1NCommand* rst = NULL, QryWdbeUntRef1NCommand::StatShr* statshrqry = NULL, QryWdbeUntRef1NCommand::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeUntRef1NCommand(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeUntRef1NCommand();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeUntRef1NCommand::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
