/**
	* \file PnlWdbeUntRef1NError.h
	* job handler for job PnlWdbeUntRef1NError (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEUNTREF1NERROR_H
#define PNLWDBEUNTREF1NERROR_H
...
#define VecVWdbeUntRef1NErrorDo PnlWdbeUntRef1NError::VecVDo

#define ContInfWdbeUntRef1NError PnlWdbeUntRef1NError::ContInf
#define StatAppWdbeUntRef1NError PnlWdbeUntRef1NError::StatApp
#define StatShrWdbeUntRef1NError PnlWdbeUntRef1NError::StatShr
#define StgIacWdbeUntRef1NError PnlWdbeUntRef1NError::StgIac
#define TagWdbeUntRef1NError PnlWdbeUntRef1NError::Tag

#define DpchAppWdbeUntRef1NErrorData PnlWdbeUntRef1NError::DpchAppData
#define DpchAppWdbeUntRef1NErrorDo PnlWdbeUntRef1NError::DpchAppDo
#define DpchEngWdbeUntRef1NErrorData PnlWdbeUntRef1NError::DpchEngData

/**
	* PnlWdbeUntRef1NError
	*/
class PnlWdbeUntRef1NError : public JobWdbe {

public:
	/**
		* VecVDo (full: VecVWdbeUntRef1NErrorDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWdbeUntRef1NError)
	  */
	...
	/**
		* StatApp (full: StatAppWdbeUntRef1NError)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrWdbeUntRef1NError)
		*/
	...
	/**
		* StgIac (full: StgIacWdbeUntRef1NError)
		*/
	...
	/**
		* DpchAppData (full: DpchAppWdbeUntRef1NErrorData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUntRef1NErrorDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWdbeUntRef1NErrorData)
		*/
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUntRef1NError* rst = NULL, QryWdbeUntRef1NError::StatShr* statshrqry = NULL, QryWdbeUntRef1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeUntRef1NError(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeUntRef1NError();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeUntRef1NError::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
