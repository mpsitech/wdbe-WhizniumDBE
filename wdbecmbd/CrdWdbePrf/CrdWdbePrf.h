/**
	* \file CrdWdbePrf.h
	* job handler for job CrdWdbePrf (declarations)
...
/**
	* CrdWdbePrf
	*/
class CrdWdbePrf : public JobWdbe {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWdbeVReqitmode = VecWdbeVReqitmode::IDLE, const Sbecore::usmallint latency = 5, const std::string& shortMenu = "", const Sbecore::uint widthMenu = 0, const bool initdoneDaemon = false, const bool initdoneHeadbar = false, const bool initdoneLicense = false);
	...
	public:
		static const Sbecore::uint JREFDAEMON = 1;
		static const Sbecore::uint JREFHEADBAR = 2;
		static const Sbecore::uint JREFLICENSE = 3;

	public:
		StatShr(const Sbecore::ubigint jrefDaemon = 0, const Sbecore::ubigint jrefHeadbar = 0, const Sbecore::ubigint jrefLicense = 0);

	public:
		Sbecore::ubigint jrefDaemon;
		Sbecore::ubigint jrefHeadbar;
		Sbecore::ubigint jrefLicense;
...
public:
	CrdWdbePrf(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~CrdWdbePrf();
...
public:
	...
	PnlWdbePrfLicense* pnllicense;
	PnlWdbePrfHeadbar* pnlheadbar;
	PnlWdbePrfDaemon* pnldaemon;

	// IP vars.cust --- INSERT

public:
	// IP cust --- BEGIN
	void setPref(DbsWdbe* dbswdbe);
	void storePref();
	// IP cust --- END
...
private:
	...
	void handleDpchAppDoMitCrdRvrClick(DbsWdbe* dbswdbe, DpchEngWdbe** dpcheng);
	void handleDpchAppDoMitCrdStoClick(DbsWdbe* dbswdbe, DpchEngWdbe** dpcheng);
