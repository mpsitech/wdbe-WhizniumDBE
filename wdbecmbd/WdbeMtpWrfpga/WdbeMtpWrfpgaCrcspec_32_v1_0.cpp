/**
	* \file WdbeMtpWrfpgaCrcspec_32_v1_0.cpp
...
DpchRetWdbe* WdbeMtpWrfpgaCrcspec_32_v1_0::run(
			XchgWdbe* xchg
			, DbsWdbe* dbswdbe
	...
	// IP run --- IBEGIN
	// exact copy from WdbeMtpWrfpgaCrcspec_v1_0 except for changed/indexed variable names
...
// IP cust --- IBEGIN
void WdbeMtpWrfpgaCrcspec_32_v1_0::writeMdlVhd(
			DbsWdbe* dbswdbe
			, fstream& outfile
			, WdbeMModule* mdl
		) {
