/**
	...
	* job handler for job PnlWdbeSegRec (declarations)
...
/**
	* PnlWdbeSegRec
	*/
class PnlWdbeSegRec : public JobWdbe {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneSup1NSegment = false);
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdoneSup1NSegment = false);
	};
	...
	public:
		...
		static const Sbecore::uint JREFSUP1NSEGMENT = 3;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 4;

	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefSup1NSegment = 0, const bool ButRegularizeActive = true);

	public:
		Sbecore::uint ixWdbeVExpstate;
		Sbecore::ubigint jrefDetail;
		Sbecore::ubigint jrefSup1NSegment;
...
public:
	PnlWdbeSegRec(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeSegRec();
...
public:
	...
	PnlWdbeSegSup1NSegment* pnlsup1nsegment;
	PnlWdbeSegDetail* pnldetail;
