/**
	* \file CrdWdbeSeg.h
	* job handler for job CrdWdbeSeg (declarations)
...
/**
	* CrdWdbeSeg
	*/
class CrdWdbeSeg : public JobWdbe {
...
public:
	CrdWdbeSeg(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeSeg();
...
public:
	...
	PnlWdbeSegList* pnllist;
	PnlWdbeSegHeadbar* pnlheadbar;
	PnlWdbeSegRec* pnlrec;
