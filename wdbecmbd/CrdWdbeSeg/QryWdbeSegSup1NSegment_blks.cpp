/**
	* \file QryWdbeSegSup1NSegment_blks.cpp
	* job handler for job QryWdbeSegSup1NSegment (implementation of blocks)
...
void QryWdbeSegSup1NSegment::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeSegSup1NSegment";
...
void QryWdbeSegSup1NSegment::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeSegSup1NSegment";
...
void QryWdbeSegSup1NSegment::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeSegSup1NSegment";
...
void QryWdbeSegSup1NSegment::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeSegSup1NSegment";
...
bool QryWdbeSegSup1NSegment::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbeSegSup1NSegment"];}();
...
void QryWdbeSegSup1NSegment::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
