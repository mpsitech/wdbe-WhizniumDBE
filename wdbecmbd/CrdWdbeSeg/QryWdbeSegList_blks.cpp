/**
	* \file QryWdbeSegList_blks.cpp
	* job handler for job QryWdbeSegList (implementation of blocks)
...
void QryWdbeSegList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWdbeSegList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeSegList";
...
void QryWdbeSegList::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWdbeSegList";
...
void QryWdbeSegList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeSegList";
...
void QryWdbeSegList::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeSegList";
...
void QryWdbeSegList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
