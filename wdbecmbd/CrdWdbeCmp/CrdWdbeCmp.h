/**
	* \file CrdWdbeCmp.h
	* job handler for job CrdWdbeCmp (declarations)
...
/**
	* CrdWdbeCmp
	*/
class CrdWdbeCmp : public JobWdbe {
...
public:
	CrdWdbeCmp(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeCmp();
...
public:
	...
	PnlWdbeCmpList* pnllist;
	PnlWdbeCmpHeadbar* pnlheadbar;
	PnlWdbeCmpRec* pnlrec;
