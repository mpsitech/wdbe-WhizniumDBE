/**
	* \file PnlWdbeCmpList.h
	* job handler for job PnlWdbeCmpList (declarations)
...
#ifndef PNLWDBECMPLIST_H
#define PNLWDBECMPLIST_H
...
#define VecVWdbeCmpListDo PnlWdbeCmpList::VecVDo

#define ContIacWdbeCmpList PnlWdbeCmpList::ContIac
#define ContInfWdbeCmpList PnlWdbeCmpList::ContInf
#define StatShrWdbeCmpList PnlWdbeCmpList::StatShr
#define StgIacWdbeCmpList PnlWdbeCmpList::StgIac
#define TagWdbeCmpList PnlWdbeCmpList::Tag

#define DpchAppWdbeCmpListData PnlWdbeCmpList::DpchAppData
#define DpchAppWdbeCmpListDo PnlWdbeCmpList::DpchAppDo
#define DpchEngWdbeCmpListData PnlWdbeCmpList::DpchEngData

/**
	* PnlWdbeCmpList
	*/
class PnlWdbeCmpList : public JobWdbe {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoVerWidth = 250);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCmpList* rst = NULL, QryWdbeCmpList::StatShr* statshrqry = NULL, QryWdbeCmpList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCmpList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCmpList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCmpList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
