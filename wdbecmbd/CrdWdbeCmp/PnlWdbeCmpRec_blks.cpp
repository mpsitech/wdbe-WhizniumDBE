/**
	* \file PnlWdbeCmpRec_blks.cpp
	* job handler for job PnlWdbeCmpRec (implementation of blocks)
...
void PnlWdbeCmpRec::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeCmpRec";
...
void PnlWdbeCmpRec::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeCmpRec";
...
void PnlWdbeCmpRec::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	if (difftag.length() == 0) difftag = "StatAppWdbeCmpRec";
...
void PnlWdbeCmpRec::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const bool initdoneDetail
	...
	else itemtag = "StatitemAppWdbeCmpRec";
...
void PnlWdbeCmpRec::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeCmpRec";
...
void PnlWdbeCmpRec::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeCmpRec";
...
set<uint> PnlWdbeCmpRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NRELEASE, JREFMNLIBRARY, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
void PnlWdbeCmpRec::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeCmpRec";
...
void PnlWdbeCmpRec::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeCmpRec";
...
PnlWdbeCmpRec::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBECMPRECDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeCmpRec::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeCmpRecDo"];}();
...
void PnlWdbeCmpRec::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeCmpRecDo");
	else
...
PnlWdbeCmpRec::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBECMPRECDATA, jref)
		{
...
void PnlWdbeCmpRec::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeCmpRec::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeCmpRecData"] = Json::Value(Json::objectValue);
...
void PnlWdbeCmpRec::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeCmpRecData");
