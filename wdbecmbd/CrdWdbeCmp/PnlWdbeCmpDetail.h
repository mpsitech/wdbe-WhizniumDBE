/**
	...
	* job handler for job PnlWdbeCmpDetail (declarations)
...
/**
	* PnlWdbeCmpDetail
	*/
class PnlWdbeCmpDetail : public JobWdbe {
...
public:
	PnlWdbeCmpDetail(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCmpDetail();
...
public:
	...
	void refreshRecCmp(DbsWdbe* dbswdbe, std::set<Sbecore::uint>& moditems);
