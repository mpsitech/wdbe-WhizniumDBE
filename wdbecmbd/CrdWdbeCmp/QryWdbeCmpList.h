/**
	* \file QryWdbeCmpList.h
	* job handler for job QryWdbeCmpList (declarations)
...
#ifndef QRYWDBECMPLIST_H
#define QRYWDBECMPLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbeCmpListOrd QryWdbeCmpList::VecVOrd

#define StatAppQryWdbeCmpList QryWdbeCmpList::StatApp
#define StatShrQryWdbeCmpList QryWdbeCmpList::StatShr
#define StgIacQryWdbeCmpList QryWdbeCmpList::StgIac

/**
	* QryWdbeCmpList
	*/
class QryWdbeCmpList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbeCmpListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbeCmpList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeCmpList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeCmpList)
		*/
...
public:
	QryWdbeCmpList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeCmpList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::uint preTyp, const Sbecore::ubigint preVer, const bool addwhere);
	...
	WdbeQCmpList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWdbeCmpMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
