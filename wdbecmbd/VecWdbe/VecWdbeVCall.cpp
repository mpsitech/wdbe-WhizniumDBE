...
uint VecWdbeVCall::getIx(
	...
	if (s == "callwdbecdc.mdleq") return CALLWDBECDC_MDLEQ;
	if (s == "callwdbecdcmod") return CALLWDBECDCMOD;
	if (s == "callwdbecdcmod.mdleq") return CALLWDBECDCMOD_MDLEQ;
	if (s == "callwdbecdcrsigmod.cdceq") return CALLWDBECDCRSIGMOD_CDCEQ;
	if (s == "callwdbecdcrsigmod.sigeq") return CALLWDBECDCRSIGMOD_SIGEQ;
	if (s == "callwdbecdcupd.refeq") return CALLWDBECDCUPD_REFEQ;
	if (s == "callwdbeclaimchg") return CALLWDBECLAIMCHG;
	if (s == "callwdbecmd.ivreq") return CALLWDBECMD_IVREQ;
	if (s == "callwdbecmd.rereq") return CALLWDBECMD_REREQ;
	...
	if (s == "callwdbecmd.rvreq") return CALLWDBECMD_RVREQ;
	...
	if (s == "callwdbecmp.vereq") return CALLWDBECMP_VEREQ;
	if (s == "callwdbecmpmod") return CALLWDBECMPMOD;
	if (s == "callwdbecmpmod.vereq") return CALLWDBECMPMOD_VEREQ;
	if (s == "callwdbecmprlibmod.cmpeq") return CALLWDBECMPRLIBMOD_CMPEQ;
	if (s == "callwdbecmprlibmod.libeq") return CALLWDBECMPRLIBMOD_LIBEQ;
	if (s == "callwdbecmpupd.refeq") return CALLWDBECMPUPD_REFEQ;
	...
	if (s == "callwdbeerr.traeq") return CALLWDBEERR_TRAEQ;
	...
	if (s == "callwdbeint.unt.insbs") return CALLWDBEINT_UNT_INSBS;
	if (s == "callwdbeint.unteq") return CALLWDBEINT_UNTEQ;
	if (s == "callwdbeintmod") return CALLWDBEINTMOD;
	if (s == "callwdbeintmod.unteq") return CALLWDBEINTMOD_UNTEQ;
	if (s == "callwdbeintupd.refeq") return CALLWDBEINTUPD_REFEQ;
	...
	if (s == "callwdbemdlrmdlmod.coreq") return CALLWDBEMDLRMDLMOD_COREQ;
	if (s == "callwdbemdlrmdlmod.ctdeq") return CALLWDBEMDLRMDLMOD_CTDEQ;
	if (s == "callwdbemdlrpphmod.mdleq") return CALLWDBEMDLRPPHMOD_MDLEQ;
	if (s == "callwdbemdlrpphmod.ppheq") return CALLWDBEMDLRPPHMOD_PPHEQ;
	...
	if (s == "callwdbeppl.hsm.insbs") return CALLWDBEPPL_HSM_INSBS;
	if (s == "callwdbeppl.hsmeq") return CALLWDBEPPL_HSMEQ;
	if (s == "callwdbepplmod") return CALLWDBEPPLMOD;
	if (s == "callwdbepplmod.hsmeq") return CALLWDBEPPLMOD_HSMEQ;
	if (s == "callwdbepplupd.refeq") return CALLWDBEPPLUPD_REFEQ;
	...
	if (s == "callwdberls.cmpeq") return CALLWDBERLS_CMPEQ;
	if (s == "callwdberls.mcheq") return CALLWDBERLS_MCHEQ;
	if (s == "callwdberlsmod") return CALLWDBERLSMOD;
	if (s == "callwdberlsmod.cmpeq") return CALLWDBERLSMOD_CMPEQ;
	if (s == "callwdberlsmod.mcheq") return CALLWDBERLSMOD_MCHEQ;
	if (s == "callwdberlsupd.refeq") return CALLWDBERLSUPD_REFEQ;
	if (s == "callwdbeseg.clueq") return CALLWDBESEG_CLUEQ;
	if (s == "callwdbeseg.ppleq") return CALLWDBESEG_PPLEQ;
	if (s == "callwdbeseg.supeq") return CALLWDBESEG_SUPEQ;
	if (s == "callwdbesegmod") return CALLWDBESEGMOD;
	if (s == "callwdbesegmod.clueq") return CALLWDBESEGMOD_CLUEQ;
	if (s == "callwdbesegmod.ppleq") return CALLWDBESEGMOD_PPLEQ;
	if (s == "callwdbesegmod.supeq") return CALLWDBESEGMOD_SUPEQ;
	if (s == "callwdbesegupd.refeq") return CALLWDBESEGUPD_REFEQ;
	...
	if (s == "callwdbesig.reteq") return CALLWDBESIG_RETEQ;
	if (s == "callwdbesig.reu.insbs") return CALLWDBESIG_REU_INSBS;
	if (s == "callwdbesig.reueq") return CALLWDBESIG_REUEQ;
	...
	if (s == "callwdbesigmod.retreueq") return CALLWDBESIGMOD_RETREUEQ;
	if (s == "callwdbesigupd.refeq") return CALLWDBESIGUPD_REFEQ;
	if (s == "callwdbesns.reteq") return CALLWDBESNS_RETEQ;
	if (s == "callwdbesns.reu.insbs") return CALLWDBESNS_REU_INSBS;
	if (s == "callwdbesns.reueq") return CALLWDBESNS_REUEQ;
	if (s == "callwdbesns.srteq") return CALLWDBESNS_SRTEQ;
	if (s == "callwdbesns.srueq") return CALLWDBESNS_SRUEQ;
	if (s == "callwdbesnsmod") return CALLWDBESNSMOD;
	if (s == "callwdbesnsmod.retreueq") return CALLWDBESNSMOD_RETREUEQ;
	if (s == "callwdbesnsmod.srtsrueq") return CALLWDBESNSMOD_SRTSRUEQ;
	if (s == "callwdbesnsupd.refeq") return CALLWDBESNSUPD_REFEQ;
	...
	if (s == "callwdbevar.reteq") return CALLWDBEVAR_RETEQ;
	if (s == "callwdbevar.reu.insbs") return CALLWDBEVAR_REU_INSBS;
	if (s == "callwdbevar.reueq") return CALLWDBEVAR_REUEQ;
...
string VecWdbeVCall::getSref(
	...
	if (ix == CALLWDBECDC_MDLEQ) return("CallWdbeCdc.mdlEq");
	if (ix == CALLWDBECDCMOD) return("CallWdbeCdcMod");
	if (ix == CALLWDBECDCMOD_MDLEQ) return("CallWdbeCdcMod.mdlEq");
	if (ix == CALLWDBECDCRSIGMOD_CDCEQ) return("CallWdbeCdcRsigMod.cdcEq");
	if (ix == CALLWDBECDCRSIGMOD_SIGEQ) return("CallWdbeCdcRsigMod.sigEq");
	if (ix == CALLWDBECDCUPD_REFEQ) return("CallWdbeCdcUpd.refEq");
	if (ix == CALLWDBECLAIMCHG) return("CallWdbeClaimChg");
	if (ix == CALLWDBECMD_IVREQ) return("CallWdbeCmd.ivrEq");
	if (ix == CALLWDBECMD_REREQ) return("CallWdbeCmd.rerEq");
	...
	if (ix == CALLWDBECMD_RVREQ) return("CallWdbeCmd.rvrEq");
	...
	if (ix == CALLWDBECMP_VEREQ) return("CallWdbeCmp.verEq");
	if (ix == CALLWDBECMPMOD) return("CallWdbeCmpMod");
	if (ix == CALLWDBECMPMOD_VEREQ) return("CallWdbeCmpMod.verEq");
	if (ix == CALLWDBECMPRLIBMOD_CMPEQ) return("CallWdbeCmpRlibMod.cmpEq");
	if (ix == CALLWDBECMPRLIBMOD_LIBEQ) return("CallWdbeCmpRlibMod.libEq");
	if (ix == CALLWDBECMPUPD_REFEQ) return("CallWdbeCmpUpd.refEq");
	...
	if (ix == CALLWDBEERR_TRAEQ) return("CallWdbeErr.traEq");
	...
	if (ix == CALLWDBEINT_UNT_INSBS) return("CallWdbeInt.unt.inSbs");
	if (ix == CALLWDBEINT_UNTEQ) return("CallWdbeInt.untEq");
	if (ix == CALLWDBEINTMOD) return("CallWdbeIntMod");
	if (ix == CALLWDBEINTMOD_UNTEQ) return("CallWdbeIntMod.untEq");
	if (ix == CALLWDBEINTUPD_REFEQ) return("CallWdbeIntUpd.refEq");
	...
	if (ix == CALLWDBEMDLRMDLMOD_COREQ) return("CallWdbeMdlRmdlMod.corEq");
	if (ix == CALLWDBEMDLRMDLMOD_CTDEQ) return("CallWdbeMdlRmdlMod.ctdEq");
	if (ix == CALLWDBEMDLRPPHMOD_MDLEQ) return("CallWdbeMdlRpphMod.mdlEq");
	if (ix == CALLWDBEMDLRPPHMOD_PPHEQ) return("CallWdbeMdlRpphMod.pphEq");
	...
	if (ix == CALLWDBEPPL_HSM_INSBS) return("CallWdbePpl.hsm.inSbs");
	if (ix == CALLWDBEPPL_HSMEQ) return("CallWdbePpl.hsmEq");
	if (ix == CALLWDBEPPLMOD) return("CallWdbePplMod");
	if (ix == CALLWDBEPPLMOD_HSMEQ) return("CallWdbePplMod.hsmEq");
	if (ix == CALLWDBEPPLUPD_REFEQ) return("CallWdbePplUpd.refEq");
	...
	if (ix == CALLWDBERLS_CMPEQ) return("CallWdbeRls.cmpEq");
	if (ix == CALLWDBERLS_MCHEQ) return("CallWdbeRls.mchEq");
	if (ix == CALLWDBERLSMOD) return("CallWdbeRlsMod");
	if (ix == CALLWDBERLSMOD_CMPEQ) return("CallWdbeRlsMod.cmpEq");
	if (ix == CALLWDBERLSMOD_MCHEQ) return("CallWdbeRlsMod.mchEq");
	if (ix == CALLWDBERLSUPD_REFEQ) return("CallWdbeRlsUpd.refEq");
	if (ix == CALLWDBESEG_CLUEQ) return("CallWdbeSeg.cluEq");
	if (ix == CALLWDBESEG_PPLEQ) return("CallWdbeSeg.pplEq");
	if (ix == CALLWDBESEG_SUPEQ) return("CallWdbeSeg.supEq");
	if (ix == CALLWDBESEGMOD) return("CallWdbeSegMod");
	if (ix == CALLWDBESEGMOD_CLUEQ) return("CallWdbeSegMod.cluEq");
	if (ix == CALLWDBESEGMOD_PPLEQ) return("CallWdbeSegMod.pplEq");
	if (ix == CALLWDBESEGMOD_SUPEQ) return("CallWdbeSegMod.supEq");
	if (ix == CALLWDBESEGUPD_REFEQ) return("CallWdbeSegUpd.refEq");
	...
	if (ix == CALLWDBESIG_RETEQ) return("CallWdbeSig.retEq");
	if (ix == CALLWDBESIG_REU_INSBS) return("CallWdbeSig.reu.inSbs");
	if (ix == CALLWDBESIG_REUEQ) return("CallWdbeSig.reuEq");
	...
	if (ix == CALLWDBESIGMOD_RETREUEQ) return("CallWdbeSigMod.retReuEq");
	if (ix == CALLWDBESIGUPD_REFEQ) return("CallWdbeSigUpd.refEq");
	if (ix == CALLWDBESNS_RETEQ) return("CallWdbeSns.retEq");
	if (ix == CALLWDBESNS_REU_INSBS) return("CallWdbeSns.reu.inSbs");
	if (ix == CALLWDBESNS_REUEQ) return("CallWdbeSns.reuEq");
	if (ix == CALLWDBESNS_SRTEQ) return("CallWdbeSns.srtEq");
	if (ix == CALLWDBESNS_SRUEQ) return("CallWdbeSns.sruEq");
	if (ix == CALLWDBESNSMOD) return("CallWdbeSnsMod");
	if (ix == CALLWDBESNSMOD_RETREUEQ) return("CallWdbeSnsMod.retReuEq");
	if (ix == CALLWDBESNSMOD_SRTSRUEQ) return("CallWdbeSnsMod.srtSruEq");
	if (ix == CALLWDBESNSUPD_REFEQ) return("CallWdbeSnsUpd.refEq");
	...
	if (ix == CALLWDBEVAR_RETEQ) return("CallWdbeVar.retEq");
	if (ix == CALLWDBEVAR_REU_INSBS) return("CallWdbeVar.reu.inSbs");
	if (ix == CALLWDBEVAR_REUEQ) return("CallWdbeVar.reuEq");
