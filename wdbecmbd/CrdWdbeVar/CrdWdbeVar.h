/**
	* \file CrdWdbeVar.h
	* job handler for job CrdWdbeVar (declarations)
...
#define ContInfWdbeVar CrdWdbeVar::ContInf
#define StatAppWdbeVar CrdWdbeVar::StatApp
#define StatShrWdbeVar CrdWdbeVar::StatShr
#define TagWdbeVar CrdWdbeVar::Tag

#define DpchAppWdbeVarDo CrdWdbeVar::DpchAppDo
#define DpchEngWdbeVarData CrdWdbeVar::DpchEngData

/**
	* CrdWdbeVar
	*/
class CrdWdbeVar : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDVAR = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdVar = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdVar;
...
public:
	CrdWdbeVar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeVar();
