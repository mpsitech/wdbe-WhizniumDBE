/**
	* \file JobWdbeIexCsx_blks.cpp
	* job handler for job JobWdbeIexCsx (implementation of blocks)
...
/******************************************************************************
 class JobWdbeIexCsx::VecVSge
 ******************************************************************************/

uint JobWdbeIexCsx::VecVSge::getIx(
			const string& sref
		) {
...
string JobWdbeIexCsx::VecVSge::getSref(
			const uint ix
		) {
...
void JobWdbeIexCsx::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
