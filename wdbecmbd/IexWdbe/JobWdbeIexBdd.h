/**
	* \file JobWdbeIexBdd.h
	* job handler for job JobWdbeIexBdd (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef JOBWDBEIEXBDD_H
#define JOBWDBEIEXBDD_H

#include "IexWdbeBdd.h"

// IP include.cust --- INSERT

#define VecVJobWdbeIexBddSge JobWdbeIexBdd::VecVSge

/**
	* JobWdbeIexBdd
	*/
class JobWdbeIexBdd : public JobWdbe {

public:
	/**
		* VecVSge (full: VecVJobWdbeIexBddSge)
		*/
	class VecVSge {
...
public:
	JobWdbeIexBdd(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~JobWdbeIexBdd();
...
public:
	...
	void collect(DbsWdbe* dbswdbe, const std::map<Sbecore::uint,Sbecore::uint>& _icsWdbeVIop = IexWdbeBdd::icsWdbeVIopInsAll());
