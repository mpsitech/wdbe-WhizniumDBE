/**
	* \file JobWdbeIexBdd_blks.cpp
	* job handler for job JobWdbeIexBdd (implementation of blocks)
...
/******************************************************************************
 class JobWdbeIexBdd::VecVSge
 ******************************************************************************/

uint JobWdbeIexBdd::VecVSge::getIx(
			const string& sref
		) {
...
string JobWdbeIexBdd::VecVSge::getSref(
			const uint ix
		) {
...
void JobWdbeIexBdd::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
