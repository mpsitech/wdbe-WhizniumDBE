/**
	* \file JobWdbeIexFin.h
	* job handler for job JobWdbeIexFin (declarations)
...
#ifndef JOBWDBEIEXFIN_H
#define JOBWDBEIEXFIN_H

#include "IexWdbeFin.h"

// IP include.cust --- INSERT

#define VecVJobWdbeIexFinSge JobWdbeIexFin::VecVSge

/**
	* JobWdbeIexFin
	*/
class JobWdbeIexFin : public JobWdbe {

public:
	/**
		* VecVSge (full: VecVJobWdbeIexFinSge)
		*/
	class VecVSge {
...
public:
	JobWdbeIexFin(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~JobWdbeIexFin();
...
public:
	...
	void collect(DbsWdbe* dbswdbe, const std::map<Sbecore::uint,Sbecore::uint>& _icsWdbeVIop = IexWdbeFin::icsWdbeVIopInsAll());
