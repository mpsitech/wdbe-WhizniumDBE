/**
	* \file JobWdbeIexDpl_blks.cpp
	* job handler for job JobWdbeIexDpl (implementation of blocks)
...
/******************************************************************************
 class JobWdbeIexDpl::VecVSge
 ******************************************************************************/

uint JobWdbeIexDpl::VecVSge::getIx(
			const string& sref
		) {
...
string JobWdbeIexDpl::VecVSge::getSref(
			const uint ix
		) {
...
void JobWdbeIexDpl::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
