/**
	* \file JobWdbeIexDal.h
	* job handler for job JobWdbeIexDal (declarations)
...
#ifndef JOBWDBEIEXDAL_H
#define JOBWDBEIEXDAL_H

#include "IexWdbeDal.h"

// IP include.cust --- INSERT

#define VecVJobWdbeIexDalSge JobWdbeIexDal::VecVSge

/**
	* JobWdbeIexDal
	*/
class JobWdbeIexDal : public JobWdbe {

public:
	/**
		* VecVSge (full: VecVJobWdbeIexDalSge)
		*/
	class VecVSge {
...
public:
	JobWdbeIexDal(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~JobWdbeIexDal();
...
public:
	...
	void collect(DbsWdbe* dbswdbe, const std::map<Sbecore::uint,Sbecore::uint>& _icsWdbeVIop = IexWdbeDal::icsWdbeVIopInsAll());
