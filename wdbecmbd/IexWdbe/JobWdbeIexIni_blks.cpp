/**
	* \file JobWdbeIexIni_blks.cpp
	* job handler for job JobWdbeIexIni (implementation of blocks)
...
/******************************************************************************
 class JobWdbeIexIni::VecVSge
 ******************************************************************************/

uint JobWdbeIexIni::VecVSge::getIx(
			const string& sref
		) {
...
string JobWdbeIexIni::VecVSge::getSref(
			const uint ix
		) {
...
void JobWdbeIexIni::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
