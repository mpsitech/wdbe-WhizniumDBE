/**
	* \file JobWdbeIexBcd.h
	* job handler for job JobWdbeIexBcd (declarations)
	* \author Alexander Wirthmueller
	* \date created: 23 Aug 2020
	* \date modified: 23 Aug 2020
	*/

#ifndef JOBWDBEIEXBCD_H
#define JOBWDBEIEXBCD_H

#include "IexWdbeBcd.h"

// IP include.cust --- INSERT

#define VecVJobWdbeIexBcdSge JobWdbeIexBcd::VecVSge

/**
	* JobWdbeIexBcd
	*/
class JobWdbeIexBcd : public JobWdbe {

public:
	/**
		* VecVSge (full: VecVJobWdbeIexBcdSge)
		*/
	class VecVSge {
...
public:
	JobWdbeIexBcd(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~JobWdbeIexBcd();
...
public:
	...
	void collect(DbsWdbe* dbswdbe, const std::map<Sbecore::uint,Sbecore::uint>& _icsWdbeVIop = IexWdbeBcd::icsWdbeVIopInsAll());
