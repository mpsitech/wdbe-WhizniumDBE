/**
	* \file JobWdbeIexPrj_blks.cpp
	* job handler for job JobWdbeIexPrj (implementation of blocks)
...
/******************************************************************************
 class JobWdbeIexPrj::VecVSge
 ******************************************************************************/

uint JobWdbeIexPrj::VecVSge::getIx(
			const string& sref
		) {
...
string JobWdbeIexPrj::VecVSge::getSref(
			const uint ix
		) {
...
void JobWdbeIexPrj::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
