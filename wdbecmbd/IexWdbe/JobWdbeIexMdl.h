/**
	* \file JobWdbeIexMdl.h
	* job handler for job JobWdbeIexMdl (declarations)
...
#ifndef JOBWDBEIEXMDL_H
#define JOBWDBEIEXMDL_H

#include "IexWdbeMdl.h"

// IP include.cust --- INSERT

#define VecVJobWdbeIexMdlSge JobWdbeIexMdl::VecVSge

/**
	* JobWdbeIexMdl
	*/
class JobWdbeIexMdl : public JobWdbe {

public:
	/**
		* VecVSge (full: VecVJobWdbeIexMdlSge)
		*/
	class VecVSge {
...
public:
	JobWdbeIexMdl(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~JobWdbeIexMdl();
...
public:
	...
	void collect(DbsWdbe* dbswdbe, const std::map<Sbecore::uint,Sbecore::uint>& _icsWdbeVIop = IexWdbeMdl::icsWdbeVIopInsAll());
