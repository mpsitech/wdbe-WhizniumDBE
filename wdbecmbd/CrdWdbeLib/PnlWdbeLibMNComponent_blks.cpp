/**
	* \file PnlWdbeLibMNComponent_blks.cpp
	* job handler for job PnlWdbeLibMNComponent (implementation of blocks)
...
void PnlWdbeLibMNComponent::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeLibMNComponent";
...
void PnlWdbeLibMNComponent::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeLibMNComponent";
...
void PnlWdbeLibMNComponent::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeLibMNComponent";
...
void PnlWdbeLibMNComponent::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeLibMNComponent";
...
void PnlWdbeLibMNComponent::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeLibMNComponent";
...
void PnlWdbeLibMNComponent::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeLibMNComponent";
...
bool PnlWdbeLibMNComponent::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeLibMNComponent"];}();
...
void PnlWdbeLibMNComponent::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeLibMNComponent::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeLibMNComponent";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "Components";
		me["TcoMref"] = "Component";
	};
...
void PnlWdbeLibMNComponent::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeLibMNComponent";
...
PnlWdbeLibMNComponent::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBELIBMNCOMPONENTDATA)
		{
};
...
void PnlWdbeLibMNComponent::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeLibMNComponentData"];}();
...
void PnlWdbeLibMNComponent::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeLibMNComponentData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeLibMNComponent::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBELIBMNCOMPONENTDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeLibMNComponent::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeLibMNComponentDo"];}();
...
void PnlWdbeLibMNComponent::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeLibMNComponentDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeLibMNComponent::DpchEngData::DpchEngData(
			...
			, QryWdbeLibMNComponent::StatShr* statshrqry
			, QryWdbeLibMNComponent::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBELIBMNCOMPONENTDATA, jref)
		{
...
void PnlWdbeLibMNComponent::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeLibMNComponent::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeLibMNComponentData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeLibMNComponent::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeLibMNComponent::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeLibMNComponentData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeLibMNComponent::StatApp::writeXML(wr);
