/**
	* \file PnlWdbeLibHeadbar_blks.cpp
	* job handler for job PnlWdbeLibHeadbar (implementation of blocks)
...
void PnlWdbeLibHeadbar::StgInf::writeXML(
	...
	else itemtag = "StgitemInfWdbeLibHeadbar";
...
void PnlWdbeLibHeadbar::Tag::writeXML(
	...
	else itemtag = "TagitemWdbeLibHeadbar";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "MenApp", "WhizniumDBE");
			writeStringAttr(wr, itemtag, "sref", "MenCrd", "Library");
		};
	xmlTextWriterEndElement(wr);
};
...
PnlWdbeLibHeadbar::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBELIBHEADBARDATA, jref)
		{
...
void PnlWdbeLibHeadbar::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeLibHeadbar::DpchEngData::writeXML(
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeLibHeadbarData");
