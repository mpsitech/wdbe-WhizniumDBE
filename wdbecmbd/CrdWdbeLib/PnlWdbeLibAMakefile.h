...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQLibAMakefile* rst = NULL, QryWdbeLibAMakefile::StatShr* statshrqry = NULL, QryWdbeLibAMakefile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
