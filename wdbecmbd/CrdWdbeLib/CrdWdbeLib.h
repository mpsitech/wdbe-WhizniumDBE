/**
	* \file CrdWdbeLib.h
	* job handler for job CrdWdbeLib (declarations)
...
#define ContInfWdbeLib CrdWdbeLib::ContInf
#define StatAppWdbeLib CrdWdbeLib::StatApp
#define StatShrWdbeLib CrdWdbeLib::StatShr
#define TagWdbeLib CrdWdbeLib::Tag

#define DpchAppWdbeLibDo CrdWdbeLib::DpchAppDo
#define DpchEngWdbeLibData CrdWdbeLib::DpchEngData

/**
	* CrdWdbeLib
	*/
class CrdWdbeLib : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDLIB = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdLib = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdLib;
...
public:
	CrdWdbeLib(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbeLib();
