/**
	* \file PnlWdbeLibList.h
	* job handler for job PnlWdbeLibList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBELIBLIST_H
#define PNLWDBELIBLIST_H
...
#define VecVWdbeLibListDo PnlWdbeLibList::VecVDo

#define ContIacWdbeLibList PnlWdbeLibList::ContIac
#define ContInfWdbeLibList PnlWdbeLibList::ContInf
#define StatShrWdbeLibList PnlWdbeLibList::StatShr
#define StgIacWdbeLibList PnlWdbeLibList::StgIac
#define TagWdbeLibList PnlWdbeLibList::Tag

#define DpchAppWdbeLibListData PnlWdbeLibList::DpchAppData
#define DpchAppWdbeLibListDo PnlWdbeLibList::DpchAppDo
#define DpchEngWdbeLibListData PnlWdbeLibList::DpchEngData

/**
	* PnlWdbeLibList
	*/
class PnlWdbeLibList : public JobWdbe {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 200, const Sbecore::uint TcoVerWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQLibList* rst = NULL, QryWdbeLibList::StatShr* statshrqry = NULL, QryWdbeLibList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeLibList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeLibList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeLibList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
