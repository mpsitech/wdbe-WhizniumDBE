/**
	* \file PnlWdbeLibAMakefile_blks.cpp
	* job handler for job PnlWdbeLibAMakefile (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeLibAMakefile::VecVDo
 ******************************************************************************/

uint PnlWdbeLibAMakefile::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeLibAMakefile::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeLibAMakefile::ContInf
 ******************************************************************************/

PnlWdbeLibAMakefile::ContInf::ContInf(
...
void PnlWdbeLibAMakefile::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeLibAMakefile";
...
void PnlWdbeLibAMakefile::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWdbeLibAMakefile";
...
set<uint> PnlWdbeLibAMakefile::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeLibAMakefile::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeLibAMakefile::StatApp
 ******************************************************************************/

void PnlWdbeLibAMakefile::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeLibAMakefile";
...
void PnlWdbeLibAMakefile::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeLibAMakefile";
...
/******************************************************************************
 class PnlWdbeLibAMakefile::StatShr
 ******************************************************************************/

PnlWdbeLibAMakefile::StatShr::StatShr(
...
void PnlWdbeLibAMakefile::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeLibAMakefile";
...
void PnlWdbeLibAMakefile::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeLibAMakefile";
...
set<uint> PnlWdbeLibAMakefile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeLibAMakefile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeLibAMakefile::StgIac
 ******************************************************************************/

PnlWdbeLibAMakefile::StgIac::StgIac(
...
bool PnlWdbeLibAMakefile::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeLibAMakefile");
	else
...
void PnlWdbeLibAMakefile::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeLibAMakefile";
...
set<uint> PnlWdbeLibAMakefile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeLibAMakefile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeLibAMakefile::Tag
 ******************************************************************************/

void PnlWdbeLibAMakefile::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeLibAMakefile";
...
void PnlWdbeLibAMakefile::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeLibAMakefile";
...
/******************************************************************************
 class PnlWdbeLibAMakefile::DpchAppData
 ******************************************************************************/

PnlWdbeLibAMakefile::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBELIBAMAKEFILEDATA)
		{
};

string PnlWdbeLibAMakefile::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeLibAMakefile::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeLibAMakefileData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeLibAMakefile::DpchAppDo
 ******************************************************************************/

PnlWdbeLibAMakefile::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBELIBAMAKEFILEDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeLibAMakefile::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeLibAMakefileDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeLibAMakefile::DpchEngData
 ******************************************************************************/

PnlWdbeLibAMakefile::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBELIBAMAKEFILEDATA, jref)
		{
...
string PnlWdbeLibAMakefile::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeLibAMakefile::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeLibAMakefile::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeLibAMakefileData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeLibAMakefile::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeLibAMakefile::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeLibAMakefileData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeLibAMakefile::StatApp::writeXML(wr);
