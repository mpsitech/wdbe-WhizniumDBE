/**
	* \file PnlWdbeTrgRec.h
	* job handler for job PnlWdbeTrgRec (declarations)
...
#ifndef PNLWDBETRGREC_H
#define PNLWDBETRGREC_H
...
#define VecVWdbeTrgRecDo PnlWdbeTrgRec::VecVDo

#define ContInfWdbeTrgRec PnlWdbeTrgRec::ContInf
#define StatAppWdbeTrgRec PnlWdbeTrgRec::StatApp
#define StatShrWdbeTrgRec PnlWdbeTrgRec::StatShr
#define TagWdbeTrgRec PnlWdbeTrgRec::Tag

#define DpchAppWdbeTrgRecDo PnlWdbeTrgRec::DpchAppDo
#define DpchEngWdbeTrgRecData PnlWdbeTrgRec::DpchEngData

/**
	* PnlWdbeTrgRec
	*/
class PnlWdbeTrgRec : public JobWdbe {
...
public:
	PnlWdbeTrgRec(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeTrgRec();
