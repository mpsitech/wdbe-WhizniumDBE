...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFLstRte = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
