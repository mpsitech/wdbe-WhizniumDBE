...
#define QRYWDBETRGLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbeTrgListOrd QryWdbeTrgList::VecVOrd

#define StatAppQryWdbeTrgList QryWdbeTrgList::StatApp
#define StatShrQryWdbeTrgList QryWdbeTrgList::StatShr
#define StgIacQryWdbeTrgList QryWdbeTrgList::StgIac

/**
	* QryWdbeTrgList
	*/
class QryWdbeTrgList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbeTrgListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbeTrgList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeTrgList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeTrgList)
		*/
...
public:
	QryWdbeTrgList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeTrgList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preSys, const Sbecore::ubigint preUnt, const bool addwhere);
	...
	WdbeQTrgList* getRecByJnum(const Sbecore::uint jnum);
