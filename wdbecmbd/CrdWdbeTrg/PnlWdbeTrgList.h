/**
	* \file PnlWdbeTrgList.h
	* job handler for job PnlWdbeTrgList (declarations)
...
#ifndef PNLWDBETRGLIST_H
#define PNLWDBETRGLIST_H
...
#define VecVWdbeTrgListDo PnlWdbeTrgList::VecVDo

#define ContIacWdbeTrgList PnlWdbeTrgList::ContIac
#define ContInfWdbeTrgList PnlWdbeTrgList::ContInf
#define StatShrWdbeTrgList PnlWdbeTrgList::StatShr
#define StgIacWdbeTrgList PnlWdbeTrgList::StgIac
#define TagWdbeTrgList PnlWdbeTrgList::Tag

#define DpchAppWdbeTrgListData PnlWdbeTrgList::DpchAppData
#define DpchAppWdbeTrgListDo PnlWdbeTrgList::DpchAppDo
#define DpchEngWdbeTrgListData PnlWdbeTrgList::DpchEngData

/**
	* PnlWdbeTrgList
	*/
class PnlWdbeTrgList : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOSYSWIDTH = 2;
		static const Sbecore::uint TCOUNTWIDTH = 3;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 150, const Sbecore::uint TcoSysWidth = 200, const Sbecore::uint TcoUntWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQTrgList* rst = NULL, QryWdbeTrgList::StatShr* statshrqry = NULL, QryWdbeTrgList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeTrgList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeTrgList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeTrgList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
