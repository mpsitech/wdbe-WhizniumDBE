/**
	* \file CrdWdbeTrg.h
	* job handler for job CrdWdbeTrg (declarations)
...
#define VecVWdbeTrgDo CrdWdbeTrg::VecVDo
#define VecVWdbeTrgSge CrdWdbeTrg::VecVSge

#define ContInfWdbeTrg CrdWdbeTrg::ContInf
#define StatAppWdbeTrg CrdWdbeTrg::StatApp
#define StatShrWdbeTrg CrdWdbeTrg::StatShr
#define TagWdbeTrg CrdWdbeTrg::Tag

#define DpchAppWdbeTrgDo CrdWdbeTrg::DpchAppDo
#define DpchEngWdbeTrgData CrdWdbeTrg::DpchEngData

/**
	* CrdWdbeTrg
	*/
class CrdWdbeTrg : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDTRG = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdTrg = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdTrg;
...
public:
	CrdWdbeTrg(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeTrg();
...
public:
	...
	PnlWdbeTrgList* pnllist;
	PnlWdbeTrgHeadbar* pnlheadbar;
	PnlWdbeTrgRec* pnlrec;
