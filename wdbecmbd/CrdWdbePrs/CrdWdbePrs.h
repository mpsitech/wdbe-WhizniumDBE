/**
	* \file CrdWdbePrs.h
	* job handler for job CrdWdbePrs (declarations)
...
#define VecVWdbePrsDo CrdWdbePrs::VecVDo
#define VecVWdbePrsSge CrdWdbePrs::VecVSge

#define ContInfWdbePrs CrdWdbePrs::ContInf
#define StatAppWdbePrs CrdWdbePrs::StatApp
#define StatShrWdbePrs CrdWdbePrs::StatShr
#define TagWdbePrs CrdWdbePrs::Tag

#define DpchAppWdbePrsDo CrdWdbePrs::DpchAppDo
#define DpchEngWdbePrsData CrdWdbePrs::DpchEngData

/**
	* CrdWdbePrs
	*/
class CrdWdbePrs : public JobWdbe {
...
public:
	CrdWdbePrs(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbePrs();
...
public:
	...
	PnlWdbePrsHeadbar* pnlheadbar;
	PnlWdbePrsList* pnllist;
	PnlWdbePrsRec* pnlrec;
