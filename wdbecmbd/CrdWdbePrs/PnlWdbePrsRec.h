...
/**
	* PnlWdbePrsRec
	*/
class PnlWdbePrsRec : public JobWdbe {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneADetail = false, const bool initdoneMNProject = false, const bool initdoneMNCoreproject = false);
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdoneADetail = false, const bool initdoneMNProject = false, const bool initdoneMNCoreproject = false);
	};
	...
	public:
		...
		static const Sbecore::uint JREFMNPROJECT = 4;
		static const Sbecore::uint JREFMNCOREPROJECT = 5;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 6;

	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefADetail = 0, const Sbecore::ubigint jrefMNProject = 0, const Sbecore::ubigint jrefMNCoreproject = 0, const bool ButRegularizeActive = true);

	public:
		Sbecore::uint ixWdbeVExpstate;
		Sbecore::ubigint jrefDetail;
		Sbecore::ubigint jrefADetail;
		Sbecore::ubigint jrefMNProject;
		Sbecore::ubigint jrefMNCoreproject;
...
public:
	PnlWdbePrsRec(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrsRec();
