...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::MIND, const bool LstDrvAlt = true, const Sbecore::uint LstDrvNumFirstdisp = 1);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFLstDrv = NULL, Sbecore::Feed* feedFPupJ = NULL, Sbecore::Feed* feedFPupSex = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
