/**
	* \file PnlWdbePrsMNCoreproject_blks.cpp
	* job handler for job PnlWdbePrsMNCoreproject (implementation of blocks)
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::VecVDo
 ******************************************************************************/

uint PnlWdbePrsMNCoreproject::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbePrsMNCoreproject::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::ContInf
 ******************************************************************************/

PnlWdbePrsMNCoreproject::ContInf::ContInf(
...
void PnlWdbePrsMNCoreproject::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbePrsMNCoreproject";
...
void PnlWdbePrsMNCoreproject::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWdbePrsMNCoreproject";
...
set<uint> PnlWdbePrsMNCoreproject::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrsMNCoreproject::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::StatApp
 ******************************************************************************/

void PnlWdbePrsMNCoreproject::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbePrsMNCoreproject";
...
void PnlWdbePrsMNCoreproject::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbePrsMNCoreproject";
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::StatShr
 ******************************************************************************/

PnlWdbePrsMNCoreproject::StatShr::StatShr(
...
void PnlWdbePrsMNCoreproject::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbePrsMNCoreproject";
...
void PnlWdbePrsMNCoreproject::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbePrsMNCoreproject";
...
set<uint> PnlWdbePrsMNCoreproject::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrsMNCoreproject::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::StgIac
 ******************************************************************************/

PnlWdbePrsMNCoreproject::StgIac::StgIac(
...
bool PnlWdbePrsMNCoreproject::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbePrsMNCoreproject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbePrsMNCoreproject";
...
void PnlWdbePrsMNCoreproject::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbePrsMNCoreproject";
...
void PnlWdbePrsMNCoreproject::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbePrsMNCoreproject";
...
set<uint> PnlWdbePrsMNCoreproject::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrsMNCoreproject::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::Tag
 ******************************************************************************/

void PnlWdbePrsMNCoreproject::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbePrsMNCoreproject";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "Contributor to core projects";
		me["TcoMref"] = "Core project";
		me["TcoSta"] = "Starting";
		me["TcoSto"] = "Ending";
		me["TcoFct"] = "Function";
	};
...
void PnlWdbePrsMNCoreproject::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbePrsMNCoreproject";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Contributor to core projects");
			writeStringAttr(wr, itemtag, "sref", "TcoMref", "Core project");
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::DpchAppData
 ******************************************************************************/

PnlWdbePrsMNCoreproject::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRSMNCOREPROJECTDATA)
		{
};

string PnlWdbePrsMNCoreproject::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrsMNCoreproject::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrsMNCoreprojectData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::DpchAppDo
 ******************************************************************************/

PnlWdbePrsMNCoreproject::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRSMNCOREPROJECTDO)
		{
	ixVDo = 0;
};

string PnlWdbePrsMNCoreproject::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrsMNCoreproject::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrsMNCoreprojectDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrsMNCoreproject::DpchEngData
 ******************************************************************************/

PnlWdbePrsMNCoreproject::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWdbePrsMNCoreproject::StatShr* statshrqry
			, QryWdbePrsMNCoreproject::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEPRSMNCOREPROJECTDATA, jref)
		{
...
string PnlWdbePrsMNCoreproject::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrsMNCoreproject::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbePrsMNCoreproject::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbePrsMNCoreprojectData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbePrsMNCoreproject::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbePrsMNCoreproject::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbePrsMNCoreprojectData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbePrsMNCoreproject::StatApp::writeXML(wr);
