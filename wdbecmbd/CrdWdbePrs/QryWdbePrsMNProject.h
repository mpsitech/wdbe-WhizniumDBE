/**
	* \file QryWdbePrsMNProject.h
	* job handler for job QryWdbePrsMNProject (declarations)
...
#ifndef QRYWDBEPRSMNPROJECT_H
#define QRYWDBEPRSMNPROJECT_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbePrsMNProject QryWdbePrsMNProject::StatApp
#define StatShrQryWdbePrsMNProject QryWdbePrsMNProject::StatShr
#define StgIacQryWdbePrsMNProject QryWdbePrsMNProject::StgIac

/**
	* QryWdbePrsMNProject
	*/
class QryWdbePrsMNProject : public JobWdbe {

public:
	/**
		* StatApp (full: StatAppQryWdbePrsMNProject)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbePrsMNProject)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbePrsMNProject)
		*/
...
public:
	QryWdbePrsMNProject(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePrsMNProject();
...
public:
	...
	WdbeQPrsMNProject* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbePrsRprjMod_prsEq(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
