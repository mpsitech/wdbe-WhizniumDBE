/**
	* \file QryWdbePrsADetail.h
	* job handler for job QryWdbePrsADetail (declarations)
...
#ifndef QRYWDBEPRSADETAIL_H
#define QRYWDBEPRSADETAIL_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbePrsADetail QryWdbePrsADetail::StatApp
#define StatShrQryWdbePrsADetail QryWdbePrsADetail::StatShr
#define StgIacQryWdbePrsADetail QryWdbePrsADetail::StgIac

/**
	* QryWdbePrsADetail
	*/
class QryWdbePrsADetail : public JobWdbe {

public:
	/**
		* StatApp (full: StatAppQryWdbePrsADetail)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbePrsADetail)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbePrsADetail)
		*/
...
public:
	QryWdbePrsADetail(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePrsADetail();
...
public:
	...
	WdbeQPrsADetail* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWdbePrsAdetMod_prsEq(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
