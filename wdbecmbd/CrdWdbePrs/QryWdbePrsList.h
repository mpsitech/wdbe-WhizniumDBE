/**
	* \file QryWdbePrsList.h
	* job handler for job QryWdbePrsList (declarations)
...
#ifndef QRYWDBEPRSLIST_H
#define QRYWDBEPRSLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbePrsListOrd QryWdbePrsList::VecVOrd

#define StatAppQryWdbePrsList QryWdbePrsList::StatApp
#define StatShrQryWdbePrsList QryWdbePrsList::StatShr
#define StgIacQryWdbePrsList QryWdbePrsList::StgIac

/**
	* QryWdbePrsList
	*/
class QryWdbePrsList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbePrsListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbePrsList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbePrsList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbePrsList)
		*/
...
public:
	QryWdbePrsList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePrsList();
...
public:
	...
	WdbeQPrsList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbePrsMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
