...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrsADetail* rst = NULL, QryWdbePrsADetail::StatShr* statshrqry = NULL, QryWdbePrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
