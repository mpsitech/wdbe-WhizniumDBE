/**
	* \file PnlWdbePrsADetail.h
	* job handler for job PnlWdbePrsADetail (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEPRSADETAIL_H
#define PNLWDBEPRSADETAIL_H
...
#define VecVWdbePrsADetailDo PnlWdbePrsADetail::VecVDo

#define ContInfWdbePrsADetail PnlWdbePrsADetail::ContInf
#define StatAppWdbePrsADetail PnlWdbePrsADetail::StatApp
#define StatShrWdbePrsADetail PnlWdbePrsADetail::StatShr
#define StgIacWdbePrsADetail PnlWdbePrsADetail::StgIac
#define TagWdbePrsADetail PnlWdbePrsADetail::Tag

#define DpchAppWdbePrsADetailData PnlWdbePrsADetail::DpchAppData
#define DpchAppWdbePrsADetailDo PnlWdbePrsADetail::DpchAppDo
#define DpchEngWdbePrsADetailData PnlWdbePrsADetail::DpchEngData

/**
	* PnlWdbePrsADetail
	*/
class PnlWdbePrsADetail : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrsADetail* rst = NULL, QryWdbePrsADetail::StatShr* statshrqry = NULL, QryWdbePrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePrsADetail(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrsADetail();
...
public:
	...
	QryWdbePrsADetail* qry;

	WdbeAMPersonDetail recPrsAdet;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePrsADetail::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
