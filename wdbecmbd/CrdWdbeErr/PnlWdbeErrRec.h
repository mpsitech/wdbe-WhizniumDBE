/**
	...
	* job handler for job PnlWdbeErrRec (declarations)
...
/**
	* PnlWdbeErrRec
	*/
class PnlWdbeErrRec : public JobWdbe {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneAPar = false);
...
public:
	PnlWdbeErrRec(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeErrRec();
...
public:
	...
	PnlWdbeErrAPar* pnlapar;
	PnlWdbeErrDetail* pnldetail;
