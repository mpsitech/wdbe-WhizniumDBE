/**
	* \file CrdWdbeErr.h
	* job handler for job CrdWdbeErr (declarations)
...
#define VecVWdbeErrDo CrdWdbeErr::VecVDo
#define VecVWdbeErrSge CrdWdbeErr::VecVSge

#define ContInfWdbeErr CrdWdbeErr::ContInf
#define StatAppWdbeErr CrdWdbeErr::StatApp
#define StatShrWdbeErr CrdWdbeErr::StatShr
#define TagWdbeErr CrdWdbeErr::Tag

#define DpchAppWdbeErrDo CrdWdbeErr::DpchAppDo
#define DpchEngWdbeErrData CrdWdbeErr::DpchEngData

/**
	* CrdWdbeErr
	*/
class CrdWdbeErr : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDERR = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdErr = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdErr;
...
public:
	CrdWdbeErr(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeErr();
...
public:
	...
	PnlWdbeErrRec* pnlrec;
	PnlWdbeErrHeadbar* pnlheadbar;
	PnlWdbeErrList* pnllist;
