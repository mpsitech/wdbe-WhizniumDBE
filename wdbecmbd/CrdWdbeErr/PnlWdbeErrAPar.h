/**
	...
	* job handler for job PnlWdbeErrAPar (declarations)
...
/**
	* PnlWdbeErrAPar
	*/
class PnlWdbeErrAPar : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQErrAPar* rst = NULL, QryWdbeErrAPar::StatShr* statshrqry = NULL, QryWdbeErrAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeErrAPar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeErrAPar();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeErrAPar::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
