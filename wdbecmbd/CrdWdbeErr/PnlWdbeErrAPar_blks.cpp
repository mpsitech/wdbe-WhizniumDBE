/**
	* \file PnlWdbeErrAPar_blks.cpp
	* job handler for job PnlWdbeErrAPar (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeErrAPar::VecVDo
 ******************************************************************************/

uint PnlWdbeErrAPar::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeErrAPar::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeErrAPar::ContInf
 ******************************************************************************/

PnlWdbeErrAPar::ContInf::ContInf(
...
void PnlWdbeErrAPar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeErrAPar";
...
void PnlWdbeErrAPar::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWdbeErrAPar";
...
set<uint> PnlWdbeErrAPar::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeErrAPar::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeErrAPar::StatApp
 ******************************************************************************/

void PnlWdbeErrAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeErrAPar";
...
void PnlWdbeErrAPar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeErrAPar";
...
/******************************************************************************
 class PnlWdbeErrAPar::StatShr
 ******************************************************************************/

PnlWdbeErrAPar::StatShr::StatShr(
...
void PnlWdbeErrAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeErrAPar";
...
void PnlWdbeErrAPar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeErrAPar";
...
set<uint> PnlWdbeErrAPar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeErrAPar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeErrAPar::StgIac
 ******************************************************************************/

PnlWdbeErrAPar::StgIac::StgIac(
...
bool PnlWdbeErrAPar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeErrAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeErrAPar";
...
void PnlWdbeErrAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeErrAPar";
...
void PnlWdbeErrAPar::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeErrAPar";
...
set<uint> PnlWdbeErrAPar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeErrAPar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeErrAPar::Tag
 ******************************************************************************/

void PnlWdbeErrAPar::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeErrAPar";
...
void PnlWdbeErrAPar::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeErrAPar";
...
/******************************************************************************
 class PnlWdbeErrAPar::DpchAppData
 ******************************************************************************/

PnlWdbeErrAPar::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEERRAPARDATA)
		{
};

string PnlWdbeErrAPar::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeErrAPar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeErrAParData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeErrAPar::DpchAppDo
 ******************************************************************************/

PnlWdbeErrAPar::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEERRAPARDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeErrAPar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeErrAParDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeErrAPar::DpchEngData
 ******************************************************************************/

PnlWdbeErrAPar::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEERRAPARDATA, jref)
		{
...
string PnlWdbeErrAPar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeErrAPar::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeErrAPar::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeErrAParData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeErrAPar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeErrAPar::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeErrAParData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeErrAPar::StatApp::writeXML(wr);
