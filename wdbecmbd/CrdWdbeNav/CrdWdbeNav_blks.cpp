...
CrdWdbeNav::StatShr::StatShr(
			...
			, jrefDevdev(jrefDevdev)
			, pnldevdevAvail(pnldevdevAvail)
			, jrefCoredev(jrefCoredev)
...
void CrdWdbeNav::StatShr::writeJSON(
	...
	me["MitCrdIdfAvail"] = MitCrdIdfAvail;
...
void CrdWdbeNav::StatShr::writeXML(
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		...
		writeBoolAttr(wr, itemtag, "sref", "MitCrdIdfAvail", MitCrdIdfAvail);
...
void CrdWdbeNav::Tag::writeXML(
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "MitCrdIdf", "Interactive diff ...");
