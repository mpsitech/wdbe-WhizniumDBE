...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::MIND, const bool LstCprAlt = true, const bool LstCvrAlt = true, const Sbecore::uint LstCprNumFirstdisp = 1, const Sbecore::uint LstCvrNumFirstdisp = 1);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, Sbecore::Feed* feedFLstCpr = NULL, Sbecore::Feed* feedFLstCvr = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});

	public:
		ContIac contiac;
		Sbecore::Feed feedFLstCpr;
		Sbecore::Feed feedFLstCvr;
		StatShr statshr;
