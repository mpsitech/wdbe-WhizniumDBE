...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, Sbecore::Feed* feedFLstFam = NULL, Sbecore::Feed* feedFLstLib = NULL, Sbecore::Feed* feedFLstMch = NULL, Sbecore::Feed* feedFLstMtp = NULL, Sbecore::Feed* feedFLstSil = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
