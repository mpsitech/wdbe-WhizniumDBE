/**
	* \file PnlWdbeCmdARetpar.h
	* job handler for job PnlWdbeCmdARetpar (declarations)
...
#ifndef PNLWDBECMDARETPAR_H
#define PNLWDBECMDARETPAR_H
...
#define VecVWdbeCmdARetparDo PnlWdbeCmdARetpar::VecVDo

#define ContInfWdbeCmdARetpar PnlWdbeCmdARetpar::ContInf
#define StatAppWdbeCmdARetpar PnlWdbeCmdARetpar::StatApp
#define StatShrWdbeCmdARetpar PnlWdbeCmdARetpar::StatShr
#define StgIacWdbeCmdARetpar PnlWdbeCmdARetpar::StgIac
#define TagWdbeCmdARetpar PnlWdbeCmdARetpar::Tag

#define DpchAppWdbeCmdARetparData PnlWdbeCmdARetpar::DpchAppData
#define DpchAppWdbeCmdARetparDo PnlWdbeCmdARetpar::DpchAppDo
#define DpchEngWdbeCmdARetparData PnlWdbeCmdARetpar::DpchEngData

/**
	* PnlWdbeCmdARetpar
	*/
class PnlWdbeCmdARetpar : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCmdARetpar* rst = NULL, QryWdbeCmdARetpar::StatShr* statshrqry = NULL, QryWdbeCmdARetpar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCmdARetpar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCmdARetpar();
...
public:
	...
	QryWdbeCmdARetpar* qry;

	WdbeAMCommandRetpar recCmdArpa;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCmdARetpar::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
