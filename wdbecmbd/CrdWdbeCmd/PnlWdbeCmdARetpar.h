...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCmdARetpar* rst = NULL, QryWdbeCmdARetpar::StatShr* statshrqry = NULL, QryWdbeCmdARetpar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
