/**
	* \file PnlWdbeCmdAInvpar.h
	* job handler for job PnlWdbeCmdAInvpar (declarations)
	* \author Alexander Wirthmueller
	* \date created: 23 Aug 2020
	* \date modified: 23 Aug 2020
	*/

#ifndef PNLWDBECMDAINVPAR_H
#define PNLWDBECMDAINVPAR_H
...
#define VecVWdbeCmdAInvparDo PnlWdbeCmdAInvpar::VecVDo

#define ContInfWdbeCmdAInvpar PnlWdbeCmdAInvpar::ContInf
#define StatAppWdbeCmdAInvpar PnlWdbeCmdAInvpar::StatApp
#define StatShrWdbeCmdAInvpar PnlWdbeCmdAInvpar::StatShr
#define StgIacWdbeCmdAInvpar PnlWdbeCmdAInvpar::StgIac
#define TagWdbeCmdAInvpar PnlWdbeCmdAInvpar::Tag

#define DpchAppWdbeCmdAInvparData PnlWdbeCmdAInvpar::DpchAppData
#define DpchAppWdbeCmdAInvparDo PnlWdbeCmdAInvpar::DpchAppDo
#define DpchEngWdbeCmdAInvparData PnlWdbeCmdAInvpar::DpchEngData

/**
	* PnlWdbeCmdAInvpar
	*/
class PnlWdbeCmdAInvpar : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCODFVWIDTH = 5;
		static const Sbecore::uint TCOVITWIDTH = 6;
		static const Sbecore::uint TCOCMTWIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoPtyWidth = 100, const Sbecore::uint TcoVecWidth = 100, const Sbecore::uint TcoLenWidth = 100, const Sbecore::uint TcoDfvWidth = 100, const Sbecore::uint TcoVitWidth = 100, const Sbecore::uint TcoCmtWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCmdAInvpar* rst = NULL, QryWdbeCmdAInvpar::StatShr* statshrqry = NULL, QryWdbeCmdAInvpar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCmdAInvpar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCmdAInvpar();
...
public:
	...
	QryWdbeCmdAInvpar* qry;

	WdbeAMCommandInvpar recCmdAipa;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCmdAInvpar::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
