/**
	...
	* job handler for job PnlWdbeCmdMNController (declarations)
...
/**
	...
	*/
class PnlWdbeCmdMNController : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCmdMNController* rst = NULL, QryWdbeCmdMNController::StatShr* statshrqry = NULL, QryWdbeCmdMNController::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCmdMNController(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCmdMNController();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCmdMNController::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
