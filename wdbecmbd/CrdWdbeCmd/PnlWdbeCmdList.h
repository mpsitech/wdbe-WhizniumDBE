/**
	* \file PnlWdbeCmdList.h
	* job handler for job PnlWdbeCmdList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBECMDLIST_H
#define PNLWDBECMDLIST_H
...
#define VecVWdbeCmdListDo PnlWdbeCmdList::VecVDo

#define ContIacWdbeCmdList PnlWdbeCmdList::ContIac
#define ContInfWdbeCmdList PnlWdbeCmdList::ContInf
#define StatShrWdbeCmdList PnlWdbeCmdList::StatShr
#define StgIacWdbeCmdList PnlWdbeCmdList::StgIac
#define TagWdbeCmdList PnlWdbeCmdList::Tag

#define DpchAppWdbeCmdListData PnlWdbeCmdList::DpchAppData
#define DpchAppWdbeCmdListDo PnlWdbeCmdList::DpchAppDo
#define DpchEngWdbeCmdListData PnlWdbeCmdList::DpchEngData

/**
	* PnlWdbeCmdList
	*/
class PnlWdbeCmdList : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCORTYWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoFsrWidth = 100, const Sbecore::uint TcoRetWidth = 100, const Sbecore::uint TcoReuWidth = 100, const Sbecore::uint TcoRtyWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCmdList* rst = NULL, QryWdbeCmdList::StatShr* statshrqry = NULL, QryWdbeCmdList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCmdList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCmdList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCmdList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
