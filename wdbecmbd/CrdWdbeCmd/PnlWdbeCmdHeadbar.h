/**
	...
	* job handler for job PnlWdbeCmdHeadbar (declarations)
...
/**
	* PnlWdbeCmdHeadbar
	*/
class PnlWdbeCmdHeadbar : public JobWdbe {
...
public:
	PnlWdbeCmdHeadbar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCmdHeadbar();
