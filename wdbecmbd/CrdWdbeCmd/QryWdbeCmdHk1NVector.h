/**
	* \file QryWdbeCmdHk1NVector.h
	* job handler for job QryWdbeCmdHk1NVector (declarations)
...
#ifndef QRYWDBECMDHK1NVECTOR_H
#define QRYWDBECMDHK1NVECTOR_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeCmdHk1NVector QryWdbeCmdHk1NVector::StatApp
#define StatShrQryWdbeCmdHk1NVector QryWdbeCmdHk1NVector::StatShr
#define StgIacQryWdbeCmdHk1NVector QryWdbeCmdHk1NVector::StgIac

/**
	* QryWdbeCmdHk1NVector
	*/
class QryWdbeCmdHk1NVector : public JobWdbe {
...
public:
	QryWdbeCmdHk1NVector(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeCmdHk1NVector();
...
public:
	...
	WdbeQCmdHk1NVector* getRecByJnum(const Sbecore::uint jnum);
