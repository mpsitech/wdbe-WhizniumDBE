/**
	* \file CrdWdbeCmd.h
	* job handler for job CrdWdbeCmd (declarations)
...
/**
	* CrdWdbeCmd
	*/
class CrdWdbeCmd : public JobWdbe {
...
public:
	CrdWdbeCmd(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeCmd();
...
public:
	...
	PnlWdbeCmdRec* pnlrec;
	PnlWdbeCmdHeadbar* pnlheadbar;
	PnlWdbeCmdList* pnllist;
