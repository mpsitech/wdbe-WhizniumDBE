/**
	...
	* job handler for job PnlWdbeCvrList (declarations)
...
/**
	* PnlWdbeCvrList
	*/
class PnlWdbeCvrList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCvrList* rst = NULL, QryWdbeCvrList::StatShr* statshrqry = NULL, QryWdbeCvrList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCvrList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCvrList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCvrList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
