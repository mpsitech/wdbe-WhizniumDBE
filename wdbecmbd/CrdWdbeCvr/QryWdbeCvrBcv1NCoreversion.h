/**
	...
	* job handler for job QryWdbeCvrBcv1NCoreversion (declarations)
...
/**
	...
	*/
class QryWdbeCvrBcv1NCoreversion : public JobWdbe {
...
public:
	QryWdbeCvrBcv1NCoreversion(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeCvrBcv1NCoreversion();
...
public:
	...
	WdbeQCvrBcv1NCoreversion* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWdbeCvrMod_bcvEq(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
