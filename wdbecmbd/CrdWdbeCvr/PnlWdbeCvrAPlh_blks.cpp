/**
	* \file PnlWdbeCvrAPlh_blks.cpp
	* job handler for job PnlWdbeCvrAPlh (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeCvrAPlh::VecVDo
 ******************************************************************************/

uint PnlWdbeCvrAPlh::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeCvrAPlh::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeCvrAPlh::ContInf
 ******************************************************************************/

PnlWdbeCvrAPlh::ContInf::ContInf(
...
void PnlWdbeCvrAPlh::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeCvrAPlh";
...
void PnlWdbeCvrAPlh::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeCvrAPlh";
...
set<uint> PnlWdbeCvrAPlh::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCvrAPlh::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeCvrAPlh::StatApp
 ******************************************************************************/

void PnlWdbeCvrAPlh::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeCvrAPlh";
...
void PnlWdbeCvrAPlh::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeCvrAPlh";
...
/******************************************************************************
 class PnlWdbeCvrAPlh::StatShr
 ******************************************************************************/

PnlWdbeCvrAPlh::StatShr::StatShr(
...
void PnlWdbeCvrAPlh::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeCvrAPlh";
...
void PnlWdbeCvrAPlh::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeCvrAPlh";
...
set<uint> PnlWdbeCvrAPlh::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCvrAPlh::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeCvrAPlh::StgIac
 ******************************************************************************/

PnlWdbeCvrAPlh::StgIac::StgIac(
	...
	mask = {TCOSRFWIDTH, TCOCMTWIDTH};
};

bool PnlWdbeCvrAPlh::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeCvrAPlh"];}();
...
bool PnlWdbeCvrAPlh::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeCvrAPlh");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeCvrAPlh";
...
void PnlWdbeCvrAPlh::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeCvrAPlh";
...
void PnlWdbeCvrAPlh::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeCvrAPlh";
...
set<uint> PnlWdbeCvrAPlh::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCvrAPlh::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOSRFWIDTH, TCOCMTWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWdbeCvrAPlh::Tag
 ******************************************************************************/

void PnlWdbeCvrAPlh::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeCvrAPlh";
...
void PnlWdbeCvrAPlh::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeCvrAPlh";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Placeholders");
...
/******************************************************************************
 class PnlWdbeCvrAPlh::DpchAppData
 ******************************************************************************/

PnlWdbeCvrAPlh::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBECVRAPLHDATA)
		{
};

string PnlWdbeCvrAPlh::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCvrAPlh::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeCvrAPlhData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWdbeCvrAPlh::StgIac();
	};
};

void PnlWdbeCvrAPlh::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeCvrAPlhData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeCvrAPlh::DpchAppDo
 ******************************************************************************/

PnlWdbeCvrAPlh::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBECVRAPLHDO)
		{
	ixVDo = 0;
};

string PnlWdbeCvrAPlh::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCvrAPlh::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeCvrAPlhDo"];}();
...
void PnlWdbeCvrAPlh::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeCvrAPlhDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeCvrAPlh::DpchEngData
 ******************************************************************************/

PnlWdbeCvrAPlh::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWdbeCvrAPlh::StatShr* statshrqry
			, QryWdbeCvrAPlh::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBECVRAPLHDATA, jref)
		{
...
string PnlWdbeCvrAPlh::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCvrAPlh::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeCvrAPlh::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeCvrAPlhData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeCvrAPlh::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeCvrAPlh::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeCvrAPlhData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeCvrAPlh::StatApp::writeXML(wr);
