/**
	* \file PnlWdbeCvrAPlh.h
	* job handler for job PnlWdbeCvrAPlh (declarations)
...
#ifndef PNLWDBECVRAPLH_H
#define PNLWDBECVRAPLH_H
...
#define VecVWdbeCvrAPlhDo PnlWdbeCvrAPlh::VecVDo

#define ContInfWdbeCvrAPlh PnlWdbeCvrAPlh::ContInf
#define StatAppWdbeCvrAPlh PnlWdbeCvrAPlh::StatApp
#define StatShrWdbeCvrAPlh PnlWdbeCvrAPlh::StatShr
#define StgIacWdbeCvrAPlh PnlWdbeCvrAPlh::StgIac
#define TagWdbeCvrAPlh PnlWdbeCvrAPlh::Tag

#define DpchAppWdbeCvrAPlhData PnlWdbeCvrAPlh::DpchAppData
#define DpchAppWdbeCvrAPlhDo PnlWdbeCvrAPlh::DpchAppDo
#define DpchEngWdbeCvrAPlhData PnlWdbeCvrAPlh::DpchEngData

/**
	* PnlWdbeCvrAPlh
	*/
class PnlWdbeCvrAPlh : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOCMTWIDTH = 2;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoCmtWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQCvrAPlh* rst = NULL, QryWdbeCvrAPlh::StatShr* statshrqry = NULL, QryWdbeCvrAPlh::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeCvrAPlh(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeCvrAPlh();
...
public:
	...
	WdbeAMCoreversionPlh recCvrAplh;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeCvrAPlh::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
