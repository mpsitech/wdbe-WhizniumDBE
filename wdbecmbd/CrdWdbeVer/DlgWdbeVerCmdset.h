/**
	...
	* job handler for job DlgWdbeVerCmdset (declarations)
...
/**
	* DlgWdbeVerCmdset
	*/
class DlgWdbeVerCmdset : public JobWdbe {
...
public:
	DlgWdbeVerCmdset(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~DlgWdbeVerCmdset();
