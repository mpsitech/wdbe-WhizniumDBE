/**
	* \file DlgWdbeVerDflalg_blks.cpp
	* job handler for job DlgWdbeVerDflalg (implementation of blocks)
...
string DlgWdbeVerDflalg::VecVDit::getTitle(
			const uint ix
...
void DlgWdbeVerDflalg::VecVDit::fillFeed(
			const uint ixWdbeVLocale
			, Feed& feed
		) {
	feed.clear();
...
void DlgWdbeVerDflalg::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
bool DlgWdbeVerDflalg::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacDlgWdbeVerDflalg"];}();
...
void DlgWdbeVerDflalg::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWdbeVerDflalg::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbeVerDflalg";
...
void DlgWdbeVerDflalg::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbeVerDflalg";
...
void DlgWdbeVerDflalg::ContInfImp::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbeVerDflalgImp";
...
void DlgWdbeVerDflalg::ContInfImp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbeVerDflalgImp";
...
void DlgWdbeVerDflalg::ContInfLfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbeVerDflalgLfi";
...
void DlgWdbeVerDflalg::ContInfLfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbeVerDflalgLfi";
...
void DlgWdbeVerDflalg::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const bool initdone
			, const string& shortMenu
		) {
	if (difftag.length() == 0) difftag = "StatAppDlgWdbeVerDflalg";
...
void DlgWdbeVerDflalg::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const bool initdone
	...
	else itemtag = "StatitemAppDlgWdbeVerDflalg";
...
void DlgWdbeVerDflalg::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerDflalg";
...
void DlgWdbeVerDflalg::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerDflalg";
...
void DlgWdbeVerDflalg::StatShrIfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerDflalgIfi";
...
void DlgWdbeVerDflalg::StatShrIfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerDflalgIfi";
...
void DlgWdbeVerDflalg::StatShrImp::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerDflalgImp";
...
void DlgWdbeVerDflalg::StatShrImp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerDflalgImp";
...
void DlgWdbeVerDflalg::StatShrLfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerDflalgLfi";
...
void DlgWdbeVerDflalg::StatShrLfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerDflalgLfi";
...
void DlgWdbeVerDflalg::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerDflalg";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "Import data flows and algorithms";
	};
	me["ButDne"] = StrMod::cap(VecWdbeVTag::getTitle(VecWdbeVTag::DONE, ixWdbeVLocale));
};

void DlgWdbeVerDflalg::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemDlgWdbeVerDflalg";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Import data flows and algorithms");
		};
...
void DlgWdbeVerDflalg::TagIfi::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerDflalgIfi";
...
void DlgWdbeVerDflalg::TagIfi::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbeVerDflalgIfi";
...
void DlgWdbeVerDflalg::TagImp::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerDflalgImp";
...
void DlgWdbeVerDflalg::TagImp::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbeVerDflalgImp";
...
void DlgWdbeVerDflalg::TagLfi::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerDflalgLfi";
...
void DlgWdbeVerDflalg::TagLfi::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbeVerDflalgLfi";
...
DlgWdbeVerDflalg::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPDLGWDBEVERDFLALGDATA)
		{
};
...
void DlgWdbeVerDflalg::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWdbeVerDflalgData"];}();
...
void DlgWdbeVerDflalg::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppDlgWdbeVerDflalgData");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWdbeVerDflalg::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPDLGWDBEVERDFLALGDO)
		{
	ixVDo = 0;
	ixVDoImp = 0;
};
...
void DlgWdbeVerDflalg::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWdbeVerDflalgDo"];}();
...
void DlgWdbeVerDflalg::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppDlgWdbeVerDflalgDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWdbeVerDflalg::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGDLGWDBEVERDFLALGDATA, jref)
		{
...
void DlgWdbeVerDflalg::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void DlgWdbeVerDflalg::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngDlgWdbeVerDflalgData"] = Json::Value(Json::objectValue);
...
void DlgWdbeVerDflalg::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngDlgWdbeVerDflalgData");
