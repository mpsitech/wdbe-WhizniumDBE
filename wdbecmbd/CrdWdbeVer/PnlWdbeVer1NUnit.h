...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQVer1NUnit* rst = NULL, QryWdbeVer1NUnit::StatShr* statshrqry = NULL, QryWdbeVer1NUnit::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
