/**
	* \file PnlWdbeVerList_blks.cpp
	* job handler for job PnlWdbeVerList (implementation of blocks)
...
bool PnlWdbeVerList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWdbeVerList"];}();
...
void PnlWdbeVerList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeVerList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeVerList";
...
void PnlWdbeVerList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWdbeVerList";
...
void PnlWdbeVerList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeVerList";
...
void PnlWdbeVerList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWdbeVerList";
...
bool PnlWdbeVerList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeVerList"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoPrjWidth")) {TcoPrjWidth = me["TcoPrjWidth"].asUInt(); add(TCOPRJWIDTH);};
		...
		if (me.isMember("TcoBvrWidth")) {TcoBvrWidth = me["TcoBvrWidth"].asUInt(); add(TCOBVRWIDTH);};
...
void PnlWdbeVerList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	...
	me["TcoPrjWidth"] = (Json::Value::UInt) TcoPrjWidth;
	...
	me["TcoBvrWidth"] = (Json::Value::UInt) TcoBvrWidth;
...
void PnlWdbeVerList::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeVerList";
...
void PnlWdbeVerList::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeVerList";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Versions");
			writeStringAttr(wr, itemtag, "sref", "TcoPrj", "Project");
			...
			writeStringAttr(wr, itemtag, "sref", "TcoBvr", "Base version");
...
PnlWdbeVerList::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEVERLISTDATA)
		{
};
...
void PnlWdbeVerList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeVerListData"];}();
...
void PnlWdbeVerList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeVerListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeVerList::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEVERLISTDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeVerList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeVerListDo"];}();
...
void PnlWdbeVerList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeVerListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeVerList::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEVERLISTDATA, jref)
		{
...
void PnlWdbeVerList::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeVerList::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeVerListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeVerList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeVerList::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeVerListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeVerList::StatApp::writeXML(wr);
