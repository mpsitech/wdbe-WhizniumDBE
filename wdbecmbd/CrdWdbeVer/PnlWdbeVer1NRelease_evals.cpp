/**
	* \file PnlWdbeVer1NRelease_evals.cpp
	* job handler for job PnlWdbeVer1NRelease (implementation of availability/activation evaluation)
...
bool PnlWdbeVer1NRelease::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeVer1NRelease::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
...
bool PnlWdbeVer1NRelease::evalButNewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeVer1NRelease::evalButDeleteAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeVer1NRelease::evalButDeleteActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
