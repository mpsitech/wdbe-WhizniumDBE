/**
	...
	* job handler for job PnlWdbeVerHeadbar (declarations)
...
/**
	* PnlWdbeVerHeadbar
	*/
class PnlWdbeVerHeadbar : public JobWdbe {
...
public:
	PnlWdbeVerHeadbar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeVerHeadbar();
