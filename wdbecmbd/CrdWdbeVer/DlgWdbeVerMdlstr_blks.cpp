/**
	* \file DlgWdbeVerMdlstr_blks.cpp
	* job handler for job DlgWdbeVerMdlstr (implementation of blocks)
...
string DlgWdbeVerMdlstr::VecVDit::getTitle(
			const uint ix
...
void DlgWdbeVerMdlstr::VecVDit::fillFeed(
			const uint ixWdbeVLocale
			, Feed& feed
		) {
	feed.clear();
...
void DlgWdbeVerMdlstr::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
bool DlgWdbeVerMdlstr::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacDlgWdbeVerMdlstr"];}();
...
void DlgWdbeVerMdlstr::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWdbeVerMdlstr::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbeVerMdlstr";
...
void DlgWdbeVerMdlstr::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbeVerMdlstr";
...
void DlgWdbeVerMdlstr::ContInfImp::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbeVerMdlstrImp";
...
void DlgWdbeVerMdlstr::ContInfImp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbeVerMdlstrImp";
...
void DlgWdbeVerMdlstr::ContInfLfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbeVerMdlstrLfi";
...
void DlgWdbeVerMdlstr::ContInfLfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbeVerMdlstrLfi";
...
void DlgWdbeVerMdlstr::ContInfPpr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfDlgWdbeVerMdlstrPpr";
...
void DlgWdbeVerMdlstr::ContInfPpr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfDlgWdbeVerMdlstrPpr";
...
void DlgWdbeVerMdlstr::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const bool initdone
			, const string& shortMenu
		) {
	if (difftag.length() == 0) difftag = "StatAppDlgWdbeVerMdlstr";
...
void DlgWdbeVerMdlstr::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const bool initdone
	...
	else itemtag = "StatitemAppDlgWdbeVerMdlstr";
...
void DlgWdbeVerMdlstr::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerMdlstr";
...
void DlgWdbeVerMdlstr::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerMdlstr";
...
void DlgWdbeVerMdlstr::StatShrIfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerMdlstrIfi";
...
void DlgWdbeVerMdlstr::StatShrIfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerMdlstrIfi";
...
void DlgWdbeVerMdlstr::StatShrImp::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerMdlstrImp";
...
void DlgWdbeVerMdlstr::StatShrImp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerMdlstrImp";
...
void DlgWdbeVerMdlstr::StatShrLfi::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerMdlstrLfi";
...
void DlgWdbeVerMdlstr::StatShrLfi::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerMdlstrLfi";
...
void DlgWdbeVerMdlstr::StatShrPpr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrDlgWdbeVerMdlstrPpr";
...
void DlgWdbeVerMdlstr::StatShrPpr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrDlgWdbeVerMdlstrPpr";
...
void DlgWdbeVerMdlstr::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerMdlstr";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "Import modular structure";
	};
	me["ButDne"] = StrMod::cap(VecWdbeVTag::getTitle(VecWdbeVTag::DONE, ixWdbeVLocale));
};

void DlgWdbeVerMdlstr::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemDlgWdbeVerMdlstr";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Import modular structure");
		};
...
void DlgWdbeVerMdlstr::TagIfi::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerMdlstrIfi";
...
void DlgWdbeVerMdlstr::TagIfi::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbeVerMdlstrIfi";
...
void DlgWdbeVerMdlstr::TagImp::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerMdlstrImp";
...
void DlgWdbeVerMdlstr::TagImp::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbeVerMdlstrImp";
...
void DlgWdbeVerMdlstr::TagLfi::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerMdlstrLfi";
...
void DlgWdbeVerMdlstr::TagLfi::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbeVerMdlstrLfi";
...
void DlgWdbeVerMdlstr::TagPpr::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagDlgWdbeVerMdlstrPpr";
...
void DlgWdbeVerMdlstr::TagPpr::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemDlgWdbeVerMdlstrPpr";
...
DlgWdbeVerMdlstr::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPDLGWDBEVERMDLSTRDATA)
		{
};
...
void DlgWdbeVerMdlstr::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWdbeVerMdlstrData"];}();
...
void DlgWdbeVerMdlstr::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppDlgWdbeVerMdlstrData");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWdbeVerMdlstr::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPDLGWDBEVERMDLSTRDO)
		{
	ixVDo = 0;
	ixVDoImp = 0;
	ixVDoPpr = 0;
...
void DlgWdbeVerMdlstr::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWdbeVerMdlstrDo"];}();
...
void DlgWdbeVerMdlstr::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppDlgWdbeVerMdlstrDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWdbeVerMdlstr::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGDLGWDBEVERMDLSTRDATA, jref)
		{
...
void DlgWdbeVerMdlstr::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void DlgWdbeVerMdlstr::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngDlgWdbeVerMdlstrData"] = Json::Value(Json::objectValue);
...
void DlgWdbeVerMdlstr::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngDlgWdbeVerMdlstrData");
