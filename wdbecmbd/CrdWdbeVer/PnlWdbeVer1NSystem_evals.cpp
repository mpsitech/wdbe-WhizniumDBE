...
bool PnlWdbeVer1NSystem::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
	// !sel()|(pre.ixCrdaccSys()&pre.refVer())
...
bool PnlWdbeVer1NSystem::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
...
bool PnlWdbeVer1NSystem::evalButNewAvail(
			DbsWdbe* dbswdbe
		) {
	// pre.ixCrdaccSysIncl(edit)&pre.refVer()
...
bool PnlWdbeVer1NSystem::evalButDeleteAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeVer1NSystem::evalButDeleteActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
