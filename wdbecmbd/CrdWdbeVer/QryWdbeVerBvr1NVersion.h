/**
	...
	* job handler for job QryWdbeVerBvr1NVersion (declarations)
...
#define StatAppQryWdbeVerBvr1NVersion QryWdbeVerBvr1NVersion::StatApp
#define StatShrQryWdbeVerBvr1NVersion QryWdbeVerBvr1NVersion::StatShr
#define StgIacQryWdbeVerBvr1NVersion QryWdbeVerBvr1NVersion::StgIac

/**
	* QryWdbeVerBvr1NVersion
	*/
class QryWdbeVerBvr1NVersion : public JobWdbe {
...
public:
	QryWdbeVerBvr1NVersion(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeVerBvr1NVersion();
...
public:
	...
	WdbeQVerBvr1NVersion* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWdbeVerMod_bvrEq(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
