/**
	* \file QryWdbeVer1NUnit_blks.cpp
	* job handler for job QryWdbeVer1NUnit (implementation of blocks)
...
void QryWdbeVer1NUnit::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeVer1NUnit";
...
void QryWdbeVer1NUnit::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeVer1NUnit";
...
void QryWdbeVer1NUnit::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeVer1NUnit";
...
void QryWdbeVer1NUnit::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeVer1NUnit";
...
bool QryWdbeVer1NUnit::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbeVer1NUnit"];}();
...
void QryWdbeVer1NUnit::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
