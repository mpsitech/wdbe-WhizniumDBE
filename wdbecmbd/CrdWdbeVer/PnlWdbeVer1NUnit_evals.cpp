/**
	* \file PnlWdbeVer1NUnit_evals.cpp
	* job handler for job PnlWdbeVer1NUnit (implementation of availability/activation evaluation)
...
bool PnlWdbeVer1NUnit::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeVer1NUnit::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
...
bool PnlWdbeVer1NUnit::evalButNewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeVer1NUnit::evalButDeleteAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeVer1NUnit::evalButDeleteActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
