...
PnlWdbeVerRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NRELEASE, JREFBVR1NVERSION, JREF1NSYSTEM, JREF1NUNIT, JREFREF1NFILE, JREFMNLIBRARY, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeVerRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NRELEASE, JREFBVR1NVERSION, JREF1NSYSTEM, JREF1NUNIT, JREFREF1NFILE, JREFMNLIBRARY, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
