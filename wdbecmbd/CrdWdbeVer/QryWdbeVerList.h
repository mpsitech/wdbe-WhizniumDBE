...
#define QRYWDBEVERLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbeVerListOrd QryWdbeVerList::VecVOrd

#define StatAppQryWdbeVerList QryWdbeVerList::StatApp
#define StatShrQryWdbeVerList QryWdbeVerList::StatShr
#define StgIacQryWdbeVerList QryWdbeVerList::StgIac

/**
	* QryWdbeVerList
	*/
class QryWdbeVerList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbeVerListOrd)
		*/
	class VecVOrd {

	public:
		static const Sbecore::uint BVR = 1;
...
public:
	QryWdbeVerList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeVerList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const Sbecore::ubigint preGrp, const Sbecore::ubigint preOwn, const Sbecore::ubigint prePrj, const Sbecore::ubigint preBvr, const Sbecore::uint preSte, const bool addwhere);
	...
	WdbeQVerList* getRecByJnum(const Sbecore::uint jnum);
