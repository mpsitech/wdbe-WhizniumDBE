...
#ifndef WDBEGENFSTCTRFWDCTR_H
#define WDBEGENFSTCTRFWDCTR_H
...
namespace WdbeGenfstCtrFwdctr {
	...
	DpchRetWdbe* run(XchgWdbe* xchg, DbsWdbe* dbswdbe, DpchInvWdbeGenfstCtrFwdctr* dpchinv);
	// IP cust --- IBEGIN
