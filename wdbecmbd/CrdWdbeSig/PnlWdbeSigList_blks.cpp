/**
	* \file PnlWdbeSigList_blks.cpp
	* job handler for job PnlWdbeSigList (implementation of blocks)
...
bool PnlWdbeSigList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWdbeSigList"];}();
...
void PnlWdbeSigList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeSigList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeSigList";
...
void PnlWdbeSigList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWdbeSigList";
...
void PnlWdbeSigList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeSigList";
...
void PnlWdbeSigList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWdbeSigList";
...
bool PnlWdbeSigList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeSigList"];}();
...
void PnlWdbeSigList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	...
	me["TcoMgtWidth"] = (Json::Value::UInt) TcoMgtWidth;
	me["TcoMguWidth"] = (Json::Value::UInt) TcoMguWidth;
	me["TcoVecWidth"] = (Json::Value::UInt) TcoVecWidth;
	me["TcoConWidth"] = (Json::Value::UInt) TcoConWidth;
...
void PnlWdbeSigList::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeSigList";
...
void PnlWdbeSigList::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeSigList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoMmx", "Width");
		};
...
PnlWdbeSigList::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBESIGLISTDATA)
		{
};
...
void PnlWdbeSigList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeSigListData"];}();
...
void PnlWdbeSigList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeSigListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeSigList::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBESIGLISTDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeSigList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeSigListDo"];}();
...
void PnlWdbeSigList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeSigListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeSigList::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBESIGLISTDATA, jref)
		{
...
void PnlWdbeSigList::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeSigList::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeSigListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeSigList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeSigList::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeSigListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeSigList::StatApp::writeXML(wr);
