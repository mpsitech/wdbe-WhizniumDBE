/**
	...
	* job handler for job PnlWdbeSigSrc1NSensitivity (implementation)
...
#include "PnlWdbeSigSrc1NSensitivity_blks.cpp"
#include "PnlWdbeSigSrc1NSensitivity_evals.cpp"
...
/******************************************************************************
 class PnlWdbeSigSrc1NSensitivity
 ******************************************************************************/

PnlWdbeSigSrc1NSensitivity::PnlWdbeSigSrc1NSensitivity(
			XchgWdbe* xchg
			, DbsWdbe* dbswdbe
			, const ubigint jrefSup
			, const uint ixWdbeVLocale
		) :
			JobWdbe(xchg, VecWdbeVJob::PNLWDBESIGSRC1NSENSITIVITY, jrefSup, ixWdbeVLocale)
		{
	...
	qry = new QryWdbeSigSrc1NSensitivity(xchg, dbswdbe, jref, ixWdbeVLocale);
...
DpchEngWdbe* PnlWdbeSigSrc1NSensitivity::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWdbeSigSrc1NSensitivity::refresh(
			DbsWdbe* dbswdbe
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWdbeSigSrc1NSensitivity::updatePreset(
			DbsWdbe* dbswdbe
...
void PnlWdbeSigSrc1NSensitivity::handleRequest(
			DbsWdbe* dbswdbe
			, ReqWdbe* req
		) {
	if (req->ixVBasetype == ReqWdbe::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWdbeVDpch == VecWdbeVDpch::DPCHAPPWDBESIGSRC1NSENSITIVITYDATA) {
		...
		} else if (req->dpchapp->ixWdbeVDpch == VecWdbeVDpch::DPCHAPPWDBESIGSRC1NSENSITIVITYDO) {
...
void PnlWdbeSigSrc1NSensitivity::handleDpchAppWdbeInit(
			DbsWdbe* dbswdbe
...
void PnlWdbeSigSrc1NSensitivity::handleDpchAppDataStgiac(
			DbsWdbe* dbswdbe
			, StgIac* _stgiac
			, DpchEngWdbe** dpcheng
		) {
...
void PnlWdbeSigSrc1NSensitivity::handleDpchAppDataStgiacqry(
			DbsWdbe* dbswdbe
			, QryWdbeSigSrc1NSensitivity::StgIac* _stgiacqry
			, DpchEngWdbe** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WdbeQSigSrc1NSensitivity* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWdbeSigSrc1NSensitivity::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWdbeSigSrc1NSensitivity::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswdbe);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWdbeSigSrc1NSensitivity::StgIac::JNUM)) {
...
void PnlWdbeSigSrc1NSensitivity::handleDpchAppDoButViewClick(
			DbsWdbe* dbswdbe
			, DpchEngWdbe** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWdbeSigSrc1NSensitivity::handleDpchAppDoButRefreshClick(
			DbsWdbe* dbswdbe
			, DpchEngWdbe** dpcheng
		) {
	set<uint> moditems;
...
void PnlWdbeSigSrc1NSensitivity::handleCall(
			DbsWdbe* dbswdbe
			, Call* call
		) {
...
bool PnlWdbeSigSrc1NSensitivity::handleCallWdbeStatChg(
			DbsWdbe* dbswdbe
			, const ubigint jrefTrig
		) {
	bool retval = false;
