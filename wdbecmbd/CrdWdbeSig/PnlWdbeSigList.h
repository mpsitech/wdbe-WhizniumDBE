/**
	...
	* job handler for job PnlWdbeSigList (declarations)
...
/**
	* PnlWdbeSigList
	*/
class PnlWdbeSigList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQSigList* rst = NULL, QryWdbeSigList::StatShr* statshrqry = NULL, QryWdbeSigList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeSigList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeSigList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeSigList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
