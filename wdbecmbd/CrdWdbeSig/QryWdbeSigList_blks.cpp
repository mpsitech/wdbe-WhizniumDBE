/**
	* \file QryWdbeSigList_blks.cpp
	* job handler for job QryWdbeSigList (implementation of blocks)
...
void QryWdbeSigList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWdbeSigList::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWdbeSigList";
...
void QryWdbeSigList::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeSigList";
