/**
	* \file CrdWdbeSig.h
	* job handler for job CrdWdbeSig (declarations)
...
#define VecVWdbeSigDo CrdWdbeSig::VecVDo
#define VecVWdbeSigSge CrdWdbeSig::VecVSge

#define ContInfWdbeSig CrdWdbeSig::ContInf
#define StatAppWdbeSig CrdWdbeSig::StatApp
#define StatShrWdbeSig CrdWdbeSig::StatShr
#define TagWdbeSig CrdWdbeSig::Tag

#define DpchAppWdbeSigDo CrdWdbeSig::DpchAppDo
#define DpchEngWdbeSigData CrdWdbeSig::DpchEngData

/**
	* CrdWdbeSig
	*/
class CrdWdbeSig : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDSIG = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdSig = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdSig;
...
public:
	CrdWdbeSig(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeSig();
...
public:
	...
	PnlWdbeSigRec* pnlrec;
	PnlWdbeSigHeadbar* pnlheadbar;
	PnlWdbeSigList* pnllist;
