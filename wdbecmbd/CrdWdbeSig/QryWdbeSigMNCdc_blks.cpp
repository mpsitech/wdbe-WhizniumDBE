/**
	* \file QryWdbeSigMNCdc_blks.cpp
	* job handler for job QryWdbeSigMNCdc (implementation of blocks)
...
/******************************************************************************
 class QryWdbeSigMNCdc::StatApp
 ******************************************************************************/

void QryWdbeSigMNCdc::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeSigMNCdc";
...
void QryWdbeSigMNCdc::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeSigMNCdc";
...
/******************************************************************************
 class QryWdbeSigMNCdc::StatShr
 ******************************************************************************/

QryWdbeSigMNCdc::StatShr::StatShr(
			const uint ntot
...
void QryWdbeSigMNCdc::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeSigMNCdc";
...
void QryWdbeSigMNCdc::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeSigMNCdc";
...
set<uint> QryWdbeSigMNCdc::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSigMNCdc::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeSigMNCdc::StgIac
 ******************************************************************************/

QryWdbeSigMNCdc::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeSigMNCdc::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbeSigMNCdc"];}();
...
bool QryWdbeSigMNCdc::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeSigMNCdc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeSigMNCdc";
...
void QryWdbeSigMNCdc::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeSigMNCdc";
...
void QryWdbeSigMNCdc::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeSigMNCdc";
...
set<uint> QryWdbeSigMNCdc::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeSigMNCdc::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
