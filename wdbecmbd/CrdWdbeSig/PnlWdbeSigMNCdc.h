/**
	* \file PnlWdbeSigMNCdc.h
	* job handler for job PnlWdbeSigMNCdc (declarations)
...
#ifndef PNLWDBESIGMNCDC_H
#define PNLWDBESIGMNCDC_H
...
#define VecVWdbeSigMNCdcDo PnlWdbeSigMNCdc::VecVDo

#define ContInfWdbeSigMNCdc PnlWdbeSigMNCdc::ContInf
#define StatAppWdbeSigMNCdc PnlWdbeSigMNCdc::StatApp
#define StatShrWdbeSigMNCdc PnlWdbeSigMNCdc::StatShr
#define StgIacWdbeSigMNCdc PnlWdbeSigMNCdc::StgIac
#define TagWdbeSigMNCdc PnlWdbeSigMNCdc::Tag

#define DpchAppWdbeSigMNCdcData PnlWdbeSigMNCdc::DpchAppData
#define DpchAppWdbeSigMNCdcDo PnlWdbeSigMNCdc::DpchAppDo
#define DpchEngWdbeSigMNCdcData PnlWdbeSigMNCdc::DpchEngData

/**
	* PnlWdbeSigMNCdc
	*/
class PnlWdbeSigMNCdc : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQSigMNCdc* rst = NULL, QryWdbeSigMNCdc::StatShr* statshrqry = NULL, QryWdbeSigMNCdc::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeSigMNCdc(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeSigMNCdc();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeSigMNCdc::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
