/**
	* \file QryWdbeIntList.h
	* job handler for job QryWdbeIntList (declarations)
...
#ifndef QRYWDBEINTLIST_H
#define QRYWDBEINTLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbeIntListOrd QryWdbeIntList::VecVOrd

#define StatAppQryWdbeIntList QryWdbeIntList::StatApp
#define StatShrQryWdbeIntList QryWdbeIntList::StatShr
#define StgIacQryWdbeIntList QryWdbeIntList::StgIac

/**
	* QryWdbeIntList
	*/
class QryWdbeIntList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbeIntListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbeIntList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeIntList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeIntList)
		*/
...
public:
	QryWdbeIntList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeIntList();
...
public:
	...
	WdbeQIntList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWdbeIntMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
