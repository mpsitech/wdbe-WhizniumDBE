/**
	* \file PnlWdbeIntList.h
	* job handler for job PnlWdbeIntList (declarations)
...
#ifndef PNLWDBEINTLIST_H
#define PNLWDBEINTLIST_H
...
#define VecVWdbeIntListDo PnlWdbeIntList::VecVDo

#define ContIacWdbeIntList PnlWdbeIntList::ContIac
#define ContInfWdbeIntList PnlWdbeIntList::ContInf
#define StatShrWdbeIntList PnlWdbeIntList::StatShr
#define StgIacWdbeIntList PnlWdbeIntList::StgIac
#define TagWdbeIntList PnlWdbeIntList::Tag

#define DpchAppWdbeIntListData PnlWdbeIntList::DpchAppData
#define DpchAppWdbeIntListDo PnlWdbeIntList::DpchAppDo
#define DpchEngWdbeIntListData PnlWdbeIntList::DpchEngData

/**
	* PnlWdbeIntList
	*/
class PnlWdbeIntList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQIntList* rst = NULL, QryWdbeIntList::StatShr* statshrqry = NULL, QryWdbeIntList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeIntList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeIntList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeIntList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
