/**
	* \file PnlWdbeIntList_blks.cpp
	* job handler for job PnlWdbeIntList (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeIntList::VecVDo
 ******************************************************************************/

uint PnlWdbeIntList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeIntList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeIntList::ContIac
 ******************************************************************************/

PnlWdbeIntList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
			, numFTos(numFTos)
...
bool PnlWdbeIntList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWdbeIntList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWdbeIntList";
...
void PnlWdbeIntList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWdbeIntList";
...
void PnlWdbeIntList::ContIac::writeXML(
	...
	else itemtag = "ContitemIacWdbeIntList";
...
set<uint> PnlWdbeIntList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeIntList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeIntList::ContInf
 ******************************************************************************/

PnlWdbeIntList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWdbeIntList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeIntList";
...
void PnlWdbeIntList::ContInf::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWdbeIntList";
...
set<uint> PnlWdbeIntList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeIntList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeIntList::StatShr
 ******************************************************************************/

PnlWdbeIntList::StatShr::StatShr(
...
void PnlWdbeIntList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeIntList";
...
void PnlWdbeIntList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWdbeIntList";
...
set<uint> PnlWdbeIntList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeIntList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeIntList::StgIac
 ******************************************************************************/

PnlWdbeIntList::StgIac::StgIac(
...
bool PnlWdbeIntList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeIntList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeIntList";
...
void PnlWdbeIntList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeIntList";
...
void PnlWdbeIntList::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeIntList";
...
set<uint> PnlWdbeIntList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeIntList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeIntList::Tag
 ******************************************************************************/

void PnlWdbeIntList::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeIntList";
...
void PnlWdbeIntList::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeIntList";
...
/******************************************************************************
 class PnlWdbeIntList::DpchAppData
 ******************************************************************************/

PnlWdbeIntList::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEINTLISTDATA)
		{
};

string PnlWdbeIntList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeIntList::DpchAppData::readJSON(
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWdbeIntList::StgIac();
	};
};

void PnlWdbeIntList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeIntListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeIntList::DpchAppDo
 ******************************************************************************/

PnlWdbeIntList::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEINTLISTDO)
		{
	ixVDo = 0;
};

string PnlWdbeIntList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeIntList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeIntListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeIntList::DpchEngData
 ******************************************************************************/

PnlWdbeIntList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, QryWdbeIntList::StatShr* statshrqry
			, QryWdbeIntList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEINTLISTDATA, jref)
		{
...
string PnlWdbeIntList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeIntList::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeIntList::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeIntListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeIntList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeIntList::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeIntListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeIntList::StatApp::writeXML(wr);
