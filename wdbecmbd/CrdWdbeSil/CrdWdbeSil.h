/**
	* \file CrdWdbeSil.h
	* job handler for job CrdWdbeSil (declarations)
...
#define ContInfWdbeSil CrdWdbeSil::ContInf
#define StatAppWdbeSil CrdWdbeSil::StatApp
#define StatShrWdbeSil CrdWdbeSil::StatShr
#define TagWdbeSil CrdWdbeSil::Tag

#define DpchAppWdbeSilDo CrdWdbeSil::DpchAppDo
#define DpchEngWdbeSilData CrdWdbeSil::DpchEngData

/**
	* CrdWdbeSil
	*/
class CrdWdbeSil : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDSIL = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdSil = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdSil;
...
public:
	CrdWdbeSil(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbeSil();
