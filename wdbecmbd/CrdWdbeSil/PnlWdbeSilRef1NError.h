/**
	* \file PnlWdbeSilRef1NError.h
	* job handler for job PnlWdbeSilRef1NError (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBESILREF1NERROR_H
#define PNLWDBESILREF1NERROR_H
...
#define VecVWdbeSilRef1NErrorDo PnlWdbeSilRef1NError::VecVDo

#define ContInfWdbeSilRef1NError PnlWdbeSilRef1NError::ContInf
#define StatAppWdbeSilRef1NError PnlWdbeSilRef1NError::StatApp
#define StatShrWdbeSilRef1NError PnlWdbeSilRef1NError::StatShr
#define StgIacWdbeSilRef1NError PnlWdbeSilRef1NError::StgIac
#define TagWdbeSilRef1NError PnlWdbeSilRef1NError::Tag

#define DpchAppWdbeSilRef1NErrorData PnlWdbeSilRef1NError::DpchAppData
#define DpchAppWdbeSilRef1NErrorDo PnlWdbeSilRef1NError::DpchAppDo
#define DpchEngWdbeSilRef1NErrorData PnlWdbeSilRef1NError::DpchEngData

/**
	* PnlWdbeSilRef1NError
	*/
class PnlWdbeSilRef1NError : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQSilRef1NError* rst = NULL, QryWdbeSilRef1NError::StatShr* statshrqry = NULL, QryWdbeSilRef1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeSilRef1NError(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeSilRef1NError();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeSilRef1NError::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
