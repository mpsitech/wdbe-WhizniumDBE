/**
	* \file QryWdbeSilRef1NSignal_blks.cpp
	* job handler for job QryWdbeSilRef1NSignal (implementation of blocks)
...
void QryWdbeSilRef1NSignal::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeSilRef1NSignal";
...
void QryWdbeSilRef1NSignal::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeSilRef1NSignal";
...
void QryWdbeSilRef1NSignal::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeSilRef1NSignal";
...
void QryWdbeSilRef1NSignal::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeSilRef1NSignal";
...
bool QryWdbeSilRef1NSignal::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbeSilRef1NSignal"];}();
...
void QryWdbeSilRef1NSignal::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
