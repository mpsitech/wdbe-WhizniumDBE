/**
	...
	* job handler for job QryWdbeSil1NBank (declarations)
...
/**
	* QryWdbeSil1NBank
	*/
class QryWdbeSil1NBank : public JobWdbe {
...
public:
	QryWdbeSil1NBank(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeSil1NBank();
...
public:
	...
	WdbeQSil1NBank* getRecByJnum(const Sbecore::uint jnum);
