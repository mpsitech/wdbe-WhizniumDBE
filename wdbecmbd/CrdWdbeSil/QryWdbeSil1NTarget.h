/**
	* \file QryWdbeSil1NTarget.h
	* job handler for job QryWdbeSil1NTarget (declarations)
...
#ifndef QRYWDBESIL1NTARGET_H
#define QRYWDBESIL1NTARGET_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeSil1NTarget QryWdbeSil1NTarget::StatApp
#define StatShrQryWdbeSil1NTarget QryWdbeSil1NTarget::StatShr
#define StgIacQryWdbeSil1NTarget QryWdbeSil1NTarget::StgIac

/**
	* QryWdbeSil1NTarget
	*/
class QryWdbeSil1NTarget : public JobWdbe {
...
public:
	QryWdbeSil1NTarget(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeSil1NTarget();
...
public:
	...
	WdbeQSil1NTarget* getRecByJnum(const Sbecore::uint jnum);
