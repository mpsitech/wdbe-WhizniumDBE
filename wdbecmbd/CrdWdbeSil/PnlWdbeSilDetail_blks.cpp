...
bool PnlWdbeSilDetail::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWdbeSilDetail"];}();
...
void PnlWdbeSilDetail::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeSilDetail::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeSilDetail::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
PnlWdbeSilDetail::StatShr::StatShr(
		...
		{
	mask = {BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, TXFTITACTIVE, TXFFSRACTIVE, PUPTYPACTIVE, TXTREUACTIVE, BUTREUVIEWAVAIL, BUTREUVIEWACTIVE, TXTMDLACTIVE, BUTMDLVIEWAVAIL, BUTMDLVIEWACTIVE, PUPPKGACTIVE, TXFPKGVALID, BUTPKGEDITAVAIL, CHKESYACTIVE, PUPTCHACTIVE, TXFTCHVALID, BUTTCHEDITAVAIL, TXFCMTACTIVE};
};

void PnlWdbeSilDetail::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
set<uint> PnlWdbeSilDetail::StatShr::diff(
	...
	diffitems = {BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, TXFTITACTIVE, TXFFSRACTIVE, PUPTYPACTIVE, TXTREUACTIVE, BUTREUVIEWAVAIL, BUTREUVIEWACTIVE, TXTMDLACTIVE, BUTMDLVIEWAVAIL, BUTMDLVIEWACTIVE, PUPPKGACTIVE, TXFPKGVALID, BUTPKGEDITAVAIL, CHKESYACTIVE, PUPTCHACTIVE, TXFTCHVALID, BUTTCHEDITAVAIL, TXFCMTACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
void PnlWdbeSilDetail::Tag::writeJSON(
...
void PnlWdbeSilDetail::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeSilDetailData"];}();
...
void PnlWdbeSilDetail::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeSilDetailDo"];}();
...
void PnlWdbeSilDetail::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeSilDetailData"] = Json::Value(Json::objectValue);
