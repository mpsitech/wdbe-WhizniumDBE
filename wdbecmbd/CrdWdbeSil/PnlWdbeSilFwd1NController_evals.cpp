/**
	* \file PnlWdbeSilFwd1NController_evals.cpp
	* job handler for job PnlWdbeSilFwd1NController (implementation of availability/activation evaluation)
...
bool PnlWdbeSilFwd1NController::evalButViewAvail(
			DbsWdbe* dbswdbe
		) {
...
bool PnlWdbeSilFwd1NController::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
