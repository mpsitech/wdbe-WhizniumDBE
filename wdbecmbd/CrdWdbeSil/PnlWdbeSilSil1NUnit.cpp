/**
	...
	* job handler for job PnlWdbeSilSil1NUnit (implementation)
...
#include "PnlWdbeSilSil1NUnit_blks.cpp"
...
/******************************************************************************
 class PnlWdbeSilSil1NUnit
 ******************************************************************************/

PnlWdbeSilSil1NUnit::PnlWdbeSilSil1NUnit(
			XchgWdbe* xchg
			, DbsWdbe* dbswdbe
			, const ubigint jrefSup
			, const uint ixWdbeVLocale
		) :
			JobWdbe(xchg, VecWdbeVJob::PNLWDBESILSIL1NUNIT, jrefSup, ixWdbeVLocale)
		{
	...
	qry = new QryWdbeSilSil1NUnit(xchg, dbswdbe, jref, ixWdbeVLocale);
...
DpchEngWdbe* PnlWdbeSilSil1NUnit::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWdbeSilSil1NUnit::refresh(
			DbsWdbe* dbswdbe
			, set<uint>& moditems
		) {
...
void PnlWdbeSilSil1NUnit::updatePreset(
			DbsWdbe* dbswdbe
...
void PnlWdbeSilSil1NUnit::handleRequest(
			DbsWdbe* dbswdbe
			, ReqWdbe* req
		) {
	if (req->ixVBasetype == ReqWdbe::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWdbeVDpch == VecWdbeVDpch::DPCHAPPWDBESILSIL1NUNITDATA) {
		...
		} else if (req->dpchapp->ixWdbeVDpch == VecWdbeVDpch::DPCHAPPWDBESILSIL1NUNITDO) {
...
void PnlWdbeSilSil1NUnit::handleDpchAppWdbeInit(
			DbsWdbe* dbswdbe
...
void PnlWdbeSilSil1NUnit::handleDpchAppDataStgiac(
			DbsWdbe* dbswdbe
			, StgIac* _stgiac
			, DpchEngWdbe** dpcheng
		) {
...
void PnlWdbeSilSil1NUnit::handleDpchAppDataStgiacqry(
			DbsWdbe* dbswdbe
			, QryWdbeSilSil1NUnit::StgIac* _stgiacqry
			, DpchEngWdbe** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WdbeQSilSil1NUnit* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWdbeSilSil1NUnit::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWdbeSilSil1NUnit::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswdbe);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWdbeSilSil1NUnit::StgIac::JNUM)) {
...
void PnlWdbeSilSil1NUnit::handleDpchAppDoButRefreshClick(
			DbsWdbe* dbswdbe
			, DpchEngWdbe** dpcheng
		) {
	set<uint> moditems;
...
void PnlWdbeSilSil1NUnit::handleCall(
			DbsWdbe* dbswdbe
			, Call* call
		) {
...
bool PnlWdbeSilSil1NUnit::handleCallWdbeStatChg(
			DbsWdbe* dbswdbe
			, const ubigint jrefTrig
		) {
	bool retval = false;
