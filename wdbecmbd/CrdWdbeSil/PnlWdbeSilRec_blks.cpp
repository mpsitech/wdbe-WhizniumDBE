...
PnlWdbeSilRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NPERIPHERAL, JREFSIL1NUNIT, JREF1NBANK, JREFFWD1NCONTROLLER, JREF1NTARGET, JREFREF1NERROR, JREFHK1NVECTOR, JREFREF1NCOMMAND, JREFHK1NMODULE, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeSilRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NPERIPHERAL, JREFSIL1NUNIT, JREF1NBANK, JREFFWD1NCONTROLLER, JREF1NTARGET, JREFREF1NERROR, JREFHK1NVECTOR, JREFREF1NCOMMAND, JREFHK1NMODULE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
