...
PnlWdbeSilRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NTARGET, JREF1NINTERRUPT, JREF1NPERIPHERAL, JREFSIL1NUNIT, JREFFWD1NCONTROLLER, JREF1NBANK, JREFHK1NMODULE, JREFHK1NVECTOR, JREFREF1NSIGNAL, JREFREF1NERROR, JREFREF1NCOMMAND, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeSilRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREF1NTARGET, JREF1NINTERRUPT, JREF1NPERIPHERAL, JREFSIL1NUNIT, JREFFWD1NCONTROLLER, JREF1NBANK, JREFHK1NMODULE, JREFHK1NVECTOR, JREFREF1NSIGNAL, JREFREF1NERROR, JREFREF1NCOMMAND, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
