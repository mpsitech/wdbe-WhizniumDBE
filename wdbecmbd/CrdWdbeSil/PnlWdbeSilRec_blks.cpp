...
PnlWdbeSilRec::StatShr::StatShr(
	...
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREFSIL1NUNIT, JREF1NPERIPHERAL, JREF1NBANK, JREFFWD1NCONTROLLER, JREF1NTARGET, JREFHK1NVECTOR, JREFHK1NMODULE, JREFREF1NCOMMAND, JREFREF1NERROR, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeSilRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREFSIL1NUNIT, JREF1NPERIPHERAL, JREF1NBANK, JREFFWD1NCONTROLLER, JREF1NTARGET, JREFHK1NVECTOR, JREFHK1NMODULE, JREFREF1NCOMMAND, JREFREF1NERROR, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
