...
#define QRYWDBESILHK1NVECTOR_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeSilHk1NVector QryWdbeSilHk1NVector::StatApp
#define StatShrQryWdbeSilHk1NVector QryWdbeSilHk1NVector::StatShr
#define StgIacQryWdbeSilHk1NVector QryWdbeSilHk1NVector::StgIac

/**
	* QryWdbeSilHk1NVector
	*/
class QryWdbeSilHk1NVector : public JobWdbe {
...
public:
	QryWdbeSilHk1NVector(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeSilHk1NVector();
...
public:
	...
	WdbeQSilHk1NVector* getRecByJnum(const Sbecore::uint jnum);
