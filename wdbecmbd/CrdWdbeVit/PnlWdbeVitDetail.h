/**
	...
	* job handler for job PnlWdbeVitDetail (declarations)
...
/**
	* PnlWdbeVitDetail
	*/
class PnlWdbeVitDetail : public JobWdbe {
...
public:
	PnlWdbeVitDetail(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeVitDetail();
...
public:
	...
	void refreshRecVit(DbsWdbe* dbswdbe, std::set<Sbecore::uint>& moditems);
