/**
	* \file QryWdbePrcKHdltype_blks.cpp
	* job handler for job QryWdbePrcKHdltype (implementation of blocks)
...
void QryWdbePrcKHdltype::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbePrcKHdltype";
...
void QryWdbePrcKHdltype::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbePrcKHdltype";
...
void QryWdbePrcKHdltype::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbePrcKHdltype";
...
void QryWdbePrcKHdltype::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbePrcKHdltype";
...
bool QryWdbePrcKHdltype::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbePrcKHdltype"];}();
...
void QryWdbePrcKHdltype::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
