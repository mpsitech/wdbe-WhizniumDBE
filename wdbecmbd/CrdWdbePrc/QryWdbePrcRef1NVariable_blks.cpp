/**
	* \file QryWdbePrcRef1NVariable_blks.cpp
	* job handler for job QryWdbePrcRef1NVariable (implementation of blocks)
...
/******************************************************************************
 class QryWdbePrcRef1NVariable::StatApp
 ******************************************************************************/

void QryWdbePrcRef1NVariable::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbePrcRef1NVariable";
...
void QryWdbePrcRef1NVariable::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbePrcRef1NVariable";
...
/******************************************************************************
 class QryWdbePrcRef1NVariable::StatShr
 ******************************************************************************/

QryWdbePrcRef1NVariable::StatShr::StatShr(
			const uint ntot
...
void QryWdbePrcRef1NVariable::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbePrcRef1NVariable";
...
void QryWdbePrcRef1NVariable::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbePrcRef1NVariable";
...
set<uint> QryWdbePrcRef1NVariable::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbePrcRef1NVariable::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbePrcRef1NVariable::StgIac
 ******************************************************************************/

QryWdbePrcRef1NVariable::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbePrcRef1NVariable::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbePrcRef1NVariable");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbePrcRef1NVariable";
...
void QryWdbePrcRef1NVariable::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbePrcRef1NVariable";
...
void QryWdbePrcRef1NVariable::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbePrcRef1NVariable";
...
set<uint> QryWdbePrcRef1NVariable::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbePrcRef1NVariable::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
