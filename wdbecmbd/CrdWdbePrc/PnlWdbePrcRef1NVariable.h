/**
	* \file PnlWdbePrcRef1NVariable.h
	* job handler for job PnlWdbePrcRef1NVariable (declarations)
...
#ifndef PNLWDBEPRCREF1NVARIABLE_H
#define PNLWDBEPRCREF1NVARIABLE_H
...
#define VecVWdbePrcRef1NVariableDo PnlWdbePrcRef1NVariable::VecVDo

#define ContInfWdbePrcRef1NVariable PnlWdbePrcRef1NVariable::ContInf
#define StatAppWdbePrcRef1NVariable PnlWdbePrcRef1NVariable::StatApp
#define StatShrWdbePrcRef1NVariable PnlWdbePrcRef1NVariable::StatShr
#define StgIacWdbePrcRef1NVariable PnlWdbePrcRef1NVariable::StgIac
#define TagWdbePrcRef1NVariable PnlWdbePrcRef1NVariable::Tag

#define DpchAppWdbePrcRef1NVariableData PnlWdbePrcRef1NVariable::DpchAppData
#define DpchAppWdbePrcRef1NVariableDo PnlWdbePrcRef1NVariable::DpchAppDo
#define DpchEngWdbePrcRef1NVariableData PnlWdbePrcRef1NVariable::DpchEngData

/**
	* PnlWdbePrcRef1NVariable
	*/
class PnlWdbePrcRef1NVariable : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrcRef1NVariable* rst = NULL, QryWdbePrcRef1NVariable::StatShr* statshrqry = NULL, QryWdbePrcRef1NVariable::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePrcRef1NVariable(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrcRef1NVariable();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePrcRef1NVariable::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
