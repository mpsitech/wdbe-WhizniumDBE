/**
	* \file QryWdbePrcMge1NSignal.h
	* job handler for job QryWdbePrcMge1NSignal (declarations)
...
#ifndef QRYWDBEPRCMGE1NSIGNAL_H
#define QRYWDBEPRCMGE1NSIGNAL_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbePrcMge1NSignal QryWdbePrcMge1NSignal::StatApp
#define StatShrQryWdbePrcMge1NSignal QryWdbePrcMge1NSignal::StatShr
#define StgIacQryWdbePrcMge1NSignal QryWdbePrcMge1NSignal::StgIac

/**
	* QryWdbePrcMge1NSignal
	*/
class QryWdbePrcMge1NSignal : public JobWdbe {
...
public:
	QryWdbePrcMge1NSignal(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePrcMge1NSignal();
...
public:
	...
	WdbeQPrcMge1NSignal* getRecByJnum(const Sbecore::uint jnum);
