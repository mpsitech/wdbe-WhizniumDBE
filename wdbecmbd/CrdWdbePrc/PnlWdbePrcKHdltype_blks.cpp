/**
	* \file PnlWdbePrcKHdltype_blks.cpp
	* job handler for job PnlWdbePrcKHdltype (implementation of blocks)
...
/******************************************************************************
 class PnlWdbePrcKHdltype::VecVDo
 ******************************************************************************/

uint PnlWdbePrcKHdltype::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbePrcKHdltype::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbePrcKHdltype::ContInf
 ******************************************************************************/

PnlWdbePrcKHdltype::ContInf::ContInf(
...
void PnlWdbePrcKHdltype::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbePrcKHdltype";
...
void PnlWdbePrcKHdltype::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbePrcKHdltype";
...
set<uint> PnlWdbePrcKHdltype::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcKHdltype::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrcKHdltype::StatApp
 ******************************************************************************/

void PnlWdbePrcKHdltype::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbePrcKHdltype";
...
void PnlWdbePrcKHdltype::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbePrcKHdltype";
...
/******************************************************************************
 class PnlWdbePrcKHdltype::StatShr
 ******************************************************************************/

PnlWdbePrcKHdltype::StatShr::StatShr(
...
void PnlWdbePrcKHdltype::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbePrcKHdltype";
...
void PnlWdbePrcKHdltype::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbePrcKHdltype";
...
set<uint> PnlWdbePrcKHdltype::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcKHdltype::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrcKHdltype::StgIac
 ******************************************************************************/

PnlWdbePrcKHdltype::StgIac::StgIac(
...
bool PnlWdbePrcKHdltype::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbePrcKHdltype"];}();
...
bool PnlWdbePrcKHdltype::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbePrcKHdltype");
	else
...
void PnlWdbePrcKHdltype::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbePrcKHdltype";
...
void PnlWdbePrcKHdltype::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> PnlWdbePrcKHdltype::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcKHdltype::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrcKHdltype::Tag
 ******************************************************************************/

void PnlWdbePrcKHdltype::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbePrcKHdltype";
...
void PnlWdbePrcKHdltype::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbePrcKHdltype";
...
/******************************************************************************
 class PnlWdbePrcKHdltype::DpchAppData
 ******************************************************************************/

PnlWdbePrcKHdltype::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRCKHDLTYPEDATA)
		{
};

string PnlWdbePrcKHdltype::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrcKHdltype::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePrcKHdltypeData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWdbePrcKHdltype::StgIac();
	};
};

void PnlWdbePrcKHdltype::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrcKHdltypeData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrcKHdltype::DpchAppDo
 ******************************************************************************/

PnlWdbePrcKHdltype::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRCKHDLTYPEDO)
		{
	ixVDo = 0;
};

string PnlWdbePrcKHdltype::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrcKHdltype::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePrcKHdltypeDo"];}();
...
void PnlWdbePrcKHdltype::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrcKHdltypeDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrcKHdltype::DpchEngData
 ******************************************************************************/

PnlWdbePrcKHdltype::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEPRCKHDLTYPEDATA, jref)
		{
...
string PnlWdbePrcKHdltype::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrcKHdltype::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbePrcKHdltype::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbePrcKHdltypeData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbePrcKHdltype::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbePrcKHdltype::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbePrcKHdltypeData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbePrcKHdltype::StatApp::writeXML(wr);
