...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrcFsmFsm1NFsmstate* rst = NULL, QryWdbePrcFsmFsm1NFsmstate::StatShr* statshrqry = NULL, QryWdbePrcFsmFsm1NFsmstate::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
