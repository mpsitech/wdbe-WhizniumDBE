/**
	* \file PnlWdbePrcFsmFsm1NFsmstate.h
	* job handler for job PnlWdbePrcFsmFsm1NFsmstate (declarations)
...
#ifndef PNLWDBEPRCFSMFSM1NFSMSTATE_H
#define PNLWDBEPRCFSMFSM1NFSMSTATE_H
...
#define VecVWdbePrcFsmFsm1NFsmstateDo PnlWdbePrcFsmFsm1NFsmstate::VecVDo

#define ContInfWdbePrcFsmFsm1NFsmstate PnlWdbePrcFsmFsm1NFsmstate::ContInf
#define StatAppWdbePrcFsmFsm1NFsmstate PnlWdbePrcFsmFsm1NFsmstate::StatApp
#define StatShrWdbePrcFsmFsm1NFsmstate PnlWdbePrcFsmFsm1NFsmstate::StatShr
#define StgIacWdbePrcFsmFsm1NFsmstate PnlWdbePrcFsmFsm1NFsmstate::StgIac
#define TagWdbePrcFsmFsm1NFsmstate PnlWdbePrcFsmFsm1NFsmstate::Tag

#define DpchAppWdbePrcFsmFsm1NFsmstateData PnlWdbePrcFsmFsm1NFsmstate::DpchAppData
#define DpchAppWdbePrcFsmFsm1NFsmstateDo PnlWdbePrcFsmFsm1NFsmstate::DpchAppDo
#define DpchEngWdbePrcFsmFsm1NFsmstateData PnlWdbePrcFsmFsm1NFsmstate::DpchEngData

/**
	* PnlWdbePrcFsmFsm1NFsmstate
	*/
class PnlWdbePrcFsmFsm1NFsmstate : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrcFsmFsm1NFsmstate* rst = NULL, QryWdbePrcFsmFsm1NFsmstate::StatShr* statshrqry = NULL, QryWdbePrcFsmFsm1NFsmstate::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePrcFsmFsm1NFsmstate(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrcFsmFsm1NFsmstate();
...
public:
	...
	QryWdbePrcFsmFsm1NFsmstate* qry;

	WdbeMFsmstate recFst;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePrcFsmFsm1NFsmstate::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
