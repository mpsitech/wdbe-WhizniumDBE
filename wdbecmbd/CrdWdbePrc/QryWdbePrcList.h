/**
	* \file QryWdbePrcList.h
	* job handler for job QryWdbePrcList (declarations)
...
#ifndef QRYWDBEPRCLIST_H
#define QRYWDBEPRCLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbePrcListOrd QryWdbePrcList::VecVOrd

#define StatAppQryWdbePrcList QryWdbePrcList::StatApp
#define StatShrQryWdbePrcList QryWdbePrcList::StatShr
#define StgIacQryWdbePrcList QryWdbePrcList::StgIac

/**
	* QryWdbePrcList
	*/
class QryWdbePrcList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbePrcListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbePrcList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbePrcList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbePrcList)
		*/
...
public:
	QryWdbePrcList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePrcList();
...
public:
	...
	WdbeQPrcList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbePrcMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
