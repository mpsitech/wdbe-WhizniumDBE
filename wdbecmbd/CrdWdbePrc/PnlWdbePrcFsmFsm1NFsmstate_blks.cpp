/**
	* \file PnlWdbePrcFsmFsm1NFsmstate_blks.cpp
	* job handler for job PnlWdbePrcFsmFsm1NFsmstate (implementation of blocks)
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::VecVDo
 ******************************************************************************/

uint PnlWdbePrcFsmFsm1NFsmstate::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbePrcFsmFsm1NFsmstate::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::ContInf
 ******************************************************************************/

PnlWdbePrcFsmFsm1NFsmstate::ContInf::ContInf(
...
void PnlWdbePrcFsmFsm1NFsmstate::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbePrcFsmFsm1NFsmstate";
...
void PnlWdbePrcFsmFsm1NFsmstate::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWdbePrcFsmFsm1NFsmstate";
...
set<uint> PnlWdbePrcFsmFsm1NFsmstate::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcFsmFsm1NFsmstate::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::StatApp
 ******************************************************************************/

void PnlWdbePrcFsmFsm1NFsmstate::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbePrcFsmFsm1NFsmstate";
...
void PnlWdbePrcFsmFsm1NFsmstate::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbePrcFsmFsm1NFsmstate";
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::StatShr
 ******************************************************************************/

PnlWdbePrcFsmFsm1NFsmstate::StatShr::StatShr(
...
void PnlWdbePrcFsmFsm1NFsmstate::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbePrcFsmFsm1NFsmstate";
...
void PnlWdbePrcFsmFsm1NFsmstate::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbePrcFsmFsm1NFsmstate";
...
set<uint> PnlWdbePrcFsmFsm1NFsmstate::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcFsmFsm1NFsmstate::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::StgIac
 ******************************************************************************/

PnlWdbePrcFsmFsm1NFsmstate::StgIac::StgIac(
...
bool PnlWdbePrcFsmFsm1NFsmstate::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbePrcFsmFsm1NFsmstate");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbePrcFsmFsm1NFsmstate";
...
void PnlWdbePrcFsmFsm1NFsmstate::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbePrcFsmFsm1NFsmstate";
...
void PnlWdbePrcFsmFsm1NFsmstate::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbePrcFsmFsm1NFsmstate";
...
set<uint> PnlWdbePrcFsmFsm1NFsmstate::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbePrcFsmFsm1NFsmstate::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::Tag
 ******************************************************************************/

void PnlWdbePrcFsmFsm1NFsmstate::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbePrcFsmFsm1NFsmstate";
...
void PnlWdbePrcFsmFsm1NFsmstate::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbePrcFsmFsm1NFsmstate";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "FSM states");
			writeStringAttr(wr, itemtag, "sref", "TcoRef", "FSM state");
		};
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::DpchAppData
 ******************************************************************************/

PnlWdbePrcFsmFsm1NFsmstate::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRCFSMFSM1NFSMSTATEDATA)
		{
};

string PnlWdbePrcFsmFsm1NFsmstate::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrcFsmFsm1NFsmstate::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrcFsmFsm1NFsmstateData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::DpchAppDo
 ******************************************************************************/

PnlWdbePrcFsmFsm1NFsmstate::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEPRCFSMFSM1NFSMSTATEDO)
		{
	ixVDo = 0;
};

string PnlWdbePrcFsmFsm1NFsmstate::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrcFsmFsm1NFsmstate::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbePrcFsmFsm1NFsmstateDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbePrcFsmFsm1NFsmstate::DpchEngData
 ******************************************************************************/

PnlWdbePrcFsmFsm1NFsmstate::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWdbePrcFsmFsm1NFsmstate::StatShr* statshrqry
			, QryWdbePrcFsmFsm1NFsmstate::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEPRCFSMFSM1NFSMSTATEDATA, jref)
		{
...
string PnlWdbePrcFsmFsm1NFsmstate::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbePrcFsmFsm1NFsmstate::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbePrcFsmFsm1NFsmstate::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbePrcFsmFsm1NFsmstateData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbePrcFsmFsm1NFsmstate::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbePrcFsmFsm1NFsmstate::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbePrcFsmFsm1NFsmstateData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbePrcFsmFsm1NFsmstate::StatApp::writeXML(wr);
