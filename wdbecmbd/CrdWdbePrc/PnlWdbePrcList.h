/**
	...
	* job handler for job PnlWdbePrcList (declarations)
...
/**
	* PnlWdbePrcList
	*/
class PnlWdbePrcList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPrcList* rst = NULL, QryWdbePrcList::StatShr* statshrqry = NULL, QryWdbePrcList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePrcList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePrcList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePrcList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
