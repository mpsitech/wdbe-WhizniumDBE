/**
	* \file QryWdbePrcList_blks.cpp
	* job handler for job QryWdbePrcList (implementation of blocks)
...
/******************************************************************************
 class QryWdbePrcList::VecVOrd
 ******************************************************************************/

uint QryWdbePrcList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWdbePrcList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWdbePrcList::StatApp
 ******************************************************************************/

void QryWdbePrcList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbePrcList";
...
void QryWdbePrcList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbePrcList";
...
/******************************************************************************
 class QryWdbePrcList::StatShr
 ******************************************************************************/

QryWdbePrcList::StatShr::StatShr(
			const uint ntot
...
void QryWdbePrcList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbePrcList";
...
void QryWdbePrcList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbePrcList";
...
set<uint> QryWdbePrcList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbePrcList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbePrcList::StgIac
 ******************************************************************************/

QryWdbePrcList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbePrcList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbePrcList"];}();
...
bool QryWdbePrcList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbePrcList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbePrcList";
...
void QryWdbePrcList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbePrcList";
...
void QryWdbePrcList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbePrcList";
...
set<uint> QryWdbePrcList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbePrcList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
