/**
	* \file QryWdbePrcFsmHk1NVector.h
	* job handler for job QryWdbePrcFsmHk1NVector (declarations)
...
#ifndef QRYWDBEPRCFSMHK1NVECTOR_H
#define QRYWDBEPRCFSMHK1NVECTOR_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbePrcFsmHk1NVector QryWdbePrcFsmHk1NVector::StatApp
#define StatShrQryWdbePrcFsmHk1NVector QryWdbePrcFsmHk1NVector::StatShr
#define StgIacQryWdbePrcFsmHk1NVector QryWdbePrcFsmHk1NVector::StgIac

/**
	* QryWdbePrcFsmHk1NVector
	*/
class QryWdbePrcFsmHk1NVector : public JobWdbe {
...
public:
	QryWdbePrcFsmHk1NVector(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePrcFsmHk1NVector();
...
public:
	...
	WdbeQPrcFsmHk1NVector* getRecByJnum(const Sbecore::uint jnum);
