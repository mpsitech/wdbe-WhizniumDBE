/**
	* \file PnlWdbePrcMge1NSignal_evals.cpp
	* job handler for job PnlWdbePrcMge1NSignal (implementation of availability/activation evaluation)
...
bool PnlWdbePrcMge1NSignal::evalButViewActive(
			DbsWdbe* dbswdbe
		) {
	// sel()
