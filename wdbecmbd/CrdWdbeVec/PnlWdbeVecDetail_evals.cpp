...
bool PnlWdbeVecDetail::evalButHkuViewAvail(
	...
	// vec.hkuEq(0)|((pre.ixCrdaccSig()&vec.hktEq(sig)&pre.refUnt())|(pre.ixCrdaccUnt()&vec.hktEq(unt)&pre.refVer())|(pre.ixCrdaccSil()&vec.hktEq(unt)&vec.hku.inSbs(sil))|(pre.ixCrdaccSys()&vec.hktEq(sys)&pre.refVer())|(pre.ixCrdaccMod()&vec.hktEq(ctr)&vec.hku.mdl.inSbs(mod)&pre.refUnt())|(pre.ixCrdaccMod()&vec.hktEq(ctr)&vec.hku.mdl.inSbs(mod)&pre.refCvr())|(pre.ixCrdaccMtp()&vec.hktEq(ctr)&vec.hku.mdl.inSbs(mtp)))
