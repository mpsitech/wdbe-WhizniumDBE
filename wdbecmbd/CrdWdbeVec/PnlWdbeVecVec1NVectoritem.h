...
/**
	...
	*/
class PnlWdbeVecVec1NVectoritem : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQVecVec1NVectoritem* rst = NULL, QryWdbeVecVec1NVectoritem::StatShr* statshrqry = NULL, QryWdbeVecVec1NVectoritem::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeVecVec1NVectoritem(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeVecVec1NVectoritem();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeVecVec1NVectoritem::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
