...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQVecVec1NVectoritem* rst = NULL, QryWdbeVecVec1NVectoritem::StatShr* statshrqry = NULL, QryWdbeVecVec1NVectoritem::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
