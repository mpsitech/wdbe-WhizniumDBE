...
#define QRYWDBEVECVEC1NVECTORITEM_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeVecVec1NVectoritem QryWdbeVecVec1NVectoritem::StatApp
#define StatShrQryWdbeVecVec1NVectoritem QryWdbeVecVec1NVectoritem::StatShr
#define StgIacQryWdbeVecVec1NVectoritem QryWdbeVecVec1NVectoritem::StgIac

/**
	* QryWdbeVecVec1NVectoritem
	*/
class QryWdbeVecVec1NVectoritem : public JobWdbe {
...
public:
	QryWdbeVecVec1NVectoritem(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeVecVec1NVectoritem();
...
public:
	...
	WdbeQVecVec1NVectoritem* getRecByJnum(const Sbecore::uint jnum);
