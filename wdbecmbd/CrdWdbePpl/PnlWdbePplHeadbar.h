/**
	...
	* job handler for job PnlWdbePplHeadbar (declarations)
...
/**
	* PnlWdbePplHeadbar
	*/
class PnlWdbePplHeadbar : public JobWdbe {
...
public:
	PnlWdbePplHeadbar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePplHeadbar();
