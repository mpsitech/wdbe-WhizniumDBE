/**
	* \file CrdWdbePpl.h
	* job handler for job CrdWdbePpl (declarations)
...
#define VecVWdbePplDo CrdWdbePpl::VecVDo
#define VecVWdbePplSge CrdWdbePpl::VecVSge

#define ContInfWdbePpl CrdWdbePpl::ContInf
#define StatAppWdbePpl CrdWdbePpl::StatApp
#define StatShrWdbePpl CrdWdbePpl::StatShr
#define TagWdbePpl CrdWdbePpl::Tag

#define DpchAppWdbePplDo CrdWdbePpl::DpchAppDo
#define DpchEngWdbePplData CrdWdbePpl::DpchEngData

/**
	* CrdWdbePpl
	*/
class CrdWdbePpl : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDPPL = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdPpl = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdPpl;
...
public:
	CrdWdbePpl(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbePpl();
...
public:
	...
	PnlWdbePplRec* pnlrec;
	PnlWdbePplHeadbar* pnlheadbar;
	PnlWdbePplList* pnllist;
