/**
	* \file PnlWdbePplPpl1NSegment.h
	* job handler for job PnlWdbePplPpl1NSegment (declarations)
...
#ifndef PNLWDBEPPLPPL1NSEGMENT_H
#define PNLWDBEPPLPPL1NSEGMENT_H
...
#define VecVWdbePplPpl1NSegmentDo PnlWdbePplPpl1NSegment::VecVDo

#define ContInfWdbePplPpl1NSegment PnlWdbePplPpl1NSegment::ContInf
#define StatAppWdbePplPpl1NSegment PnlWdbePplPpl1NSegment::StatApp
#define StatShrWdbePplPpl1NSegment PnlWdbePplPpl1NSegment::StatShr
#define StgIacWdbePplPpl1NSegment PnlWdbePplPpl1NSegment::StgIac
#define TagWdbePplPpl1NSegment PnlWdbePplPpl1NSegment::Tag

#define DpchAppWdbePplPpl1NSegmentData PnlWdbePplPpl1NSegment::DpchAppData
#define DpchAppWdbePplPpl1NSegmentDo PnlWdbePplPpl1NSegment::DpchAppDo
#define DpchEngWdbePplPpl1NSegmentData PnlWdbePplPpl1NSegment::DpchEngData

/**
	* PnlWdbePplPpl1NSegment
	*/
class PnlWdbePplPpl1NSegment : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQPplPpl1NSegment* rst = NULL, QryWdbePplPpl1NSegment::StatShr* statshrqry = NULL, QryWdbePplPpl1NSegment::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbePplPpl1NSegment(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbePplPpl1NSegment();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbePplPpl1NSegment::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
