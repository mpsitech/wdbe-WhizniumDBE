/**
	* \file CrdWdbeSns.h
	* job handler for job CrdWdbeSns (declarations)
...
#define VecVWdbeSnsDo CrdWdbeSns::VecVDo
#define VecVWdbeSnsSge CrdWdbeSns::VecVSge

#define ContInfWdbeSns CrdWdbeSns::ContInf
#define StatAppWdbeSns CrdWdbeSns::StatApp
#define StatShrWdbeSns CrdWdbeSns::StatShr
#define TagWdbeSns CrdWdbeSns::Tag

#define DpchAppWdbeSnsDo CrdWdbeSns::DpchAppDo
#define DpchEngWdbeSnsData CrdWdbeSns::DpchEngData

/**
	* CrdWdbeSns
	*/
class CrdWdbeSns : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDSNS = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdSns = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdSns;
...
public:
	CrdWdbeSns(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeSns();
...
public:
	...
	PnlWdbeSnsRec* pnlrec;
	PnlWdbeSnsHeadbar* pnlheadbar;
	PnlWdbeSnsList* pnllist;
