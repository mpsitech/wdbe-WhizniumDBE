/**
	...
	* job handler for job PnlWdbeSnsHeadbar (declarations)
...
/**
	* PnlWdbeSnsHeadbar
	*/
class PnlWdbeSnsHeadbar : public JobWdbe {
...
public:
	PnlWdbeSnsHeadbar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeSnsHeadbar();
