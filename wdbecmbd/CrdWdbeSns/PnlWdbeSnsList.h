/**
	...
	* job handler for job PnlWdbeSnsList (declarations)
...
/**
	* PnlWdbeSnsList
	*/
class PnlWdbeSnsList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQSnsList* rst = NULL, QryWdbeSnsList::StatShr* statshrqry = NULL, QryWdbeSnsList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeSnsList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeSnsList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeSnsList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
