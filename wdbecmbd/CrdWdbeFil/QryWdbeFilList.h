/**
	...
	* job handler for job QryWdbeFilList (declarations)
...
/**
	* QryWdbeFilList
	*/
class QryWdbeFilList : public JobWdbe {
...
public:
	QryWdbeFilList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeFilList();
...
public:
	...
	WdbeQFilList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbeFilMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
