...
void PnlWdbePinAPar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbePinAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWdbePinAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlWdbePinAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbePinAPar"];}();
...
void PnlWdbePinAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbePinAPar::Tag::writeJSON(
...
void PnlWdbePinAPar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePinAParData"];}();
...
void PnlWdbePinAPar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbePinAParDo"];}();
...
void PnlWdbePinAPar::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbePinAParData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbePinAPar::StatApp::writeJSON(me);
