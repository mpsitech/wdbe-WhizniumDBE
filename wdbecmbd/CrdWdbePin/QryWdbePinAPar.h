...
/**
	* QryWdbePinAPar
	*/
class QryWdbePinAPar : public JobWdbe {
...
public:
	QryWdbePinAPar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbePinAPar();
...
public:
	...
	WdbeQPinAPar* getRecByJnum(const Sbecore::uint jnum);
