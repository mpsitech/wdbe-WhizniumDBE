...
/******************************************************************************
 class QryWdbePinList::VecVOrd
 ******************************************************************************/

uint QryWdbePinList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWdbePinList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWdbePinList::StatApp
 ******************************************************************************/

void QryWdbePinList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbePinList";
...
void QryWdbePinList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbePinList";
...
/******************************************************************************
 class QryWdbePinList::StatShr
 ******************************************************************************/

QryWdbePinList::StatShr::StatShr(
			const uint ntot
...
void QryWdbePinList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbePinList";
...
void QryWdbePinList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbePinList";
...
set<uint> QryWdbePinList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbePinList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbePinList::StgIac
 ******************************************************************************/

QryWdbePinList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbePinList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbePinList"];}();
...
bool QryWdbePinList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbePinList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbePinList";
...
void QryWdbePinList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbePinList";
...
void QryWdbePinList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbePinList";
...
set<uint> QryWdbePinList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbePinList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
