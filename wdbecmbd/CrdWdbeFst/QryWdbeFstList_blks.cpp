...
void QryWdbeFstList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWdbeFstList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeFstList";
...
void QryWdbeFstList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeFstList";
...
void QryWdbeFstList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeFstList";
...
void QryWdbeFstList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeFstList";
...
void QryWdbeFstList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
