/**
	* \file PnlWdbeFstList.h
	* job handler for job PnlWdbeFstList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 23 Aug 2020
	* \date modified: 23 Aug 2020
	*/

#ifndef PNLWDBEFSTLIST_H
#define PNLWDBEFSTLIST_H
...
#define VecVWdbeFstListDo PnlWdbeFstList::VecVDo

#define ContIacWdbeFstList PnlWdbeFstList::ContIac
#define ContInfWdbeFstList PnlWdbeFstList::ContInf
#define StatShrWdbeFstList PnlWdbeFstList::StatShr
#define StgIacWdbeFstList PnlWdbeFstList::StgIac
#define TagWdbeFstList PnlWdbeFstList::Tag

#define DpchAppWdbeFstListData PnlWdbeFstList::DpchAppData
#define DpchAppWdbeFstListDo PnlWdbeFstList::DpchAppDo
#define DpchEngWdbeFstListData PnlWdbeFstList::DpchEngData

/**
	* PnlWdbeFstList
	*/
class PnlWdbeFstList : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOFSMWIDTH = 2;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoFsmWidth = 100);

	public:
		Sbecore::uint TcoSrfWidth;
		Sbecore::uint TcoFsmWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQFstList* rst = NULL, QryWdbeFstList::StatShr* statshrqry = NULL, QryWdbeFstList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeFstList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeFstList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeFstList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
