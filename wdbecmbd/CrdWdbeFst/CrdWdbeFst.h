/**
	* \file CrdWdbeFst.h
	* job handler for job CrdWdbeFst (declarations)
...
#define VecVWdbeFstDo CrdWdbeFst::VecVDo
#define VecVWdbeFstSge CrdWdbeFst::VecVSge

#define ContInfWdbeFst CrdWdbeFst::ContInf
#define StatAppWdbeFst CrdWdbeFst::StatApp
#define StatShrWdbeFst CrdWdbeFst::StatShr
#define TagWdbeFst CrdWdbeFst::Tag

#define DpchAppWdbeFstDo CrdWdbeFst::DpchAppDo
#define DpchEngWdbeFstData CrdWdbeFst::DpchEngData

/**
	* CrdWdbeFst
	*/
class CrdWdbeFst : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDFST = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdFst = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdFst;
...
public:
	CrdWdbeFst(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWdbeVPreset = VecWdbeVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWdbeFst();
...
public:
	...
	PnlWdbeFstList* pnllist;
	PnlWdbeFstHeadbar* pnlheadbar;
	PnlWdbeFstRec* pnlrec;
