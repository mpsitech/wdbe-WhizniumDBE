/**
	* \file QryWdbeFstList.h
	* job handler for job QryWdbeFstList (declarations)
...
#ifndef QRYWDBEFSTLIST_H
#define QRYWDBEFSTLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWdbeFstListOrd QryWdbeFstList::VecVOrd

#define StatAppQryWdbeFstList QryWdbeFstList::StatApp
#define StatShrQryWdbeFstList QryWdbeFstList::StatShr
#define StgIacQryWdbeFstList QryWdbeFstList::StgIac

/**
	* QryWdbeFstList
	*/
class QryWdbeFstList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbeFstListOrd)
		*/
	class VecVOrd {

	public:
		static const Sbecore::uint FSM = 1;
	...
	/**
		* StatApp (full: StatAppQryWdbeFstList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeFstList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeFstList)
		*/
...
public:
	QryWdbeFstList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeFstList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preFsm, const bool addwhere);
	...
	WdbeQFstList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWdbeFstMod(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
