/**
	...
	* job handler for job PnlWdbeFstAStep (declarations)
...
/**
	* PnlWdbeFstAStep
	*/
class PnlWdbeFstAStep : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQFstAStep* rst = NULL, QryWdbeFstAStep::StatShr* statshrqry = NULL, QryWdbeFstAStep::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeFstAStep(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeFstAStep();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeFstAStep::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
