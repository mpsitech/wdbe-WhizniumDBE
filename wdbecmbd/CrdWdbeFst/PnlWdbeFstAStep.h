...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQFstAStep* rst = NULL, QryWdbeFstAStep::StatShr* statshrqry = NULL, QryWdbeFstAStep::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
