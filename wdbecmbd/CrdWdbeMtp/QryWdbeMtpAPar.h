/**
	* \file QryWdbeMtpAPar.h
	* job handler for job QryWdbeMtpAPar (declarations)
...
#ifndef QRYWDBEMTPAPAR_H
#define QRYWDBEMTPAPAR_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeMtpAPar QryWdbeMtpAPar::StatApp
#define StatShrQryWdbeMtpAPar QryWdbeMtpAPar::StatShr
#define StgIacQryWdbeMtpAPar QryWdbeMtpAPar::StgIac

/**
	* QryWdbeMtpAPar
	*/
class QryWdbeMtpAPar : public JobWdbe {

public:
	/**
		* StatApp (full: StatAppQryWdbeMtpAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeMtpAPar)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeMtpAPar)
		*/
...
public:
	QryWdbeMtpAPar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeMtpAPar();
...
public:
	...
	WdbeQMtpAPar* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWdbeMdlAparMod_mdlEq(DbsWdbe* dbswdbe, const Sbecore::ubigint jrefTrig);
