...
#define QRYWDBEMTPMDL1NPORT_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWdbeMtpMdl1NPort QryWdbeMtpMdl1NPort::StatApp
#define StatShrQryWdbeMtpMdl1NPort QryWdbeMtpMdl1NPort::StatShr
#define StgIacQryWdbeMtpMdl1NPort QryWdbeMtpMdl1NPort::StgIac

/**
	* QryWdbeMtpMdl1NPort
	*/
class QryWdbeMtpMdl1NPort : public JobWdbe {
...
public:
	QryWdbeMtpMdl1NPort(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeMtpMdl1NPort();
...
public:
	...
	WdbeQMtpMdl1NPort* getRecByJnum(const Sbecore::uint jnum);
