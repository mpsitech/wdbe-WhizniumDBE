...
public:
	...
	public:
		...
		static const Sbecore::uint JREFHSM1NPIPELINE = 9;
		...
		static const Sbecore::uint JREFREF1NSENSITIVITY = 14;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 15;

	public:
		StatShr(const Sbecore::uint ixWdbeVExpstate = VecWdbeVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefKParKey = 0, const Sbecore::ubigint jrefKHdltype = 0, const Sbecore::ubigint jrefAPar = 0, const Sbecore::ubigint jrefMdl1NGeneric = 0, const Sbecore::ubigint jrefTpl1NModule = 0, const Sbecore::ubigint jrefMdl1NPort = 0, const Sbecore::ubigint jrefHsm1NPipeline = 0, const Sbecore::ubigint jrefSup1NModule = 0, const Sbecore::ubigint jrefRef1NFile = 0, const Sbecore::ubigint jrefMge1NSignal = 0, const Sbecore::ubigint jrefRef1NVariable = 0, const Sbecore::ubigint jrefRef1NSensitivity = 0, const bool ButRegularizeActive = true);
