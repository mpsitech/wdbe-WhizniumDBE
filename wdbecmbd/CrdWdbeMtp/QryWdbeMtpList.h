...
#define VecVQryWdbeMtpListOrd QryWdbeMtpList::VecVOrd

#define StatAppQryWdbeMtpList QryWdbeMtpList::StatApp
#define StatShrQryWdbeMtpList QryWdbeMtpList::StatShr
#define StgIacQryWdbeMtpList QryWdbeMtpList::StgIac

/**
	* QryWdbeMtpList
	*/
class QryWdbeMtpList : public JobWdbe {

public:
	/**
		* VecVOrd (full: VecVQryWdbeMtpListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWdbeMtpList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWdbeMtpList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWdbeMtpList)
		*/
...
public:
	QryWdbeMtpList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~QryWdbeMtpList();
...
public:
	...
	WdbeQMtpList* getRecByJnum(const Sbecore::uint jnum);
