/**
	* \file PnlWdbeMtpList.h
	* job handler for job PnlWdbeMtpList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 23 Aug 2020
	* \date modified: 23 Aug 2020
	*/

#ifndef PNLWDBEMTPLIST_H
#define PNLWDBEMTPLIST_H
...
#define VecVWdbeMtpListDo PnlWdbeMtpList::VecVDo

#define ContIacWdbeMtpList PnlWdbeMtpList::ContIac
#define ContInfWdbeMtpList PnlWdbeMtpList::ContInf
#define StatShrWdbeMtpList PnlWdbeMtpList::StatShr
#define StgIacWdbeMtpList PnlWdbeMtpList::StgIac
#define TagWdbeMtpList PnlWdbeMtpList::Tag

#define DpchAppWdbeMtpListData PnlWdbeMtpList::DpchAppData
#define DpchAppWdbeMtpListDo PnlWdbeMtpList::DpchAppDo
#define DpchEngWdbeMtpListData PnlWdbeMtpList::DpchEngData

/**
	* PnlWdbeMtpList
	*/
class PnlWdbeMtpList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpList* rst = NULL, QryWdbeMtpList::StatShr* statshrqry = NULL, QryWdbeMtpList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMtpList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMtpList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMtpList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
