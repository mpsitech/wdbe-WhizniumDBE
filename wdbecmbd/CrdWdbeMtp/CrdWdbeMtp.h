/**
	* \file CrdWdbeMtp.h
	* job handler for job CrdWdbeMtp (declarations)
...
#define VecVWdbeMtpDo CrdWdbeMtp::VecVDo
#define VecVWdbeMtpSge CrdWdbeMtp::VecVSge

#define ContInfWdbeMtp CrdWdbeMtp::ContInf
#define StatAppWdbeMtp CrdWdbeMtp::StatApp
#define StatShrWdbeMtp CrdWdbeMtp::StatShr
#define TagWdbeMtp CrdWdbeMtp::Tag

#define DpchAppWdbeMtpDo CrdWdbeMtp::DpchAppDo
#define DpchEngWdbeMtpData CrdWdbeMtp::DpchEngData

/**
	* CrdWdbeMtp
	*/
class CrdWdbeMtp : public JobWdbe {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDMTP = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdMtp = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdMtp;
...
public:
	CrdWdbeMtp(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbeMtp();
...
public:
	...
	PnlWdbeMtpList* pnllist;
	PnlWdbeMtpHeadbar* pnlheadbar;
	PnlWdbeMtpRec* pnlrec;
