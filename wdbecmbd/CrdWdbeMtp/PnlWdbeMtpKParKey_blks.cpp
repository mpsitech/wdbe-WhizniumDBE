/**
	* \file PnlWdbeMtpKParKey_blks.cpp
	* job handler for job PnlWdbeMtpKParKey (implementation of blocks)
...
void PnlWdbeMtpKParKey::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeMtpKParKey";
...
void PnlWdbeMtpKParKey::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeMtpKParKey";
...
void PnlWdbeMtpKParKey::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeMtpKParKey";
...
void PnlWdbeMtpKParKey::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeMtpKParKey";
...
void PnlWdbeMtpKParKey::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeMtpKParKey";
...
void PnlWdbeMtpKParKey::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeMtpKParKey";
...
bool PnlWdbeMtpKParKey::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeMtpKParKey"];}();
...
void PnlWdbeMtpKParKey::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeMtpKParKey::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeMtpKParKey";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "Parameter keys";
		me["TcoFix"] = "Fixed";
...
void PnlWdbeMtpKParKey::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeMtpKParKey";
...
PnlWdbeMtpKParKey::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPKPARKEYDATA)
		{
};
...
void PnlWdbeMtpKParKey::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeMtpKParKeyData"];}();
...
void PnlWdbeMtpKParKey::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMtpKParKeyData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpKParKey::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPKPARKEYDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeMtpKParKey::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeMtpKParKeyDo"];}();
...
void PnlWdbeMtpKParKey::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMtpKParKeyDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpKParKey::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMTPKPARKEYDATA, jref)
		{
...
void PnlWdbeMtpKParKey::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeMtpKParKey::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeMtpKParKeyData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeMtpKParKey::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeMtpKParKey::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeMtpKParKeyData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeMtpKParKey::StatApp::writeXML(wr);
