/**
	* \file PnlWdbeMtpKHdltype_blks.cpp
	* job handler for job PnlWdbeMtpKHdltype (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::VecVDo
 ******************************************************************************/

uint PnlWdbeMtpKHdltype::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeMtpKHdltype::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::ContInf
 ******************************************************************************/

PnlWdbeMtpKHdltype::ContInf::ContInf(
...
void PnlWdbeMtpKHdltype::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeMtpKHdltype";
...
void PnlWdbeMtpKHdltype::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeMtpKHdltype";
...
set<uint> PnlWdbeMtpKHdltype::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMtpKHdltype::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::StatApp
 ******************************************************************************/

void PnlWdbeMtpKHdltype::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeMtpKHdltype";
...
void PnlWdbeMtpKHdltype::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeMtpKHdltype";
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::StatShr
 ******************************************************************************/

PnlWdbeMtpKHdltype::StatShr::StatShr(
...
void PnlWdbeMtpKHdltype::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeMtpKHdltype";
...
void PnlWdbeMtpKHdltype::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeMtpKHdltype";
...
set<uint> PnlWdbeMtpKHdltype::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMtpKHdltype::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::StgIac
 ******************************************************************************/

PnlWdbeMtpKHdltype::StgIac::StgIac(
...
bool PnlWdbeMtpKHdltype::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeMtpKHdltype"];}();
...
bool PnlWdbeMtpKHdltype::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeMtpKHdltype");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeMtpKHdltype";
...
void PnlWdbeMtpKHdltype::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeMtpKHdltype";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	me["TcoFixWidth"] = (Json::Value::UInt) TcoFixWidth;
	me["TcoSrfWidth"] = (Json::Value::UInt) TcoSrfWidth;
	me["TcoAvlWidth"] = (Json::Value::UInt) TcoAvlWidth;
	me["TcoImpWidth"] = (Json::Value::UInt) TcoImpWidth;
	me["TcoTitWidth"] = (Json::Value::UInt) TcoTitWidth;
	me["TcoCmtWidth"] = (Json::Value::UInt) TcoCmtWidth;
};

void PnlWdbeMtpKHdltype::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeMtpKHdltype";
...
set<uint> PnlWdbeMtpKHdltype::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeMtpKHdltype::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::Tag
 ******************************************************************************/

void PnlWdbeMtpKHdltype::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeMtpKHdltype";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "HDL data types";
		me["TcoFix"] = "Fixed";
...
void PnlWdbeMtpKHdltype::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeMtpKHdltype";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "HDL data types");
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::DpchAppData
 ******************************************************************************/

PnlWdbeMtpKHdltype::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPKHDLTYPEDATA)
		{
};

string PnlWdbeMtpKHdltype::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMtpKHdltype::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeMtpKHdltypeData"];}();
...
void PnlWdbeMtpKHdltype::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMtpKHdltypeData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::DpchAppDo
 ******************************************************************************/

PnlWdbeMtpKHdltype::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPKHDLTYPEDO)
		{
	ixVDo = 0;
};

string PnlWdbeMtpKHdltype::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMtpKHdltype::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeMtpKHdltypeDo"];}();
...
void PnlWdbeMtpKHdltype::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMtpKHdltypeDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeMtpKHdltype::DpchEngData
 ******************************************************************************/

PnlWdbeMtpKHdltype::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMTPKHDLTYPEDATA, jref)
		{
...
string PnlWdbeMtpKHdltype::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeMtpKHdltype::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeMtpKHdltype::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeMtpKHdltypeData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeMtpKHdltype::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeMtpKHdltype::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeMtpKHdltypeData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeMtpKHdltype::StatApp::writeXML(wr);
