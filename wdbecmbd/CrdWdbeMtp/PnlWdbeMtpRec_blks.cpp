...
PnlWdbeMtpRec::StatShr::StatShr(
		...
		{
	mask = {IXWDBEVEXPSTATE, JREFDETAIL, JREFKPARKEY, JREFKHDLTYPE, JREFAPAR, JREFMDL1NPORT, JREFHSM1NPIPELINE, JREFTPL1NMODULE, JREFMDL1NGENERIC, JREFSUP1NMODULE, JREFREF1NVARIABLE, JREFREF1NSENSITIVITY, JREFMGE1NSIGNAL, JREFREF1NFILE, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWdbeMtpRec::StatShr::diff(
	...
	diffitems = {IXWDBEVEXPSTATE, JREFDETAIL, JREFKPARKEY, JREFKHDLTYPE, JREFAPAR, JREFMDL1NPORT, JREFHSM1NPIPELINE, JREFTPL1NMODULE, JREFMDL1NGENERIC, JREFSUP1NMODULE, JREFREF1NVARIABLE, JREFREF1NSENSITIVITY, JREFMGE1NSIGNAL, JREFREF1NFILE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
