/**
	* \file QryWdbeMtpAPar_blks.cpp
	* job handler for job QryWdbeMtpAPar (implementation of blocks)
...
/******************************************************************************
 class QryWdbeMtpAPar::StatApp
 ******************************************************************************/

void QryWdbeMtpAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeMtpAPar";
...
void QryWdbeMtpAPar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeMtpAPar";
...
/******************************************************************************
 class QryWdbeMtpAPar::StatShr
 ******************************************************************************/

QryWdbeMtpAPar::StatShr::StatShr(
			const uint ntot
...
void QryWdbeMtpAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeMtpAPar";
...
void QryWdbeMtpAPar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeMtpAPar";
...
set<uint> QryWdbeMtpAPar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMtpAPar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeMtpAPar::StgIac
 ******************************************************************************/

QryWdbeMtpAPar::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeMtpAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWdbeMtpAPar"];}();
...
bool QryWdbeMtpAPar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeMtpAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeMtpAPar";
...
void QryWdbeMtpAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeMtpAPar";
...
void QryWdbeMtpAPar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeMtpAPar";
...
set<uint> QryWdbeMtpAPar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMtpAPar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
