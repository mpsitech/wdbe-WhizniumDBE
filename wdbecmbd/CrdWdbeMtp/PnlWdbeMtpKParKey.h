...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpKParKey* rst = NULL, QryWdbeMtpKParKey::StatShr* statshrqry = NULL, QryWdbeMtpKParKey::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
