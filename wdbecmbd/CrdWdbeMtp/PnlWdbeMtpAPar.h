...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpAPar* rst = NULL, QryWdbeMtpAPar::StatShr* statshrqry = NULL, QryWdbeMtpAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
