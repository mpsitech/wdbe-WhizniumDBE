...
#define VecVWdbeMtpAParDo PnlWdbeMtpAPar::VecVDo

#define ContInfWdbeMtpAPar PnlWdbeMtpAPar::ContInf
#define StatAppWdbeMtpAPar PnlWdbeMtpAPar::StatApp
#define StatShrWdbeMtpAPar PnlWdbeMtpAPar::StatShr
#define StgIacWdbeMtpAPar PnlWdbeMtpAPar::StgIac
#define TagWdbeMtpAPar PnlWdbeMtpAPar::Tag

#define DpchAppWdbeMtpAParData PnlWdbeMtpAPar::DpchAppData
#define DpchAppWdbeMtpAParDo PnlWdbeMtpAPar::DpchAppDo
#define DpchEngWdbeMtpAParData PnlWdbeMtpAPar::DpchEngData

/**
	* PnlWdbeMtpAPar
	*/
class PnlWdbeMtpAPar : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpAPar* rst = NULL, QryWdbeMtpAPar::StatShr* statshrqry = NULL, QryWdbeMtpAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMtpAPar(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMtpAPar();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMtpAPar::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
