...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpSup1NModule* rst = NULL, QryWdbeMtpSup1NModule::StatShr* statshrqry = NULL, QryWdbeMtpSup1NModule::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
