/**
	* \file PnlWdbeMtpSup1NModule.h
	* job handler for job PnlWdbeMtpSup1NModule (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEMTPSUP1NMODULE_H
#define PNLWDBEMTPSUP1NMODULE_H
...
#define VecVWdbeMtpSup1NModuleDo PnlWdbeMtpSup1NModule::VecVDo

#define ContInfWdbeMtpSup1NModule PnlWdbeMtpSup1NModule::ContInf
#define StatAppWdbeMtpSup1NModule PnlWdbeMtpSup1NModule::StatApp
#define StatShrWdbeMtpSup1NModule PnlWdbeMtpSup1NModule::StatShr
#define StgIacWdbeMtpSup1NModule PnlWdbeMtpSup1NModule::StgIac
#define TagWdbeMtpSup1NModule PnlWdbeMtpSup1NModule::Tag

#define DpchAppWdbeMtpSup1NModuleData PnlWdbeMtpSup1NModule::DpchAppData
#define DpchAppWdbeMtpSup1NModuleDo PnlWdbeMtpSup1NModule::DpchAppDo
#define DpchEngWdbeMtpSup1NModuleData PnlWdbeMtpSup1NModule::DpchEngData

/**
	* PnlWdbeMtpSup1NModule
	*/
class PnlWdbeMtpSup1NModule : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpSup1NModule* rst = NULL, QryWdbeMtpSup1NModule::StatShr* statshrqry = NULL, QryWdbeMtpSup1NModule::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMtpSup1NModule(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMtpSup1NModule();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMtpSup1NModule::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
