...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpKHdltype* rst = NULL, QryWdbeMtpKHdltype::StatShr* statshrqry = NULL, QryWdbeMtpKHdltype::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
