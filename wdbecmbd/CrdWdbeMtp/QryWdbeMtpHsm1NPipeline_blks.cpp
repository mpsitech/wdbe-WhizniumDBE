/**
	* \file QryWdbeMtpHsm1NPipeline_blks.cpp
	* job handler for job QryWdbeMtpHsm1NPipeline (implementation of blocks)
...
/******************************************************************************
 class QryWdbeMtpHsm1NPipeline::StatApp
 ******************************************************************************/

void QryWdbeMtpHsm1NPipeline::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWdbeMtpHsm1NPipeline";
...
void QryWdbeMtpHsm1NPipeline::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWdbeMtpHsm1NPipeline";
...
/******************************************************************************
 class QryWdbeMtpHsm1NPipeline::StatShr
 ******************************************************************************/

QryWdbeMtpHsm1NPipeline::StatShr::StatShr(
			const uint ntot
...
void QryWdbeMtpHsm1NPipeline::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWdbeMtpHsm1NPipeline";
...
void QryWdbeMtpHsm1NPipeline::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWdbeMtpHsm1NPipeline";
...
set<uint> QryWdbeMtpHsm1NPipeline::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMtpHsm1NPipeline::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWdbeMtpHsm1NPipeline::StgIac
 ******************************************************************************/

QryWdbeMtpHsm1NPipeline::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWdbeMtpHsm1NPipeline::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWdbeMtpHsm1NPipeline");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWdbeMtpHsm1NPipeline";
...
void QryWdbeMtpHsm1NPipeline::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWdbeMtpHsm1NPipeline";
...
void QryWdbeMtpHsm1NPipeline::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWdbeMtpHsm1NPipeline";
...
set<uint> QryWdbeMtpHsm1NPipeline::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWdbeMtpHsm1NPipeline::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
