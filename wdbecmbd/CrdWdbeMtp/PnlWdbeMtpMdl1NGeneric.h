/**
	* \file PnlWdbeMtpMdl1NGeneric.h
	* job handler for job PnlWdbeMtpMdl1NGeneric (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEMTPMDL1NGENERIC_H
#define PNLWDBEMTPMDL1NGENERIC_H
...
#define VecVWdbeMtpMdl1NGenericDo PnlWdbeMtpMdl1NGeneric::VecVDo

#define ContInfWdbeMtpMdl1NGeneric PnlWdbeMtpMdl1NGeneric::ContInf
#define StatAppWdbeMtpMdl1NGeneric PnlWdbeMtpMdl1NGeneric::StatApp
#define StatShrWdbeMtpMdl1NGeneric PnlWdbeMtpMdl1NGeneric::StatShr
#define StgIacWdbeMtpMdl1NGeneric PnlWdbeMtpMdl1NGeneric::StgIac
#define TagWdbeMtpMdl1NGeneric PnlWdbeMtpMdl1NGeneric::Tag

#define DpchAppWdbeMtpMdl1NGenericData PnlWdbeMtpMdl1NGeneric::DpchAppData
#define DpchAppWdbeMtpMdl1NGenericDo PnlWdbeMtpMdl1NGeneric::DpchAppDo
#define DpchEngWdbeMtpMdl1NGenericData PnlWdbeMtpMdl1NGeneric::DpchEngData

/**
	* PnlWdbeMtpMdl1NGeneric
	*/
class PnlWdbeMtpMdl1NGeneric : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpMdl1NGeneric* rst = NULL, QryWdbeMtpMdl1NGeneric::StatShr* statshrqry = NULL, QryWdbeMtpMdl1NGeneric::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMtpMdl1NGeneric(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMtpMdl1NGeneric();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMtpMdl1NGeneric::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
