...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpMdl1NGeneric* rst = NULL, QryWdbeMtpMdl1NGeneric::StatShr* statshrqry = NULL, QryWdbeMtpMdl1NGeneric::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
