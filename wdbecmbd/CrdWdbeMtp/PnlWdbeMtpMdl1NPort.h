...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpMdl1NPort* rst = NULL, QryWdbeMtpMdl1NPort::StatShr* statshrqry = NULL, QryWdbeMtpMdl1NPort::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
