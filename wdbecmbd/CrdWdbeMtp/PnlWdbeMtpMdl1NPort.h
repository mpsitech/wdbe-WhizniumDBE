/**
	* \file PnlWdbeMtpMdl1NPort.h
	* job handler for job PnlWdbeMtpMdl1NPort (declarations)
...
#ifndef PNLWDBEMTPMDL1NPORT_H
#define PNLWDBEMTPMDL1NPORT_H
...
#define VecVWdbeMtpMdl1NPortDo PnlWdbeMtpMdl1NPort::VecVDo

#define ContInfWdbeMtpMdl1NPort PnlWdbeMtpMdl1NPort::ContInf
#define StatAppWdbeMtpMdl1NPort PnlWdbeMtpMdl1NPort::StatApp
#define StatShrWdbeMtpMdl1NPort PnlWdbeMtpMdl1NPort::StatShr
#define StgIacWdbeMtpMdl1NPort PnlWdbeMtpMdl1NPort::StgIac
#define TagWdbeMtpMdl1NPort PnlWdbeMtpMdl1NPort::Tag

#define DpchAppWdbeMtpMdl1NPortData PnlWdbeMtpMdl1NPort::DpchAppData
#define DpchAppWdbeMtpMdl1NPortDo PnlWdbeMtpMdl1NPort::DpchAppDo
#define DpchEngWdbeMtpMdl1NPortData PnlWdbeMtpMdl1NPort::DpchEngData

/**
	* PnlWdbeMtpMdl1NPort
	*/
class PnlWdbeMtpMdl1NPort : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQMtpMdl1NPort* rst = NULL, QryWdbeMtpMdl1NPort::StatShr* statshrqry = NULL, QryWdbeMtpMdl1NPort::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeMtpMdl1NPort(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeMtpMdl1NPort();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeMtpMdl1NPort::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
