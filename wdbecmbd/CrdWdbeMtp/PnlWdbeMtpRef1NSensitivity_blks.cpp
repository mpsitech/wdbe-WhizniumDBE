/**
	* \file PnlWdbeMtpRef1NSensitivity_blks.cpp
	* job handler for job PnlWdbeMtpRef1NSensitivity (implementation of blocks)
...
void PnlWdbeMtpRef1NSensitivity::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeMtpRef1NSensitivity";
...
void PnlWdbeMtpRef1NSensitivity::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWdbeMtpRef1NSensitivity";
...
void PnlWdbeMtpRef1NSensitivity::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeMtpRef1NSensitivity";
...
void PnlWdbeMtpRef1NSensitivity::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeMtpRef1NSensitivity";
...
void PnlWdbeMtpRef1NSensitivity::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeMtpRef1NSensitivity";
...
void PnlWdbeMtpRef1NSensitivity::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeMtpRef1NSensitivity";
...
void PnlWdbeMtpRef1NSensitivity::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWdbeMtpRef1NSensitivity::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeMtpRef1NSensitivity";
...
void PnlWdbeMtpRef1NSensitivity::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeMtpRef1NSensitivity";
...
PnlWdbeMtpRef1NSensitivity::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPREF1NSENSITIVITYDATA)
		{
};
...
void PnlWdbeMtpRef1NSensitivity::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMtpRef1NSensitivityData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpRef1NSensitivity::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEMTPREF1NSENSITIVITYDO)
		{
	ixVDo = 0;
};
...
void PnlWdbeMtpRef1NSensitivity::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeMtpRef1NSensitivityDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWdbeMtpRef1NSensitivity::DpchEngData::DpchEngData(
			...
			, QryWdbeMtpRef1NSensitivity::StatShr* statshrqry
			, QryWdbeMtpRef1NSensitivity::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEMTPREF1NSENSITIVITYDATA, jref)
		{
...
void PnlWdbeMtpRef1NSensitivity::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeMtpRef1NSensitivity::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeMtpRef1NSensitivityData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeMtpRef1NSensitivity::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeMtpRef1NSensitivity::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeMtpRef1NSensitivityData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeMtpRef1NSensitivity::StatApp::writeXML(wr);
