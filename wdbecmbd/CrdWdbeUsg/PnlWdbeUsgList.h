/**
	* \file PnlWdbeUsgList.h
	* job handler for job PnlWdbeUsgList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWDBEUSGLIST_H
#define PNLWDBEUSGLIST_H
...
#define VecVWdbeUsgListDo PnlWdbeUsgList::VecVDo

#define ContIacWdbeUsgList PnlWdbeUsgList::ContIac
#define ContInfWdbeUsgList PnlWdbeUsgList::ContInf
#define StatShrWdbeUsgList PnlWdbeUsgList::StatShr
#define StgIacWdbeUsgList PnlWdbeUsgList::StgIac
#define TagWdbeUsgList PnlWdbeUsgList::Tag

#define DpchAppWdbeUsgListData PnlWdbeUsgList::DpchAppData
#define DpchAppWdbeUsgListDo PnlWdbeUsgList::DpchAppDo
#define DpchEngWdbeUsgListData PnlWdbeUsgList::DpchEngData

/**
	* PnlWdbeUsgList
	*/
class PnlWdbeUsgList : public JobWdbe {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWdbeQUsgList* rst = NULL, QryWdbeUsgList::StatShr* statshrqry = NULL, QryWdbeUsgList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWdbeUsgList(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeUsgList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWdbe* dbswdbe, QryWdbeUsgList::StgIac* _stgiacqry, DpchEngWdbe** dpcheng);
