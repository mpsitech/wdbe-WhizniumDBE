/**
	* \file CrdWdbeUsg_blks.cpp
	* job handler for job CrdWdbeUsg (implementation of blocks)
...
void CrdWdbeUsg::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void CrdWdbeUsg::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeUsg";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	me["numFSge"] = (Json::Value::UInt) numFSge;
	me["MrlAppHlp"] = MrlAppHlp;
	me["MtxCrdUsg"] = MtxCrdUsg;
};

void CrdWdbeUsg::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeUsg";
...
void CrdWdbeUsg::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	if (difftag.length() == 0) difftag = "StatAppWdbeUsg";
...
void CrdWdbeUsg::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVReqitmode
	...
	else itemtag = "StatitemAppWdbeUsg";
...
void CrdWdbeUsg::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeUsg";
...
void CrdWdbeUsg::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeUsg";
...
void CrdWdbeUsg::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeUsg";
...
CrdWdbeUsg::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEUSGDO)
		{
	ixVDo = 0;
};
...
void CrdWdbeUsg::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUsgDo"];}();
...
void CrdWdbeUsg::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeUsgDo");
	else
...
CrdWdbeUsg::DpchEngData::DpchEngData(
			...
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEUSGDATA, jref)
		{
...
void CrdWdbeUsg::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void CrdWdbeUsg::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeUsgData"] = Json::Value(Json::objectValue);
...
void CrdWdbeUsg::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeUsgData");
