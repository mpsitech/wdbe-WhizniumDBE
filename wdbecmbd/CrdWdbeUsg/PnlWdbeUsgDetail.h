/**
	...
	* job handler for job PnlWdbeUsgDetail (declarations)
...
/**
	* PnlWdbeUsgDetail
	*/
class PnlWdbeUsgDetail : public JobWdbe {
...
public:
	PnlWdbeUsgDetail(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale);
	~PnlWdbeUsgDetail();
...
public:
	...
	void refreshRecUsg(DbsWdbe* dbswdbe, std::set<Sbecore::uint>& moditems);
