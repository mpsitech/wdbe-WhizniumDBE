/**
	* \file CrdWdbeUsg.h
	* job handler for job CrdWdbeUsg (declarations)
...
#define VecVWdbeUsgDo CrdWdbeUsg::VecVDo
#define VecVWdbeUsgSge CrdWdbeUsg::VecVSge

#define ContInfWdbeUsg CrdWdbeUsg::ContInf
#define StatAppWdbeUsg CrdWdbeUsg::StatApp
#define StatShrWdbeUsg CrdWdbeUsg::StatShr
#define TagWdbeUsg CrdWdbeUsg::Tag

#define DpchAppWdbeUsgDo CrdWdbeUsg::DpchAppDo
#define DpchEngWdbeUsgData CrdWdbeUsg::DpchEngData

/**
	* CrdWdbeUsg
	*/
class CrdWdbeUsg : public JobWdbe {

public:
	/**
		* VecVDo (full: VecVWdbeUsgDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppWdbeUsgDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWdbeUsgData)
		*/
...
public:
	CrdWdbeUsg(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbeUsg();
...
public:
	...
	PnlWdbeUsgList* pnllist;
	PnlWdbeUsgHeadbar* pnlheadbar;
	PnlWdbeUsgRec* pnlrec;
