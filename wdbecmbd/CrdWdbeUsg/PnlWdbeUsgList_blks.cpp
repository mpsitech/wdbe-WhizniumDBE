/**
	* \file PnlWdbeUsgList_blks.cpp
	* job handler for job PnlWdbeUsgList (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeUsgList::VecVDo
 ******************************************************************************/

uint PnlWdbeUsgList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeUsgList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeUsgList::ContIac
 ******************************************************************************/

PnlWdbeUsgList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
		{
...
bool PnlWdbeUsgList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWdbeUsgList"];}();
...
bool PnlWdbeUsgList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWdbeUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWdbeUsgList";
...
void PnlWdbeUsgList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWdbeUsgList";
...
void PnlWdbeUsgList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWdbeUsgList";
...
set<uint> PnlWdbeUsgList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeUsgList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeUsgList::ContInf
 ******************************************************************************/

PnlWdbeUsgList::ContInf::ContInf(
...
void PnlWdbeUsgList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeUsgList";
...
void PnlWdbeUsgList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWdbeUsgList";
...
set<uint> PnlWdbeUsgList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeUsgList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeUsgList::StatShr
 ******************************************************************************/

PnlWdbeUsgList::StatShr::StatShr(
...
void PnlWdbeUsgList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeUsgList";
...
void PnlWdbeUsgList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWdbeUsgList";
...
set<uint> PnlWdbeUsgList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeUsgList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeUsgList::StgIac
 ******************************************************************************/

PnlWdbeUsgList::StgIac::StgIac(
...
bool PnlWdbeUsgList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeUsgList"];}();
...
bool PnlWdbeUsgList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeUsgList";
...
void PnlWdbeUsgList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeUsgList";
...
void PnlWdbeUsgList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeUsgList";
...
set<uint> PnlWdbeUsgList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeUsgList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeUsgList::Tag
 ******************************************************************************/

void PnlWdbeUsgList::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeUsgList";
...
void PnlWdbeUsgList::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeUsgList";
...
/******************************************************************************
 class PnlWdbeUsgList::DpchAppData
 ******************************************************************************/

PnlWdbeUsgList::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEUSGLISTDATA)
		{
};

string PnlWdbeUsgList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeUsgList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUsgListData"];}();
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWdbeUsgList::StgIac();
	};
};

void PnlWdbeUsgList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeUsgListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeUsgList::DpchAppDo
 ******************************************************************************/

PnlWdbeUsgList::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBEUSGLISTDO)
		{
	ixVDo = 0;
};

string PnlWdbeUsgList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeUsgList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeUsgListDo"];}();
...
void PnlWdbeUsgList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeUsgListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeUsgList::DpchEngData
 ******************************************************************************/

PnlWdbeUsgList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, QryWdbeUsgList::StatShr* statshrqry
			, QryWdbeUsgList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBEUSGLISTDATA, jref)
		{
...
string PnlWdbeUsgList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeUsgList::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeUsgList::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeUsgListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeUsgList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeUsgList::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeUsgListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeUsgList::StatApp::writeXML(wr);
