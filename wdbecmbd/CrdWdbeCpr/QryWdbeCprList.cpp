...
void QryWdbeCprList::rerun_orderSQL(
	...
	if (preIxOrd == VecVOrd::TYP) sqlstr += " ORDER BY TblWdbeMCoreproject.ixVBasetype ASC";
	else if (preIxOrd == VecVOrd::CVR) sqlstr += " ORDER BY TblWdbeMCoreproject.refWdbeMCoreversion ASC";
...
void QryWdbeCprList::handleCall(
	...
	if (call->ixVCall == VecWdbeVCall::CALLWDBECPRMOD) {
