/**
	* \file CrdWdbeCpr.h
	* job handler for job CrdWdbeCpr (declarations)
...
/**
	* CrdWdbeCpr
	*/
class CrdWdbeCpr : public JobWdbe {
...
public:
	CrdWdbeCpr(XchgWdbe* xchg, DbsWdbe* dbswdbe, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWdbeVLocale, const Sbecore::ubigint ref = 0);
	~CrdWdbeCpr();
