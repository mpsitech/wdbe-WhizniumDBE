/**
	* \file PnlWdbeCprMNPerson_blks.cpp
	* job handler for job PnlWdbeCprMNPerson (implementation of blocks)
...
/******************************************************************************
 class PnlWdbeCprMNPerson::VecVDo
 ******************************************************************************/

uint PnlWdbeCprMNPerson::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWdbeCprMNPerson::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWdbeCprMNPerson::ContInf
 ******************************************************************************/

PnlWdbeCprMNPerson::ContInf::ContInf(
...
void PnlWdbeCprMNPerson::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWdbeCprMNPerson";
...
void PnlWdbeCprMNPerson::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWdbeCprMNPerson";
...
set<uint> PnlWdbeCprMNPerson::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCprMNPerson::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeCprMNPerson::StatApp
 ******************************************************************************/

void PnlWdbeCprMNPerson::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWdbeVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWdbeCprMNPerson";
...
void PnlWdbeCprMNPerson::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWdbeVExpstate
	...
	else itemtag = "StatitemAppWdbeCprMNPerson";
...
/******************************************************************************
 class PnlWdbeCprMNPerson::StatShr
 ******************************************************************************/

PnlWdbeCprMNPerson::StatShr::StatShr(
...
void PnlWdbeCprMNPerson::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWdbeCprMNPerson";
...
void PnlWdbeCprMNPerson::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWdbeCprMNPerson";
...
set<uint> PnlWdbeCprMNPerson::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCprMNPerson::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeCprMNPerson::StgIac
 ******************************************************************************/

PnlWdbeCprMNPerson::StgIac::StgIac(
...
bool PnlWdbeCprMNPerson::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWdbeCprMNPerson"];}();
...
bool PnlWdbeCprMNPerson::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWdbeCprMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWdbeCprMNPerson";
...
void PnlWdbeCprMNPerson::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWdbeCprMNPerson";
...
void PnlWdbeCprMNPerson::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWdbeCprMNPerson";
...
set<uint> PnlWdbeCprMNPerson::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWdbeCprMNPerson::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWdbeCprMNPerson::Tag
 ******************************************************************************/

void PnlWdbeCprMNPerson::Tag::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWdbeCprMNPerson";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
		me["Cpt"] = "Contributing persons";
		me["TcoMref"] = "Person";
		me["TcoSta"] = "Starting";
		me["TcoSto"] = "Ending";
		me["TcoFct"] = "Function";
...
void PnlWdbeCprMNPerson::Tag::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWdbeCprMNPerson";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWdbeVLocale == VecWdbeVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Contributing persons");
			writeStringAttr(wr, itemtag, "sref", "TcoMref", "Person");
			writeStringAttr(wr, itemtag, "sref", "TcoSta", "Starting");
			writeStringAttr(wr, itemtag, "sref", "TcoSto", "Ending");
...
/******************************************************************************
 class PnlWdbeCprMNPerson::DpchAppData
 ******************************************************************************/

PnlWdbeCprMNPerson::DpchAppData::DpchAppData() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBECPRMNPERSONDATA)
		{
};

string PnlWdbeCprMNPerson::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCprMNPerson::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeCprMNPersonData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWdbeCprMNPerson::StgIac();
	};
};

void PnlWdbeCprMNPerson::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeCprMNPersonData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeCprMNPerson::DpchAppDo
 ******************************************************************************/

PnlWdbeCprMNPerson::DpchAppDo::DpchAppDo() :
			DpchAppWdbe(VecWdbeVDpch::DPCHAPPWDBECPRMNPERSONDO)
		{
	ixVDo = 0;
};

string PnlWdbeCprMNPerson::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCprMNPerson::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWdbeCprMNPersonDo"];}();
...
void PnlWdbeCprMNPerson::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWdbeCprMNPersonDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWdbeCprMNPerson::DpchEngData
 ******************************************************************************/

PnlWdbeCprMNPerson::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWdbeCprMNPerson::StatShr* statshrqry
			, QryWdbeCprMNPerson::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWdbe(VecWdbeVDpch::DPCHENGWDBECPRMNPERSONDATA, jref)
		{
...
string PnlWdbeCprMNPerson::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWdbeCprMNPerson::DpchEngData::merge(
			DpchEngWdbe* dpcheng
		) {
...
void PnlWdbeCprMNPerson::DpchEngData::writeJSON(
			const uint ixWdbeVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWdbeCprMNPersonData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWdbeCprMNPerson::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWdbeCprMNPerson::DpchEngData::writeXML(
			const uint ixWdbeVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWdbeCprMNPersonData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wdbe");
		...
		if (has(STATAPPQRY)) QryWdbeCprMNPerson::StatApp::writeXML(wr);
